#  西藏到Digital Ocean各机房的测速数据（20180918） 
...
西藏移动到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
阿姆斯特丹 | 8个 | 0 | 352ms | 16% | 纽约 | 11个 | 0 | 387ms | 6%  
伦敦 | 4个 | 0 | 352ms | 18% | 旧金山 | 8个 | 0 | 401ms | 8%  
新加坡 | 4个 | 0 | 361ms | 6% | 多伦多 | 4个 | 0 | 404ms | 4%  
均值 | 47个 | 0 | 381ms | 9% | 班加罗尔 | 4个 | 0 | 407ms | 6%  
法兰克福 | 4个 | 0 | 383ms | 14% |  |  |  |  |   
