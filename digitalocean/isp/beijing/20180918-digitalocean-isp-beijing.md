#  北京到Digital Ocean各机房的测速数据（20180918） 
...
北京全部运营商到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 7个 | 0 | 217ms | 3% | 法兰克福 | 8个 | 0 | 282ms | 1%  
旧金山 | 17个 | 0 | 242ms | 7% | 伦敦 | 7个 | 0 | 289ms | 0  
多伦多 | 8个 | 0 | 254ms | 8% | 班加罗尔 | 8个 | 0 | 292ms | 0  
纽约 | 22个 | 0 | 257ms | 0 | 阿姆斯特丹 | 15个 | 0 | 301ms | 3%  
均值 | 92个 | 0 | 266ms | 2% |  |  |  |  |   
...
北京电信到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 4个 | 0 | 311ms | 0 | 法兰克福 | 4个 | 0 | 246ms | 0  
旧金山 | 8个 | 0 | 242ms | 20% | 伦敦 | 4个 | 0 | 247ms | 0  
多伦多 | 4个 | 0 | 232ms | 0 | 班加罗尔 | 4个 | 0 | 388ms | 0  
纽约 | 12个 | 0 | 274ms | 0 | 阿姆斯特丹 | 8个 | 0 | 266ms | 2%  
均值 | 48个 | 0 | 272ms | 3% |  |  |  |  |   
...
北京联通到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 2个 | 0 | 268ms | 10% | 法兰克福 | 2个 | 0 | 359ms | 5%  
旧金山 | 6个 | 0 | 244ms | 1% | 伦敦 | 2个 | 0 | 376ms | 0  
多伦多 | 2个 | 0 | 273ms | 25% | 班加罗尔 | 2个 | 0 | 219ms | 0  
纽约 | 7个 | 0 | 253ms | 0 | 阿姆斯特丹 | 4个 | 0 | 391ms | 7%  
均值 | 27个 | 0 | 288ms | 4% |  |  |  |  |   
  
简评：如果你是来自北京的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **班加罗尔、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

北京移动到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 1个 | 0 | 74ms | 0 | 法兰克福 | 2个 | 0 | 242ms | 0  
旧金山 | 3个 | 0 | 242ms | 0 | 伦敦 | 1个 | 0 | 245ms | 0  
多伦多 | 2个 | 0 | 257ms | 0 | 班加罗尔 | 2个 | 0 | 270ms | 0  
纽约 | 3个 | 0 | 244ms | 0 | 阿姆斯特丹 | 3个 | 0 | 247ms | 0  
均值 | 17个 | 0 | 238ms | 0 |  |  |  |  |   
