#  北京到Digital Ocean各机房的测速数据（20180527） 
...
北京全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 8个 | 1个 | 180ms | 5% | 纽约 | 24个 | 3个 | 253ms | 0  
旧金山 | 16个 | 2个 | 209ms | 1% | 均值 | 96个 | 12个 | 258ms | 2%  
多伦多 | 8个 | 1个 | 242ms | 1% | 阿姆斯特丹 | 16个 | 2个 | 319ms | 6%  
伦敦 | 8个 | 1个 | 250ms | 0 | 班加罗尔 | 8个 | 1个 | 359ms | 3%  
法兰克福 | 8个 | 1个 | 251ms | 1% |  |  |  |  |   
...
北京电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 4个 | 1个 | 284ms | 12% | 纽约 | 12个 | 3个 | 243ms | 0  
旧金山 | 8个 | 2个 | 209ms | 1% | 均值 | 48个 | 12个 | 258ms | 3%  
多伦多 | 4个 | 1个 | 234ms | 0 | 阿姆斯特丹 | 8个 | 2个 | 307ms | 11%  
伦敦 | 4个 | 1个 | 208ms | 0 | 班加罗尔 | 4个 | 1个 | 373ms | 0  
法兰克福 | 4个 | 1个 | 235ms | 0 |  |  |  |  |   
...
北京联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 3个 | 0 | 176ms | 3% | 纽约 | 9个 | 0 | 243ms | 0  
旧金山 | 6个 | 0 | 210ms | 1% | 均值 | 36个 | 0 | 252ms | 2%  
多伦多 | 3个 | 0 | 237ms | 1% | 阿姆斯特丹 | 6个 | 0 | 323ms | 7%  
伦敦 | 3个 | 0 | 267ms | 0 | 班加罗尔 | 3个 | 0 | 293ms | 5%  
法兰克福 | 3个 | 0 | 256ms | 3% |  |  |  |  |   
  
简评：如果你是来自北京的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山、多伦多、纽约** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

北京移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 1个 | 0 | 79ms | 0 | 纽约 | 3个 | 0 | 273ms | 0  
旧金山 | 2个 | 0 | 208ms | 0 | 均值 | 12个 | 0 | 264ms | 0  
多伦多 | 1个 | 0 | 256ms | 3% | 阿姆斯特丹 | 2个 | 0 | 327ms | 0  
伦敦 | 1个 | 0 | 277ms | 0 | 班加罗尔 | 1个 | 0 | 411ms | 6%  
法兰克福 | 1个 | 0 | 263ms | 0 |  |  |  |  |   
