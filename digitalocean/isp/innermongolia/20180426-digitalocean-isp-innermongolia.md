#  内蒙古到Digital Ocean各机房的测速数据（20180426） 
...
内蒙古全部运营商到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 30个 | 1个 | 224ms | 2% | 纽约 | 86个 | 1个 | 300ms | 2%  
旧金山 | 58个 | 0 | 265ms | 4% | 阿姆斯特丹 | 59个 | 2个 | 301ms | 0  
伦敦 | 30个 | 0 | 276ms | 1% | 法兰克福 | 28个 | 0 | 305ms | 4%  
多伦多 | 30个 | 0 | 287ms | 2% | 班加罗尔 | 30个 | 0 | 393ms | 4%  
均值 | 351个 | 4个 | 293ms | 2% |  |  |  |  |   
...
内蒙古电信到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 10个 | 1个 | 289ms | 2% | 纽约 | 28个 | 1个 | 315ms | 3%  
旧金山 | 18个 | 0 | 324ms | 7% | 阿姆斯特丹 | 20个 | 1个 | 311ms | 1%  
伦敦 | 10个 | 0 | 311ms | 2% | 法兰克福 | 9个 | 0 | 352ms | 8%  
多伦多 | 10个 | 0 | 304ms | 3% | 班加罗尔 | 10个 | 0 | 402ms | 3%  
均值 | 115个 | 3个 | 323ms | 4% |  |  |  |  |   
...
内蒙古联通到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 10个 | 0 | 256ms | 4% | 纽约 | 29个 | 0 | 271ms | 4%  
旧金山 | 20个 | 0 | 227ms | 3% | 阿姆斯特丹 | 20个 | 0 | 264ms | 0  
伦敦 | 10个 | 0 | 262ms | 1% | 法兰克福 | 10个 | 0 | 270ms | 3%  
多伦多 | 10个 | 0 | 268ms | 3% | 班加罗尔 | 10个 | 0 | 375ms | 1%  
均值 | 119个 | 0 | 269ms | 3% |  |  |  |  |   
...
内蒙古移动到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 10个 | 0 | 126ms | 0 | 纽约 | 29个 | 0 | 316ms | 0  
旧金山 | 20个 | 0 | 243ms | 2% | 阿姆斯特丹 | 19个 | 1个 | 329ms | 0  
伦敦 | 10个 | 0 | 255ms | 0 | 法兰克福 | 9个 | 0 | 292ms | 2%  
多伦多 | 10个 | 0 | 288ms | 0 | 班加罗尔 | 10个 | 0 | 402ms | 7%  
均值 | 117个 | 1个 | 287ms | 1% |  |  |  |  |   
