#  内蒙古到Digital Ocean各机房的测速数据（20180527） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![内蒙古到Digital Ocean各机房的测速数据（20180527）](/images/thumbnails/InnerMongolia_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点395个，无超时点。连通概况如下：大陆线路响应均值为282毫秒，最快的三个机房所在地为旧金山、法兰克福、多伦多，最慢的三个为新加坡、阿姆斯特丹、班加罗尔；新加坡丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 内蒙古图表数据

![大陆省份内蒙古到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180527](/images/pingtests/do_20180527/plot_isp_innermongolia_do_20180527.png)

### 全部运营商

内蒙古全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 68个 | 0 | 236ms | 2% | 均值 | 395个 | 0 | 282ms | 2%  
法兰克福 | 34个 | 0 | 258ms | 0 | 新加坡 | 33个 | 0 | 286ms | 14%  
多伦多 | 31个 | 0 | 261ms | 0 | 阿姆斯特丹 | 65个 | 0 | 298ms | 1%  
伦敦 | 31个 | 0 | 264ms | 0 | 班加罗尔 | 33个 | 0 | 398ms | 1%  
纽约 | 100个 | 0 | 282ms | 0 |  |  |  |  |   
...
内蒙古电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 24个 | 0 | 253ms | 5% | 均值 | 138个 | 0 | 288ms | 3%  
法兰克福 | 12个 | 0 | 252ms | 0 | 新加坡 | 12个 | 0 | 352ms | 20%  
多伦多 | 10个 | 0 | 262ms | 0 | 阿姆斯特丹 | 23个 | 0 | 306ms | 2%  
伦敦 | 10个 | 0 | 267ms | 0 | 班加罗尔 | 12个 | 0 | 384ms | 0  
纽约 | 35个 | 0 | 272ms | 0 |  |  |  |  |   
...
内蒙古联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 28个 | 0 | 217ms | 2% | 均值 | 168个 | 0 | 275ms | 1%  
法兰克福 | 14个 | 0 | 252ms | 0 | 新加坡 | 14个 | 0 | 328ms | 12%  
多伦多 | 14个 | 0 | 253ms | 0 | 阿姆斯特丹 | 28个 | 0 | 267ms | 0  
伦敦 | 14个 | 0 | 260ms | 0 | 班加罗尔 | 14个 | 0 | 383ms | 0  
纽约 | 42个 | 0 | 285ms | 0 |  |  |  |  |   
  
简评：如果你是来自内蒙古的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_4)吧！

### 移动

内蒙古移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 16个 | 0 | 237ms | 0 | 均值 | 89个 | 0 | 281ms | 1%  
法兰克福 | 8个 | 0 | 270ms | 0 | 新加坡 | 7个 | 0 | 178ms | 11%  
多伦多 | 7个 | 0 | 268ms | 0 | 阿姆斯特丹 | 14个 | 0 | 320ms | 0  
伦敦 | 7个 | 0 | 264ms | 0 | 班加罗尔 | 7个 | 0 | 428ms | 2%  
纽约 | 23个 | 0 | 289ms | 0 |  |  |  |  |   
  
简评：如果你是来自内蒙古的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **新加坡** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_5)吧！
...
本文最初发表于[内蒙古到Digital Ocean各机房的测速数据（20180527）](https://vps123.top/pingtest/20180527-digitalocean-isp-innermongolia.html)
