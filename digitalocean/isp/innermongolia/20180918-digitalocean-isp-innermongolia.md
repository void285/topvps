#  内蒙古到Digital Ocean各机房的测速数据（20180918） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![内蒙古到Digital Ocean各机房的测速数据（20180918）](/images/thumbnails/InnerMongolia_to_digitalocean.png)
...
本文提供20180918内蒙古到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点650个，无超时点。连通概况如下：大陆线路响应均值为278毫秒，最快的三个机房所在地为法兰克福、伦敦、新加坡，最慢的三个为纽约、多伦多、班加罗尔；新加坡、旧金山、阿姆斯特丹、法兰克福、纽约等7处丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 内蒙古图表数据

![大陆省份内蒙古到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180918](/images/pingtests/do_20180918/plot_isp_innermongolia_do_20180918.png)

### 全部运营商

内蒙古全部运营商到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法兰克福 | 60个 | 0 | 255ms | 11% | 均值 | 650个 | 0 | 278ms | 10%  
伦敦 | 49个 | 0 | 256ms | 7% | 纽约 | 158个 | 0 | 282ms | 10%  
新加坡 | 55个 | 0 | 263ms | 15% | 多伦多 | 49个 | 0 | 291ms | 10%  
阿姆斯特丹 | 108个 | 0 | 273ms | 11% | 班加罗尔 | 53个 | 0 | 325ms | 0  
旧金山 | 118个 | 0 | 278ms | 11% |  |  |  |  |   
...
内蒙古电信到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法兰克福 | 21个 | 0 | 260ms | 8% | 均值 | 221个 | 0 | 295ms | 9%  
伦敦 | 17个 | 0 | 258ms | 3% | 纽约 | 52个 | 0 | 291ms | 7%  
新加坡 | 19个 | 0 | 349ms | 14% | 多伦多 | 16个 | 0 | 300ms | 7%  
阿姆斯特丹 | 37个 | 0 | 286ms | 11% | 班加罗尔 | 18个 | 0 | 385ms | 0  
旧金山 | 41个 | 0 | 274ms | 14% |  |  |  |  |   
...
内蒙古联通到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法兰克福 | 24个 | 0 | 271ms | 18% | 均值 | 284个 | 0 | 290ms | 15%  
伦敦 | 22个 | 0 | 268ms | 12% | 纽约 | 72个 | 0 | 285ms | 18%  
新加坡 | 24个 | 0 | 331ms | 18% | 多伦多 | 22个 | 0 | 291ms | 23%  
阿姆斯特丹 | 48个 | 0 | 277ms | 15% | 班加罗尔 | 24个 | 0 | 344ms | 0  
旧金山 | 48个 | 0 | 283ms | 15% |  |  |  |  |   
...
内蒙古移动到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法兰克福 | 15个 | 0 | 233ms | 6% | 均值 | 145个 | 0 | 249ms | 5%  
伦敦 | 10个 | 0 | 241ms | 5% | 纽约 | 34个 | 0 | 271ms | 4%  
新加坡 | 12个 | 0 | 108ms | 13% | 多伦多 | 11个 | 0 | 282ms | 0  
阿姆斯特丹 | 23个 | 0 | 255ms | 7% | 班加罗尔 | 11个 | 0 | 246ms | 0  
旧金山 | 29个 | 0 | 277ms | 5% |  |  |  |  |   
  
简评：如果你是来自内蒙古的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **伦敦、班加罗尔** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **新加坡、法兰克福** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_7)吧！
...
本文最初发表于[内蒙古到Digital Ocean各机房的测速数据（20180918）](https://vps123.top/pingtest/20180918-digitalocean-isp-innermongolia.html)
