#  福建到Digital Ocean各机房的测速数据（20180918） 
...
福建全部运营商到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 46个 | 0 | 205ms | 3% | 法兰克福 | 45个 | 0 | 290ms | 6%  
旧金山 | 89个 | 1个 | 242ms | 6% | 伦敦 | 39个 | 1个 | 291ms | 8%  
多伦多 | 42个 | 0 | 269ms | 3% | 阿姆斯特丹 | 89个 | 2个 | 294ms | 8%  
均值 | 528个 | 5个 | 277ms | 5% | 班加罗尔 | 46个 | 0 | 345ms | 1%  
纽约 | 132个 | 1个 | 289ms | 3% |  |  |  |  |   
...
福建电信到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 20个 | 0 | 297ms | 2% | 法兰克福 | 20个 | 0 | 271ms | 1%  
旧金山 | 39个 | 1个 | 230ms | 5% | 伦敦 | 16个 | 1个 | 248ms | 2%  
多伦多 | 17个 | 0 | 271ms | 4% | 阿姆斯特丹 | 37个 | 0 | 267ms | 4%  
均值 | 227个 | 3个 | 277ms | 2% | 班加罗尔 | 20个 | 0 | 395ms | 0  
纽约 | 58个 | 1个 | 292ms | 2% |  |  |  |  |   
...
福建联通到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 15个 | 0 | 230ms | 6% | 法兰克福 | 15个 | 0 | 313ms | 12%  
旧金山 | 30个 | 0 | 267ms | 12% | 伦敦 | 14个 | 0 | 332ms | 10%  
多伦多 | 15个 | 0 | 286ms | 6% | 阿姆斯特丹 | 29个 | 1个 | 327ms | 15%  
均值 | 175个 | 1个 | 300ms | 9% | 班加罗尔 | 15个 | 0 | 354ms | 2%  
纽约 | 42个 | 0 | 304ms | 6% |  |  |  |  |   
  
简评：如果你是来自福建的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，请慎重选择部署在 **新加坡** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

福建移动到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 11个 | 0 | 88ms | 0 | 法兰克福 | 10个 | 0 | 286ms | 6%  
旧金山 | 20个 | 0 | 228ms | 1% | 伦敦 | 9个 | 0 | 292ms | 12%  
多伦多 | 10个 | 0 | 251ms | 0 | 阿姆斯特丹 | 23个 | 1个 | 289ms | 6%  
均值 | 126个 | 1个 | 255ms | 3% | 班加罗尔 | 11个 | 0 | 284ms | 0  
纽约 | 32个 | 0 | 272ms | 1% |  |  |  |  |   
