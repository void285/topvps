#  福建到Digital Ocean各机房的测速数据（20180622） 
...
福建全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 61个 | 1个 | 218ms | 1% | 阿姆斯特丹 | 59个 | 0 | 283ms | 1%  
新加坡 | 16个 | 1个 | 245ms | 8% | 法兰克福 | 31个 | 0 | 287ms | 1%  
多伦多 | 31个 | 1个 | 251ms | 0 | 纽约 | 77个 | 2个 | 300ms | 0  
伦敦 | 27个 | 1个 | 269ms | 1% | 班加罗尔 | 31个 | 0 | 370ms | 2%  
均值 | 333个 | 6个 | 277ms | 1% |  |  |  |  |   
...
福建电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 27个 | 1个 | 243ms | 2% | 阿姆斯特丹 | 27个 | 0 | 260ms | 0  
新加坡 | 8个 | 1个 | 322ms | 26% | 法兰克福 | 15个 | 0 | 262ms | 0  
多伦多 | 14个 | 0 | 237ms | 0 | 纽约 | 36个 | 0 | 322ms | 1%  
伦敦 | 13个 | 0 | 250ms | 0 | 班加罗尔 | 14个 | 0 | 414ms | 3%  
均值 | 154个 | 2个 | 281ms | 2% |  |  |  |  |   
...
福建联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 19个 | 0 | 215ms | 0 | 阿姆斯特丹 | 17个 | 0 | 301ms | 2%  
新加坡 | 5个 | 0 | 259ms | 0 | 法兰克福 | 9个 | 0 | 308ms | 1%  
多伦多 | 11个 | 1个 | 250ms | 1% | 纽约 | 24个 | 2个 | 311ms | 1%  
伦敦 | 9个 | 1个 | 281ms | 2% | 班加罗尔 | 10个 | 0 | 371ms | 1%  
均值 | 104个 | 4个 | 288ms | 1% |  |  |  |  |   
  
简评：如果你是来自福建的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山、多伦多** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

福建移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 15个 | 0 | 196ms | 0 | 阿姆斯特丹 | 15个 | 0 | 287ms | 2%  
新加坡 | 3个 | 0 | 154ms | 0 | 法兰克福 | 7个 | 0 | 292ms | 2%  
多伦多 | 6个 | 0 | 265ms | 0 | 纽约 | 17个 | 0 | 269ms | 0  
伦敦 | 5个 | 0 | 277ms | 0 | 班加罗尔 | 7个 | 0 | 324ms | 2%  
均值 | 75个 | 0 | 262ms | 1% |  |  |  |  |   
