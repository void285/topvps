#  黑龙江到Digital Ocean各机房的测速数据（20180622） 
...
黑龙江全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 12个 | 0 | 236ms | 11% | 均值 | 298个 | 6个 | 291ms | 2%  
旧金山 | 52个 | 1个 | 246ms | 2% | 纽约 | 65个 | 1个 | 301ms | 1%  
多伦多 | 32个 | 2个 | 265ms | 1% | 阿姆斯特丹 | 49个 | 0 | 311ms | 5%  
法兰克福 | 31个 | 1个 | 284ms | 1% | 班加罗尔 | 25个 | 1个 | 384ms | 0  
伦敦 | 32个 | 0 | 287ms | 0 |  |  |  |  |   
...
黑龙江电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 3个 | 0 | 353ms | 30% | 均值 | 77个 | 4个 | 294ms | 3%  
旧金山 | 12个 | 0 | 274ms | 1% | 纽约 | 18个 | 1个 | 329ms | 1%  
多伦多 | 9个 | 2个 | 253ms | 0 | 阿姆斯特丹 | 12个 | 0 | 294ms | 9%  
法兰克福 | 8个 | 0 | 219ms | 0 | 班加罗尔 | 6个 | 1个 | 443ms | 0  
伦敦 | 9个 | 0 | 253ms | 0 |  |  |  |  |   
...
黑龙江联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 6个 | 0 | 253ms | 4% | 均值 | 118个 | 2个 | 297ms | 2%  
旧金山 | 22个 | 1个 | 234ms | 3% | 纽约 | 24个 | 0 | 279ms | 2%  
多伦多 | 11个 | 0 | 263ms | 0 | 阿姆斯特丹 | 22个 | 0 | 342ms | 3%  
法兰克福 | 11个 | 1个 | 334ms | 2% | 班加罗尔 | 11个 | 0 | 380ms | 1%  
伦敦 | 11个 | 0 | 303ms | 0 |  |  |  |  |   
...
黑龙江移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 3个 | 0 | 103ms | 0 | 均值 | 103个 | 0 | 281ms | 2%  
旧金山 | 18个 | 0 | 231ms | 1% | 纽约 | 23个 | 0 | 296ms | 1%  
多伦多 | 12个 | 0 | 278ms | 2% | 阿姆斯特丹 | 15个 | 0 | 298ms | 5%  
法兰克福 | 12个 | 0 | 298ms | 3% | 班加罗尔 | 8个 | 0 | 329ms | 0  
伦敦 | 12个 | 0 | 303ms | 1% |  |  |  |  |   
