...
黑龙江全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 36个 | 0 | 170ms | 1% | 伦敦 | 34个 | 0 | 298ms | 3%  
旧金山 | 79个 | 0 | 235ms | 2% | 法兰克福 | 39个 | 0 | 308ms | 8%  
均值 | 451个 | 0 | 287ms | 5% | 阿姆斯特丹 | 74个 | 0 | 332ms | 4%  
纽约 | 115个 | 0 | 289ms | 8% | 班加罗尔 | 36个 | 0 | 368ms | 0  
多伦多 | 38个 | 0 | 294ms | 11% |  |  |  |  |   
...
黑龙江电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 8个 | 0 | 217ms | 2% | 伦敦 | 8个 | 0 | 255ms | 2%  
旧金山 | 20个 | 0 | 237ms | 2% | 法兰克福 | 10个 | 0 | 265ms | 4%  
均值 | 110个 | 0 | 279ms | 2% | 阿姆斯特丹 | 18个 | 0 | 300ms | 1%  
纽约 | 28个 | 0 | 281ms | 4% | 班加罗尔 | 9个 | 0 | 425ms | 1%  
多伦多 | 9个 | 0 | 267ms | 4% |  |  |  |  |   
...
黑龙江联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 15个 | 0 | 159ms | 0 | 伦敦 | 15个 | 0 | 357ms | 4%  
旧金山 | 30个 | 0 | 229ms | 2% | 法兰克福 | 14个 | 0 | 357ms | 15%  
均值 | 176个 | 0 | 300ms | 8% | 阿姆斯特丹 | 30个 | 0 | 373ms | 7%  
纽约 | 43个 | 0 | 286ms | 16% | 班加罗尔 | 14个 | 0 | 360ms | 0  
多伦多 | 15个 | 0 | 290ms | 16% |  |  |  |  |   
...
黑龙江移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 13个 | 0 | 134ms | 2% | 伦敦 | 11个 | 0 | 282ms | 2%  
旧金山 | 29个 | 0 | 238ms | 2% | 法兰克福 | 15个 | 0 | 302ms | 5%  
均值 | 165个 | 0 | 282ms | 4% | 阿姆斯特丹 | 26个 | 0 | 322ms | 4%  
纽约 | 44个 | 0 | 299ms | 4% | 班加罗尔 | 13个 | 0 | 318ms | 0  
多伦多 | 14个 | 0 | 324ms | 14% |  |  |  |  |   
