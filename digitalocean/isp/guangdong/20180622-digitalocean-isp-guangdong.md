#  广东到Digital Ocean各机房的测速数据（20180622） 
...
广东全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 145个 | 2个 | 224ms | 2% | 法兰克福 | 73个 | 1个 | 271ms | 1%  
新加坡 | 29个 | 0 | 225ms | 6% | 阿姆斯特丹 | 144个 | 2个 | 281ms | 1%  
多伦多 | 74个 | 0 | 245ms | 0 | 纽约 | 166个 | 0 | 282ms | 1%  
伦敦 | 73个 | 0 | 255ms | 0 | 班加罗尔 | 74个 | 0 | 315ms | 0  
均值 | 778个 | 5个 | 262ms | 1% |  |  |  |  |   
...
广东电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 83个 | 2个 | 244ms | 4% | 法兰克福 | 38个 | 1个 | 250ms | 1%  
新加坡 | 19个 | 0 | 275ms | 19% | 阿姆斯特丹 | 85个 | 0 | 269ms | 1%  
多伦多 | 43个 | 0 | 231ms | 0 | 纽约 | 97个 | 0 | 283ms | 2%  
伦敦 | 41个 | 0 | 231ms | 1% | 班加罗尔 | 42个 | 0 | 389ms | 1%  
均值 | 448个 | 3个 | 267ms | 2% |  |  |  |  |   
...
广东联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 31个 | 0 | 253ms | 3% | 法兰克福 | 17个 | 0 | 309ms | 2%  
新加坡 | 3个 | 0 | 337ms | 0 | 阿姆斯特丹 | 30个 | 0 | 322ms | 2%  
多伦多 | 13个 | 0 | 267ms | 0 | 纽约 | 32个 | 0 | 319ms | 1%  
伦敦 | 14个 | 0 | 288ms | 0 | 班加罗尔 | 15个 | 0 | 324ms | 0  
均值 | 155个 | 0 | 295ms | 1% |  |  |  |  |   
...
广东移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 31个 | 0 | 175ms | 0 | 法兰克福 | 18个 | 0 | 255ms | 0  
新加坡 | 7个 | 0 | 64ms | 0 | 阿姆斯特丹 | 29个 | 2个 | 251ms | 0  
多伦多 | 18个 | 0 | 236ms | 0 | 纽约 | 37个 | 0 | 245ms | 0  
伦敦 | 18个 | 0 | 247ms | 0 | 班加罗尔 | 17个 | 0 | 233ms | 0  
均值 | 175个 | 2个 | 223ms | 0 |  |  |  |  |   
