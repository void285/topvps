#  广东到Digital Ocean各机房的测速数据（20180514） 
...
广东全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 75个 | 1个 | 164ms | 3% | 伦敦 | 74个 | 2个 | 287ms | 2%  
旧金山 | 153个 | 3个 | 236ms | 3% | 法兰克福 | 81个 | 2个 | 288ms | 5%  
多伦多 | 75个 | 1个 | 270ms | 8% | 阿姆斯特丹 | 159个 | 6个 | 302ms | 3%  
均值 | 920个 | 21个 | 272ms | 4% | 班加罗尔 | 74个 | 1个 | 357ms | 2%  
纽约 | 229个 | 5个 | 280ms | 4% |  |  |  |  |   
...
广东电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 37个 | 1个 | 229ms | 5% | 伦敦 | 40个 | 2个 | 261ms | 0  
旧金山 | 78个 | 1个 | 266ms | 3% | 法兰克福 | 44个 | 2个 | 266ms | 2%  
多伦多 | 42个 | 1个 | 241ms | 1% | 阿姆斯特丹 | 83个 | 4个 | 279ms | 2%  
均值 | 485个 | 16个 | 284ms | 2% | 班加罗尔 | 40个 | 1个 | 465ms | 5%  
纽约 | 121个 | 4个 | 292ms | 0 |  |  |  |  |   
...
广东联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 16个 | 0 | 196ms | 6% | 伦敦 | 19个 | 0 | 349ms | 7%  
旧金山 | 36个 | 1个 | 258ms | 6% | 法兰克福 | 16个 | 0 | 345ms | 13%  
多伦多 | 16个 | 0 | 288ms | 11% | 阿姆斯特丹 | 35个 | 0 | 342ms | 8%  
均值 | 205个 | 2个 | 305ms | 8% | 班加罗尔 | 15个 | 0 | 373ms | 3%  
纽约 | 52个 | 1个 | 303ms | 10% |  |  |  |  |   
  
简评：如果你是来自广东的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，请慎重选择部署在 **新加坡** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

广东移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 22个 | 0 | 67ms | 0 | 伦敦 | 15个 | 0 | 253ms | 0  
旧金山 | 39个 | 1个 | 185ms | 0 | 法兰克福 | 21个 | 0 | 252ms | 0  
多伦多 | 17个 | 0 | 279ms | 12% | 阿姆斯特丹 | 41个 | 2个 | 285ms | 0  
均值 | 230个 | 3个 | 227ms | 1% | 班加罗尔 | 19个 | 0 | 232ms | 0  
纽约 | 56个 | 0 | 245ms | 0 |  |  |  |  |   
