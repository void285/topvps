#  湖南到Digital Ocean各机房的测速数据（20180514） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![湖南到Digital Ocean各机房的测速数据（20180514）](/images/thumbnails/Hunan_to_digitalocean.png)
...
本文提供20180514湖南到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点520个，其中超时点2个。连通概况如下：大陆线路响应均值为279毫秒，最快的三个机房所在地为新加坡、旧金山、均值，最慢的三个为阿姆斯特丹、纽约、班加罗尔；法兰克福、纽约有响应超时情况；多伦多丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 湖南图表数据

![大陆省份湖南到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180514](/images/pingtests/do_20180514/plot_isp_hunan_do_20180514.png)

### 全部运营商

湖南全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 42个 | 0 | 176ms | 3% | 伦敦 | 40个 | 0 | 293ms | 3%  
旧金山 | 93个 | 0 | 229ms | 1% | 阿姆斯特丹 | 89个 | 0 | 294ms | 3%  
均值 | 520个 | 2个 | 279ms | 4% | 纽约 | 123个 | 1个 | 296ms | 5%  
多伦多 | 45个 | 0 | 287ms | 10% | 班加罗尔 | 43个 | 0 | 370ms | 3%  
法兰克福 | 45个 | 1个 | 289ms | 4% |  |  |  |  |   
...
湖南电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 12个 | 0 | 228ms | 4% | 伦敦 | 13个 | 0 | 257ms | 0  
旧金山 | 33个 | 0 | 257ms | 2% | 阿姆斯特丹 | 31个 | 0 | 262ms | 1%  
均值 | 180个 | 1个 | 279ms | 2% | 纽约 | 44个 | 1个 | 302ms | 1%  
多伦多 | 16个 | 0 | 262ms | 5% | 班加罗尔 | 15个 | 0 | 421ms | 2%  
法兰克福 | 16个 | 0 | 255ms | 0 |  |  |  |  |   
  
简评：如果你是来自湖南的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

湖南联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 14个 | 0 | 146ms | 1% | 伦敦 | 14个 | 0 | 358ms | 9%  
旧金山 | 28个 | 0 | 211ms | 2% | 阿姆斯特丹 | 27个 | 0 | 334ms | 8%  
均值 | 161个 | 1个 | 294ms | 8% | 纽约 | 38个 | 0 | 297ms | 12%  
多伦多 | 13个 | 0 | 291ms | 16% | 班加罗尔 | 14个 | 0 | 379ms | 2%  
法兰克福 | 13个 | 1个 | 348ms | 12% |  |  |  |  |   
  
简评：如果你是来自湖南的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

湖南移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 16个 | 0 | 156ms | 4% | 伦敦 | 13个 | 0 | 263ms | 1%  
旧金山 | 32个 | 0 | 220ms | 0 | 阿姆斯特丹 | 31个 | 0 | 286ms | 2%  
均值 | 179个 | 0 | 263ms | 2% | 纽约 | 41个 | 0 | 288ms | 1%  
多伦多 | 16个 | 0 | 308ms | 10% | 班加罗尔 | 14个 | 0 | 310ms | 4%  
法兰克福 | 16个 | 0 | 265ms | 1% |  |  |  |  |   
...
本文最初发表于[湖南到Digital Ocean各机房的测速数据（20180514）](https://vps123.top/pingtest/20180514-digitalocean-isp-hunan.html)
