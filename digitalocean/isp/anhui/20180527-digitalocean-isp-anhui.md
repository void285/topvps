#  安徽到Digital Ocean各机房的测速数据（20180527） 
...
安徽全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 78个 | 1个 | 224ms | 2% | 伦敦 | 40个 | 0 | 280ms | 1%  
新加坡 | 40个 | 0 | 229ms | 18% | 法兰克福 | 39个 | 1个 | 280ms | 2%  
多伦多 | 39个 | 0 | 262ms | 0 | 阿姆斯特丹 | 78个 | 0 | 297ms | 1%  
纽约 | 116个 | 0 | 264ms | 1% | 班加罗尔 | 40个 | 1个 | 353ms | 5%  
均值 | 470个 | 3个 | 267ms | 3% |  |  |  |  |   
...
安徽电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 36个 | 0 | 236ms | 4% | 伦敦 | 19个 | 0 | 230ms | 0  
新加坡 | 19个 | 0 | 310ms | 33% | 法兰克福 | 18个 | 1个 | 231ms | 0  
多伦多 | 18个 | 0 | 243ms | 0 | 阿姆斯特丹 | 36个 | 0 | 235ms | 0  
纽约 | 54个 | 0 | 255ms | 0 | 班加罗尔 | 19个 | 1个 | 378ms | 0  
均值 | 219个 | 2个 | 255ms | 3% |  |  |  |  |   
...
安徽联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 16个 | 1个 | 214ms | 1% | 伦敦 | 7个 | 0 | 325ms | 0  
新加坡 | 7个 | 0 | 254ms | 13% | 法兰克福 | 8个 | 0 | 329ms | 0  
多伦多 | 7个 | 0 | 270ms | 0 | 阿姆斯特丹 | 14个 | 0 | 328ms | 1%  
纽约 | 21个 | 0 | 255ms | 0 | 班加罗尔 | 7个 | 0 | 292ms | 1%  
均值 | 87个 | 1个 | 273ms | 1% |  |  |  |  |   
...
安徽移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 26个 | 0 | 221ms | 3% | 伦敦 | 14个 | 0 | 284ms | 4%  
新加坡 | 14个 | 0 | 122ms | 7% | 法兰克福 | 13个 | 0 | 280ms | 5%  
多伦多 | 14个 | 0 | 273ms | 1% | 阿姆斯特丹 | 28个 | 0 | 327ms | 3%  
纽约 | 41个 | 0 | 281ms | 3% | 班加罗尔 | 14个 | 0 | 387ms | 13%  
均值 | 164个 | 0 | 274ms | 4% |  |  |  |  |   
