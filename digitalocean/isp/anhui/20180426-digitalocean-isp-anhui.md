...
![安徽到Digital Ocean各机房的测速数据（20180426）](/images/thumbnails/Anhui_to_digitalocean.png)
...
![大陆省份安徽到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180426](/images/pingtests/do_20180426/plot_isp_anhui_do_20180426.png)

### 全部运营商

安徽全部运营商到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 36个 | 0 | 187ms | 4% | 阿姆斯特丹 | 76个 | 0 | 292ms | 5%  
旧金山 | 69个 | 0 | 248ms | 3% | 纽约 | 111个 | 0 | 294ms | 2%  
多伦多 | 36个 | 0 | 260ms | 2% | 法兰克福 | 36个 | 0 | 313ms | 13%  
伦敦 | 35个 | 0 | 266ms | 6% | 班加罗尔 | 34个 | 0 | 369ms | 9%  
均值 | 433个 | 0 | 280ms | 5% |  |  |  |  |   
...
安徽电信到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 13个 | 0 | 239ms | 1% | 阿姆斯特丹 | 30个 | 0 | 230ms | 0  
旧金山 | 26个 | 0 | 301ms | 7% | 纽约 | 45个 | 0 | 317ms | 2%  
多伦多 | 13个 | 0 | 240ms | 0 | 法兰克福 | 13个 | 0 | 305ms | 19%  
伦敦 | 12个 | 0 | 222ms | 1% | 班加罗尔 | 12个 | 0 | 420ms | 5%  
均值 | 164个 | 0 | 286ms | 4% |  |  |  |  |   
  
简评：如果你是来自安徽的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **伦敦、阿姆斯特丹、新加坡、多伦多** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

安徽联通到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 7个 | 0 | 207ms | 7% | 阿姆斯特丹 | 14个 | 0 | 314ms | 4%  
旧金山 | 14个 | 0 | 237ms | 4% | 纽约 | 20个 | 0 | 282ms | 1%  
多伦多 | 7个 | 0 | 266ms | 1% | 法兰克福 | 7个 | 0 | 328ms | 13%  
伦敦 | 7个 | 0 | 285ms | 9% | 班加罗尔 | 6个 | 0 | 311ms | 6%  
均值 | 82个 | 0 | 278ms | 5% |  |  |  |  |   
  
简评：如果你是来自安徽的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **新加坡** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

安徽移动到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 16个 | 0 | 114ms | 5% | 阿姆斯特丹 | 32个 | 0 | 331ms | 10%  
旧金山 | 29个 | 0 | 206ms | 0 | 纽约 | 46个 | 0 | 284ms | 2%  
多伦多 | 16个 | 0 | 274ms | 4% | 法兰克福 | 16个 | 0 | 305ms | 8%  
伦敦 | 16个 | 0 | 290ms | 9% | 班加罗尔 | 16个 | 0 | 376ms | 17%  
均值 | 187个 | 0 | 275ms | 6% |  |  |  |  |   
...
本文最初发表于[安徽到Digital Ocean各机房的测速数据（20180426）](https://vps123.top/pingtest/20180426-digitalocean-isp-anhui.html)
