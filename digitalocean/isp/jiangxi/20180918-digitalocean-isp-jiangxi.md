#  江西到Digital Ocean各机房的测速数据（20180918） 
...
江西全部运营商到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 37个 | 0 | 224ms | 6% | 法兰克福 | 40个 | 0 | 289ms | 6%  
旧金山 | 82个 | 0 | 251ms | 7% | 班加罗尔 | 39个 | 0 | 291ms | 2%  
均值 | 459个 | 0 | 278ms | 6% | 伦敦 | 36个 | 0 | 292ms | 8%  
纽约 | 116个 | 0 | 279ms | 3% | 阿姆斯特丹 | 72个 | 0 | 305ms | 8%  
多伦多 | 37个 | 0 | 288ms | 7% |  |  |  |  |   
...
江西电信到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 19个 | 0 | 309ms | 2% | 法兰克福 | 20个 | 0 | 257ms | 2%  
旧金山 | 40个 | 0 | 259ms | 8% | 班加罗尔 | 19个 | 0 | 399ms | 4%  
均值 | 227个 | 0 | 286ms | 4% | 伦敦 | 18个 | 0 | 246ms | 3%  
纽约 | 56个 | 0 | 294ms | 3% | 阿姆斯特丹 | 38个 | 0 | 270ms | 5%  
多伦多 | 17个 | 0 | 300ms | 4% |  |  |  |  |   
...
江西联通到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 6个 | 0 | 246ms | 15% | 法兰克福 | 6个 | 0 | 347ms | 16%  
旧金山 | 12个 | 0 | 248ms | 11% | 班加罗尔 | 6个 | 0 | 187ms | 0  
均值 | 71个 | 0 | 292ms | 11% | 伦敦 | 6个 | 0 | 359ms | 15%  
纽约 | 17个 | 0 | 276ms | 7% | 阿姆斯特丹 | 12个 | 0 | 366ms | 13%  
多伦多 | 6个 | 0 | 307ms | 18% |  |  |  |  |   
  
简评：如果你是来自江西的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **班加罗尔** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **新加坡、旧金山** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

江西移动到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 12个 | 0 | 116ms | 0 | 法兰克福 | 14个 | 0 | 264ms | 0  
旧金山 | 30个 | 0 | 246ms | 1% | 班加罗尔 | 14个 | 0 | 286ms | 1%  
均值 | 161个 | 0 | 254ms | 2% | 伦敦 | 12个 | 0 | 270ms | 7%  
纽约 | 43个 | 0 | 268ms | 0 | 阿姆斯特丹 | 22个 | 0 | 278ms | 6%  
多伦多 | 14个 | 0 | 259ms | 0 |  |  |  |  |   
