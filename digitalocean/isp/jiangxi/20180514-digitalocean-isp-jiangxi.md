#  江西到Digital Ocean各机房的测速数据（20180514） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![江西到Digital Ocean各机房的测速数据（20180514）](/images/thumbnails/Jiangxi_to_digitalocean.png)
...
本文提供20180514江西到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点271个，无超时点。连通概况如下：大陆线路响应均值为282毫秒，最快的三个机房所在地为新加坡、旧金山、均值，最慢的三个为纽约、法兰克福、班加罗尔；多伦多、纽约、法兰克福、伦敦丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 江西图表数据

![大陆省份江西到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180514](/images/pingtests/do_20180514/plot_isp_jiangxi_do_20180514.png)

### 全部运营商

江西全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 22个 | 0 | 181ms | 5% | 阿姆斯特丹 | 46个 | 0 | 303ms | 4%  
旧金山 | 46个 | 0 | 220ms | 2% | 纽约 | 67个 | 0 | 303ms | 11%  
均值 | 271个 | 0 | 282ms | 7% | 法兰克福 | 23个 | 0 | 308ms | 9%  
多伦多 | 22个 | 0 | 288ms | 17% | 班加罗尔 | 24个 | 0 | 314ms | 3%  
伦敦 | 21个 | 0 | 295ms | 5% |  |  |  |  |   
...
江西电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 11个 | 0 | 255ms | 8% | 阿姆斯特丹 | 23个 | 0 | 269ms | 5%  
旧金山 | 24个 | 0 | 247ms | 3% | 纽约 | 34个 | 0 | 298ms | 7%  
均值 | 136个 | 0 | 285ms | 6% | 法兰克福 | 12个 | 0 | 262ms | 9%  
多伦多 | 10个 | 0 | 263ms | 12% | 班加罗尔 | 13个 | 0 | 421ms | 6%  
伦敦 | 9个 | 0 | 267ms | 4% |  |  |  |  |   
  
简评：如果你是来自江西的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

江西联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 2个 | 0 | 173ms | 4% | 阿姆斯特丹 | 4个 | 0 | 341ms | 4%  
旧金山 | 2个 | 0 | 194ms | 1% | 纽约 | 6个 | 0 | 320ms | 17%  
均值 | 22个 | 0 | 295ms | 11% | 法兰克福 | 2个 | 0 | 383ms | 16%  
多伦多 | 2个 | 0 | 299ms | 26% | 班加罗尔 | 2个 | 0 | 220ms | 0  
伦敦 | 2个 | 0 | 333ms | 10% |  |  |  |  |   
  
简评：如果你是来自江西的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山、班加罗尔** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

江西移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 9个 | 0 | 115ms | 1% | 阿姆斯特丹 | 19个 | 0 | 300ms | 2%  
旧金山 | 20个 | 0 | 218ms | 0 | 纽约 | 27个 | 0 | 292ms | 9%  
均值 | 113个 | 0 | 266ms | 4% | 法兰克福 | 9个 | 0 | 280ms | 0  
多伦多 | 10个 | 0 | 301ms | 13% | 班加罗尔 | 9个 | 0 | 303ms | 2%  
伦敦 | 10个 | 0 | 286ms | 1% |  |  |  |  |   
...
本文最初发表于[江西到Digital Ocean各机房的测速数据（20180514）](https://vps123.top/pingtest/20180514-digitalocean-isp-jiangxi.html)
