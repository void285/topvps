...
![辽宁到Digital Ocean各机房的测速数据（20180918）](/images/thumbnails/Liaoning_to_digitalocean.png)
...
**辽宁全部运营商到Digital Ocean各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 60个 | 1个 | 267ms | 12%  
旧金山 | 123个 | 1个 | 267ms | 14%  
伦敦 | 46个 | 0 | 270ms | 6%  
均值 | 666个 | 4个 | 283ms | 10%  
纽约 | 164个 | 0 | 285ms | 8%  
阿姆斯特丹 | 112个 | 1个 | 291ms | 11%  
多伦多 | 49个 | 1个 | 292ms | 10%  
新加坡 | 55个 | 0 | 313ms | 20%  
班加罗尔 | 57个 | 0 | 339ms | 0  
...
**辽宁电信到Digital Ocean各机房的测速数据 [20180918]**
...
**辽宁联通到Digital Ocean各机房的测速数据 [20180918]**
...
**辽宁移动到Digital Ocean各机房的测速数据 [20180918]**
