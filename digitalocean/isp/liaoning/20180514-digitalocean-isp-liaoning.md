#  辽宁到Digital Ocean各机房的测速数据（20180514） 
...
辽宁全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 37个 | 0 | 202ms | 5% | 纽约 | 112个 | 0 | 287ms | 6%  
旧金山 | 78个 | 0 | 238ms | 5% | 伦敦 | 37个 | 0 | 288ms | 8%  
均值 | 445个 | 0 | 275ms | 6% | 阿姆斯特丹 | 77个 | 0 | 316ms | 3%  
法兰克福 | 37个 | 0 | 281ms | 2% | 班加罗尔 | 32个 | 0 | 330ms | 5%  
多伦多 | 35个 | 0 | 285ms | 15% |  |  |  |  |   
...
辽宁电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 12个 | 0 | 218ms | 2% | 纽约 | 36个 | 0 | 298ms | 2%  
旧金山 | 28个 | 0 | 263ms | 3% | 伦敦 | 14个 | 0 | 267ms | 3%  
均值 | 153个 | 0 | 278ms | 3% | 阿姆斯特丹 | 27个 | 0 | 314ms | 2%  
法兰克福 | 12个 | 0 | 246ms | 1% | 班加罗尔 | 12个 | 0 | 385ms | 1%  
多伦多 | 12个 | 0 | 271ms | 8% |  |  |  |  |   
...
辽宁联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 18个 | 0 | 266ms | 12% | 纽约 | 50个 | 0 | 279ms | 10%  
旧金山 | 33个 | 0 | 232ms | 9% | 伦敦 | 17个 | 0 | 280ms | 7%  
均值 | 202个 | 0 | 271ms | 9% | 阿姆斯特丹 | 35个 | 0 | 298ms | 7%  
法兰克福 | 18个 | 0 | 283ms | 6% | 班加罗尔 | 16个 | 0 | 287ms | 8%  
多伦多 | 15个 | 0 | 265ms | 17% |  |  |  |  |   
...
辽宁移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 7个 | 0 | 121ms | 0 | 纽约 | 26个 | 0 | 283ms | 7%  
旧金山 | 17个 | 0 | 219ms | 1% | 伦敦 | 6个 | 0 | 318ms | 16%  
均值 | 90个 | 0 | 277ms | 6% | 阿姆斯特丹 | 15个 | 0 | 337ms | 1%  
法兰克福 | 7个 | 0 | 313ms | 0 | 班加罗尔 | 4个 | 0 | 317ms | 5%  
多伦多 | 8个 | 0 | 318ms | 20% |  |  |  |  |   
