...
**辽宁全部运营商到Digital Ocean各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 206个 | 3个 | 264ms | 2%  
旧金山 | 405个 | 9个 | 277ms | 7%  
伦敦 | 210个 | 0 | 280ms | 1%  
多伦多 | 218个 | 0 | 288ms | 3%  
阿姆斯特丹 | 428个 | 9个 | 292ms | 9%  
均值 | 2509个 | 33个 | 299ms | 5%  
纽约 | 622个 | 3个 | 310ms | 5%  
班加罗尔 | 210个 | 3个 | 333ms | 2%  
新加坡 | 210个 | 6个 | 350ms | 11%  
...
**辽宁电信到Digital Ocean各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 84个 | 0 | 226ms | 0  
旧金山 | 152个 | 3个 | 340ms | 10%  
伦敦 | 84个 | 0 | 280ms | 0  
多伦多 | 84个 | 0 | 284ms | 1%  
...
**辽宁联通到Digital Ocean各机房的测速数据 [20180804]**
...
**辽宁移动到Digital Ocean各机房的测速数据 [20180804]**
