#  湖北到Digital Ocean各机房的测速数据（20180804） 
...
湖北全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 326个 | 0 | 236ms | 3% | 纽约 | 507个 | 3个 | 288ms | 4%  
新加坡 | 177个 | 0 | 257ms | 5% | 多伦多 | 177个 | 0 | 292ms | 3%  
均值 | 2048个 | 3个 | 284ms | 3% | 阿姆斯特丹 | 346个 | 0 | 313ms | 3%  
班加罗尔 | 173个 | 0 | 285ms | 1% | 法兰克福 | 165个 | 0 | 333ms | 5%  
伦敦 | 177个 | 0 | 288ms | 2% |  |  |  |  |   
...
湖北电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 178个 | 0 | 295ms | 8% | 纽约 | 271个 | 3个 | 306ms | 8%  
新加坡 | 97个 | 0 | 358ms | 13% | 多伦多 | 97个 | 0 | 279ms | 3%  
均值 | 1128个 | 3个 | 307ms | 6% | 阿姆斯特丹 | 194个 | 0 | 308ms | 2%  
班加罗尔 | 97个 | 0 | 374ms | 3% | 法兰克福 | 93个 | 0 | 305ms | 5%  
伦敦 | 101个 | 0 | 259ms | 1% |  |  |  |  |   
...
湖北联通到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 40个 | 0 | 216ms | 2% | 纽约 | 64个 | 0 | 293ms | 4%  
新加坡 | 24个 | 0 | 271ms | 0 | 多伦多 | 24个 | 0 | 317ms | 7%  
均值 | 268个 | 0 | 293ms | 3% | 阿姆斯特丹 | 48个 | 0 | 344ms | 1%  
班加罗尔 | 24个 | 0 | 220ms | 1% | 法兰克福 | 20个 | 0 | 381ms | 7%  
伦敦 | 24个 | 0 | 320ms | 1% |  |  |  |  |   
  
简评：如果你是来自湖北的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山、班加罗尔** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_4)吧！

### 移动

湖北移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 108个 | 0 | 197ms | 0 | 纽约 | 172个 | 0 | 265ms | 0  
新加坡 | 56个 | 0 | 142ms | 1% | 多伦多 | 56个 | 0 | 279ms | 0  
均值 | 652个 | 0 | 253ms | 2% | 阿姆斯特丹 | 104个 | 0 | 287ms | 5%  
班加罗尔 | 52个 | 0 | 260ms | 0 | 法兰克福 | 52个 | 0 | 312ms | 4%  
伦敦 | 52个 | 0 | 285ms | 4% |  |  |  |  |   
