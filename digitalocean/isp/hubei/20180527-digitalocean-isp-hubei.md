...
![湖北到Digital Ocean各机房的测速数据（20180527）](/images/thumbnails/Hubei_to_digitalocean.png)
...
![大陆省份湖北到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180527](/images/pingtests/do_20180527/plot_isp_hubei_do_20180527.png)

### 全部运营商

湖北全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 84个 | 0 | 222ms | 2% | 均值 | 515个 | 1个 | 274ms | 2%  
新加坡 | 43个 | 1个 | 257ms | 14% | 伦敦 | 43个 | 0 | 277ms | 2%  
纽约 | 128个 | 0 | 264ms | 0 | 阿姆斯特丹 | 85个 | 0 | 322ms | 2%  
多伦多 | 44个 | 0 | 266ms | 0 | 班加罗尔 | 44个 | 0 | 352ms | 4%  
法兰克福 | 44个 | 0 | 271ms | 0 |  |  |  |  |   
...
湖北电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 48个 | 0 | 255ms | 5% | 均值 | 293个 | 1个 | 293ms | 3%  
新加坡 | 25个 | 1个 | 349ms | 25% | 伦敦 | 24个 | 0 | 254ms | 1%  
纽约 | 74个 | 0 | 286ms | 0 | 阿姆斯特丹 | 48个 | 0 | 334ms | 1%  
多伦多 | 25个 | 0 | 287ms | 1% | 班加罗尔 | 25个 | 0 | 401ms | 3%  
法兰克福 | 24个 | 0 | 257ms | 0 |  |  |  |  |   
...
湖北联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 14个 | 0 | 220ms | 2% | 均值 | 80个 | 0 | 274ms | 1%  
新加坡 | 6个 | 0 | 298ms | 13% | 伦敦 | 7个 | 0 | 305ms | 1%  
纽约 | 18个 | 0 | 252ms | 0 | 阿姆斯特丹 | 13个 | 0 | 321ms | 2%  
多伦多 | 7个 | 0 | 252ms | 0 | 班加罗尔 | 7个 | 0 | 296ms | 0  
法兰克福 | 8个 | 0 | 301ms | 0 |  |  |  |  |   
  
简评：如果你是来自湖北的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_4)吧！

### 移动

湖北移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 22个 | 0 | 192ms | 0 | 均值 | 142个 | 0 | 254ms | 2%  
新加坡 | 12个 | 0 | 124ms | 3% | 伦敦 | 12个 | 0 | 274ms | 4%  
纽约 | 36个 | 0 | 253ms | 0 | 阿姆斯特丹 | 24个 | 0 | 312ms | 3%  
多伦多 | 12个 | 0 | 260ms | 0 | 班加罗尔 | 12个 | 0 | 360ms | 10%  
法兰克福 | 12个 | 0 | 254ms | 0 |  |  |  |  |   
...
本文最初发表于[湖北到Digital Ocean各机房的测速数据（20180527）](https://vps123.top/pingtest/20180527-digitalocean-isp-hubei.html)
