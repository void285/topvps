...
**山西全部运营商到Digital Ocean各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
旧金山 | 117个 | 5个 | 263ms | 10%  
纽约 | 147个 | 3个 | 266ms | 7%  
新加坡 | 47个 | 1个 | 287ms | 13%  
多伦多 | 44个 | 2个 | 288ms | 14%  
均值 | 597个 | 18个 | 293ms | 10%  
法兰克福 | 56个 | 2个 | 299ms | 15%  
伦敦 | 44个 | 1个 | 327ms | 13%  
阿姆斯特丹 | 94个 | 3个 | 332ms | 15%  
班加罗尔 | 48个 | 1个 | 339ms | 0  
...
**山西电信到Digital Ocean各机房的测速数据 [20180918]**
...
**山西联通到Digital Ocean各机房的测速数据 [20180918]**
...
法兰克福 | 21个 | 2个 | 373ms | 22%  
伦敦 | 19个 | 1个 | 387ms | 14%  
阿姆斯特丹 | 40个 | 3个 | 400ms | 21%  
班加罗尔 | 20个 | 1个 | 363ms | 0  
...
**山西移动到Digital Ocean各机房的测速数据 [20180918]**
