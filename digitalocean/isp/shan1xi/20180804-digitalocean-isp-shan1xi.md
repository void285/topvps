#  山西到Digital Ocean各机房的测速数据（20180804） 
...
山西全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 327个 | 0 | 254ms | 4% | 均值 | 2013个 | 12个 | 304ms | 4%  
多伦多 | 177个 | 0 | 286ms | 5% | 阿姆斯特丹 | 342个 | 0 | 319ms | 5%  
伦敦 | 165个 | 0 | 295ms | 1% | 新加坡 | 169个 | 3个 | 345ms | 9%  
纽约 | 507个 | 6个 | 299ms | 2% | 班加罗尔 | 169个 | 0 | 374ms | 2%  
...
山西电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 118个 | 0 | 326ms | 10% | 均值 | 708个 | 3个 | 327ms | 7%  
多伦多 | 59个 | 0 | 279ms | 2% | 阿姆斯特丹 | 118个 | 0 | 309ms | 12%  
伦敦 | 59个 | 0 | 278ms | 1% | 新加坡 | 59个 | 0 | 429ms | 15%  
纽约 | 177个 | 3个 | 327ms | 7% | 班加罗尔 | 59个 | 0 | 422ms | 2%  
法兰克福 | 59个 | 0 | 246ms | 1% |  |  |  |  |   
...
山西联通到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 117个 | 0 | 227ms | 2% | 均值 | 725个 | 9个 | 314ms | 3%  
多伦多 | 66个 | 0 | 293ms | 6% | 阿姆斯特丹 | 124个 | 0 | 351ms | 2%  
伦敦 | 58个 | 0 | 322ms | 1% | 新加坡 | 58个 | 3个 | 390ms | 8%  
纽约 | 186个 | 3个 | 291ms | 0 | 班加罗尔 | 58个 | 0 | 394ms | 4%  
法兰克福 | 58个 | 3个 | 360ms | 5% |  |  |  |  |   
...
山西移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 92个 | 0 | 209ms | 1% | 均值 | 580个 | 0 | 271ms | 2%  
多伦多 | 52个 | 0 | 286ms | 6% | 阿姆斯特丹 | 100个 | 0 | 297ms | 2%  
伦敦 | 48个 | 0 | 286ms | 2% | 新加坡 | 52个 | 0 | 218ms | 4%  
纽约 | 144个 | 0 | 278ms | 0 | 班加罗尔 | 52个 | 0 | 308ms | 0  
法兰克福 | 40个 | 0 | 303ms | 4% |  |  |  |  |   
