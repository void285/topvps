#  陕西到Digital Ocean各机房的测速数据（20180804） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![陕西到Digital Ocean各机房的测速数据（20180804）](/images/thumbnails/Shan3xi_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点1649个，其中超时点15个。连通概况如下：大陆线路响应均值为292毫秒，最快的三个机房所在地为旧金山、新加坡、多伦多，最慢的三个为伦敦、阿姆斯特丹、班加罗尔；旧金山、新加坡、纽约、阿姆斯特丹、班加罗尔有响应超时情况；新加坡、阿姆斯特丹丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 陕西图表数据

![大陆省份陕西到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180804](/images/pingtests/do_20180804/plot_isp_shan3xi_do_20180804.png)

### 全部运营商

陕西全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 271个 | 3个 | 260ms | 3% | 纽约 | 403个 | 3个 | 295ms | 2%  
新加坡 | 145个 | 3个 | 266ms | 9% | 伦敦 | 138个 | 0 | 297ms | 1%  
多伦多 | 138个 | 0 | 278ms | 1% | 阿姆斯特丹 | 287个 | 3个 | 308ms | 7%  
法兰克福 | 129个 | 0 | 282ms | 2% | 班加罗尔 | 138个 | 3个 | 342ms | 1%  
均值 | 1649个 | 15个 | 292ms | 3% |  |  |  |  |   
  
简评：本表展示了陕西的 **电信、联通、移动** 线路到Digital Ocean各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻陕西，可从此表了解你常用的网络到Digital Ocean各个机房的平均响应速度以及丢包率。从表中数据可以看到，各机房所在城市的响应值、丢包率都较高（TopVPS推荐选用响应值低于250ms，丢包率在5%%以内的机房），请慎重选择；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

陕西电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 119个 | 3个 | 328ms | 5% | 纽约 | 171个 | 3个 | 308ms | 4%  
新加坡 | 61个 | 3个 | 379ms | 20% | 伦敦 | 54个 | 0 | 291ms | 0  
多伦多 | 54个 | 0 | 268ms | 0 | 阿姆斯特丹 | 119个 | 3个 | 303ms | 16%  
法兰克福 | 57个 | 0 | 244ms | 0 | 班加罗尔 | 54个 | 3个 | 423ms | 0  
均值 | 689个 | 15个 | 319ms | 6% |  |  |  |  |   
  
简评：如果你是来自陕西的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **法兰克福** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

陕西联通到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 64个 | 0 | 224ms | 3% | 纽约 | 92个 | 0 | 296ms | 2%  
新加坡 | 32个 | 0 | 230ms | 4% | 伦敦 | 32个 | 0 | 322ms | 1%  
多伦多 | 32个 | 0 | 281ms | 2% | 阿姆斯特丹 | 64个 | 0 | 332ms | 1%  
法兰克福 | 28个 | 0 | 338ms | 5% | 班加罗尔 | 32个 | 0 | 300ms | 2%  
均值 | 376个 | 0 | 289ms | 3% |  |  |  |  |   
...
陕西移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 88个 | 0 | 229ms | 1% | 纽约 | 140个 | 0 | 283ms | 0  
新加坡 | 52个 | 0 | 190ms | 4% | 伦敦 | 52个 | 0 | 278ms | 1%  
多伦多 | 52个 | 0 | 284ms | 0 | 阿姆斯特丹 | 104个 | 0 | 290ms | 5%  
法兰克福 | 44个 | 0 | 266ms | 2% | 班加罗尔 | 52个 | 0 | 302ms | 0  
均值 | 584个 | 0 | 268ms | 1% |  |  |  |  |   
...
本文最初发表于[陕西到Digital Ocean各机房的测速数据（20180804）](https://vps123.top/pingtest/20180804-digitalocean-isp-shan3xi.html)
