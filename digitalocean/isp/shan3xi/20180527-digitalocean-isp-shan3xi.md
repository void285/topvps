#  陕西到Digital Ocean各机房的测速数据（20180527） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![陕西到Digital Ocean各机房的测速数据（20180527）](/images/thumbnails/Shan3xi_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点397个，其中超时点8个。连通概况如下：大陆线路响应均值为287毫秒，最快的三个机房所在地为旧金山、多伦多、新加坡，最慢的三个为法兰克福、阿姆斯特丹、班加罗尔；新加坡、阿姆斯特丹、旧金山、多伦多、纽约等6处有响应超时情况；新加坡丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 陕西图表数据

![大陆省份陕西到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180527](/images/pingtests/do_20180527/plot_isp_shan3xi_do_20180527.png)

### 全部运营商

陕西全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 65个 | 1个 | 229ms | 3% | 均值 | 397个 | 8个 | 287ms | 3%  
多伦多 | 32个 | 1个 | 262ms | 1% | 法兰克福 | 33个 | 0 | 295ms | 1%  
新加坡 | 33个 | 2个 | 264ms | 12% | 阿姆斯特丹 | 68个 | 2个 | 324ms | 4%  
伦敦 | 33个 | 0 | 285ms | 1% | 班加罗尔 | 34个 | 1个 | 385ms | 4%  
纽约 | 99个 | 1个 | 286ms | 1% |  |  |  |  |   
...
陕西电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 25个 | 1个 | 249ms | 4% | 均值 | 158个 | 7个 | 286ms | 3%  
多伦多 | 13个 | 1个 | 244ms | 0 | 法兰克福 | 13个 | 0 | 269ms | 0  
新加坡 | 13个 | 1个 | 352ms | 20% | 阿姆斯特丹 | 28个 | 2个 | 307ms | 3%  
伦敦 | 13个 | 0 | 249ms | 0 | 班加罗尔 | 14个 | 1个 | 394ms | 0  
纽约 | 39个 | 1个 | 278ms | 0 |  |  |  |  |   
  
简评：如果你是来自陕西的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **多伦多、旧金山、伦敦** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

陕西联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 22个 | 0 | 224ms | 6% | 均值 | 131个 | 1个 | 301ms | 6%  
多伦多 | 10个 | 0 | 272ms | 4% | 法兰克福 | 11个 | 0 | 335ms | 5%  
新加坡 | 11个 | 1个 | 256ms | 10% | 阿姆斯特丹 | 22个 | 0 | 348ms | 8%  
伦敦 | 11个 | 0 | 335ms | 5% | 班加罗尔 | 11个 | 0 | 360ms | 7%  
纽约 | 33个 | 0 | 305ms | 4% |  |  |  |  |   
  
简评：如果你是来自陕西的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，请慎重选择部署在 **旧金山** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

陕西移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 18个 | 0 | 215ms | 0 | 均值 | 108个 | 0 | 274ms | 1%  
多伦多 | 9个 | 0 | 271ms | 0 | 法兰克福 | 9个 | 0 | 279ms | 0  
新加坡 | 9个 | 0 | 184ms | 6% | 阿姆斯特丹 | 18个 | 0 | 316ms | 1%  
伦敦 | 9个 | 0 | 272ms | 0 | 班加罗尔 | 9个 | 0 | 400ms | 4%  
纽约 | 27个 | 0 | 274ms | 0 |  |  |  |  |   
  
简评：如果你是来自陕西的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **新加坡** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_3)吧！
...
本文最初发表于[陕西到Digital Ocean各机房的测速数据（20180527）](https://vps123.top/pingtest/20180527-digitalocean-isp-shan3xi.html)
