#  青海到Digital Ocean各机房的测速数据（20180918） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![青海到Digital Ocean各机房的测速数据（20180918）](/images/thumbnails/Qinghai_to_digitalocean.png)
...
本文提供20180918青海到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通，有效样本点60个，无超时点。连通概况如下：大陆线路响应均值为306毫秒，最快的三个机房所在地为法兰克福、旧金山、阿姆斯特丹，最慢的三个为新加坡、多伦多、班加罗尔；班加罗尔、旧金山、阿姆斯特丹、伦敦、多伦多丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 青海图表数据

![大陆省份青海到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180918](/images/pingtests/do_20180918/plot_isp_qinghai_do_20180918.png)

### 全部运营商

青海全部运营商到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法兰克福 | 5个 | 0 | 234ms | 0 | 纽约 | 16个 | 0 | 307ms | 2%  
旧金山 | 10个 | 0 | 281ms | 12% | 新加坡 | 5个 | 0 | 314ms | 2%  
阿姆斯特丹 | 10个 | 0 | 287ms | 11% | 多伦多 | 5个 | 0 | 317ms | 8%  
伦敦 | 4个 | 0 | 294ms | 10% | 班加罗尔 | 5个 | 0 | 465ms | 14%  
均值 | 60个 | 0 | 306ms | 7% |  |  |  |  |   
...
青海电信到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法兰克福 | 3个 | 0 | 231ms | 0 | 纽约 | 10个 | 0 | 335ms | 2%  
旧金山 | 6个 | 0 | 274ms | 9% | 新加坡 | 3个 | 0 | 340ms | 4%  
阿姆斯特丹 | 6个 | 0 | 319ms | 20% | 多伦多 | 3个 | 0 | 339ms | 16%  
伦敦 | 2个 | 0 | 380ms | 21% | 班加罗尔 | 3个 | 0 | 446ms | 28%  
均值 | 36个 | 0 | 326ms | 11% |  |  |  |  |   
...
青海联通到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法兰克福 | 2个 | 0 | 237ms | 0 | 纽约 | 6个 | 0 | 280ms | 1%  
旧金山 | 4个 | 0 | 288ms | 14% | 新加坡 | 2个 | 0 | 289ms | 0  
阿姆斯特丹 | 4个 | 0 | 255ms | 2% | 多伦多 | 2个 | 0 | 295ms | 1%  
伦敦 | 2个 | 0 | 208ms | 0 | 班加罗尔 | 2个 | 0 | 483ms | 0  
均值 | 24个 | 0 | 286ms | 3% |  |  |  |  |   
  
简评：如果你是来自青海的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **伦敦、法兰克福** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！
...
## 相关测速报告
  ...
  * 本期报告：青海到 _其他VPS提供商_ 各机房的测速报告： 
    * [Vultr](/vultr/isp/qinghai/20180918-vultr-isp-qinghai.md "青海到Vultr各机房的Ping测试 20180918")
    * [Linode](/linode/isp/qinghai/20180918-linode-isp-qinghai.md "青海到Linode各机房的Ping测试 20180918")



本文最初发表于[青海到Digital Ocean各机房的测速数据（20180918）](https://vps123.top/pingtest/20180918-digitalocean-isp-qinghai.html)
