#  青海到Digital Ocean各机房的测速数据（20180426） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![青海到Digital Ocean各机房的测速数据（20180426）](/images/thumbnails/Qinghai_to_digitalocean.png)
...
本文提供20180426青海到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、移动，有效样本点48个，无超时点。连通概况如下：大陆线路响应均值为303毫秒，最快的三个机房所在地为新加坡、伦敦、多伦多，最慢的三个为法兰克福、纽约、班加罗尔；法兰克福、班加罗尔、旧金山丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 青海图表数据

![大陆省份青海到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180426](/images/pingtests/do_20180426/plot_isp_qinghai_do_20180426.png)

### 全部运营商

青海全部运营商到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 4个 | 0 | 190ms | 0 | 均值 | 48个 | 0 | 303ms | 2%  
伦敦 | 4个 | 0 | 260ms | 0 | 法兰克福 | 4个 | 0 | 334ms | 10%  
多伦多 | 4个 | 0 | 279ms | 0 | 纽约 | 12个 | 0 | 338ms | 1%  
旧金山 | 8个 | 0 | 282ms | 5% | 班加罗尔 | 4个 | 0 | 394ms | 6%  
阿姆斯特丹 | 8个 | 0 | 302ms | 0 |  |  |  |  |   
  
简评：本表展示了青海的 **电信、移动** 线路到Digital Ocean各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻青海，可从此表了解你常用的网络到Digital Ocean各个机房的平均响应速度以及丢包率。从表中数据可以看到， **新加坡** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

青海电信到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 2个 | 0 | 260ms | 0 | 均值 | 24个 | 0 | 315ms | 3%  
伦敦 | 2个 | 0 | 247ms | 0 | 法兰克福 | 2个 | 0 | 377ms | 21%  
多伦多 | 2个 | 0 | 255ms | 0 | 纽约 | 6个 | 0 | 356ms | 2%  
旧金山 | 4个 | 0 | 321ms | 5% | 班加罗尔 | 2个 | 0 | 385ms | 0  
阿姆斯特丹 | 4个 | 0 | 270ms | 0 |  |  |  |  |   
  
简评：如果你是来自青海的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **伦敦** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 移动

青海移动到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 2个 | 0 | 120ms | 0 | 均值 | 24个 | 0 | 292ms | 2%  
伦敦 | 2个 | 0 | 274ms | 0 | 法兰克福 | 2个 | 0 | 291ms | 0  
多伦多 | 2个 | 0 | 303ms | 0 | 纽约 | 6个 | 0 | 320ms | 1%  
旧金山 | 4个 | 0 | 244ms | 5% | 班加罗尔 | 2个 | 0 | 404ms | 12%  
阿姆斯特丹 | 4个 | 0 | 334ms | 0 |  |  |  |  |   
  
简评：如果你是来自青海的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！
...
## 相关测速报告
  ...
  * 本期报告：青海到 _其他VPS提供商_ 各机房的测速报告： 
    * [Vultr](/vultr/isp/qinghai/20180426-vultr-isp-qinghai.md "青海到Vultr各机房的Ping测试 20180426")
    * [Linode](/linode/isp/qinghai/20180426-linode-isp-qinghai.md "青海到Linode各机房的Ping测试 20180426")



本文最初发表于[青海到Digital Ocean各机房的测速数据（20180426）](https://vps123.top/pingtest/20180426-digitalocean-isp-qinghai.html)
