...
**青海全部运营商到Digital Ocean各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 16个 | 0 | 242ms | 0  
多伦多 | 16个 | 0 | 264ms | 0  
阿姆斯特丹 | 32个 | 0 | 327ms | 13%  
均值 | 192个 | 0 | 338ms | 9%  
伦敦 | 16个 | 0 | 343ms | 0  
纽约 | 48个 | 0 | 346ms | 10%  
旧金山 | 32个 | 0 | 353ms | 12%  
...
**青海电信到Digital Ocean各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 8个 | 0 | 203ms | 0  
多伦多 | 8个 | 0 | 268ms | 0  
阿姆斯特丹 | 16个 | 0 | 318ms | 14%  
均值 | 96个 | 0 | 336ms | 9%  
伦敦 | 8个 | 0 | 339ms | 0  
纽约 | 24个 | 0 | 344ms | 10%  
旧金山 | 16个 | 0 | 356ms | 15%  
...
**青海联通到Digital Ocean各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 8个 | 0 | 281ms | 0  
多伦多 | 8个 | 0 | 260ms | 0  
阿姆斯特丹 | 16个 | 0 | 337ms | 12%  
均值 | 96个 | 0 | 341ms | 8%  
伦敦 | 8个 | 0 | 347ms | 0  
纽约 | 24个 | 0 | 348ms | 11%  
旧金山 | 16个 | 0 | 351ms | 10%  
