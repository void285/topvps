#  山东到Digital Ocean各机房的测速数据（20180622） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![山东到Digital Ocean各机房的测速数据（20180622）](/images/thumbnails/Shandong_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点397个，无超时点。连通概况如下：大陆线路响应均值为289毫秒，最快的三个机房所在地为旧金山、多伦多、均值，最慢的三个为阿姆斯特丹、新加坡、班加罗尔；新加坡丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 山东图表数据

![大陆省份山东到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180622](/images/pingtests/do_20180622/plot_isp_shandong_do_20180622.png)

### 全部运营商

山东全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 76个 | 0 | 226ms | 2% | 纽约 | 77个 | 0 | 316ms | 2%  
多伦多 | 40个 | 0 | 252ms | 1% | 阿姆斯特丹 | 81个 | 0 | 325ms | 1%  
均值 | 397个 | 0 | 289ms | 1% | 新加坡 | 7个 | 0 | 331ms | 8%  
伦敦 | 42个 | 0 | 297ms | 0 | 班加罗尔 | 37个 | 0 | 369ms | 3%  
法兰克福 | 37个 | 0 | 303ms | 1% |  |  |  |  |   
...
山东电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 29个 | 0 | 253ms | 2% | 纽约 | 26个 | 0 | 307ms | 0  
多伦多 | 14个 | 0 | 242ms | 0 | 阿姆斯特丹 | 31个 | 0 | 303ms | 0  
均值 | 147个 | 0 | 293ms | 1% | 新加坡 | 3个 | 0 | 283ms | 16%  
伦敦 | 14个 | 0 | 263ms | 0 | 班加罗尔 | 16个 | 0 | 394ms | 0  
法兰克福 | 14个 | 0 | 280ms | 0 |  |  |  |  |   
  
简评：如果你是来自山东的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **多伦多** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

山东联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 30个 | 0 | 214ms | 2% | 纽约 | 35个 | 0 | 358ms | 1%  
多伦多 | 16个 | 0 | 252ms | 0 | 阿姆斯特丹 | 30个 | 0 | 360ms | 1%  
均值 | 162个 | 0 | 293ms | 1% | 新加坡 | 4个 | 0 | 380ms | 0  
伦敦 | 17个 | 0 | 334ms | 0 | 班加罗尔 | 15个 | 0 | 401ms | 1%  
法兰克福 | 15个 | 0 | 320ms | 1% |  |  |  |  |   
  
简评：如果你是来自山东的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

山东移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 17个 | 0 | 212ms | 3% | 纽约 | 16个 | 0 | 284ms | 5%  
多伦多 | 10个 | 0 | 263ms | 2% | 阿姆斯特丹 | 20个 | 0 | 312ms | 0  
均值 | 88个 | 0 | 280ms | 2% | 新加坡 | - | - | - | -  
伦敦 | 11个 | 0 | 294ms | 0 | 班加罗尔 | 6个 | 0 | 313ms | 7%  
法兰克福 | 8个 | 0 | 310ms | 3% |  |  |  |  |   
  
简评：如果你是来自山东的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_3)吧！
...
本文最初发表于[山东到Digital Ocean各机房的测速数据（20180622）](https://vps123.top/pingtest/20180622-digitalocean-isp-shandong.html)
