...
![吉林到Digital Ocean各机房的测速数据（20180918）](/images/thumbnails/Jilin_to_digitalocean.png)
...
![大陆省份吉林到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180918](/images/pingtests/do_20180918/plot_isp_jilin_do_20180918.png)

### 全部运营商

吉林全部运营商到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 43个 | 0 | 277ms | 12% | 伦敦 | 20个 | 0 | 340ms | 8%  
多伦多 | 19个 | 0 | 294ms | 10% | 阿姆斯特丹 | 43个 | 0 | 353ms | 11%  
纽约 | 61个 | 0 | 306ms | 6% | 新加坡 | 22个 | 0 | 371ms | 14%  
均值 | 252个 | 0 | 309ms | 7% | 班加罗尔 | 22个 | 0 | 371ms | 0  
法兰克福 | 22个 | 0 | 337ms | 10% |  |  |  |  |   
...
吉林电信到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 8个 | 0 | 270ms | 6% | 伦敦 | 5个 | 0 | 265ms | 0  
多伦多 | 4个 | 0 | 283ms | 0 | 阿姆斯特丹 | 8个 | 0 | 274ms | 0  
纽约 | 9个 | 0 | 313ms | 3% | 新加坡 | 5个 | 0 | 335ms | 0  
均值 | 49个 | 0 | 293ms | 1% | 班加罗尔 | 5个 | 0 | 376ms | 0  
法兰克福 | 5个 | 0 | 235ms | 0 |  |  |  |  |   
  
简评：如果你是来自吉林的 **电信** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **法兰克福** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

吉林联通到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 35个 | 0 | 285ms | 19% | 伦敦 | 15个 | 0 | 415ms | 17%  
多伦多 | 15个 | 0 | 306ms | 20% | 阿姆斯特丹 | 35个 | 0 | 432ms | 21%  
纽约 | 51个 | 0 | 334ms | 12% | 新加坡 | 17个 | 0 | 407ms | 28%  
均值 | 202个 | 0 | 364ms | 17% | 班加罗尔 | 17个 | 0 | 367ms | 0  
法兰克福 | 17个 | 0 | 439ms | 21% |  |  |  |  |   
  
简评：如果你是来自吉林的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，很遗憾从本次测试来看，没有值得你关注的机房；请查看往期的测试，如果数据一直不乐观，你应考虑换用其他VPS提供商如[Vultr](https://vps123.top/go/vultr/_2)、[BandwagonHost](https://vps123.top/go/bandwagon/_3)、[Linode](https://vps123.top/go/linode/_4)等。

### 移动

吉林移动到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | - | - | - | - | 伦敦 | - | - | - | -  
多伦多 | - | - | - | - | 阿姆斯特丹 | - | - | - | -  
纽约 | 1个 | 0 | 270ms | 2% | 新加坡 | - | - | - | -  
均值 | 1个 | 0 | 270ms | 2% | 班加罗尔 | - | - | - | -  
法兰克福 | - | - | - | - |  |  |  |  |   
  
简评：如果你是来自吉林的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，很遗憾从本次测试来看，没有值得你关注的机房；请查看往期的测试，如果数据一直不乐观，你应考虑换用其他VPS提供商如[Vultr](https://vps123.top/go/vultr/_5)、[BandwagonHost](https://vps123.top/go/bandwagon/_6)、[Linode](https://vps123.top/go/linode/_7)等。
...
本文最初发表于[吉林到Digital Ocean各机房的测速数据（20180918）](https://vps123.top/pingtest/20180918-digitalocean-isp-jilin.html)
