...
![吉林到Digital Ocean各机房的测速数据（20180622）](/images/thumbnails/Jilin_to_digitalocean.png)
...
![大陆省份吉林到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180622](/images/pingtests/do_20180622/plot_isp_jilin_do_20180622.png)

### 全部运营商

吉林全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 26个 | 0 | 235ms | 0 | 阿姆斯特丹 | 27个 | 1个 | 328ms | 2%  
多伦多 | 19个 | 0 | 273ms | 2% | 纽约 | 39个 | 1个 | 336ms | 1%  
均值 | 161个 | 2个 | 307ms | 1% | 新加坡 | 2个 | 0 | 358ms | 16%  
伦敦 | 18个 | 0 | 309ms | 0 | 班加罗尔 | 13个 | 0 | 372ms | 0  
法兰克福 | 17个 | 0 | 309ms | 3% |  |  |  |  |   
...
吉林电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 12个 | 0 | 266ms | 0 | 阿姆斯特丹 | 12个 | 1个 | 307ms | 6%  
多伦多 | 8个 | 0 | 277ms | 0 | 纽约 | 17个 | 1个 | 358ms | 4%  
均值 | 71个 | 2个 | 307ms | 3% | 新加坡 | 1个 | 0 | 366ms | 33%  
伦敦 | 8个 | 0 | 256ms | 0 | 班加罗尔 | 6个 | 0 | 418ms | 0  
法兰克福 | 7个 | 0 | 249ms | 5% |  |  |  |  |   
...
吉林联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 8个 | 0 | 211ms | 0 | 阿姆斯特丹 | 10个 | 0 | 347ms | 1%  
多伦多 | 8个 | 0 | 265ms | 0 | 纽约 | 16个 | 0 | 339ms | 1%  
均值 | 62个 | 0 | 317ms | 1% | 新加坡 | 1个 | 0 | 350ms | 0  
伦敦 | 8个 | 0 | 341ms | 0 | 班加罗尔 | 4个 | 0 | 387ms | 0  
法兰克福 | 7个 | 0 | 337ms | 2% |  |  |  |  |   
...
吉林移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 6个 | 0 | 227ms | 1% | 阿姆斯特丹 | 5个 | 0 | 330ms | 0  
多伦多 | 3个 | 0 | 277ms | 5% | 纽约 | 6个 | 0 | 311ms | 0  
均值 | 28个 | 0 | 297ms | 1% | 新加坡 | - | - | - | -  
伦敦 | 2个 | 0 | 331ms | 0 | 班加罗尔 | 3个 | 0 | 311ms | 0  
法兰克福 | 3个 | 0 | 340ms | 1% |  |  |  |  |   
  
简评：如果你是来自吉林的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_3)吧！
...
本文最初发表于[吉林到Digital Ocean各机房的测速数据（20180622）](https://vps123.top/pingtest/20180622-digitalocean-isp-jilin.html)
