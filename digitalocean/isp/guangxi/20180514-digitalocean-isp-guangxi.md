#  广西到Digital Ocean各机房的测速数据（20180514） 
...
广西全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 37个 | 2个 | 196ms | 5% | 法兰克福 | 39个 | 1个 | 277ms | 2%  
旧金山 | 72个 | 1个 | 228ms | 3% | 纽约 | 100个 | 3个 | 283ms | 2%  
伦敦 | 34个 | 1个 | 270ms | 1% | 阿姆斯特丹 | 74个 | 2个 | 286ms | 1%  
多伦多 | 37个 | 1个 | 271ms | 7% | 班加罗尔 | 32个 | 1个 | 406ms | 6%  
均值 | 425个 | 12个 | 274ms | 3% |  |  |  |  |   
...
广西电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 15个 | 0 | 321ms | 10% | 法兰克福 | 16个 | 0 | 244ms | 0  
旧金山 | 30个 | 0 | 274ms | 3% | 纽约 | 42个 | 0 | 301ms | 0  
伦敦 | 14个 | 0 | 239ms | 0 | 阿姆斯特丹 | 32个 | 0 | 259ms | 0  
多伦多 | 16个 | 0 | 251ms | 1% | 班加罗尔 | 16个 | 0 | 510ms | 13%  
均值 | 181个 | 0 | 295ms | 2% |  |  |  |  |   
...
广西联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 11个 | 2个 | 178ms | 7% | 法兰克福 | 12个 | 1个 | 324ms | 5%  
旧金山 | 20个 | 1个 | 223ms | 6% | 纽约 | 27个 | 3个 | 294ms | 5%  
伦敦 | 12个 | 1个 | 300ms | 3% | 阿姆斯特丹 | 23个 | 2个 | 316ms | 4%  
多伦多 | 11个 | 1个 | 269ms | 5% | 班加罗尔 | 9个 | 1个 | 433ms | 6%  
均值 | 125个 | 12个 | 288ms | 5% |  |  |  |  |   
...
广西移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 11个 | 0 | 88ms | 0 | 法兰克福 | 11个 | 0 | 263ms | 0  
旧金山 | 22个 | 0 | 187ms | 0 | 纽约 | 31个 | 0 | 256ms | 0  
伦敦 | 8个 | 0 | 271ms | 0 | 阿姆斯特丹 | 19个 | 0 | 283ms | 0  
多伦多 | 10个 | 0 | 292ms | 15% | 班加罗尔 | 7个 | 0 | 275ms | 0  
均值 | 119个 | 0 | 238ms | 1% |  |  |  |  |   
