#  广西到Digital Ocean各机房的测速数据（20180527） 
...
广西全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 78个 | 0 | 216ms | 3% | 法兰克福 | 39个 | 0 | 271ms | 3%  
新加坡 | 38个 | 0 | 220ms | 12% | 均值 | 460个 | 0 | 271ms | 3%  
多伦多 | 39个 | 0 | 248ms | 1% | 阿姆斯特丹 | 77个 | 0 | 317ms | 2%  
纽约 | 113个 | 0 | 264ms | 1% | 班加罗尔 | 39个 | 0 | 386ms | 3%  
伦敦 | 37个 | 0 | 268ms | 2% |  |  |  |  |   
...
广西电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 32个 | 0 | 247ms | 7% | 法兰克福 | 16个 | 0 | 242ms | 4%  
新加坡 | 16个 | 0 | 330ms | 27% | 均值 | 191个 | 0 | 277ms | 6%  
多伦多 | 16个 | 0 | 244ms | 3% | 阿姆斯特丹 | 32个 | 0 | 303ms | 3%  
纽约 | 47个 | 0 | 267ms | 3% | 班加罗尔 | 16个 | 0 | 387ms | 5%  
伦敦 | 16个 | 0 | 234ms | 3% |  |  |  |  |   
...
广西联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 22个 | 0 | 216ms | 3% | 法兰克福 | 11个 | 0 | 310ms | 5%  
新加坡 | 11个 | 0 | 266ms | 9% | 均值 | 132个 | 0 | 285ms | 2%  
多伦多 | 11个 | 0 | 257ms | 0 | 阿姆斯特丹 | 22个 | 0 | 322ms | 4%  
纽约 | 33个 | 0 | 273ms | 0 | 班加罗尔 | 11个 | 0 | 389ms | 0  
伦敦 | 11个 | 0 | 301ms | 1% |  |  |  |  |   
...
广西移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 24个 | 0 | 185ms | 0 | 法兰克福 | 12个 | 0 | 262ms | 0  
新加坡 | 11个 | 0 | 65ms | 0 | 均值 | 137个 | 0 | 251ms | 1%  
多伦多 | 12个 | 0 | 244ms | 0 | 阿姆斯特丹 | 23个 | 0 | 326ms | 0  
纽约 | 33个 | 0 | 253ms | 0 | 班加罗尔 | 12个 | 0 | 382ms | 5%  
伦敦 | 10个 | 0 | 270ms | 0 |  |  |  |  |   
