#  中国大陆到Digital Ocean各机房的测速数据（20180514） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![中国大陆到Digital Ocean各机房的测速数据（20180514）](/images/thumbnails/China_to_digitalocean.png)
...
本文提供20180514中国大陆到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点11222个，其中超时点161个。连通概况如下：大陆线路响应均值为280毫秒，最快的三个机房所在地为新加坡、旧金山、均值，最慢的三个为纽约、阿姆斯特丹、班加罗尔；纽约、阿姆斯特丹、旧金山、班加罗尔、法兰克福等8处有响应超时情况；多伦多、纽约、法兰克福丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 大陆图表数据

![大陆省份大陆到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180514](/images/pingtests/do_20180514/plot_isp_china_do_20180514.png)

### 全部运营商

**大陆全部运营商到Digital Ocean各机房的测速数据 [20180514]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
新加坡 | 925个 | 13个 | 195ms | 4%  
旧金山 | 1939个 | 26个 | 238ms | 4%  
均值 | 11222个 | 161个 | 280ms | 5%  
多伦多 | 945个 | 11个 | 281ms | 9%  
伦敦 | 903个 | 10个 | 283ms | 4%  
法兰克福 | 972个 | 16个 | 288ms | 5%  
纽约 | 2747个 | 40个 | 293ms | 6%  
阿姆斯特丹 | 1900个 | 28个 | 302ms | 3%  
班加罗尔 | 891个 | 17个 | 365ms | 2%  
...
在这里， **新加坡、旧金山** 的响应速度小于250ms，且丢包率在5%以内，值得关注。如果你主要关心某运营商的网络概况，后面几个表格的数据更有参考价值。  
如果你打算将VPS用作科学上网、云存储、远程任务、游戏服务器等用途，请 **关注你所在的省份** 到Digital Ocean各机房的测速数据，它们可以给你更有益的参考。

### 电信

**大陆电信到Digital Ocean各机房的测速数据 [20180514]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
新加坡 | 371个 | 7个 | 253ms | 5%  
旧金山 | 797个 | 15个 | 263ms | 4%  
均值 | 4640个 | 92个 | 284ms | 3%  
多伦多 | 389个 | 6个 | 255ms | 3%  
伦敦 | 372个 | 7个 | 248ms | 1%  
法兰克福 | 412个 | 7个 | 258ms | 2%  
纽约 | 1128个 | 23个 | 299ms | 3%  
阿姆斯特丹 | 791个 | 15个 | 272ms | 2%  
班加罗尔 | 380个 | 12个 | 440ms | 3%  
  
**简评：** 如果你关注电信的网络到Digital Ocean各机房的连通性，此表数据提供了一个不错的概览， **伦敦** 的整体的连通速度、丢包率都比较不错，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

**大陆联通到Digital Ocean各机房的测速数据 [20180514]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
新加坡 | 273个 | 5个 | 195ms | 5%  
旧金山 | 571个 | 8个 | 224ms | 4%  
均值 | 3314个 | 54个 | 289ms | 7%  
多伦多 | 277个 | 4个 | 282ms | 13%  
伦敦 | 282个 | 2个 | 327ms | 7%  
法兰克福 | 277个 | 8个 | 332ms | 10%  
纽约 | 814个 | 14个 | 291ms | 11%  
阿姆斯特丹 | 559个 | 9个 | 334ms | 7%  
班加罗尔 | 261个 | 4个 | 344ms | 2%  
  
**简评：** 如果你关注联通的网络到Digital Ocean各机房的连通性，此表数据提供了一个不错的概览， **新加坡、旧金山** 的整体的连通速度、丢包率都比较不错，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

**大陆移动到Digital Ocean各机房的测速数据 [20180514]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
新加坡 | 281个 | 1个 | 123ms | 1%  
旧金山 | 571个 | 3个 | 222ms | 3%  
均值 | 3268个 | 15个 | 267ms | 4%  
多伦多 | 279个 | 1个 | 306ms | 13%  
伦敦 | 249个 | 1个 | 283ms | 4%  
法兰克福 | 283个 | 1个 | 285ms | 3%  
纽约 | 805个 | 3个 | 289ms | 6%  
阿姆斯特丹 | 550个 | 4个 | 307ms | 3%  
班加罗尔 | 250个 | 1个 | 290ms | 1%  
...
本文最初发表于[中国大陆到Digital Ocean各机房的测速数据（20180514）](https://vps123.top/pingtest/20180514-digitalocean-isp-china.html)
