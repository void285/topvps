#  大陆到Digital Ocean各机房的测速数据（20180918） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![大陆到Digital Ocean各机房的测速数据（20180918）](/images/thumbnails/China_to_digitalocean.png)
...
本文提供20180918大陆到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点16138个，其中超时点175个。连通概况如下：大陆线路响应均值为283毫秒，最快的三个机房所在地为旧金山、新加坡、纽约，最慢的三个为法兰克福、阿姆斯特丹、班加罗尔；旧金山、纽约、阿姆斯特丹、多伦多、新加坡等8处有响应超时情况；旧金山、阿姆斯特丹、法兰克福、新加坡、多伦多等7处丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 大陆图表数据

![大陆省份大陆到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180918](/images/pingtests/do_20180918/plot_isp_china_do_20180918.png)

### 全部运营商

**大陆全部运营商到Digital Ocean各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
旧金山 | 2916个 | 46个 | 252ms | 9%  
新加坡 | 1353个 | 12个 | 256ms | 8%  
纽约 | 3928个 | 42个 | 282ms | 5%  
多伦多 | 1238个 | 15个 | 283ms | 8%  
均值 | 16138个 | 175个 | 283ms | 7%  
伦敦 | 1238个 | 10个 | 286ms | 7%  
法兰克福 | 1447个 | 11个 | 286ms | 8%  
阿姆斯特丹 | 2679个 | 29个 | 298ms | 8%  
班加罗尔 | 1339个 | 10个 | 341ms | 1%  
...
**大陆电信到Digital Ocean各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
旧金山 | 1181个 | 37个 | 256ms | 9%  
新加坡 | 549个 | 10个 | 307ms | 4%  
纽约 | 1586个 | 28个 | 287ms | 3%  
多伦多 | 499个 | 9个 | 279ms | 4%  
均值 | 6528个 | 124个 | 283ms | 4%  
伦敦 | 500个 | 6个 | 262ms | 3%  
法兰克福 | 584个 | 8个 | 261ms | 3%  
阿姆斯特丹 | 1085个 | 18个 | 279ms | 4%  
班加罗尔 | 544个 | 8个 | 381ms | 1%  
...
**大陆联通到Digital Ocean各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
旧金山 | 855个 | 9个 | 261ms | 15%  
新加坡 | 403个 | 2个 | 317ms | 18%  
纽约 | 1165个 | 13个 | 292ms | 10%  
多伦多 | 377个 | 6个 | 294ms | 17%  
均值 | 4803个 | 44个 | 311ms | 13%  
伦敦 | 378个 | 3个 | 339ms | 14%  
法兰克福 | 423个 | 3个 | 346ms | 17%  
阿姆斯特丹 | 801个 | 6个 | 352ms | 17%  
班加罗尔 | 401个 | 2个 | 345ms | 0  
  
**简评：** 如果你关注联通的网络到Digital Ocean各机房的连通性，此表数据提供了一个不错的概览，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

**大陆移动到Digital Ocean各机房的测速数据 [20180918]**
...
本文最初发表于[大陆到Digital Ocean各机房的测速数据（20180918）](https://vps123.top/pingtest/20180918-digitalocean-isp-china.html)
