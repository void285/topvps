#  大陆到Digital Ocean各机房的测速数据（20180527） 
...
大陆全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 1964个 | 28个 | 223ms | 3% | 均值 | 11708个 | 118个 | 276ms | 3%  
新加坡 | 979个 | 17个 | 252ms | 13% | 法兰克福 | 983个 | 8个 | 277ms | 2%  
多伦多 | 965个 | 7个 | 256ms | 0 | 阿姆斯特丹 | 1935个 | 18个 | 311ms | 3%  
纽约 | 2935个 | 22个 | 268ms | 0 | 班加罗尔 | 973个 | 10个 | 379ms | 3%  
伦敦 | 974个 | 8个 | 276ms | 2% |  |  |  |  |   
...
大陆电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 829个 | 16个 | 244ms | 4% | 均值 | 4943个 | 69个 | 276ms | 3%  
新加坡 | 414个 | 11个 | 325ms | 23% | 法兰克福 | 419个 | 5个 | 253ms | 1%  
多伦多 | 404个 | 4个 | 249ms | 0 | 阿姆斯特丹 | 813个 | 10个 | 291ms | 2%  
纽约 | 1249个 | 14个 | 270ms | 0 | 班加罗尔 | 405个 | 5个 | 386ms | 1%  
伦敦 | 410个 | 4个 | 246ms | 1% |  |  |  |  |   
...
大陆联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 564个 | 6个 | 214ms | 3% | 均值 | 3335个 | 13个 | 283ms | 3%  
新加坡 | 276个 | 3个 | 283ms | 10% | 法兰克福 | 281个 | 0 | 311ms | 5%  
多伦多 | 278个 | 1个 | 258ms | 0 | 阿姆斯特丹 | 551个 | 1个 | 320ms | 5%  
纽约 | 824个 | 0 | 272ms | 1% | 班加罗尔 | 280个 | 1个 | 359ms | 1%  
伦敦 | 281个 | 1个 | 311ms | 3% |  |  |  |  |   
...
大陆移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 571个 | 6个 | 212ms | 1% | 均值 | 3430个 | 36个 | 271ms | 2%  
新加坡 | 289个 | 3个 | 128ms | 4% | 法兰克福 | 283个 | 3个 | 279ms | 1%  
多伦多 | 283个 | 2个 | 264ms | 1% | 阿姆斯特丹 | 571个 | 7个 | 330ms | 2%  
纽约 | 862个 | 8个 | 273ms | 1% | 班加罗尔 | 288个 | 4个 | 389ms | 7%  
伦敦 | 283个 | 3个 | 282ms | 2% |  |  |  |  |   
