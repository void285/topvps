#  中国大陆到Digital Ocean各机房的测速数据（20180426） 
...
大陆全部运营商到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 806个 | 6个 | 190ms | 2% | 纽约 | 2465个 | 13个 | 290ms | 2%  
旧金山 | 1608个 | 11个 | 245ms | 4% | 法兰克福 | 813个 | 5个 | 305ms | 9%  
多伦多 | 809个 | 7个 | 262ms | 1% | 阿姆斯特丹 | 1609个 | 12个 | 307ms | 2%  
伦敦 | 830个 | 9个 | 282ms | 3% | 班加罗尔 | 824个 | 3个 | 369ms | 5%  
均值 | 9764个 | 66个 | 282ms | 3% |  |  |  |  |   
...
大陆电信到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 327个 | 5个 | 240ms | 2% | 纽约 | 984个 | 9个 | 315ms | 2%  
旧金山 | 646个 | 9个 | 284ms | 5% | 法兰克福 | 327个 | 3个 | 309ms | 16%  
多伦多 | 330个 | 4个 | 256ms | 0 | 阿姆斯特丹 | 633个 | 6个 | 280ms | 1%  
伦敦 | 334个 | 5个 | 254ms | 1% | 班加罗尔 | 332个 | 2个 | 390ms | 3%  
均值 | 3913个 | 43个 | 294ms | 3% |  |  |  |  |   
  
简评：如果你关注电信的网络到Digital Ocean各机房的连通性，此表数据提供了一个不错的概览， **新加坡** 的整体的连通速度、丢包率都比较不错，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_1)吧！

### 联通

大陆联通到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 225个 | 1个 | 200ms | 3% | 纽约 | 686个 | 4个 | 261ms | 1%  
旧金山 | 444个 | 1个 | 221ms | 4% | 法兰克福 | 225个 | 1个 | 321ms | 5%  
多伦多 | 229个 | 3个 | 261ms | 2% | 阿姆斯特丹 | 449个 | 2个 | 320ms | 2%  
伦敦 | 230个 | 2个 | 324ms | 8% | 班加罗尔 | 230个 | 1个 | 348ms | 2%  
均值 | 2718个 | 15个 | 277ms | 3% |  |  |  |  |   
...
大陆移动到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 254个 | 0 | 119ms | 1% | 纽约 | 795个 | 0 | 285ms | 2%  
旧金山 | 518个 | 1个 | 218ms | 2% | 法兰克福 | 261个 | 1个 | 286ms | 3%  
多伦多 | 250个 | 0 | 269ms | 2% | 阿姆斯特丹 | 527个 | 4个 | 329ms | 2%  
伦敦 | 266个 | 2个 | 281ms | 3% | 班加罗尔 | 262个 | 0 | 362ms | 11%  
均值 | 3133个 | 8个 | 273ms | 3% |  |  |  |  |   
