...
大陆全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 1724个 | 48个 | 233ms | 2% | 均值 | 9057个 | 246个 | 280ms | 2%  
多伦多 | 872个 | 25个 | 255ms | 1% | 纽约 | 1916个 | 52个 | 295ms | 2%  
伦敦 | 833个 | 16个 | 268ms | 0 | 阿姆斯特丹 | 1701个 | 44个 | 296ms | 3%  
新加坡 | 263个 | 19个 | 270ms | 15% | 班加罗尔 | 864个 | 21个 | 347ms | 1%  
...
大陆电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 777个 | 27个 | 253ms | 3% | 均值 | 4142个 | 118个 | 283ms | 3%  
多伦多 | 397个 | 12个 | 245ms | 1% | 纽约 | 889个 | 20个 | 304ms | 1%  
伦敦 | 367个 | 6个 | 244ms | 1% | 阿姆斯特丹 | 771个 | 20个 | 284ms | 2%  
新加坡 | 165个 | 14个 | 320ms | 24% | 班加罗尔 | 390个 | 12个 | 395ms | 1%  
...
大陆联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 465个 | 11个 | 217ms | 2% | 均值 | 2441个 | 67个 | 285ms | 1%  
多伦多 | 238个 | 8个 | 258ms | 1% | 纽约 | 519个 | 17个 | 306ms | 2%  
伦敦 | 229个 | 5个 | 295ms | 0 | 阿姆斯特丹 | 454个 | 10个 | 313ms | 2%  
新加坡 | 62个 | 4个 | 278ms | 0 | 班加罗尔 | 232个 | 4个 | 339ms | 1%  
...
大陆移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 482个 | 10个 | 221ms | 1% | 均值 | 2474个 | 61个 | 270ms | 2%  
多伦多 | 237个 | 5个 | 266ms | 0 | 纽约 | 508个 | 15个 | 280ms | 2%  
伦敦 | 237个 | 5个 | 277ms | 1% | 阿姆斯特丹 | 476个 | 14个 | 297ms | 3%  
新加坡 | 36个 | 1个 | 103ms | 0 | 班加罗尔 | 242个 | 5个 | 289ms | 1%  
