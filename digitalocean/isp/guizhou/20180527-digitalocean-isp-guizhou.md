#  贵州到Digital Ocean各机房的测速数据（20180527） 
...
贵州全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 55个 | 0 | 213ms | 2% | 法兰克福 | 27个 | 1个 | 296ms | 3%  
新加坡 | 28个 | 2个 | 236ms | 10% | 伦敦 | 28个 | 0 | 299ms | 3%  
多伦多 | 28个 | 1个 | 263ms | 2% | 阿姆斯特丹 | 56个 | 0 | 342ms | 3%  
纽约 | 84个 | 0 | 273ms | 2% | 班加罗尔 | 27个 | 1个 | 414ms | 5%  
均值 | 333个 | 5个 | 287ms | 3% |  |  |  |  |   
...
贵州电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 27个 | 0 | 231ms | 3% | 法兰克福 | 14个 | 1个 | 262ms | 0  
新加坡 | 14个 | 2个 | 357ms | 23% | 伦敦 | 14个 | 0 | 241ms | 0  
多伦多 | 14个 | 1个 | 254ms | 1% | 阿姆斯特丹 | 28个 | 0 | 321ms | 2%  
纽约 | 42个 | 0 | 269ms | 0 | 班加罗尔 | 13个 | 1个 | 406ms | 0  
均值 | 166个 | 5个 | 288ms | 3% |  |  |  |  |   
...
贵州联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 12个 | 0 | 209ms | 0 | 法兰克福 | 6个 | 0 | 359ms | 0  
新加坡 | 6个 | 0 | 241ms | 0 | 伦敦 | 6个 | 0 | 359ms | 2%  
多伦多 | 6个 | 0 | 282ms | 0 | 阿姆斯特丹 | 12个 | 0 | 352ms | 1%  
纽约 | 18个 | 0 | 290ms | 0 | 班加罗尔 | 6个 | 0 | 428ms | 0  
均值 | 72个 | 0 | 305ms | 0 |  |  |  |  |   
  
简评：如果你是来自贵州的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山、新加坡** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

贵州移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 16个 | 0 | 199ms | 4% | 法兰克福 | 7个 | 0 | 268ms | 9%  
新加坡 | 8个 | 0 | 109ms | 8% | 伦敦 | 8个 | 0 | 299ms | 9%  
多伦多 | 8个 | 0 | 253ms | 6% | 阿姆斯特丹 | 16个 | 0 | 352ms | 7%  
纽约 | 24个 | 0 | 261ms | 6% | 班加罗尔 | 8个 | 0 | 409ms | 17%  
均值 | 95个 | 0 | 269ms | 8% |  |  |  |  |   
