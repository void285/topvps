...
![宁夏到Digital Ocean各机房的测速数据（20180804）](/images/thumbnails/Ningxia_to_digitalocean.png)
...
![大陆省份宁夏到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180804](/images/pingtests/do_20180804/plot_isp_ningxia_do_20180804.png)

### 全部运营商

宁夏全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
多伦多 | 32个 | 0 | 274ms | 7% | 阿姆斯特丹 | 56个 | 0 | 319ms | 15%  
法兰克福 | 24个 | 0 | 279ms | 14% | 纽约 | 84个 | 0 | 322ms | 5%  
新加坡 | 32个 | 0 | 301ms | 11% | 旧金山 | 48个 | 0 | 328ms | 17%  
伦敦 | 32个 | 0 | 304ms | 4% | 班加罗尔 | 32个 | 0 | 352ms | 0  
均值 | 340个 | 0 | 311ms | 8% |  |  |  |  |   
  
简评：本表展示了宁夏的 **电信、移动** 线路到Digital Ocean各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻宁夏，可从此表了解你常用的网络到Digital Ocean各个机房的平均响应速度以及丢包率。从表中数据可以看到，各机房所在城市的响应值、丢包率都较高（TopVPS推荐选用响应值低于250ms，丢包率在5%%以内的机房），请慎重选择；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

宁夏电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
多伦多 | 24个 | 0 | 272ms | 2% | 阿姆斯特丹 | 40个 | 0 | 300ms | 23%  
法兰克福 | 24个 | 0 | 279ms | 14% | 纽约 | 72个 | 0 | 336ms | 10%  
新加坡 | 24个 | 0 | 438ms | 22% | 旧金山 | 48个 | 0 | 328ms | 17%  
伦敦 | 24个 | 0 | 295ms | 7% | 班加罗尔 | 24个 | 0 | 401ms | 0  
均值 | 280个 | 0 | 330ms | 13% |  |  |  |  |   
...
宁夏移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
多伦多 | 8个 | 0 | 277ms | 13% | 阿姆斯特丹 | 16个 | 0 | 338ms | 7%  
法兰克福 | - | - | - | - | 纽约 | 12个 | 0 | 309ms | 1%  
新加坡 | 8个 | 0 | 165ms | 1% | 旧金山 | - | - | - | -  
伦敦 | 8个 | 0 | 314ms | 2% | 班加罗尔 | 8个 | 0 | 304ms | 0  
均值 | 60个 | 0 | 293ms | 4% |  |  |  |  |   
  
简评：如果你是来自宁夏的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_4)吧！
...
本文最初发表于[宁夏到Digital Ocean各机房的测速数据（20180804）](https://vps123.top/pingtest/20180804-digitalocean-isp-ningxia.html)
