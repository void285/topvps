#  重庆到Digital Ocean各机房的测速数据（20180804） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![重庆到Digital Ocean各机房的测速数据（20180804）](/images/thumbnails/Chongqing_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点432个，其中超时点9个。连通概况如下：大陆线路响应均值为285毫秒，最快的三个机房所在地为新加坡、多伦多、伦敦，最慢的三个为阿姆斯特丹、纽约、班加罗尔；新加坡、旧金山、纽约有响应超时情况；新加坡、阿姆斯特丹、旧金山、纽约丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 重庆图表数据

![大陆省份重庆到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180804](/images/pingtests/do_20180804/plot_isp_chongqing_do_20180804.png)

### 全部运营商

重庆全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 37个 | 3个 | 241ms | 23% | 均值 | 432个 | 9个 | 285ms | 7%  
多伦多 | 37个 | 0 | 259ms | 0 | 阿姆斯特丹 | 74个 | 0 | 302ms | 12%  
伦敦 | 37个 | 0 | 269ms | 3% | 纽约 | 108个 | 3个 | 316ms | 5%  
法兰克福 | 34个 | 0 | 276ms | 3% | 班加罗尔 | 34个 | 0 | 357ms | 0  
旧金山 | 71个 | 3个 | 280ms | 7% |  |  |  |  |   
...
重庆电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 11个 | 0 | 297ms | 28% | 均值 | 132个 | 3个 | 309ms | 12%  
多伦多 | 11个 | 0 | 254ms | 1% | 阿姆斯特丹 | 22个 | 0 | 315ms | 26%  
伦敦 | 11个 | 0 | 227ms | 0 | 纽约 | 33个 | 3个 | 340ms | 10%  
法兰克福 | 11个 | 0 | 247ms | 5% | 班加罗尔 | 11个 | 0 | 431ms | 2%  
旧金山 | 22个 | 0 | 339ms | 12% |  |  |  |  |   
...
重庆联通到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 14个 | 3个 | 154ms | 1% | 均值 | 156个 | 6个 | 258ms | 2%  
多伦多 | 14个 | 0 | 267ms | 0 | 阿姆斯特丹 | 28个 | 0 | 312ms | 8%  
伦敦 | 14个 | 0 | 327ms | 7% | 纽约 | 39个 | 0 | 304ms | 0  
法兰克福 | 11个 | 0 | 332ms | 5% | 班加罗尔 | 11个 | 0 | 288ms | 0  
旧金山 | 25个 | 3个 | 204ms | 1% |  |  |  |  |   
...
重庆移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 12个 | 0 | 272ms | 39% | 均值 | 144个 | 0 | 287ms | 6%  
多伦多 | 12个 | 0 | 255ms | 0 | 阿姆斯特丹 | 24个 | 0 | 280ms | 2%  
伦敦 | 12个 | 0 | 253ms | 1% | 纽约 | 36个 | 0 | 305ms | 6%  
法兰克福 | 12个 | 0 | 249ms | 0 | 班加罗尔 | 12个 | 0 | 351ms | 0  
旧金山 | 24个 | 0 | 297ms | 7% |  |  |  |  |   
  
简评：如果你是来自重庆的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **法兰克福** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_3)吧！
...
本文最初发表于[重庆到Digital Ocean各机房的测速数据（20180804）](https://vps123.top/pingtest/20180804-digitalocean-isp-chongqing.html)
