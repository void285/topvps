#  新疆到Digital Ocean各机房的测速数据（20180622） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![新疆到Digital Ocean各机房的测速数据（20180622）](/images/thumbnails/Xinjiang_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点232个，其中超时点7个。连通概况如下：大陆线路响应均值为331毫秒，最快的三个机房所在地为旧金山、新加坡、多伦多，最慢的三个为阿姆斯特丹、纽约、班加罗尔；旧金山、多伦多、伦敦、法兰克福、阿姆斯特丹有响应超时情况；新加坡、阿姆斯特丹丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 新疆图表数据

![大陆省份新疆到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180622](/images/pingtests/do_20180622/plot_isp_xinjiang_do_20180622.png)

### 全部运营商

新疆全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 42个 | 3个 | 264ms | 2% | 均值 | 232个 | 7个 | 331ms | 2%  
新加坡 | 9个 | 0 | 274ms | 16% | 阿姆斯特丹 | 43个 | 1个 | 350ms | 5%  
多伦多 | 24个 | 1个 | 307ms | 1% | 纽约 | 48个 | 0 | 351ms | 0  
伦敦 | 25个 | 1个 | 320ms | 0 | 班加罗尔 | 21个 | 0 | 400ms | 1%  
法兰克福 | 20个 | 1个 | 331ms | 1% |  |  |  |  |   
...
新疆电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 22个 | 3个 | 301ms | 2% | 均值 | 117个 | 7个 | 329ms | 4%  
新加坡 | 7个 | 0 | 422ms | 33% | 阿姆斯特丹 | 21个 | 1个 | 341ms | 9%  
多伦多 | 11个 | 1个 | 297ms | 0 | 纽约 | 24个 | 0 | 340ms | 0  
伦敦 | 12个 | 1个 | 274ms | 0 | 班加罗尔 | 10个 | 0 | 461ms | 2%  
法兰克福 | 10个 | 1个 | 269ms | 0 |  |  |  |  |   
...
新疆联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 4个 | 0 | 236ms | 1% | 均值 | 27个 | 0 | 354ms | 1%  
新加坡 | - | - | - | - | 阿姆斯特丹 | 6个 | 0 | 385ms | 1%  
多伦多 | 3个 | 0 | 302ms | 1% | 纽约 | 5个 | 0 | 382ms | 2%  
伦敦 | 3个 | 0 | 377ms | 0 | 班加罗尔 | 3个 | 0 | 407ms | 0  
法兰克福 | 3个 | 0 | 377ms | 1% |  |  |  |  |   
  
简评：如果你是来自新疆的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_4)吧！

### 移动

新疆移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 16个 | 0 | 256ms | 4% | 均值 | 88个 | 0 | 310ms | 2%  
新加坡 | 2个 | 0 | 127ms | 0 | 阿姆斯特丹 | 16个 | 0 | 324ms | 5%  
多伦多 | 10个 | 0 | 323ms | 2% | 纽约 | 19个 | 0 | 331ms | 0  
伦敦 | 10个 | 0 | 310ms | 0 | 班加罗尔 | 8个 | 0 | 333ms | 0  
法兰克福 | 7个 | 0 | 346ms | 2% |  |  |  |  |   
  
简评：如果你是来自新疆的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_5)吧！
...
本文最初发表于[新疆到Digital Ocean各机房的测速数据（20180622）](https://vps123.top/pingtest/20180622-digitalocean-isp-xinjiang.html)
