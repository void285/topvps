#  新疆到Digital Ocean各机房的测速数据（20180527） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![新疆到Digital Ocean各机房的测速数据（20180527）](/images/thumbnails/Xinjiang_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点337个，其中超时点1个。连通概况如下：大陆线路响应均值为327毫秒，最快的三个机房所在地为旧金山、多伦多、新加坡，最慢的三个为伦敦、阿姆斯特丹、班加罗尔；纽约有响应超时情况；新加坡丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 新疆图表数据

![大陆省份新疆到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180527](/images/pingtests/do_20180527/plot_isp_xinjiang_do_20180527.png)

### 全部运营商

新疆全部运营商到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 54个 | 0 | 263ms | 3% | 均值 | 337个 | 1个 | 327ms | 3%  
多伦多 | 28个 | 0 | 300ms | 0 | 伦敦 | 28个 | 0 | 331ms | 1%  
新加坡 | 29个 | 0 | 317ms | 10% | 阿姆斯特丹 | 57个 | 0 | 362ms | 2%  
法兰克福 | 28个 | 0 | 319ms | 2% | 班加罗尔 | 28个 | 0 | 439ms | 3%  
纽约 | 85个 | 1个 | 319ms | 1% |  |  |  |  |   
...
新疆电信到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 22个 | 0 | 286ms | 5% | 均值 | 140个 | 1个 | 317ms | 4%  
多伦多 | 12个 | 0 | 289ms | 0 | 伦敦 | 12个 | 0 | 289ms | 2%  
新加坡 | 12个 | 0 | 386ms | 18% | 阿姆斯特丹 | 23个 | 0 | 334ms | 5%  
法兰克福 | 12个 | 0 | 270ms | 3% | 班加罗尔 | 11个 | 0 | 435ms | 1%  
纽约 | 36个 | 1个 | 311ms | 0 |  |  |  |  |   
...
新疆联通到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 6个 | 0 | 245ms | 2% | 均值 | 41个 | 0 | 348ms | 1%  
多伦多 | 3个 | 0 | 292ms | 0 | 伦敦 | 3个 | 0 | 391ms | 1%  
新加坡 | 4个 | 0 | 405ms | 12% | 阿姆斯特丹 | 8个 | 0 | 388ms | 1%  
法兰克福 | 3个 | 0 | 372ms | 0 | 班加罗尔 | 4个 | 0 | 419ms | 0  
纽约 | 10个 | 0 | 323ms | 0 |  |  |  |  |   
...
新疆移动到Digital Ocean各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 26个 | 0 | 257ms | 2% | 均值 | 156个 | 0 | 315ms | 3%  
多伦多 | 13个 | 0 | 318ms | 1% | 伦敦 | 13个 | 0 | 313ms | 1%  
新加坡 | 13个 | 0 | 162ms | 2% | 阿姆斯特丹 | 26个 | 0 | 365ms | 1%  
法兰克福 | 13个 | 0 | 316ms | 3% | 班加罗尔 | 13个 | 0 | 464ms | 9%  
纽约 | 39个 | 0 | 322ms | 3% |  |  |  |  |   
...
本文最初发表于[新疆到Digital Ocean各机房的测速数据（20180527）](https://vps123.top/pingtest/20180527-digitalocean-isp-xinjiang.html)
