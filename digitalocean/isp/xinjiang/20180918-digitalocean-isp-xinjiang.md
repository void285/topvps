#  新疆到Digital Ocean各机房的测速数据（20180918） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![新疆到Digital Ocean各机房的测速数据（20180918）](/images/thumbnails/Xinjiang_to_digitalocean.png)
...
本文提供20180918新疆到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点395个，无超时点。连通概况如下：大陆线路响应均值为333毫秒，最快的三个机房所在地为新加坡、旧金山、多伦多，最慢的三个为纽约、阿姆斯特丹、班加罗尔；阿姆斯特丹、多伦多、法兰克福、旧金山、伦敦等7处丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 新疆图表数据

![大陆省份新疆到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180918](/images/pingtests/do_20180918/plot_isp_xinjiang_do_20180918.png)

### 全部运营商

新疆全部运营商到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 34个 | 0 | 297ms | 5% | 法兰克福 | 36个 | 0 | 337ms | 10%  
旧金山 | 73个 | 0 | 307ms | 10% | 纽约 | 90个 | 0 | 338ms | 5%  
多伦多 | 30个 | 0 | 327ms | 10% | 阿姆斯特丹 | 68个 | 0 | 349ms | 12%  
伦敦 | 30个 | 0 | 331ms | 8% | 班加罗尔 | 34个 | 0 | 388ms | 0  
均值 | 395个 | 0 | 333ms | 8% |  |  |  |  |   
...
新疆电信到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 19个 | 0 | 361ms | 5% | 法兰克福 | 19个 | 0 | 287ms | 5%  
旧金山 | 39个 | 0 | 292ms | 12% | 纽约 | 53个 | 0 | 329ms | 3%  
多伦多 | 17个 | 0 | 319ms | 8% | 阿姆斯特丹 | 38个 | 0 | 326ms | 6%  
伦敦 | 17个 | 0 | 320ms | 3% | 班加罗尔 | 19个 | 0 | 411ms | 0  
均值 | 221个 | 0 | 324ms | 6% |  |  |  |  |   
...
新疆联通到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 8个 | 0 | 349ms | 9% | 法兰克福 | 8个 | 0 | 400ms | 17%  
旧金山 | 16个 | 0 | 306ms | 11% | 纽约 | 21个 | 0 | 357ms | 5%  
多伦多 | 8个 | 0 | 332ms | 12% | 阿姆斯特丹 | 16个 | 0 | 390ms | 19%  
伦敦 | 8个 | 0 | 366ms | 13% | 班加罗尔 | 8个 | 0 | 398ms | 0  
均值 | 93个 | 0 | 359ms | 11% |  |  |  |  |   
...
新疆移动到Digital Ocean各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 7个 | 0 | 180ms | 1% | 法兰克福 | 9个 | 0 | 324ms | 7%  
旧金山 | 18个 | 0 | 323ms | 6% | 纽约 | 16个 | 0 | 329ms | 6%  
多伦多 | 5个 | 0 | 331ms | 10% | 阿姆斯特丹 | 14个 | 0 | 331ms | 11%  
伦敦 | 5个 | 0 | 307ms | 8% | 班加罗尔 | 7个 | 0 | 354ms | 1%  
均值 | 81个 | 0 | 316ms | 7% |  |  |  |  |   
...
本文最初发表于[新疆到Digital Ocean各机房的测速数据（20180918）](https://vps123.top/pingtest/20180918-digitalocean-isp-xinjiang.html)
