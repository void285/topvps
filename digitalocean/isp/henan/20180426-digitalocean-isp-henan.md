#  河南到Digital Ocean各机房的测速数据（20180426） 
...
河南全部运营商到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 48个 | 0 | 155ms | 2% | 伦敦 | 51个 | 0 | 275ms | 0  
旧金山 | 100个 | 2个 | 216ms | 3% | 法兰克福 | 49个 | 0 | 298ms | 6%  
多伦多 | 49个 | 0 | 259ms | 3% | 阿姆斯特丹 | 98个 | 0 | 298ms | 0  
均值 | 596个 | 2个 | 266ms | 2% | 班加罗尔 | 50个 | 0 | 365ms | 6%  
纽约 | 151个 | 0 | 270ms | 2% |  |  |  |  |   
...
河南电信到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 16个 | 0 | 184ms | 2% | 伦敦 | 16个 | 0 | 262ms | 0  
旧金山 | 31个 | 2个 | 228ms | 3% | 法兰克福 | 15个 | 0 | 316ms | 11%  
多伦多 | 16个 | 0 | 258ms | 2% | 阿姆斯特丹 | 31个 | 0 | 278ms | 0  
均值 | 186个 | 2个 | 270ms | 2% | 班加罗尔 | 15个 | 0 | 370ms | 4%  
纽约 | 46个 | 0 | 280ms | 1% |  |  |  |  |   
...
河南联通到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 17个 | 0 | 183ms | 3% | 伦敦 | 18个 | 0 | 303ms | 1%  
旧金山 | 36个 | 0 | 210ms | 2% | 法兰克福 | 17个 | 0 | 318ms | 5%  
多伦多 | 18个 | 0 | 254ms | 3% | 阿姆斯特丹 | 35个 | 0 | 315ms | 1%  
均值 | 213个 | 0 | 269ms | 2% | 班加罗尔 | 18个 | 0 | 369ms | 2%  
纽约 | 54个 | 0 | 250ms | 0 |  |  |  |  |   
  
简评：如果你是来自河南的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山、纽约** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

河南移动到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 15个 | 0 | 98ms | 0 | 伦敦 | 17个 | 0 | 259ms | 0  
旧金山 | 33个 | 0 | 210ms | 5% | 法兰克福 | 17个 | 0 | 260ms | 1%  
多伦多 | 15个 | 0 | 264ms | 4% | 阿姆斯特丹 | 32个 | 0 | 302ms | 0  
均值 | 197个 | 0 | 260ms | 3% | 班加罗尔 | 17个 | 0 | 356ms | 10%  
纽约 | 51个 | 0 | 280ms | 3% |  |  |  |  |   
