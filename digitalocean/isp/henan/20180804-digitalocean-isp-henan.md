#  河南到Digital Ocean各机房的测速数据（20180804） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![河南到Digital Ocean各机房的测速数据（20180804）](/images/thumbnails/Henan_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点3732个，其中超时点3个。连通概况如下：大陆线路响应均值为298毫秒，最快的三个机房所在地为旧金山、纽约、多伦多，最慢的三个为阿姆斯特丹、法兰克福、班加罗尔；法兰克福有响应超时情况；新加坡、阿姆斯特丹、旧金山、法兰克福、纽约丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 河南图表数据

![大陆省份河南到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180804](/images/pingtests/do_20180804/plot_isp_henan_do_20180804.png)

### 全部运营商

河南全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 610个 | 0 | 256ms | 6% | 伦敦 | 319个 | 0 | 308ms | 3%  
纽约 | 893个 | 0 | 280ms | 5% | 阿姆斯特丹 | 642个 | 0 | 320ms | 7%  
多伦多 | 327个 | 0 | 289ms | 4% | 法兰克福 | 291个 | 3个 | 322ms | 5%  
均值 | 3732个 | 3个 | 298ms | 6% | 班加罗尔 | 323个 | 0 | 355ms | 3%  
新加坡 | 327个 | 0 | 303ms | 11% |  |  |  |  |   
...
河南电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 176个 | 0 | 329ms | 6% | 伦敦 | 96个 | 0 | 315ms | 3%  
纽约 | 272个 | 0 | 292ms | 4% | 阿姆斯特丹 | 196个 | 0 | 323ms | 16%  
多伦多 | 92个 | 0 | 286ms | 1% | 法兰克福 | 88个 | 0 | 290ms | 3%  
均值 | 1120个 | 0 | 317ms | 7% | 班加罗尔 | 100个 | 0 | 385ms | 4%  
新加坡 | 100个 | 0 | 343ms | 18% |  |  |  |  |   
...
河南联通到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 202个 | 0 | 218ms | 5% | 伦敦 | 103个 | 0 | 329ms | 1%  
纽约 | 265个 | 0 | 272ms | 3% | 阿姆斯特丹 | 206个 | 0 | 345ms | 1%  
多伦多 | 115个 | 0 | 304ms | 7% | 法兰克福 | 83个 | 3个 | 379ms | 8%  
均值 | 1184个 | 3个 | 311ms | 4% | 班加罗尔 | 103个 | 0 | 398ms | 3%  
新加坡 | 107个 | 0 | 380ms | 7% |  |  |  |  |   
  
简评：如果你是来自河南的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_4)吧！

### 移动

河南移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 232个 | 0 | 221ms | 7% | 伦敦 | 120个 | 0 | 280ms | 5%  
纽约 | 356个 | 0 | 276ms | 7% | 阿姆斯特丹 | 240个 | 0 | 291ms | 4%  
多伦多 | 120个 | 0 | 278ms | 5% | 法兰克福 | 120个 | 0 | 295ms | 4%  
均值 | 1428个 | 0 | 265ms | 5% | 班加罗尔 | 120个 | 0 | 281ms | 2%  
新加坡 | 120个 | 0 | 186ms | 6% |  |  |  |  |   
  
简评：如果你是来自河南的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，请慎重选择部署在 **新加坡、旧金山** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_5)吧！
...
## 相关测速报告
  ...
  * 本期报告：河南到 _其他VPS提供商_ 各机房的测速报告： 
    * [Vultr](/vultr/isp/henan/20180804-vultr-isp-henan.md "河南到Vultr各机房的Ping测试 20180804")
...
本文最初发表于[河南到Digital Ocean各机房的测速数据（20180804）](https://vps123.top/pingtest/20180804-digitalocean-isp-henan.html)
