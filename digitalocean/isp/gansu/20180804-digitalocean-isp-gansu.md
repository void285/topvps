#  甘肃到Digital Ocean各机房的测速数据（20180804） 
...
**甘肃全部运营商到Digital Ocean各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 104个 | 0 | 255ms | 1%  
伦敦 | 104个 | 0 | 299ms | 1%  
阿姆斯特丹 | 208个 | 0 | 308ms | 12%  
多伦多 | 104个 | 0 | 309ms | 1%  
新加坡 | 104个 | 0 | 312ms | 11%  
均值 | 1244个 | 0 | 318ms | 7%  
旧金山 | 204个 | 0 | 322ms | 10%  
...
**甘肃电信到Digital Ocean各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
法兰克福 | 72个 | 0 | 223ms | 0  
伦敦 | 72个 | 0 | 275ms | 0  
阿姆斯特丹 | 144个 | 0 | 305ms | 18%  
多伦多 | 72个 | 0 | 314ms | 1%  
新加坡 | 72个 | 0 | 413ms | 18%  
均值 | 860个 | 0 | 338ms | 9%  
旧金山 | 140个 | 0 | 364ms | 13%  
...
**甘肃移动到Digital Ocean各机房的测速数据 [20180804]**
