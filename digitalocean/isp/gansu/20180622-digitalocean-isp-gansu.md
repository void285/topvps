#  甘肃到Digital Ocean各机房的测速数据（20180622） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![甘肃到Digital Ocean各机房的测速数据（20180622）](/images/thumbnails/Gansu_to_digitalocean.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点168个，其中超时点2个。连通概况如下：大陆线路响应均值为300毫秒，最快的三个机房所在地为伦敦、旧金山、法兰克福，最慢的三个为新加坡、纽约、班加罗尔；法兰克福、班加罗尔有响应超时情况；新加坡、阿姆斯特丹丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 甘肃图表数据

![大陆省份甘肃到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180622](/images/pingtests/do_20180622/plot_isp_gansu_do_20180622.png)

### 全部运营商

甘肃全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 15个 | 0 | 259ms | 0 | 阿姆斯特丹 | 33个 | 0 | 313ms | 6%  
旧金山 | 34个 | 0 | 264ms | 1% | 新加坡 | 6个 | 0 | 331ms | 26%  
法兰克福 | 17个 | 1个 | 276ms | 2% | 纽约 | 31个 | 0 | 336ms | 3%  
多伦多 | 15个 | 0 | 279ms | 0 | 班加罗尔 | 17个 | 1个 | 347ms | 0  
均值 | 168个 | 2个 | 300ms | 2% |  |  |  |  |   
...
甘肃电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 9个 | 0 | 255ms | 1% | 阿姆斯特丹 | 19个 | 0 | 310ms | 8%  
旧金山 | 20个 | 0 | 278ms | 0 | 新加坡 | 6个 | 0 | 331ms | 26%  
法兰克福 | 9个 | 1个 | 231ms | 0 | 纽约 | 18个 | 0 | 349ms | 1%  
多伦多 | 9个 | 0 | 263ms | 1% | 班加罗尔 | 10个 | 1个 | 400ms | 0  
均值 | 100个 | 2个 | 304ms | 3% |  |  |  |  |   
...
甘肃联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 1个 | 0 | 267ms | 0 | 阿姆斯特丹 | - | - | - | -  
旧金山 | - | - | - | - | 新加坡 | - | - | - | -  
法兰克福 | - | - | - | - | 纽约 | 1个 | 0 | 365ms | 5%  
多伦多 | 1个 | 0 | 288ms | 1% | 班加罗尔 | - | - | - | -  
均值 | 3个 | 0 | 306ms | 2% |  |  |  |  |   
  
简评：如果你是来自甘肃的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，很遗憾从本次测试来看，没有值得你关注的机房；请查看往期的测试，如果数据一直不乐观，你应考虑换用其他VPS提供商如[Vultr](https://vps123.top/go/vultr/_2)、[BandwagonHost](https://vps123.top/go/bandwagon/_3)、[Linode](https://vps123.top/go/linode/_4)等。

### 移动

甘肃移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 5个 | 0 | 257ms | 0 | 阿姆斯特丹 | 14个 | 0 | 317ms | 4%  
旧金山 | 14个 | 0 | 251ms | 1% | 新加坡 | - | - | - | -  
法兰克福 | 8个 | 0 | 320ms | 4% | 纽约 | 12个 | 0 | 296ms | 2%  
多伦多 | 5个 | 0 | 286ms | 0 | 班加罗尔 | 7个 | 0 | 293ms | 0  
均值 | 65个 | 0 | 290ms | 2% |  |  |  |  |   
  
简评：如果你是来自甘肃的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，很遗憾从本次测试来看，没有值得你关注的机房；请查看往期的测试，如果数据一直不乐观，你应考虑换用其他VPS提供商如[Vultr](https://vps123.top/go/vultr/_5)、[BandwagonHost](https://vps123.top/go/bandwagon/_6)、[Linode](https://vps123.top/go/linode/_7)等。
...
本文最初发表于[甘肃到Digital Ocean各机房的测速数据（20180622）](https://vps123.top/pingtest/20180622-digitalocean-isp-gansu.html)
