...
![云南到Digital Ocean各机房的测速数据（20180804）](/images/thumbnails/Yunnan_to_digitalocean.png)
...
![大陆省份云南到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180804](/images/pingtests/do_20180804/plot_isp_yunnan_do_20180804.png)

### 全部运营商

云南全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 115个 | 0 | 307ms | 9% | 新加坡 | 119个 | 0 | 338ms | 20%  
多伦多 | 119个 | 0 | 307ms | 12% | 纽约 | 321个 | 3个 | 342ms | 12%  
旧金山 | 218个 | 0 | 322ms | 10% | 阿姆斯特丹 | 226个 | 0 | 344ms | 7%  
法兰克福 | 111个 | 0 | 328ms | 4% | 班加罗尔 | 115个 | 0 | 392ms | 14%  
均值 | 1344个 | 3个 | 336ms | 11% |  |  |  |  |   
...
云南电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 51个 | 0 | 278ms | 7% | 新加坡 | 51个 | 0 | 373ms | 21%  
多伦多 | 51个 | 0 | 271ms | 5% | 纽约 | 125个 | 3个 | 329ms | 15%  
旧金山 | 94个 | 0 | 320ms | 15% | 阿姆斯特丹 | 98个 | 0 | 328ms | 8%  
法兰克福 | 47个 | 0 | 311ms | 7% | 班加罗尔 | 47个 | 0 | 406ms | 10%  
均值 | 564个 | 3个 | 326ms | 12% |  |  |  |  |   
...
云南联通到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 8个 | 0 | 358ms | 18% | 新加坡 | 8个 | 0 | 462ms | 33%  
多伦多 | 8个 | 0 | 376ms | 31% | 纽约 | 24个 | 0 | 417ms | 21%  
旧金山 | 16个 | 0 | 433ms | 15% | 阿姆斯特丹 | 16个 | 0 | 410ms | 11%  
法兰克福 | 8个 | 0 | 389ms | 4% | 班加罗尔 | 8个 | 0 | 475ms | 34%  
均值 | 96个 | 0 | 416ms | 20% |  |  |  |  |   
...
云南移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
伦敦 | 56个 | 0 | 284ms | 3% | 新加坡 | 60个 | 0 | 179ms | 4%  
多伦多 | 60个 | 0 | 275ms | 0 | 纽约 | 172个 | 0 | 280ms | 1%  
旧金山 | 108个 | 0 | 214ms | 0 | 阿姆斯特丹 | 112个 | 0 | 293ms | 2%  
法兰克福 | 56个 | 0 | 284ms | 2% | 班加罗尔 | 60个 | 0 | 295ms | 0  
均值 | 684个 | 0 | 264ms | 1% |  |  |  |  |   
  
简评：如果你是来自云南的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_7)吧！
...
本文最初发表于[云南到Digital Ocean各机房的测速数据（20180804）](https://vps123.top/pingtest/20180804-digitalocean-isp-yunnan.html)
