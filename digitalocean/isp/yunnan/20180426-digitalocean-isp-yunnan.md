#  云南到Digital Ocean各机房的测速数据（20180426） 
...
云南全部运营商到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 28个 | 0 | 174ms | 1% | 伦敦 | 27个 | 0 | 297ms | 2%  
旧金山 | 50个 | 2个 | 249ms | 4% | 法兰克福 | 25个 | 0 | 303ms | 6%  
多伦多 | 28个 | 0 | 273ms | 2% | 阿姆斯特丹 | 37个 | 0 | 336ms | 1%  
均值 | 303个 | 2个 | 288ms | 3% | 班加罗尔 | 28个 | 0 | 376ms | 6%  
纽约 | 80个 | 0 | 292ms | 1% |  |  |  |  |   
...
云南电信到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 12个 | 0 | 237ms | 0 | 伦敦 | 11个 | 0 | 265ms | 0  
旧金山 | 20个 | 2个 | 300ms | 5% | 法兰克福 | 10个 | 0 | 322ms | 15%  
多伦多 | 12个 | 0 | 267ms | 0 | 阿姆斯特丹 | 8个 | 0 | 324ms | 0  
均值 | 119个 | 2个 | 305ms | 2% | 班加罗尔 | 12个 | 0 | 410ms | 1%  
纽约 | 34个 | 0 | 310ms | 1% |  |  |  |  |   
...
云南联通到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 6个 | 0 | 145ms | 0 | 伦敦 | 6个 | 0 | 347ms | 1%  
旧金山 | 11个 | 0 | 206ms | 1% | 法兰克福 | 6个 | 0 | 312ms | 0  
多伦多 | 6个 | 0 | 272ms | 0 | 阿姆斯特丹 | 10个 | 0 | 344ms | 1%  
均值 | 68个 | 0 | 278ms | 1% | 班加罗尔 | 6个 | 0 | 353ms | 4%  
纽约 | 17个 | 0 | 273ms | 0 |  |  |  |  |   
  
简评：如果你是来自云南的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

云南移动到Digital Ocean各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 10个 | 0 | 140ms | 5% | 伦敦 | 10个 | 0 | 278ms | 5%  
旧金山 | 19个 | 0 | 241ms | 6% | 法兰克福 | 9个 | 0 | 274ms | 2%  
多伦多 | 10个 | 0 | 281ms | 5% | 阿姆斯特丹 | 19个 | 0 | 341ms | 3%  
均值 | 116个 | 0 | 282ms | 5% | 班加罗尔 | 10个 | 0 | 365ms | 13%  
纽约 | 29个 | 0 | 294ms | 2% |  |  |  |  |   
