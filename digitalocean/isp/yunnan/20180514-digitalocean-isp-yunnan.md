...
![云南到Digital Ocean各机房的测速数据（20180514）](/images/thumbnails/Yunnan_to_digitalocean.png)
...
![大陆省份云南到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180514](/images/pingtests/do_20180514/plot_isp_yunnan_do_20180514.png)

### 全部运营商

云南全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 22个 | 0 | 179ms | 5% | 纽约 | 67个 | 0 | 299ms | 3%  
旧金山 | 54个 | 2个 | 254ms | 6% | 多伦多 | 25个 | 0 | 300ms | 8%  
均值 | 288个 | 2个 | 287ms | 4% | 阿姆斯特丹 | 48个 | 0 | 309ms | 2%  
法兰克福 | 25个 | 0 | 290ms | 1% | 班加罗尔 | 24个 | 0 | 362ms | 5%  
伦敦 | 23个 | 0 | 299ms | 2% |  |  |  |  |   
  
简评：本表展示了云南的 **电信、联通、移动** 线路到Digital Ocean各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻云南，可从此表了解你常用的网络到Digital Ocean各个机房的平均响应速度以及丢包率。从表中数据可以看到， **新加坡** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

云南电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 9个 | 0 | 273ms | 12% | 纽约 | 29个 | 0 | 319ms | 4%  
旧金山 | 26个 | 2个 | 311ms | 16% | 多伦多 | 11个 | 0 | 292ms | 3%  
均值 | 127个 | 2个 | 315ms | 6% | 阿姆斯特丹 | 22个 | 0 | 299ms | 1%  
法兰克福 | 11个 | 0 | 283ms | 0 | 班加罗尔 | 10个 | 0 | 471ms | 10%  
伦敦 | 9个 | 0 | 285ms | 0 |  |  |  |  |   
...
云南联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 5个 | 0 | 115ms | 0 | 纽约 | 14个 | 0 | 287ms | 3%  
旧金山 | 10个 | 0 | 210ms | 1% | 多伦多 | 5个 | 0 | 312ms | 11%  
均值 | 59个 | 0 | 275ms | 3% | 阿姆斯特丹 | 10个 | 0 | 330ms | 4%  
法兰克福 | 5个 | 0 | 320ms | 3% | 班加罗尔 | 5个 | 0 | 274ms | 0  
伦敦 | 5个 | 0 | 339ms | 7% |  |  |  |  |   
  
简评：如果你是来自云南的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_4)吧！

### 移动

云南移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 8个 | 0 | 149ms | 4% | 纽约 | 24个 | 0 | 292ms | 2%  
旧金山 | 18个 | 0 | 240ms | 1% | 多伦多 | 9个 | 0 | 296ms | 9%  
均值 | 102个 | 0 | 273ms | 2% | 阿姆斯特丹 | 16个 | 0 | 297ms | 0  
法兰克福 | 9个 | 0 | 266ms | 0 | 班加罗尔 | 9个 | 0 | 339ms | 6%  
伦敦 | 9个 | 0 | 273ms | 0 |  |  |  |  |   
  
简评：如果你是来自云南的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_5)吧！
...
本文最初发表于[云南到Digital Ocean各机房的测速数据（20180514）](https://vps123.top/pingtest/20180514-digitalocean-isp-yunnan.html)
