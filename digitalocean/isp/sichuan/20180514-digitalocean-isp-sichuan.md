#  四川到Digital Ocean各机房的测速数据（20180514） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![四川到Digital Ocean各机房的测速数据（20180514）](/images/thumbnails/Sichuan_to_digitalocean.png)
...
本文提供20180514四川到Digital Ocean各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点574个，其中超时点2个。连通概况如下：大陆线路响应均值为299毫秒，最快的三个机房所在地为新加坡、旧金山、多伦多，最慢的三个为阿姆斯特丹、纽约、班加罗尔；法兰克福、班加罗尔有响应超时情况；新加坡、多伦多、纽约、法兰克福丢包率较高。

[注册 Digital Ocean](https://vps123.top/go/do/_btn1)

## 四川图表数据

![大陆省份四川到VPS提供商Digital Ocean各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180514](/images/pingtests/do_20180514/plot_isp_sichuan_do_20180514.png)

### 全部运营商

四川全部运营商到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 49个 | 0 | 254ms | 9% | 均值 | 574个 | 2个 | 299ms | 5%  
旧金山 | 96个 | 0 | 255ms | 3% | 阿姆斯特丹 | 98个 | 0 | 306ms | 2%  
多伦多 | 46个 | 0 | 290ms | 9% | 纽约 | 141个 | 0 | 311ms | 6%  
伦敦 | 49个 | 0 | 291ms | 3% | 班加罗尔 | 45个 | 1个 | 410ms | 4%  
法兰克福 | 50个 | 1个 | 298ms | 5% |  |  |  |  |   
...
四川电信到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 22个 | 0 | 320ms | 13% | 均值 | 271个 | 2个 | 312ms | 3%  
旧金山 | 45个 | 0 | 303ms | 4% | 阿姆斯特丹 | 46个 | 0 | 269ms | 0  
多伦多 | 21个 | 0 | 267ms | 0 | 纽约 | 68个 | 0 | 333ms | 3%  
伦敦 | 24个 | 0 | 248ms | 0 | 班加罗尔 | 21个 | 1个 | 512ms | 7%  
法兰克福 | 24个 | 1个 | 264ms | 0 |  |  |  |  |   
...
四川联通到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 12个 | 0 | 260ms | 9% | 均值 | 137个 | 0 | 308ms | 8%  
旧金山 | 23个 | 0 | 235ms | 3% | 阿姆斯特丹 | 24个 | 0 | 343ms | 5%  
多伦多 | 12个 | 0 | 296ms | 13% | 纽约 | 32个 | 0 | 303ms | 12%  
伦敦 | 12个 | 0 | 346ms | 8% | 班加罗尔 | 11个 | 0 | 379ms | 4%  
法兰克福 | 11个 | 0 | 346ms | 12% |  |  |  |  |   
...
四川移动到Digital Ocean各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 15个 | 0 | 182ms | 5% | 均值 | 166个 | 0 | 278ms | 4%  
旧金山 | 28个 | 0 | 227ms | 2% | 阿姆斯特丹 | 28个 | 0 | 307ms | 2%  
多伦多 | 13个 | 0 | 309ms | 14% | 纽约 | 41个 | 0 | 295ms | 4%  
伦敦 | 13个 | 0 | 279ms | 3% | 班加罗尔 | 13个 | 0 | 340ms | 2%  
法兰克福 | 15个 | 0 | 284ms | 4% |  |  |  |  |   
  
简评：如果你是来自四川的 **移动** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、旧金山** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_3)吧！
...
本文最初发表于[四川到Digital Ocean各机房的测速数据（20180514）](https://vps123.top/pingtest/20180514-digitalocean-isp-sichuan.html)
