...
上海全部运营商到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 15个 | 2个 | 201ms | 4% | 法兰克福 | 8个 | 1个 | 260ms | 3%  
多伦多 | 7个 | 1个 | 238ms | 0 | 纽约 | 18个 | 3个 | 261ms | 6%  
新加坡 | 3个 | 1个 | 246ms | 11% | 伦敦 | 5个 | 0 | 264ms | 0  
均值 | 77个 | 11个 | 251ms | 4% | 班加罗尔 | 7个 | 1个 | 317ms | 0  
...
上海电信到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 12个 | 2个 | 217ms | 3% | 法兰克福 | 6个 | 1个 | 258ms | 0  
多伦多 | 6个 | 1个 | 227ms | 0 | 纽约 | 15个 | 3个 | 287ms | 0  
新加坡 | 3个 | 1个 | 246ms | 11% | 伦敦 | 4个 | 0 | 213ms | 0  
均值 | 64个 | 11个 | 260ms | 1% | 班加罗尔 | 6个 | 1个 | 357ms | 0  
...
上海联通到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 2个 | 0 | 198ms | 10% | 法兰克福 | 1个 | 0 | 259ms | 0  
多伦多 | 1个 | 0 | 249ms | 0 | 纽约 | 2个 | 0 | 249ms | 5%  
新加坡 | - | - | - | - | 伦敦 | 1个 | 0 | 315ms | 1%  
均值 | 7个 | 0 | 245ms | 4% | 班加罗尔 | - | - | - | -  
阿姆斯特丹 | - | - | - | - |  |  |  |  |   
...
上海移动到Digital Ocean各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 1个 | 0 | 187ms | 1% | 法兰克福 | 1个 | 0 | 265ms | 11%  
多伦多 | - | - | - | - | 纽约 | 1个 | 0 | 249ms | 13%  
新加坡 | - | - | - | - | 伦敦 | - | - | - | -  
均值 | 6个 | 0 | 246ms | 6% | 班加罗尔 | 1个 | 0 | 278ms | 0  
阿姆斯特丹 | 2个 | 0 | 251ms | 7% |  |  |  |  |   
