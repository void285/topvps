#  上海到Digital Ocean各机房的测速数据（20180804） 
...
上海全部运营商到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 62个 | 11个 | 210ms | 0 | 伦敦 | 24个 | 4个 | 283ms | 0  
多伦多 | 28个 | 4个 | 252ms | 1% | 法兰克福 | 27个 | 4个 | 308ms | 2%  
阿姆斯特丹 | 59个 | 8个 | 272ms | 3% | 新加坡 | 31个 | 4个 | 316ms | 18%  
均值 | 351个 | 51个 | 276ms | 3% | 班加罗尔 | 31个 | 4个 | 340ms | 2%  
纽约 | 89个 | 12个 | 280ms | 2% |  |  |  |  |   
...
上海电信到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 38个 | 11个 | 217ms | 0 | 伦敦 | 16个 | 4个 | 270ms | 0  
多伦多 | 16个 | 4个 | 256ms | 3% | 法兰克福 | 19个 | 4个 | 282ms | 4%  
阿姆斯特丹 | 35个 | 8个 | 274ms | 3% | 新加坡 | 19个 | 4个 | 282ms | 44%  
均值 | 219个 | 51个 | 281ms | 6% | 班加罗尔 | 19个 | 4个 | 340ms | 0  
纽约 | 57个 | 12个 | 310ms | 6% |  |  |  |  |   
...
上海联通到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 8个 | 0 | 227ms | 2% | 伦敦 | - | - | - | -  
多伦多 | 4个 | 0 | 261ms | 0 | 法兰克福 | - | - | - | -  
阿姆斯特丹 | 8个 | 0 | 265ms | 2% | 新加坡 | 4个 | 0 | 402ms | 9%  
均值 | 36个 | 0 | 291ms | 3% | 班加罗尔 | 4个 | 0 | 403ms | 6%  
纽约 | 8个 | 0 | 285ms | 1% |  |  |  |  |   
  
简评：如果你是来自上海的 **联通** 用户，想运行Digital Ocean的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **旧金山** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/do/_2)吧！

### 移动

上海移动到Digital Ocean各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
旧金山 | 16个 | 0 | 186ms | 0 | 伦敦 | 8个 | 0 | 297ms | 0  
多伦多 | 8个 | 0 | 239ms | 0 | 法兰克福 | 8个 | 0 | 335ms | 1%  
阿姆斯特丹 | 16个 | 0 | 276ms | 4% | 新加坡 | 8个 | 0 | 265ms | 1%  
均值 | 96个 | 0 | 256ms | 1% | 班加罗尔 | 8个 | 0 | 277ms | 0  
纽约 | 24个 | 0 | 246ms | 0 |  |  |  |  |   
