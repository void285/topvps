...
大陆各省份到Digital Ocean美国-纽约机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
河南 | 893个 | 0 | 279ms | 5.4% | 江西 | 385个 | 24个 | 305ms | 5.2%  
北京 | 96个 | 0 | 285ms | 4.1% | 黑龙江 | 440个 | 0 | 306ms | 3.9%  
湖北 | 507个 | 3个 | 288ms | 4.8% | 福建 | 448个 | 3个 | 307ms | 7.0%  
山东 | 1002个 | 3个 | 289ms | 5.7% | 云南 | 321个 | 3个 | 310ms | 8.1%  
广东 | 1211个 | 3个 | 289ms | 5.4% | 广西 | 649个 | 4个 | 313ms | 6.7%  
海南 | 96个 | 0 | 289ms | 5.2% | 内蒙古 | 552个 | 0 | 313ms | 8.0%  
上海 | 89个 | 12个 | 291ms | 3.6% | 辽宁 | 622个 | 3个 | 313ms | 5.3%  
河北 | 636个 | 0 | 293ms | 5.9% | 四川 | 775个 | 0 | 314ms | 6.4%  
浙江 | 658个 | 34个 | 296ms | 4.5% | 天津 | 64个 | 0 | 319ms | 15.0%  
陕西 | 403个 | 3个 | 297ms | 2.7% | 贵州 | 386个 | 0 | 320ms | 4.3%  
江苏 | 954个 | 36个 | 298ms | 5.2% | 宁夏 | 84个 | 0 | 332ms | 9.0%  
安徽 | 646个 | 0 | 298ms | 7.1% | 吉林 | 196个 | 0 | 345ms | 6.5%  
山西 | 507个 | 6个 | 299ms | 2.9% | 青海 | 48个 | 0 | 346ms | 10.8%  
湖南 | 731个 | 3个 | 300ms | 4.8% | 甘肃 | 312个 | 0 | 348ms | 8.7%  
重庆 | 108个 | 3个 | 303ms | 5.8% | 新疆 | 305个 | 0 | 361ms | 5.2%  
均值 | 14148个 | 143个 | 303ms | 5.7% | 西藏 | 24个 | 0 | 444ms | 15.2%  
...
海外线路到Digital Ocean美国-纽约机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 34个 | 0 | 21ms | 0 | 日本 | 14个 | 0 | 196ms | 2.9%  
荷兰 | 12个 | 0 | 67ms | 0 | 韩国 | 63个 | 0 | 201ms | 0  
巴西 | 9个 | 0 | 71ms | 0 | 新加坡 | 41个 | 0 | 205ms | 0  
意大利 | 9个 | 0 | 71ms | - | 台湾 | 9个 | 0 | 217ms | 0  
德国 | 23个 | 0 | 94ms | 0 | 澳大利亚 | 14个 | 0 | 229ms | 0  
美国 | 139个 | 0 | 96ms | 1.1% | 法国 | 9个 | 0 | 235ms | 0  
英国 | 14个 | 0 | 115ms | 0 | 越南 | 2个 | 0 | 243ms | 0  
俄罗斯 | 9个 | 0 | 115ms | - | 印度尼西亚 | 14个 | 0 | 267ms | 0  
南非 | 12个 | 0 | 131ms | 0 | 马来西亚 | 22个 | 0 | 269ms | 0.6%  
均值 | 658个 | 0 | 171ms | 0.6% | 菲律宾 | 11个 | 0 | 392ms | 5.5%  
香港 | 198个 | 0 | 196ms | 0 |  |  |  |  |   
