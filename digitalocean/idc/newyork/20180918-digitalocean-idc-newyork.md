...
大陆各省份到Digital Ocean美国-纽约机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 20个 | 0 | 247ms | 1.2% | 海南 | 42个 | 0 | 283ms | 3.2%  
河南 | 243个 | 0 | 263ms | 8.8% | 内蒙古 | 158个 | 0 | 284ms | 11.7%  
浙江 | 192个 | 10个 | 263ms | 3.2% | 黑龙江 | 146个 | 0 | 285ms | 8.2%  
北京 | 22个 | 0 | 263ms | 0.2% | 天津 | 17个 | 0 | 287ms | 2.0%  
山西 | 147个 | 3个 | 265ms | 7.9% | 湖南 | 196个 | 1个 | 287ms | 3.9%  
河北 | 170个 | 0 | 271ms | 6.8% | 福建 | 132个 | 1个 | 288ms | 3.1%  
安徽 | 203个 | 1个 | 272ms | 2.9% | 陕西 | 124个 | 1个 | 289ms | 2.5%  
湖北 | 142个 | 1个 | 273ms | 2.5% | 贵州 | 111个 | 0 | 293ms | 4.5%  
江苏 | 252个 | 13个 | 274ms | 4.6% | 云南 | 78个 | 0 | 297ms | 2.3%  
广西 | 159个 | 2个 | 274ms | 2.7% | 宁夏 | 16个 | 0 | 302ms | 1.6%  
山东 | 254个 | 0 | 278ms | 9.3% | 四川 | 196个 | 0 | 303ms | 4.7%  
广东 | 334个 | 8个 | 278ms | 4.0% | 甘肃 | 94个 | 0 | 312ms | 2.7%  
江西 | 116个 | 0 | 281ms | 2.7% | 青海 | 16个 | 0 | 314ms | 2.1%  
辽宁 | 164个 | 0 | 282ms | 9.1% | 吉林 | 61个 | 0 | 330ms | 10.7%  
均值 | 3928个 | 42个 | 282ms | 5.4% | 新疆 | 90个 | 0 | 335ms | 4.7%  
重庆 | 22个 | 1个 | 283ms | 1.8% | 西藏 | 11个 | 0 | 387ms | 6.5%  
...
海外线路到Digital Ocean美国-纽约机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 6个 | 0 | 8ms | - | 香港 | 60个 | 0 | 187ms | 0  
意大利 | 3个 | 0 | 71ms | - | 日本 | 6个 | 0 | 197ms | 8.3%  
美国 | 45个 | 0 | 86ms | 0.1% | 新加坡 | 15个 | 0 | 217ms | 0  
德国 | 9个 | 0 | 97ms | 0 | 澳大利亚 | 6个 | 0 | 246ms | 0.3%  
俄罗斯 | 3个 | 0 | 116ms | - | 越南 | 6个 | 0 | 274ms | 0.6%  
台湾 | 6个 | 0 | 134ms | 0 | 赞比亚 | 5个 | 0 | 282ms | 1.0%  
荷兰 | 3个 | 0 | 166ms | 0 | 马来西亚 | 9个 | 0 | 304ms | 0  
韩国 | 36个 | 0 | 172ms | 0 | 菲律宾 | 5个 | 0 | 332ms | 17.3%  
均值 | 223个 | 0 | 180ms | 2.1% |  |  |  |  |   
