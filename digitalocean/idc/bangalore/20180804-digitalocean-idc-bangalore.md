...
大陆各省份到Digital Ocean印度-班加罗尔机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
浙江 | 226个 | 7个 | 296ms | 0.8% | 重庆 | 34个 | 0 | 351ms | 0.6%  
湖北 | 173个 | 0 | 313ms | 2.3% | 广西 | 220个 | 0 | 355ms | 2.2%  
广东 | 406个 | 0 | 321ms | 2.0% | 四川 | 273个 | 0 | 357ms | 2.1%  
上海 | 31个 | 4个 | 325ms | 1.0% | 黑龙江 | 144个 | 0 | 359ms | 2.7%  
江苏 | 335个 | 9个 | 330ms | 2.5% | 天津 | 20个 | 0 | 361ms | 16.1%  
北京 | 36个 | 0 | 338ms | 1.2% | 海南 | 32个 | 0 | 365ms | 4.3%  
湖南 | 237个 | 3个 | 339ms | 3.0% | 福建 | 160个 | 0 | 371ms | 3.3%  
辽宁 | 210个 | 3个 | 340ms | 2.1% | 山西 | 169个 | 0 | 376ms | 2.5%  
江西 | 127个 | 4个 | 341ms | 2.2% | 宁夏 | 32个 | 0 | 377ms | 0.4%  
陕西 | 138个 | 3个 | 346ms | 1.1% | 甘肃 | 104个 | 0 | 380ms | 0.9%  
河北 | 232个 | 0 | 347ms | 2.9% | 贵州 | 138个 | 4个 | 382ms | 1.9%  
山东 | 346个 | 0 | 349ms | 0.5% | 内蒙古 | 200个 | 0 | 383ms | 2.1%  
安徽 | 207个 | 0 | 349ms | 6.0% | 吉林 | 72个 | 0 | 414ms | 5.0%  
河南 | 323个 | 0 | 350ms | 3.5% | 新疆 | 123个 | 0 | 421ms | 2.0%  
云南 | 115个 | 0 | 350ms | 6.6% | 西藏 | 8个 | 0 | 434ms | 19.0%  
均值 | 4887个 | 37个 | 350ms | 2.6% | 青海 | 16个 | 0 | 444ms | 5.3%  
...
海外线路到Digital Ocean印度-班加罗尔机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
印度尼西亚 | 6个 | 0 | 70ms | 0 | 俄罗斯 | 3个 | 0 | 200ms | -  
新加坡 | 15个 | 0 | 87ms | 0 | 美国 | 48个 | 0 | 228ms | 8.5%  
菲律宾 | 3个 | 0 | 114ms | 0 | 台湾 | 3个 | 0 | 234ms | 0  
日本 | 6个 | 0 | 127ms | 2.7% | 加拿大 | 15个 | 0 | 240ms | 0  
巴西 | 3个 | 0 | 158ms | 0 | 英国 | 6个 | 0 | 253ms | 0.5%  
意大利 | 3个 | 0 | 159ms | - | 荷兰 | 3个 | 0 | 259ms | 0  
德国 | 9个 | 0 | 164ms | 0 | 韩国 | 21个 | 0 | 262ms | 0  
香港 | 66个 | 0 | 182ms | 0 | 澳大利亚 | 6个 | 0 | 290ms | 0  
马来西亚 | 12个 | 0 | 186ms | 6.3% | 南非 | 6个 | 0 | 321ms | 3.5%  
均值 | 234个 | 0 | 196ms | 1.3% |  |  |  |  |   
