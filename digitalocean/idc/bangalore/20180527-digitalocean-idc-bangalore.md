#  多地到Digital Ocean班加罗尔[Bangalore]机房的Ping测试（20180527） 
...
大陆各省份到Digital Ocean印度-班加罗尔机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
浙江 | 49个 | 0 | 281ms | 0.8% | 海南 | 14个 | 0 | 385ms | 3.7%  
北京 | 8个 | 1个 | 344ms | 3.3% | 广西 | 39个 | 0 | 386ms | 3.8%  
江苏 | 63个 | 1个 | 351ms | 3.9% | 黑龙江 | 38个 | 0 | 389ms | 1.9%  
辽宁 | 38个 | 0 | 352ms | 6.6% | 宁夏 | 12个 | 0 | 390ms | 2.2%  
天津 | 5个 | 0 | 362ms | 2.0% | 重庆 | 14个 | 0 | 390ms | 3.5%  
安徽 | 40个 | 1个 | 369ms | 5.6% | 湖南 | 44个 | 0 | 391ms | 7.4%  
湖北 | 44个 | 0 | 371ms | 5.2% | 内蒙古 | 33个 | 0 | 393ms | 0.8%  
广东 | 83个 | 1个 | 371ms | 3.6% | 山东 | 51个 | 1个 | 398ms | 2.4%  
上海 | 8个 | 0 | 372ms | 0.6% | 四川 | 48个 | 0 | 400ms | 2.5%  
江西 | 24个 | 0 | 378ms | 3.0% | 福建 | 34个 | 1个 | 400ms | 3.3%  
山西 | 38个 | 0 | 378ms | 3.0% | 云南 | 20个 | 0 | 400ms | 6.5%  
河南 | 57个 | 1个 | 379ms | 1.8% | 甘肃 | 22个 | 0 | 409ms | 2.7%  
均值 | 973个 | 10个 | 379ms | 3.5% | 贵州 | 27个 | 1个 | 412ms | 5.8%  
河北 | 36个 | 0 | 380ms | 3.0% | 新疆 | 28个 | 0 | 442ms | 5.0%  
陕西 | 34个 | 1个 | 382ms | 3.8% | 青海 | 3个 | 0 | 442ms | 2.7%  
吉林 | 19个 | 1个 | 382ms | 0.3% |  |  |  |  |   
...
海外线路到Digital Ocean印度-班加罗尔机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 6个 | 0 | 39ms | 0 | 英国 | 2个 | 0 | 174ms | 0  
印度尼西亚 | 1个 | 0 | 63ms | 0 | 均值 | 85个 | 0 | 175ms | 0.2%  
马来西亚 | 4个 | 0 | 93ms | 0 | 韩国 | 12个 | 0 | 176ms | 0  
越南 | 2个 | 0 | 106ms | 0 | 德国 | 3个 | 0 | 176ms | 0  
台湾 | 1个 | 0 | 111ms | - | 法国 | 1个 | 0 | 177ms | 0  
日本 | 1个 | 0 | 125ms | 0 | 俄罗斯 | 1个 | 0 | 242ms | 0  
香港 | 18个 | 0 | 139ms | 3.3% | 美国 | 21个 | 0 | 242ms | 0  
柬埔寨 | 1个 | 0 | 147ms | 0 | 加拿大 | 3个 | 0 | 246ms | 0  
菲律宾 | 1个 | 0 | 150ms | 0 | 澳大利亚 | 2个 | 0 | 306ms | 0.5%  
意大利 | 1个 | 0 | 155ms | - | 南非 | 2个 | 0 | 329ms | 0  
荷兰 | 1个 | 0 | 157ms | 0 | 巴西 | 1个 | 0 | 338ms | 0  
