...
大陆各省份到Digital Ocean印度-班加罗尔机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
浙江 | 36个 | 2个 | 271ms | 2.6% | 海南 | 10个 | 0 | 377ms | 3.2%  
天津 | 5个 | 0 | 337ms | 0.3% | 河北 | 30个 | 0 | 379ms | 6.1%  
江苏 | 49个 | 1个 | 340ms | 7.7% | 安徽 | 35个 | 0 | 380ms | 11.3%  
辽宁 | 35个 | 0 | 343ms | 4.8% | 云南 | 28个 | 0 | 382ms | 6.6%  
湖北 | 37个 | 0 | 346ms | 3.5% | 重庆 | 9个 | 0 | 383ms | 4.7%  
北京 | 4个 | 1个 | 348ms | 0.3% | 四川 | 44个 | 0 | 388ms | 3.0%  
广东 | 57个 | 0 | 351ms | 3.7% | 内蒙古 | 31个 | 0 | 393ms | 4.3%  
上海 | 6个 | 0 | 357ms | 3.0% | 青海 | 4个 | 0 | 394ms | 6.0%  
河南 | 52个 | 0 | 365ms | 6.0% | 甘肃 | 20个 | 0 | 398ms | 8.3%  
江西 | 23个 | 0 | 366ms | 9.4% | 黑龙江 | 31个 | 0 | 399ms | 7.5%  
湖南 | 42个 | 0 | 366ms | 5.0% | 宁夏 | 11个 | 0 | 400ms | 8.4%  
广西 | 35个 | 0 | 369ms | 6.4% | 福建 | 26个 | 0 | 401ms | 7.1%  
均值 | 831个 | 4个 | 369ms | 5.5% | 贵州 | 21个 | 0 | 401ms | 6.9%  
山西 | 32个 | 0 | 370ms | 3.8% | 吉林 | 15个 | 0 | 401ms | 2.3%  
陕西 | 29个 | 0 | 373ms | 4.6% | 新疆 | 27个 | 0 | 417ms | 4.9%  
山东 | 46个 | 0 | 374ms | 4.8% | 西藏 | 1个 | 0 | 455ms | 12.0%  
...
海外线路到Digital Ocean印度-班加罗尔机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 5个 | 0 | 44ms | 0 | 德国 | 1个 | 0 | 184ms | 0  
马来西亚 | 3个 | 0 | 52ms | 0 | 均值 | 75个 | 0 | 190ms | 1.5%  
日本 | 3个 | 0 | 125ms | 1.7% | 英国 | 3个 | 0 | 199ms | 0  
台湾 | 1个 | 0 | 128ms | - | 美国 | 16个 | 0 | 229ms | 0  
香港 | 20个 | 0 | 156ms | 0 | 越南 | 1个 | 0 | 242ms | 0  
荷兰 | 2个 | 0 | 157ms | 0 | 加拿大 | 3个 | 0 | 265ms | 0  
韩国 | 12个 | 0 | 163ms | 0.2% | 南非 | 1个 | 0 | 303ms | 0  
法国 | 2个 | 0 | 167ms | 0 | 柬埔寨 | 1个 | 0 | 452ms | 20.0%  
澳大利亚 | 1个 | 0 | 179ms | 0 |  |  |  |  |   
