...
大陆各省份到Digital Ocean印度-班加罗尔机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
浙江 | 50个 | 2个 | 294ms | 0.5% | 青海 | 4个 | 0 | 370ms | 0  
辽宁 | 32个 | 0 | 321ms | 5.4% | 内蒙古 | 29个 | 0 | 370ms | 1.8%  
山西 | 31个 | 0 | 326ms | 1.9% | 湖北 | 41个 | 3个 | 373ms | 4.4%  
江苏 | 55个 | 3个 | 327ms | 0.7% | 甘肃 | 19个 | 0 | 380ms | 0.6%  
河南 | 53个 | 0 | 335ms | 0.9% | 广东 | 74个 | 1个 | 381ms | 3.5%  
北京 | 7个 | 1个 | 338ms | 0 | 云南 | 24个 | 0 | 381ms | 6.8%  
天津 | 5个 | 0 | 341ms | 0 | 上海 | 8个 | 0 | 381ms | 0  
山东 | 48个 | 1个 | 345ms | 1.0% | 海南 | 11个 | 0 | 385ms | 0.7%  
江西 | 24个 | 0 | 351ms | 4.2% | 河北 | 28个 | 0 | 391ms | 3.1%  
陕西 | 30个 | 1个 | 354ms | 1.0% | 贵州 | 24个 | 1个 | 392ms | 3.3%  
安徽 | 39个 | 0 | 359ms | 1.2% | 吉林 | 13个 | 0 | 394ms | 1.3%  
黑龙江 | 36个 | 0 | 361ms | 0.7% | 福建 | 33个 | 2个 | 397ms | 1.2%  
西藏 | 1个 | 0 | 363ms | 0 | 新疆 | 26个 | 0 | 403ms | 2.1%  
均值 | 891个 | 17个 | 365ms | 2.5% | 重庆 | 14个 | 0 | 409ms | 1.3%  
宁夏 | 12个 | 0 | 367ms | 0.1% | 四川 | 45个 | 1个 | 417ms | 5.1%  
湖南 | 43个 | 0 | 368ms | 3.2% | 广西 | 32个 | 1个 | 432ms | 8.5%  
...
海外线路到Digital Ocean印度-班加罗尔机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 6个 | 0 | 39ms | 0 | 均值 | 81个 | 0 | 188ms | 0.4%  
马来西亚 | 3个 | 0 | 61ms | 0 | 法国 | 2个 | 0 | 205ms | 0  
菲律宾 | 1个 | 0 | 93ms | 0 | 英国 | 2个 | 0 | 213ms | 0  
台湾 | 1个 | 0 | 103ms | - | 美国 | 19个 | 0 | 236ms | 0.4%  
日本 | 2个 | 0 | 118ms | 0.5% | 澳大利亚 | 2个 | 0 | 256ms | 0  
香港 | 19个 | 0 | 123ms | 0 | 加拿大 | 3个 | 0 | 259ms | 1.0%  
韩国 | 13个 | 0 | 149ms | 0.3% | 南非 | 2个 | 0 | 336ms | 0  
荷兰 | 1个 | 0 | 149ms | 0 | 俄罗斯 | 1个 | 0 | 344ms | 0  
印度尼西亚 | 1个 | 0 | 167ms | 5.0% | 巴西 | 1个 | 0 | 352ms | 0  
德国 | 2个 | 0 | 181ms | 0 |  |  |  |  |   
