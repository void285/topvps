...
大陆各省份到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 16个 | 0 | 227ms | 0.1% | 河南 | 109个 | 2个 | 318ms | 1.8%  
天津 | 10个 | 0 | 266ms | 2.1% | 湖北 | 85个 | 0 | 320ms | 2.0%  
江西 | 49个 | 0 | 282ms | 1.3% | 海南 | 28个 | 0 | 321ms | 1.1%  
安徽 | 78个 | 0 | 282ms | 1.9% | 山东 | 103个 | 2个 | 322ms | 1.2%  
河北 | 67个 | 0 | 288ms | 12.9% | 湖南 | 90个 | 1个 | 323ms | 5.3%  
辽宁 | 76个 | 0 | 289ms | 15.7% | 宁夏 | 24个 | 0 | 324ms | 2.2%  
福建 | 72个 | 0 | 291ms | 1.9% | 陕西 | 68个 | 2个 | 326ms | 4.5%  
内蒙古 | 65个 | 0 | 292ms | 1.3% | 云南 | 44个 | 0 | 327ms | 0.4%  
江苏 | 122个 | 2个 | 293ms | 0.8% | 四川 | 96个 | 0 | 331ms | 1.1%  
浙江 | 100个 | 1个 | 295ms | 0.7% | 吉林 | 38个 | 1个 | 331ms | 1.9%  
广东 | 160个 | 4个 | 300ms | 1.4% | 重庆 | 26个 | 1个 | 333ms | 2.0%  
均值 | 1935个 | 18个 | 311ms | 3.0% | 青海 | 6个 | 0 | 334ms | 2.0%  
甘肃 | 45个 | 0 | 314ms | 2.1% | 黑龙江 | 78个 | 0 | 339ms | 1.5%  
山西 | 74个 | 0 | 314ms | 3.0% | 贵州 | 56个 | 0 | 340ms | 3.8%  
北京 | 16个 | 2个 | 316ms | 8.3% | 新疆 | 57个 | 0 | 356ms | 3.2%  
广西 | 77个 | 0 | 316ms | 3.0% |  |  |  |  |   
...
海外线路到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 2个 | 0 | 1ms | 0 | 南非 | 4个 | 0 | 190ms | 1.3%  
意大利 | 2个 | 0 | 7ms | - | 巴西 | 2个 | 0 | 207ms | 0  
法国 | 2个 | 0 | 11ms | 0 | 日本 | 2个 | 0 | 263ms | 0  
德国 | 6个 | 0 | 16ms | 0 | 香港 | 40个 | 0 | 273ms | 0  
英国 | 4个 | 0 | 31ms | 0 | 马来西亚 | 8个 | 0 | 279ms | 0  
加拿大 | 6个 | 0 | 98ms | 0 | 韩国 | 24个 | 0 | 283ms | 0  
俄罗斯 | 2个 | 0 | 103ms | 0 | 菲律宾 | 2个 | 0 | 286ms | 1.0%  
美国 | 42个 | 0 | 144ms | 2.6% | 台湾 | 2个 | 0 | 290ms | -  
新加坡 | 12个 | 0 | 173ms | 0 | 柬埔寨 | 2个 | 0 | 312ms | 0  
印度尼西亚 | 2个 | 0 | 181ms | 0.5% | 澳大利亚 | 4个 | 0 | 317ms | 0.3%  
均值 | 174个 | 0 | 181ms | 0.3% | 越南 | 4个 | 0 | 338ms | 0  
