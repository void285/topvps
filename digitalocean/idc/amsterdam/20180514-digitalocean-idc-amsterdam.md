...
大陆各省份到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 16个 | 0 | 248ms | 0.1% | 江苏 | 118个 | 2个 | 303ms | 8.6%  
天津 | 10个 | 0 | 259ms | 7.1% | 云南 | 48个 | 0 | 305ms | 1.7%  
安徽 | 79个 | 1个 | 260ms | 4.1% | 浙江 | 97个 | 8个 | 306ms | 7.8%  
重庆 | 32个 | 1个 | 278ms | 0.1% | 甘肃 | 43个 | 0 | 306ms | 1.2%  
河北 | 66个 | 0 | 281ms | 4.3% | 辽宁 | 77个 | 0 | 307ms | 4.5%  
广西 | 74个 | 2个 | 283ms | 1.4% | 宁夏 | 23个 | 0 | 309ms | 1.9%  
海南 | 21个 | 0 | 283ms | 3.2% | 河南 | 110个 | 1个 | 312ms | 3.6%  
青海 | 8个 | 0 | 285ms | 0.4% | 陕西 | 65个 | 0 | 316ms | 4.8%  
福建 | 69个 | 2个 | 287ms | 3.2% | 山西 | 73个 | 0 | 316ms | 4.2%  
湖北 | 83个 | 0 | 291ms | 3.7% | 北京 | 14个 | 2个 | 317ms | 6.5%  
江西 | 46个 | 0 | 291ms | 4.1% | 山东 | 102个 | 3个 | 320ms | 4.9%  
广东 | 159个 | 6个 | 291ms | 3.4% | 贵州 | 55个 | 0 | 320ms | 5.0%  
湖南 | 89个 | 0 | 291ms | 3.5% | 黑龙江 | 74个 | 0 | 338ms | 4.6%  
内蒙古 | 67个 | 0 | 293ms | 3.0% | 吉林 | 28个 | 0 | 340ms | 4.3%  
四川 | 98个 | 0 | 301ms | 2.5% | 新疆 | 54个 | 0 | 353ms | 2.2%  
均值 | 1900个 | 28个 | 302ms | 3.9% | 西藏 | 2个 | 0 | 378ms | 0  
...
海外线路到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 2个 | 0 | 1ms | 0 | 南非 | 4个 | 0 | 193ms | 0  
法国 | 4个 | 0 | 8ms | 0 | 巴西 | 1个 | 0 | 197ms | 0  
德国 | 4个 | 0 | 21ms | 0 | 马来西亚 | 6个 | 0 | 217ms | 0.2%  
英国 | 4个 | 0 | 24ms | 0 | 菲律宾 | 2个 | 0 | 237ms | 0.5%  
加拿大 | 6个 | 0 | 96ms | 0.5% | 日本 | 4个 | 0 | 265ms | 0.5%  
俄罗斯 | 2个 | 0 | 102ms | 0 | 香港 | 38个 | 0 | 274ms | 0  
美国 | 38个 | 1个 | 142ms | 0 | 韩国 | 26个 | 0 | 282ms | 0  
印度尼西亚 | 2个 | 0 | 187ms | 0.5% | 台湾 | 2个 | 0 | 298ms | -  
均值 | 163个 | 1个 | 187ms | 1.8% | 澳大利亚 | 4个 | 0 | 311ms | 0  
新加坡 | 12个 | 0 | 189ms | 0 | 柬埔寨 | 2个 | 0 | 514ms | 31.0%  
