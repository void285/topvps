...
大陆各省份到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 6个 | 0 | 240ms | 4.1% | 山西 | 66个 | 1个 | 303ms | 4.4%  
浙江 | 101个 | 4个 | 258ms | 1.7% | 湖北 | 68个 | 0 | 306ms | 1.8%  
上海 | 14个 | 2个 | 261ms | 1.3% | 陕西 | 54个 | 1个 | 306ms | 4.4%  
江苏 | 128个 | 4个 | 265ms | 0.8% | 宁夏 | 28个 | 0 | 310ms | 6.5%  
河北 | 57个 | 0 | 270ms | 2.3% | 海南 | 20个 | 0 | 310ms | 2.5%  
安徽 | 70个 | 2个 | 271ms | 1.9% | 青海 | 10个 | 0 | 312ms | 8.5%  
北京 | 19个 | 0 | 275ms | 2.0% | 湖南 | 70个 | 0 | 312ms | 3.1%  
广东 | 144个 | 2个 | 277ms | 1.2% | 甘肃 | 33个 | 0 | 313ms | 6.8%  
江西 | 44个 | 0 | 283ms | 1.8% | 山东 | 81个 | 0 | 317ms | 1.1%  
福建 | 59个 | 0 | 285ms | 1.7% | 黑龙江 | 49个 | 0 | 317ms | 5.3%  
重庆 | 24个 | 1个 | 288ms | 1.6% | 贵州 | 44个 | 2个 | 317ms | 5.6%  
内蒙古 | 65个 | 0 | 288ms | 4.7% | 云南 | 46个 | 17个 | 326ms | 1.1%  
辽宁 | 66个 | 2个 | 294ms | 5.5% | 吉林 | 27个 | 1个 | 327ms | 3.3%  
均值 | 1747个 | 49个 | 296ms | 3.1% | 四川 | 79个 | 0 | 340ms | 2.7%  
广西 | 87个 | 1个 | 298ms | 2.4% | 新疆 | 43个 | 1个 | 341ms | 6.3%  
河南 | 97个 | 3个 | 303ms | 5.5% | 香港 | 48个 | 5个 | - | -  
...
海外线路到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
德国 | 2个 | 0 | 6ms | - | 香港 | 48个 | 5个 | 214ms | 0  
意大利 | 2个 | 0 | 7ms | - | 菲律宾 | 4个 | 0 | 245ms | 0  
法国 | 2个 | 0 | 8ms | 0 | 韩国 | 28个 | 0 | 262ms | 0.3%  
巴西 | 2个 | 0 | 13ms | 0 | 台湾 | 4个 | 0 | 262ms | 0  
加拿大 | 4个 | 0 | 99ms | 0 | 马来西亚 | 7个 | 0 | 265ms | 0.1%  
英国 | 3个 | 0 | 130ms | 0 | 日本 | 4个 | 0 | 267ms | 3.5%  
美国 | 41个 | 0 | 131ms | 0 | 越南 | 4个 | 0 | 286ms | 0  
新加坡 | 10个 | 0 | 170ms | 0 | 澳大利亚 | 2个 | 0 | 296ms | 0  
均值 | 173个 | 5个 | 175ms | 0.3% | 柬埔寨 | 2个 | 0 | 312ms | 0  
南非 | 4个 | 0 | 178ms | 0.5% |  |  |  |  |   
