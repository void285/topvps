...
大陆各省份到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 10个 | 0 | 229ms | 0 | 广东 | 113个 | 2个 | 307ms | 1.0%  
上海 | 12个 | 0 | 239ms | 0.3% | 均值 | 1623个 | 14个 | 307ms | 2.2%  
北京 | 8个 | 1个 | 249ms | 1.4% | 山西 | 65个 | 0 | 313ms | 2.0%  
河北 | 57个 | 0 | 276ms | 1.6% | 广西 | 66个 | 0 | 318ms | 4.2%  
辽宁 | 70个 | 0 | 277ms | 2.5% | 湖北 | 73个 | 0 | 319ms | 2.9%  
江西 | 45个 | 0 | 284ms | 2.5% | 重庆 | 18个 | 0 | 319ms | 2.0%  
福建 | 48个 | 0 | 286ms | 1.5% | 山东 | 86个 | 0 | 320ms | 2.1%  
甘肃 | 38个 | 0 | 286ms | 0.5% | 海南 | 20个 | 0 | 321ms | 1.8%  
宁夏 | 22个 | 1个 | 288ms | 1.7% | 湖南 | 81个 | 1个 | 327ms | 3.3%  
安徽 | 78个 | 0 | 288ms | 5.6% | 新疆 | 53个 | 0 | 328ms | 0.8%  
浙江 | 76个 | 4个 | 295ms | 0.7% | 吉林 | 28个 | 0 | 332ms | 2.8%  
陕西 | 53个 | 1个 | 295ms | 0.7% | 四川 | 87个 | 0 | 333ms | 2.0%  
河南 | 102个 | 0 | 299ms | 0.7% | 黑龙江 | 59个 | 0 | 334ms | 5.8%  
内蒙古 | 61个 | 2个 | 300ms | 0.8% | 云南 | 37个 | 0 | 338ms | 2.3%  
青海 | 8个 | 0 | 302ms | 0.1% | 贵州 | 47个 | 0 | 347ms | 5.8%  
江苏 | 100个 | 2个 | 302ms | 0.8% | 西藏 | 2个 | 0 | 385ms | 0.5%  
...
海外线路到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 4个 | 0 | 1ms | 0 | 均值 | 154个 | 1个 | 185ms | 2.1%  
法国 | 4个 | 0 | 8ms | 0 | 新加坡 | 10个 | 0 | 193ms | 0  
德国 | 2个 | 0 | 12ms | 0 | 越南 | 2个 | 0 | 230ms | 0  
英国 | 6个 | 0 | 19ms | 0 | 日本 | 5个 | 0 | 260ms | 0.2%  
加拿大 | 7个 | 0 | 98ms | 0 | 香港 | 40个 | 0 | 271ms | 0  
俄罗斯 | 2个 | 0 | 102ms | 0 | 韩国 | 24个 | 0 | 290ms | 0.3%  
美国 | 32个 | 1个 | 140ms | 0 | 台湾 | 2个 | 0 | 305ms | -  
南非 | 2个 | 0 | 167ms | 0 | 澳大利亚 | 4个 | 0 | 317ms | 0  
马来西亚 | 6个 | 0 | 184ms | 0 | 柬埔寨 | 2个 | 0 | 554ms | 32.5%  
