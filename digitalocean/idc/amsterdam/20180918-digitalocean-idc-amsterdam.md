...
大陆各省份到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
浙江 | 126个 | 4个 | 258ms | 5.6% | 辽宁 | 112个 | 1个 | 295ms | 12.4%  
宁夏 | 13个 | 0 | 268ms | 1.5% | 北京 | 15个 | 0 | 296ms | 3.1%  
河北 | 112个 | 0 | 269ms | 10.1% | 云南 | 53个 | 0 | 297ms | 6.5%  
广西 | 107个 | 0 | 271ms | 8.0% | 陕西 | 85个 | 0 | 297ms | 8.1%  
安徽 | 140个 | 0 | 271ms | 6.4% | 四川 | 136个 | 0 | 298ms | 3.5%  
内蒙古 | 108个 | 0 | 275ms | 12.3% | 均值 | 2679个 | 29个 | 298ms | 8.9%  
上海 | 15个 | 0 | 277ms | 9.4% | 贵州 | 80个 | 1个 | 310ms | 8.1%  
甘肃 | 61个 | 0 | 278ms | 3.7% | 海南 | 26个 | 0 | 310ms | 8.8%  
湖北 | 99个 | 1个 | 279ms | 5.6% | 重庆 | 14个 | 0 | 313ms | 12.2%  
江苏 | 169个 | 9个 | 283ms | 5.6% | 山东 | 183个 | 0 | 320ms | 11.8%  
广东 | 229个 | 8个 | 283ms | 5.4% | 河南 | 162个 | 0 | 336ms | 14.2%  
江西 | 72个 | 0 | 289ms | 7.0% | 山西 | 94个 | 3个 | 340ms | 15.7%  
湖南 | 135个 | 0 | 289ms | 9.5% | 新疆 | 68个 | 0 | 342ms | 10.4%  
福建 | 89个 | 2个 | 291ms | 8.4% | 黑龙江 | 104个 | 0 | 350ms | 12.1%  
青海 | 10个 | 0 | 293ms | 13.5% | 西藏 | 8个 | 0 | 352ms | 16.3%  
天津 | 11个 | 0 | 295ms | 4.3% | 吉林 | 43个 | 0 | 402ms | 17.8%  
...
海外线路到Digital Ocean荷兰-阿姆斯特丹机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 2个 | 0 | 7ms | - | 台湾 | 4个 | 0 | 201ms | 0  
德国 | 6个 | 0 | 24ms | 0 | 印度尼西亚 | 2个 | 0 | 202ms | 0.5%  
俄罗斯 | 2个 | 0 | 42ms | - | 越南 | 4个 | 0 | 223ms | 0.5%  
加拿大 | 6个 | 0 | 84ms | 0 | 赞比亚 | 2个 | 0 | 223ms | 5.0%  
荷兰 | 2个 | 0 | 102ms | 0 | 马来西亚 | 12个 | 4个 | 233ms | 0  
美国 | 32个 | 0 | 146ms | 0.9% | 日本 | 6个 | 0 | 244ms | 0.3%  
新加坡 | 10个 | 1个 | 171ms | 0 | 韩国 | 24个 | 0 | 246ms | 0  
均值 | 164个 | 6个 | 183ms | 1.5% | 澳大利亚 | 4个 | 0 | 334ms | 0.3%  
香港 | 42个 | 1个 | 190ms | 0 | 菲律宾 | 4个 | 0 | 437ms | 14.7%  
