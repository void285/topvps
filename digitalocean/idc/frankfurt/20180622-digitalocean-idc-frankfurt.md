...
大陆各省份到Digital Ocean德国-法兰克福机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 3个 | 0 | 210ms | 0 | 湖北 | 34个 | 0 | 279ms | 1.9%  
北京 | 10个 | 0 | 245ms | 1.2% | 均值 | 895个 | 21个 | 279ms | 1.9%  
安徽 | 37个 | 1个 | 257ms | 0.4% | 陕西 | 29个 | 0 | 282ms | 1.1%  
青海 | 5个 | 0 | 259ms | 1.8% | 辽宁 | 35个 | 1个 | 283ms | 0.4%  
上海 | 8个 | 1个 | 259ms | 1.6% | 云南 | 23个 | 9个 | 284ms | 1.1%  
江西 | 23个 | 0 | 260ms | 0.8% | 福建 | 31个 | 0 | 285ms | 0.9%  
河北 | 34个 | 0 | 261ms | 1.0% | 河南 | 50个 | 1个 | 288ms | 4.4%  
广东 | 73个 | 1个 | 262ms | 1.5% | 黑龙江 | 31个 | 1个 | 289ms | 1.9%  
浙江 | 50个 | 1个 | 263ms | 3.8% | 湖南 | 37个 | 0 | 291ms | 1.7%  
内蒙古 | 34个 | 0 | 263ms | 1.4% | 山西 | 35个 | 0 | 296ms | 2.2%  
江苏 | 63个 | 2个 | 267ms | 0.7% | 吉林 | 17个 | 0 | 301ms | 3.3%  
宁夏 | 14个 | 0 | 271ms | 1.4% | 山东 | 37个 | 0 | 303ms | 1.4%  
重庆 | 12个 | 0 | 272ms | 1.5% | 四川 | 42个 | 0 | 306ms | 4.5%  
广西 | 44个 | 0 | 274ms | 1.7% | 贵州 | 24个 | 1个 | 306ms | 3.7%  
甘肃 | 17个 | 1个 | 276ms | 2.4% | 新疆 | 20个 | 1个 | 319ms | 1.2%  
海南 | 11个 | 0 | 278ms | 1.8% | 香港 | 12个 | 0 | - | -  
...
海外线路到Digital Ocean德国-法兰克福机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 1个 | 0 | 0 | 0 | 均值 | 50个 | 0 | 199ms | 0.4%  
巴西 | 1个 | 0 | 10ms | 0 | 菲律宾 | 2个 | 0 | 234ms | 0  
英国 | 1个 | 0 | 57ms | 0 | 韩国 | 7个 | 0 | 242ms | 0.1%  
加拿大 | 1个 | 0 | 129ms | 0 | 马来西亚 | 4个 | 0 | 264ms | 4.5%  
美国 | 10个 | 0 | 141ms | 0 | 日本 | 1个 | 0 | 280ms | 2.0%  
新加坡 | 2个 | 0 | 160ms | 0 | 越南 | 2个 | 0 | 283ms | 0  
印度尼西亚 | 1个 | 0 | 189ms | 0 | 台湾 | 1个 | 0 | 284ms | 0  
香港 | 12个 | 0 | 192ms | 0 | 澳大利亚 | 1个 | 0 | 333ms | 0  
南非 | 2个 | 0 | 195ms | 0 | 柬埔寨 | 1个 | 0 | 388ms | 0  
