...
大陆各省份到Digital Ocean德国-法兰克福机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 215ms | 0 | 江西 | 25个 | 0 | 274ms | 1.2%  
上海 | 8个 | 0 | 243ms | 3.0% | 均值 | 983个 | 8个 | 277ms | 2.4%  
北京 | 8个 | 1个 | 248ms | 1.4% | 湖南 | 44个 | 0 | 278ms | 4.6%  
内蒙古 | 34个 | 0 | 256ms | 0.1% | 河南 | 56个 | 1个 | 279ms | 0.1%  
青海 | 3个 | 0 | 258ms | 0.3% | 云南 | 22个 | 0 | 280ms | 0.8%  
河北 | 36个 | 0 | 260ms | 13.5% | 四川 | 49个 | 0 | 281ms | 0.6%  
广东 | 83个 | 1个 | 262ms | 0.6% | 山西 | 38个 | 0 | 281ms | 0.6%  
宁夏 | 12个 | 0 | 262ms | 0.2% | 江苏 | 64个 | 1个 | 284ms | 0.4%  
海南 | 14个 | 0 | 265ms | 0.6% | 福建 | 36个 | 0 | 287ms | 2.2%  
湖北 | 44个 | 0 | 267ms | 0.1% | 贵州 | 27个 | 1个 | 290ms | 3.2%  
甘肃 | 23个 | 0 | 268ms | 0.2% | 吉林 | 18个 | 0 | 295ms | 0.3%  
安徽 | 39个 | 1个 | 268ms | 2.4% | 陕西 | 33个 | 0 | 298ms | 1.9%  
广西 | 39个 | 0 | 269ms | 3.6% | 黑龙江 | 39个 | 0 | 301ms | 0.1%  
辽宁 | 39个 | 0 | 269ms | 15.7% | 新疆 | 28个 | 0 | 303ms | 2.9%  
重庆 | 14个 | 0 | 270ms | 0 | 山东 | 52个 | 1个 | 314ms | 1.4%  
浙江 | 51个 | 1个 | 273ms | 2.4% |  |  |  |  |   
...
海外线路到Digital Ocean德国-法兰克福机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 1个 | 0 | 10ms | 0 | 马来西亚 | 4个 | 0 | 216ms | 0  
荷兰 | 1个 | 0 | 11ms | 0 | 香港 | 19个 | 0 | 216ms | 0  
意大利 | 1个 | 0 | 11ms | - | 巴西 | 1个 | 0 | 217ms | 0  
德国 | 3个 | 0 | 13ms | 0 | 南非 | 2个 | 0 | 218ms | 1.0%  
英国 | 2个 | 0 | 48ms | 0 | 日本 | 1个 | 0 | 246ms | 0  
俄罗斯 | 1个 | 0 | 94ms | 0 | 越南 | 2个 | 0 | 271ms | 1.0%  
加拿大 | 4个 | 0 | 103ms | 0 | 柬埔寨 | 1个 | 0 | 272ms | 0  
美国 | 21个 | 0 | 157ms | 2.5% | 台湾 | 1个 | 0 | 274ms | -  
新加坡 | 5个 | 0 | 172ms | 0 | 菲律宾 | 1个 | 0 | 279ms | 0  
均值 | 85个 | 0 | 172ms | 0.4% | 韩国 | 12个 | 0 | 287ms | 0  
印度尼西亚 | 1个 | 0 | 185ms | 2.0% | 澳大利亚 | 1个 | 0 | 321ms | 1.0%  
