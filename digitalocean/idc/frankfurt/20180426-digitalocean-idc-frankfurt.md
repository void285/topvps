...
大陆各省份到Digital Ocean德国-法兰克福机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 239ms | 6.8% | 内蒙古 | 29个 | 0 | 304ms | 4.9%  
北京 | 4个 | 1个 | 255ms | 8.3% | 湖南 | 41个 | 0 | 305ms | 6.7%  
上海 | 6个 | 0 | 257ms | 9.7% | 均值 | 820个 | 6个 | 305ms | 9.3%  
河北 | 28个 | 1个 | 268ms | 11.4% | 福建 | 27个 | 0 | 306ms | 11.3%  
广东 | 54个 | 0 | 279ms | 8.2% | 浙江 | 37个 | 2个 | 310ms | 8.9%  
重庆 | 9个 | 0 | 292ms | 9.3% | 安徽 | 37个 | 0 | 310ms | 13.3%  
辽宁 | 34个 | 0 | 292ms | 10.9% | 海南 | 10个 | 0 | 316ms | 10.5%  
广西 | 34个 | 0 | 293ms | 11.8% | 江苏 | 50个 | 1个 | 317ms | 8.8%  
河南 | 51个 | 0 | 297ms | 6.0% | 山东 | 44个 | 0 | 318ms | 7.1%  
山西 | 32个 | 0 | 299ms | 5.9% | 黑龙江 | 29个 | 0 | 322ms | 11.1%  
陕西 | 29个 | 0 | 300ms | 8.8% | 四川 | 44个 | 0 | 323ms | 10.0%  
甘肃 | 19个 | 0 | 300ms | 14.1% | 贵州 | 23个 | 0 | 328ms | 9.4%  
湖北 | 38个 | 0 | 301ms | 10.5% | 青海 | 4个 | 0 | 334ms | 10.5%  
宁夏 | 11个 | 0 | 301ms | 13.3% | 吉林 | 16个 | 0 | 337ms | 11.3%  
云南 | 25个 | 0 | 302ms | 7.4% | 新疆 | 26个 | 1个 | 345ms | 8.6%  
江西 | 23个 | 0 | 304ms | 12.3% | 西藏 | 1个 | 0 | 361ms | 5.0%  
...
海外线路到Digital Ocean德国-法兰克福机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
德国 | 1个 | 0 | 1ms | 0 | 印度尼西亚 | 1个 | 0 | 198ms | 25.0%  
法国 | 2个 | 0 | 9ms | 0 | 香港 | 20个 | 1个 | 225ms | 0  
荷兰 | 2个 | 0 | 11ms | 0 | 越南 | 1个 | 0 | 228ms | 1.0%  
英国 | 3个 | 0 | 41ms | 0 | 马来西亚 | 4个 | 0 | 228ms | 0  
俄罗斯 | 1个 | 0 | 94ms | 0 | 台湾 | 1个 | 0 | 281ms | -  
加拿大 | 4个 | 0 | 104ms | 0 | 日本 | 3个 | 0 | 289ms | 7.3%  
美国 | 16个 | 0 | 156ms | 0 | 韩国 | 12个 | 0 | 289ms | 0  
南非 | 1个 | 0 | 175ms | 0 | 澳大利亚 | 2个 | 0 | 365ms | 5.0%  
新加坡 | 5个 | 0 | 180ms | 0 | 柬埔寨 | 1个 | 0 | 472ms | 2.0%  
均值 | 80个 | 1个 | 186ms | 2.4% |  |  |  |  |   
