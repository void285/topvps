...
大陆各省份到Digital Ocean德国-法兰克福机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
宁夏 | 7个 | 0 | 226ms | 0.5% | 广东 | 123个 | 1个 | 275ms | 6.3%  
青海 | 5个 | 0 | 233ms | 0 | 安徽 | 71个 | 0 | 275ms | 2.8%  
天津 | 6个 | 0 | 244ms | 3.0% | 湖南 | 68个 | 0 | 276ms | 10.2%  
浙江 | 67个 | 2个 | 250ms | 3.7% | 四川 | 73个 | 1个 | 286ms | 5.6%  
河北 | 59个 | 0 | 254ms | 8.3% | 均值 | 1447个 | 11个 | 286ms | 8.5%  
内蒙古 | 60个 | 0 | 258ms | 11.8% | 福建 | 45个 | 0 | 287ms | 6.2%  
甘肃 | 36个 | 0 | 261ms | 2.3% | 海南 | 14个 | 0 | 300ms | 4.2%  
上海 | 8个 | 0 | 263ms | 9.4% | 贵州 | 44个 | 0 | 301ms | 7.7%  
江苏 | 93个 | 4个 | 266ms | 5.6% | 山西 | 56个 | 2个 | 301ms | 15.6%  
广西 | 62个 | 0 | 266ms | 8.3% | 重庆 | 8个 | 0 | 307ms | 13.1%  
陕西 | 44个 | 0 | 267ms | 7.2% | 山东 | 94个 | 0 | 314ms | 13.2%  
辽宁 | 60个 | 1个 | 268ms | 12.7% | 新疆 | 36个 | 0 | 324ms | 9.0%  
湖北 | 54个 | 0 | 270ms | 4.9% | 河南 | 92个 | 0 | 333ms | 14.0%  
云南 | 28个 | 0 | 270ms | 6.5% | 黑龙江 | 60个 | 0 | 347ms | 13.1%  
江西 | 40个 | 0 | 272ms | 3.6% | 西藏 | 4个 | 0 | 383ms | 14.3%  
北京 | 8个 | 0 | 273ms | 1.4% | 吉林 | 22个 | 0 | 392ms | 16.6%  
...
海外线路到Digital Ocean德国-法兰克福机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 1个 | 0 | 11ms | - | 越南 | 2个 | 0 | 212ms | 0  
德国 | 3个 | 0 | 24ms | 0 | 马来西亚 | 3个 | 0 | 224ms | 0  
荷兰 | 1个 | 0 | 86ms | 0 | 赞比亚 | 2个 | 0 | 225ms | 7.7%  
加拿大 | 2个 | 0 | 87ms | - | 韩国 | 8个 | 0 | 240ms | 0  
新加坡 | 4个 | 0 | 161ms | 0 | 日本 | 2个 | 0 | 250ms | 1.7%  
美国 | 9个 | 0 | 161ms | 0 | 印度尼西亚 | 1个 | 0 | 280ms | 3.3%  
香港 | 15个 | 0 | 163ms | 1.3% | 菲律宾 | 2个 | 0 | 331ms | 31.7%  
均值 | 59个 | 0 | 188ms | 3.3% | 澳大利亚 | 2个 | 0 | 339ms | 0.5%  
台湾 | 2个 | 0 | 211ms | 0 |  |  |  |  |   
