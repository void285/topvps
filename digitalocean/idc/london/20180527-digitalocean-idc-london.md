...
大陆各省份到Digital Ocean英国-伦敦机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 8个 | 0 | 231ms | 0 | 甘肃 | 23个 | 0 | 274ms | 0.3%  
北京 | 8个 | 1个 | 243ms | 0 | 湖南 | 45个 | 0 | 275ms | 6.7%  
天津 | 5个 | 0 | 247ms | 0 | 均值 | 974个 | 8个 | 276ms | 2.1%  
广东 | 84个 | 1个 | 260ms | 0.5% | 四川 | 47个 | 1个 | 278ms | 0.8%  
海南 | 14个 | 0 | 261ms | 2.4% | 浙江 | 52个 | 0 | 279ms | 0.7%  
湖北 | 43个 | 0 | 262ms | 2.4% | 江苏 | 62个 | 1个 | 281ms | 0.3%  
宁夏 | 12个 | 0 | 263ms | 0.3% | 福建 | 35个 | 0 | 283ms | 1.8%  
安徽 | 40个 | 0 | 263ms | 1.8% | 山西 | 37个 | 0 | 283ms | 0.7%  
辽宁 | 41个 | 1个 | 263ms | 13.5% | 陕西 | 33个 | 0 | 284ms | 1.9%  
广西 | 37个 | 0 | 264ms | 2.2% | 青海 | 3个 | 0 | 291ms | 0  
内蒙古 | 31个 | 0 | 264ms | 0 | 贵州 | 28个 | 0 | 292ms | 3.7%  
江西 | 24个 | 0 | 266ms | 0.8% | 吉林 | 19个 | 0 | 298ms | 2.1%  
重庆 | 14个 | 0 | 266ms | 2.6% | 山东 | 53个 | 1个 | 306ms | 1.4%  
河北 | 33个 | 0 | 269ms | 2.2% | 黑龙江 | 39个 | 1个 | 308ms | 1.1%  
云南 | 22个 | 0 | 270ms | 4.4% | 新疆 | 28个 | 0 | 314ms | 1.8%  
河南 | 54个 | 1个 | 273ms | 0.5% |  |  |  |  |   
...
海外线路到Digital Ocean英国-伦敦机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 1个 | 0 | 8ms | 0 | 巴西 | 1个 | 0 | 197ms | 0  
法国 | 1个 | 0 | 9ms | 0 | 马来西亚 | 4个 | 0 | 213ms | 0  
意大利 | 1个 | 0 | 11ms | - | 香港 | 19个 | 0 | 215ms | 1.7%  
德国 | 3个 | 0 | 20ms | 0 | 印度尼西亚 | 1个 | 0 | 219ms | 2.0%  
英国 | 2个 | 0 | 27ms | 0 | 日本 | 1个 | 0 | 233ms | 0  
加拿大 | 3个 | 0 | 88ms | 0 | 柬埔寨 | 1个 | 0 | 254ms | 0  
俄罗斯 | 1个 | 0 | 109ms | 0 | 越南 | 2个 | 0 | 259ms | 0  
美国 | 21个 | 0 | 137ms | 0 | 台湾 | 1个 | 0 | 270ms | -  
均值 | 86个 | 0 | 165ms | 0.2% | 菲律宾 | 1个 | 0 | 270ms | 0  
新加坡 | 6个 | 0 | 166ms | 0 | 韩国 | 12个 | 0 | 282ms | 0  
南非 | 2个 | 0 | 183ms | 1.0% | 澳大利亚 | 2个 | 0 | 300ms | 0  
