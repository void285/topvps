...
大陆各省份到Digital Ocean英国-伦敦机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广西 | 216个 | 0 | 261ms | 1.6% | 均值 | 4802个 | 24个 | 291ms | 2.4%  
河北 | 220个 | 0 | 261ms | 3.0% | 浙江 | 218个 | 7个 | 292ms | 0.8%  
重庆 | 37个 | 0 | 264ms | 2.8% | 陕西 | 138个 | 0 | 292ms | 1.0%  
天津 | 16个 | 0 | 265ms | 2.0% | 广东 | 407个 | 0 | 292ms | 3.1%  
海南 | 32个 | 0 | 269ms | 3.6% | 山西 | 165个 | 0 | 295ms | 1.4%  
湖北 | 177个 | 0 | 277ms | 2.7% | 江苏 | 339个 | 9个 | 298ms | 0.8%  
江西 | 127个 | 4个 | 278ms | 1.4% | 北京 | 36个 | 0 | 300ms | 0.6%  
辽宁 | 210个 | 0 | 278ms | 1.6% | 宁夏 | 32个 | 0 | 300ms | 6.0%  
内蒙古 | 200个 | 0 | 280ms | 1.9% | 河南 | 319个 | 0 | 306ms | 3.6%  
福建 | 157个 | 0 | 281ms | 2.1% | 黑龙江 | 152个 | 0 | 308ms | 2.8%  
湖南 | 233个 | 0 | 281ms | 3.0% | 吉林 | 68个 | 0 | 309ms | 0  
上海 | 24个 | 4个 | 281ms | 0.2% | 山东 | 326个 | 0 | 315ms | 2.8%  
安徽 | 195个 | 0 | 283ms | 5.3% | 贵州 | 130个 | 0 | 323ms | 2.9%  
四川 | 262个 | 0 | 284ms | 1.1% | 新疆 | 123个 | 0 | 323ms | 1.2%  
云南 | 115个 | 0 | 286ms | 6.1% | 青海 | 16个 | 0 | 343ms | 0  
甘肃 | 104个 | 0 | 289ms | 1.1% | 西藏 | 8个 | 0 | 464ms | 34.2%  
...
海外线路到Digital Ocean英国-伦敦机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
巴西 | 3个 | 0 | 1ms | 0 | 南非 | 6个 | 0 | 189ms | 0.5%  
意大利 | 3个 | 0 | 10ms | - | 香港 | 66个 | 3个 | 191ms | 0  
德国 | 9个 | 0 | 27ms | 0 | 印度尼西亚 | 6个 | 0 | 209ms | 0  
俄罗斯 | 3个 | 0 | 49ms | - | 马来西亚 | 12个 | 0 | 210ms | 2.0%  
英国 | 6个 | 0 | 52ms | 0 | 台湾 | 3个 | 0 | 242ms | 0  
加拿大 | 15个 | 0 | 85ms | 0 | 韩国 | 21个 | 0 | 266ms | 0  
荷兰 | 3个 | 0 | 128ms | 0 | 日本 | 3个 | 0 | 282ms | 1.0%  
美国 | 48个 | 0 | 154ms | 3.8% | 澳大利亚 | 6个 | 0 | 291ms | 1.7%  
均值 | 237个 | 3个 | 170ms | 1.3% | 法国 | 3个 | 0 | 306ms | 0  
新加坡 | 15个 | 0 | 174ms | 0 | 菲律宾 | 6个 | 0 | 368ms | 13.5%  
