...
大陆各省份到Digital Ocean英国-伦敦机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
宁夏 | 6个 | 0 | 237ms | 0 | 北京 | 7个 | 0 | 283ms | 0.1%  
浙江 | 60个 | 2个 | 249ms | 3.8% | 四川 | 62个 | 0 | 285ms | 3.2%  
河北 | 51个 | 0 | 250ms | 7.0% | 上海 | 7个 | 0 | 286ms | 8.2%  
广西 | 48个 | 0 | 255ms | 6.1% | 均值 | 1238个 | 10个 | 286ms | 7.7%  
内蒙古 | 49个 | 0 | 259ms | 7.9% | 福建 | 39个 | 1个 | 291ms | 7.5%  
安徽 | 68个 | 0 | 261ms | 5.3% | 青海 | 4个 | 0 | 294ms | 10.8%  
天津 | 6个 | 0 | 262ms | 5.1% | 贵州 | 35个 | 0 | 299ms | 6.3%  
湖北 | 46个 | 0 | 270ms | 6.1% | 海南 | 13个 | 0 | 305ms | 4.2%  
辽宁 | 46个 | 0 | 270ms | 8.4% | 山东 | 91个 | 0 | 310ms | 11.5%  
甘肃 | 30个 | 0 | 273ms | 1.8% | 重庆 | 7个 | 0 | 314ms | 9.4%  
江西 | 36个 | 0 | 275ms | 6.7% | 河南 | 78个 | 0 | 318ms | 11.9%  
湖南 | 63个 | 0 | 276ms | 8.5% | 山西 | 44个 | 1个 | 329ms | 13.6%  
广东 | 104个 | 2个 | 278ms | 7.6% | 新疆 | 30个 | 0 | 330ms | 7.0%  
陕西 | 40个 | 0 | 280ms | 7.7% | 黑龙江 | 42个 | 0 | 335ms | 12.2%  
江苏 | 79个 | 4个 | 281ms | 5.9% | 西藏 | 4个 | 0 | 352ms | 18.0%  
云南 | 23个 | 0 | 282ms | 7.7% | 吉林 | 20个 | 0 | 377ms | 13.2%  
...
海外线路到Digital Ocean英国-伦敦机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 1个 | 0 | 11ms | - | 印度尼西亚 | 1个 | 0 | 201ms | 0  
德国 | 3个 | 0 | 29ms | 0 | 马来西亚 | 6个 | 0 | 208ms | 0  
加拿大 | 2个 | 0 | 75ms | 0 | 赞比亚 | 1个 | 0 | 209ms | 0  
荷兰 | 1个 | 0 | 111ms | 0 | 越南 | 2个 | 0 | 225ms | 1.0%  
美国 | 8个 | 0 | 150ms | 0 | 韩国 | 8个 | 0 | 226ms | 0  
新加坡 | 4个 | 0 | 162ms | 0 | 日本 | 3个 | 0 | 251ms | 4.0%  
香港 | 14个 | 0 | 167ms | 0 | 澳大利亚 | 2个 | 0 | 293ms | 1.7%  
均值 | 60个 | 0 | 180ms | 1.0% | 菲律宾 | 2个 | 0 | 366ms | 8.3%  
台湾 | 2个 | 0 | 192ms | 0 |  |  |  |  |   
