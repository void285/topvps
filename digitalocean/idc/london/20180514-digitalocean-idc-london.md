...
大陆各省份到Digital Ocean英国-伦敦机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 7个 | 1个 | 222ms | 0 | 均值 | 903个 | 10个 | 283ms | 4.1%  
天津 | 4个 | 0 | 226ms | 4.8% | 海南 | 10个 | 0 | 284ms | 2.8%  
上海 | 6个 | 0 | 245ms | 0.2% | 河南 | 49个 | 0 | 285ms | 4.1%  
宁夏 | 11个 | 0 | 246ms | 2.5% | 江苏 | 62个 | 1个 | 286ms | 8.0%  
重庆 | 17个 | 0 | 256ms | 0.5% | 江西 | 21个 | 0 | 287ms | 3.5%  
青海 | 4个 | 0 | 257ms | 0 | 湖南 | 40个 | 0 | 287ms | 3.9%  
甘肃 | 16个 | 0 | 257ms | 0.2% | 陕西 | 27个 | 0 | 290ms | 3.3%  
河北 | 31个 | 0 | 257ms | 4.5% | 云南 | 23个 | 0 | 292ms | 1.8%  
安徽 | 34个 | 0 | 265ms | 1.0% | 福建 | 33个 | 0 | 297ms | 3.8%  
广西 | 34个 | 1个 | 268ms | 1.2% | 山西 | 35个 | 0 | 297ms | 5.2%  
内蒙古 | 32个 | 0 | 271ms | 3.2% | 贵州 | 26个 | 1个 | 304ms | 6.4%  
辽宁 | 37个 | 0 | 274ms | 7.3% | 西藏 | 1个 | 0 | 306ms | 0  
广东 | 74个 | 2个 | 275ms | 2.4% | 黑龙江 | 34个 | 0 | 308ms | 3.6%  
浙江 | 53个 | 3个 | 280ms | 10.9% | 山东 | 49个 | 1个 | 309ms | 4.1%  
四川 | 49个 | 0 | 283ms | 3.2% | 新疆 | 27个 | 0 | 311ms | 2.0%  
湖北 | 43个 | 0 | 283ms | 4.5% | 吉林 | 14个 | 0 | 316ms | 7.6%  
...
海外线路到Digital Ocean英国-伦敦机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 1个 | 0 | 6ms | 0 | 巴西 | 1个 | 0 | 197ms | 0  
法国 | 2个 | 0 | 8ms | 0 | 印度尼西亚 | 1个 | 0 | 208ms | 3.0%  
英国 | 2个 | 0 | 18ms | 0 | 马来西亚 | 3个 | 0 | 215ms | 0.3%  
德国 | 2个 | 0 | 26ms | 0 | 香港 | 19个 | 0 | 219ms | 0  
加拿大 | 3个 | 0 | 86ms | 0.5% | 菲律宾 | 1个 | 0 | 238ms | 0  
俄罗斯 | 1个 | 0 | 109ms | 0 | 韩国 | 13个 | 0 | 274ms | 0  
美国 | 19个 | 0 | 133ms | 2.6% | 日本 | 1个 | 0 | 277ms | 1.0%  
新加坡 | 6个 | 0 | 174ms | 0 | 台湾 | 1个 | 0 | 285ms | -  
均值 | 81个 | 0 | 178ms | 2.0% | 澳大利亚 | 2个 | 0 | 294ms | 0  
南非 | 2个 | 0 | 186ms | 0 | 柬埔寨 | 1个 | 0 | 437ms | 29.0%  
