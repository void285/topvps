...
大陆各省份到Digital Ocean英国-伦敦机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
河北 | 30个 | 0 | 248ms | 2.5% | 四川 | 44个 | 0 | 278ms | 0.8%  
重庆 | 10个 | 0 | 252ms | 0 | 陕西 | 29个 | 0 | 282ms | 0.7%  
北京 | 4个 | 2个 | 256ms | 0 | 均值 | 837个 | 10个 | 282ms | 3.9%  
上海 | 6个 | 0 | 257ms | 7.0% | 宁夏 | 11个 | 0 | 284ms | 2.8%  
青海 | 4个 | 0 | 260ms | 0 | 江苏 | 50个 | 1个 | 285ms | 12.5%  
湖北 | 38个 | 0 | 260ms | 12.3% | 海南 | 10个 | 0 | 285ms | 0.4%  
天津 | 5个 | 1个 | 262ms | 6.7% | 云南 | 27个 | 0 | 288ms | 2.5%  
辽宁 | 35个 | 1个 | 264ms | 2.7% | 山东 | 47个 | 0 | 297ms | 0.3%  
广西 | 35个 | 0 | 265ms | 2.5% | 山西 | 32个 | 0 | 297ms | 2.8%  
安徽 | 36个 | 0 | 266ms | 6.7% | 福建 | 26个 | 0 | 299ms | 3.3%  
甘肃 | 20个 | 1个 | 270ms | 0.4% | 湖南 | 41个 | 2个 | 302ms | 4.6%  
江西 | 22个 | 0 | 271ms | 12.2% | 贵州 | 22个 | 0 | 311ms | 5.1%  
河南 | 53个 | 0 | 276ms | 0.7% | 吉林 | 15个 | 0 | 315ms | 1.7%  
浙江 | 36个 | 2个 | 276ms | 9.2% | 新疆 | 27个 | 0 | 316ms | 0.8%  
广东 | 59个 | 0 | 276ms | 0.4% | 黑龙江 | 31个 | 0 | 326ms | 6.8%  
内蒙古 | 31个 | 0 | 276ms | 1.3% | 西藏 | 1个 | 0 | 333ms | 3.0%  
...
海外线路到Digital Ocean英国-伦敦机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 2个 | 0 | 6ms | 0 | 马来西亚 | 3个 | 0 | 180ms | 0  
荷兰 | 2个 | 0 | 10ms | 0 | 新加坡 | 5个 | 0 | 189ms | 0  
英国 | 3个 | 0 | 14ms | 0 | 香港 | 20个 | 0 | 212ms | 0  
德国 | 1个 | 0 | 17ms | 0 | 越南 | 1个 | 0 | 229ms | 0  
加拿大 | 4个 | 0 | 86ms | 0 | 日本 | 3个 | 0 | 250ms | 0.7%  
俄罗斯 | 1个 | 0 | 111ms | 0 | 台湾 | 1个 | 0 | 262ms | -  
美国 | 16个 | 0 | 132ms | 0 | 韩国 | 12个 | 0 | 280ms | 0  
南非 | 1个 | 0 | 162ms | 0 | 澳大利亚 | 1个 | 0 | 314ms | 0  
均值 | 77个 | 0 | 175ms | 1.7% | 柬埔寨 | 1个 | 0 | 522ms | 27.0%  
