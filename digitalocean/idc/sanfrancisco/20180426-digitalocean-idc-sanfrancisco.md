...
大陆各省份到Digital Ocean美国-旧金山机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 7个 | 1个 | 213ms | 12.8% | 均值 | 1622个 | 14个 | 245ms | 4.0%  
河南 | 104个 | 2个 | 216ms | 3.6% | 江西 | 46个 | 1个 | 246ms | 2.4%  
山西 | 62个 | 0 | 222ms | 3.3% | 浙江 | 73个 | 3个 | 248ms | 5.2%  
山东 | 86个 | 0 | 225ms | 2.8% | 陕西 | 56个 | 0 | 248ms | 3.4%  
上海 | 12个 | 0 | 229ms | 8.9% | 安徽 | 71个 | 0 | 248ms | 3.7%  
湖北 | 75个 | 0 | 233ms | 2.3% | 海南 | 20个 | 0 | 254ms | 6.8%  
重庆 | 17个 | 1个 | 233ms | 1.2% | 云南 | 50个 | 2个 | 255ms | 5.0%  
天津 | 10个 | 1个 | 235ms | 6.4% | 吉林 | 32个 | 0 | 256ms | 3.2%  
湖南 | 80个 | 0 | 235ms | 4.7% | 贵州 | 47个 | 0 | 262ms | 4.7%  
河北 | 56个 | 1个 | 238ms | 3.5% | 内蒙古 | 60个 | 0 | 262ms | 4.5%  
黑龙江 | 59个 | 0 | 239ms | 5.4% | 宁夏 | 21个 | 0 | 265ms | 5.0%  
江苏 | 99个 | 2个 | 242ms | 3.1% | 西藏 | 2个 | 0 | 267ms | 0.5%  
广东 | 108个 | 0 | 243ms | 2.6% | 四川 | 85个 | 0 | 268ms | 3.8%  
福建 | 46个 | 0 | 245ms | 3.3% | 青海 | 8个 | 0 | 282ms | 5.8%  
广西 | 68个 | 0 | 245ms | 5.7% | 甘肃 | 38个 | 0 | 285ms | 4.7%  
辽宁 | 70个 | 0 | 245ms | 5.6% | 新疆 | 54个 | 0 | 289ms | 4.3%  
...
海外线路到Digital Ocean美国-旧金山机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 32个 | 0 | 20ms | 0 | 英国 | 6个 | 0 | 176ms | 6.0%  
加拿大 | 8个 | 0 | 74ms | 0 | 新加坡 | 10个 | 0 | 179ms | 0  
日本 | 6个 | 0 | 116ms | 0.8% | 均值 | 160个 | 2个 | 179ms | 0.7%  
荷兰 | 4个 | 0 | 144ms | 0 | 越南 | 2个 | 0 | 205ms | 0  
韩国 | 24个 | 0 | 150ms | 1.1% | 马来西亚 | 8个 | 0 | 213ms | 0.4%  
香港 | 40个 | 2个 | 151ms | 0 | 印度尼西亚 | 2个 | 0 | 218ms | 3.5%  
法国 | 4个 | 0 | 152ms | 0 | 俄罗斯 | 2个 | 0 | 243ms | 0  
台湾 | 2个 | 0 | 163ms | - | 南非 | 2个 | 0 | 295ms | 0  
德国 | 2个 | 0 | 169ms | 0 | 柬埔寨 | 2个 | 0 | 389ms | 0.5%  
澳大利亚 | 4个 | 0 | 174ms | 0 |  |  |  |  |   
