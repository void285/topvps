...
大陆各省份到Digital Ocean加拿大-多伦多机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 8个 | 0 | 229ms | 0.1% | 河南 | 53个 | 0 | 279ms | 10.5%  
天津 | 4个 | 0 | 251ms | 10.3% | 辽宁 | 35个 | 0 | 281ms | 14.8%  
北京 | 8个 | 1个 | 258ms | 6.4% | 均值 | 945个 | 11个 | 281ms | 9.7%  
安徽 | 41个 | 0 | 263ms | 5.3% | 浙江 | 48个 | 3个 | 284ms | 16.1%  
广东 | 75个 | 1个 | 264ms | 6.7% | 四川 | 46个 | 0 | 288ms | 8.3%  
重庆 | 16个 | 1个 | 267ms | 1.8% | 甘肃 | 20个 | 0 | 289ms | 6.1%  
吉林 | 13个 | 0 | 268ms | 10.2% | 江西 | 22个 | 0 | 290ms | 14.3%  
广西 | 37个 | 1个 | 269ms | 6.4% | 湖南 | 45个 | 0 | 292ms | 10.4%  
江苏 | 61个 | 1个 | 271ms | 11.4% | 内蒙古 | 33个 | 0 | 296ms | 12.1%  
河北 | 33个 | 0 | 271ms | 11.4% | 山西 | 38个 | 0 | 296ms | 15.1%  
福建 | 32个 | 1个 | 273ms | 5.6% | 云南 | 25个 | 0 | 297ms | 7.5%  
海南 | 11个 | 0 | 273ms | 6.0% | 黑龙江 | 38个 | 0 | 298ms | 12.7%  
山东 | 53个 | 1个 | 274ms | 7.0% | 贵州 | 28个 | 0 | 305ms | 12.6%  
湖北 | 49个 | 0 | 277ms | 8.9% | 青海 | 3个 | 0 | 307ms | 7.3%  
宁夏 | 11个 | 0 | 277ms | 8.5% | 新疆 | 27个 | 0 | 332ms | 9.7%  
陕西 | 31个 | 1个 | 278ms | 10.0% | 西藏 | 1个 | 0 | 387ms | 15.0%  
...
海外线路到Digital Ocean加拿大-多伦多机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 14ms | 1.0% | 台湾 | 1个 | 0 | 201ms | -  
美国 | 18个 | 0 | 62ms | 0.8% | 韩国 | 13个 | 0 | 211ms | 0  
法国 | 2个 | 0 | 91ms | 0 | 香港 | 19个 | 0 | 230ms | 0  
荷兰 | 1个 | 0 | 100ms | 0 | 新加坡 | 6个 | 0 | 236ms | 0  
英国 | 2个 | 0 | 107ms | 0 | 澳大利亚 | 2个 | 0 | 241ms | 0  
德国 | 1个 | 0 | 125ms | 0 | 马来西亚 | 3个 | 0 | 258ms | 0  
巴西 | 1个 | 0 | 139ms | 0 | 菲律宾 | 1个 | 0 | 264ms | 1.0%  
日本 | 2个 | 0 | 164ms | 0 | 南非 | 2个 | 0 | 274ms | 0.5%  
均值 | 79个 | 0 | 184ms | 1.7% | 印度尼西亚 | 1个 | 0 | 397ms | 26.0%  
俄罗斯 | 1个 | 0 | 200ms | 0 |  |  |  |  |   
