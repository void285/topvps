...
大陆各省份到Digital Ocean加拿大-多伦多机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 28个 | 4个 | 251ms | 1.7% | 均值 | 4874个 | 28个 | 280ms | 2.7%  
广东 | 415个 | 0 | 253ms | 1.2% | 江西 | 131个 | 8个 | 281ms | 1.8%  
重庆 | 37个 | 0 | 259ms | 0.3% | 河北 | 220个 | 0 | 281ms | 3.7%  
海南 | 32个 | 0 | 259ms | 4.0% | 江苏 | 331个 | 9个 | 283ms | 2.6%  
山东 | 346个 | 0 | 263ms | 3.2% | 湖北 | 177个 | 0 | 285ms | 3.1%  
青海 | 16个 | 0 | 264ms | 0 | 山西 | 177个 | 0 | 287ms | 5.1%  
湖南 | 237个 | 0 | 264ms | 0.2% | 河南 | 327个 | 0 | 289ms | 4.9%  
福建 | 149个 | 0 | 266ms | 2.0% | 辽宁 | 218个 | 0 | 291ms | 3.3%  
北京 | 36个 | 0 | 266ms | 3.3% | 四川 | 258个 | 0 | 292ms | 1.2%  
浙江 | 218个 | 7个 | 270ms | 1.2% | 贵州 | 130个 | 0 | 292ms | 0.5%  
广西 | 216个 | 0 | 270ms | 0.8% | 黑龙江 | 148个 | 0 | 296ms | 3.0%  
安徽 | 219个 | 0 | 270ms | 4.9% | 内蒙古 | 204个 | 0 | 301ms | 4.4%  
天津 | 20个 | 0 | 272ms | 8.7% | 吉林 | 68个 | 0 | 307ms | 4.5%  
宁夏 | 32个 | 0 | 273ms | 5.2% | 甘肃 | 104个 | 0 | 311ms | 1.6%  
陕西 | 138个 | 0 | 278ms | 0.9% | 新疆 | 115个 | 0 | 334ms | 2.9%  
云南 | 119个 | 0 | 280ms | 4.6% | 西藏 | 8个 | 0 | 500ms | 26.5%  
...
海外线路到Digital Ocean加拿大-多伦多机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 12个 | 0 | 12ms | 0 | 新加坡 | 15个 | 0 | 203ms | 0  
荷兰 | 3个 | 0 | 55ms | 0 | 香港 | 63个 | 3个 | 204ms | 0  
意大利 | 3个 | 0 | 81ms | - | 韩国 | 21个 | 0 | 205ms | 0  
巴西 | 3个 | 0 | 86ms | 0 | 南非 | 6个 | 0 | 206ms | 2.5%  
美国 | 48个 | 0 | 97ms | 9.8% | 澳大利亚 | 6个 | 0 | 221ms | 0  
德国 | 9个 | 0 | 113ms | 0 | 台湾 | 3个 | 0 | 237ms | 0  
俄罗斯 | 3个 | 0 | 142ms | - | 菲律宾 | 3个 | 0 | 255ms | 0  
英国 | 6个 | 0 | 152ms | 0.5% | 印度尼西亚 | 6个 | 0 | 260ms | 0  
均值 | 225个 | 3个 | 165ms | 1.0% | 马来西亚 | 12个 | 0 | 269ms | 1.8%  
日本 | 3个 | 0 | 182ms | 2.0% |  |  |  |  |   
