...
大陆各省份到Digital Ocean加拿大-多伦多机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 8个 | 0 | 248ms | 6.4% | 均值 | 1238个 | 15个 | 283ms | 8.2%  
上海 | 6个 | 0 | 248ms | 2.0% | 江西 | 37个 | 0 | 285ms | 5.3%  
天津 | 6个 | 0 | 257ms | 0 | 山西 | 44个 | 2个 | 285ms | 14.6%  
广西 | 49个 | 0 | 258ms | 2.0% | 云南 | 21个 | 0 | 286ms | 2.7%  
浙江 | 59个 | 3个 | 266ms | 6.2% | 河南 | 79个 | 0 | 288ms | 16.5%  
重庆 | 7个 | 0 | 266ms | 13.1% | 辽宁 | 49个 | 1个 | 288ms | 13.7%  
广东 | 101个 | 3个 | 268ms | 4.5% | 内蒙古 | 49个 | 0 | 292ms | 12.7%  
湖南 | 61个 | 0 | 270ms | 5.1% | 陕西 | 41个 | 1个 | 293ms | 5.4%  
安徽 | 65个 | 0 | 270ms | 2.3% | 四川 | 62个 | 0 | 298ms | 4.6%  
福建 | 42个 | 0 | 273ms | 4.3% | 吉林 | 19个 | 0 | 301ms | 16.2%  
河北 | 50个 | 0 | 275ms | 11.3% | 宁夏 | 5个 | 0 | 303ms | 0.6%  
贵州 | 37个 | 0 | 279ms | 3.8% | 黑龙江 | 42个 | 0 | 304ms | 19.4%  
江苏 | 81个 | 5个 | 279ms | 8.2% | 甘肃 | 30个 | 0 | 306ms | 2.0%  
山东 | 86个 | 0 | 282ms | 13.0% | 青海 | 5个 | 0 | 321ms | 10.4%  
海南 | 13个 | 0 | 282ms | 1.8% | 新疆 | 30个 | 0 | 323ms | 9.9%  
湖北 | 50个 | 0 | 283ms | 6.0% | 西藏 | 4个 | 0 | 404ms | 4.5%  
...
海外线路到Digital Ocean加拿大-多伦多机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 7ms | 0 | 日本 | 3个 | 0 | 202ms | 20.3%  
意大利 | 1个 | 0 | 81ms | - | 新加坡 | 4个 | 0 | 202ms | 0  
美国 | 9个 | 0 | 102ms | 0 | 越南 | 2个 | 0 | 242ms | 0  
德国 | 3个 | 0 | 116ms | 0 | 澳大利亚 | 2个 | 0 | 264ms | 0  
台湾 | 2个 | 0 | 127ms | 0 | 赞比亚 | 1个 | 0 | 282ms | 6.7%  
韩国 | 8个 | 0 | 171ms | 0 | 马来西亚 | 6个 | 0 | 286ms | 0  
均值 | 63个 | 0 | 193ms | 2.5% | 印度尼西亚 | 1个 | 0 | 288ms | 1.0%  
荷兰 | 1个 | 0 | 195ms | 0 | 菲律宾 | 2个 | 0 | 327ms | 10.0%  
香港 | 15个 | 0 | 198ms | 0 |  |  |  |  |   
