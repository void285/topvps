...
大陆各省份到Digital Ocean加拿大-多伦多机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 8个 | 0 | 236ms | 0 | 均值 | 965个 | 7个 | 256ms | 0.9%  
北京 | 8个 | 1个 | 238ms | 1.0% | 山东 | 51个 | 1个 | 257ms | 0.3%  
天津 | 4个 | 0 | 239ms | 0 | 湖南 | 44个 | 0 | 257ms | 3.5%  
广东 | 79个 | 0 | 240ms | 0.7% | 宁夏 | 12个 | 0 | 258ms | 0.1%  
海南 | 14个 | 0 | 244ms | 0 | 内蒙古 | 31个 | 0 | 259ms | 0.1%  
山西 | 37个 | 0 | 245ms | 2.8% | 贵州 | 28个 | 1个 | 260ms | 2.7%  
江苏 | 60个 | 1个 | 247ms | 0.2% | 陕西 | 32个 | 1个 | 262ms | 1.4%  
广西 | 39个 | 0 | 248ms | 1.8% | 重庆 | 14个 | 1个 | 262ms | 0  
福建 | 34个 | 0 | 249ms | 0.1% | 云南 | 21个 | 0 | 264ms | 3.8%  
河北 | 34个 | 0 | 249ms | 0.1% | 湖北 | 44个 | 0 | 268ms | 0.5%  
河南 | 57个 | 1个 | 250ms | 0.8% | 四川 | 46个 | 0 | 269ms | 0.6%  
浙江 | 51个 | 0 | 255ms | 0.3% | 黑龙江 | 39个 | 0 | 269ms | 0.7%  
吉林 | 19个 | 0 | 255ms | 0 | 甘肃 | 23个 | 0 | 269ms | 0.2%  
江西 | 25个 | 0 | 256ms | 0.2% | 青海 | 3个 | 0 | 277ms | 0  
安徽 | 39个 | 0 | 256ms | 0.6% | 新疆 | 28个 | 0 | 304ms | 0.8%  
辽宁 | 41个 | 0 | 256ms | 0.4% |  |  |  |  |   
...
海外线路到Digital Ocean加拿大-多伦多机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 15ms | 0 | 韩国 | 12个 | 0 | 208ms | 0  
美国 | 21个 | 0 | 61ms | 3.6% | 俄罗斯 | 1个 | 0 | 216ms | 0  
意大利 | 1个 | 0 | 83ms | - | 香港 | 21个 | 0 | 227ms | 0  
法国 | 1个 | 0 | 97ms | 0 | 新加坡 | 6个 | 0 | 236ms | 0  
荷兰 | 1个 | 0 | 100ms | 0 | 澳大利亚 | 1个 | 0 | 243ms | 1.0%  
德国 | 3个 | 0 | 108ms | 0 | 马来西亚 | 4个 | 0 | 255ms | 0  
英国 | 2个 | 0 | 114ms | 0 | 南非 | 2个 | 0 | 269ms | 1.0%  
巴西 | 1个 | 0 | 139ms | 0 | 越南 | 2个 | 0 | 277ms | 1.0%  
日本 | 1个 | 0 | 162ms | 0 | 印度尼西亚 | 1个 | 0 | 286ms | 0  
均值 | 87个 | 0 | 184ms | 0.4% | 菲律宾 | 1个 | 0 | 287ms | 0  
台湾 | 1个 | 0 | 200ms | - | 柬埔寨 | 1个 | 0 | 292ms | 1.0%  
