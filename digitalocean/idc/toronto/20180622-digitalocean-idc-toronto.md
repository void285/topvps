...
大陆各省份到Digital Ocean加拿大-多伦多机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 7个 | 1个 | 231ms | 0.7% | 湖北 | 34个 | 0 | 256ms | 0.8%  
天津 | 2个 | 0 | 234ms | 2.0% | 海南 | 12个 | 0 | 256ms | 0.1%  
广东 | 74个 | 0 | 238ms | 0.4% | 江西 | 23个 | 0 | 257ms | 0.8%  
江苏 | 67个 | 3个 | 240ms | 4.0% | 辽宁 | 36个 | 0 | 258ms | 1.4%  
安徽 | 36个 | 1个 | 240ms | 0.1% | 宁夏 | 13个 | 0 | 259ms | 0.7%  
河南 | 45个 | 1个 | 246ms | 3.0% | 贵州 | 25个 | 0 | 262ms | 2.6%  
广西 | 42个 | 0 | 247ms | 1.6% | 内蒙古 | 27个 | 0 | 265ms | 2.8%  
福建 | 31个 | 1个 | 248ms | 0.4% | 四川 | 40个 | 0 | 266ms | 0.5%  
重庆 | 12个 | 2个 | 250ms | 0.3% | 黑龙江 | 32个 | 2个 | 267ms | 1.4%  
山东 | 40个 | 0 | 251ms | 1.0% | 云南 | 23个 | 10个 | 269ms | 0.2%  
北京 | 10个 | 0 | 251ms | 1.3% | 甘肃 | 15个 | 0 | 272ms | 0.8%  
河北 | 30个 | 0 | 251ms | 0.4% | 吉林 | 19个 | 0 | 272ms | 1.5%  
湖南 | 37个 | 0 | 251ms | 1.6% | 陕西 | 26个 | 1个 | 273ms | 0.6%  
浙江 | 52个 | 2个 | 252ms | 0.3% | 青海 | 5个 | 0 | 275ms | 0.8%  
山西 | 32个 | 0 | 254ms | 0.3% | 新疆 | 24个 | 1个 | 310ms | 1.4%  
均值 | 872个 | 25个 | 255ms | 1.3% | 西藏 | 1个 | 0 | 390ms | 4.0%  
...
海外线路到Digital Ocean加拿大-多伦多机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 2个 | 0 | 15ms | 0 | 台湾 | 2个 | 0 | 193ms | 0  
美国 | 20个 | 0 | 68ms | 0 | 香港 | 23个 | 0 | 196ms | 0  
德国 | 1个 | 0 | 84ms | - | 新加坡 | 5个 | 0 | 205ms | 0  
意大利 | 1个 | 0 | 85ms | - | 韩国 | 14个 | 0 | 215ms | 0.3%  
巴西 | 1个 | 0 | 97ms | 0 | 菲律宾 | 2个 | 0 | 226ms | 0  
法国 | 1个 | 0 | 139ms | 0 | 澳大利亚 | 1个 | 0 | 244ms | 0  
日本 | 2个 | 0 | 180ms | 1.0% | 越南 | 2个 | 0 | 257ms | 0  
均值 | 88个 | 0 | 182ms | 0.3% | 印度尼西亚 | 1个 | 0 | 274ms | 0  
英国 | 2个 | 0 | 184ms | 0 | 马来西亚 | 5个 | 0 | 296ms | 2.4%  
南非 | 2个 | 0 | 188ms | 0.5% | 柬埔寨 | 1个 | 0 | 317ms | 1.0%  
