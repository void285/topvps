...
大陆各省份到Digital Ocean新加坡-新加坡机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
重庆 | 37个 | 3个 | 235ms | 25.3% | 广西 | 227个 | 0 | 293ms | 8.7%  
黑龙江 | 156个 | 0 | 242ms | 5.1% | 天津 | 24个 | 0 | 294ms | 8.3%  
湖南 | 241个 | 3个 | 254ms | 7.3% | 河南 | 327个 | 0 | 296ms | 10.8%  
安徽 | 206个 | 0 | 259ms | 27.2% | 上海 | 31个 | 4个 | 297ms | 24.1%  
浙江 | 222个 | 10个 | 267ms | 23.4% | 四川 | 269个 | 0 | 298ms | 8.9%  
广东 | 409个 | 9个 | 268ms | 5.5% | 均值 | 4917个 | 77个 | 298ms | 12.6%  
湖北 | 177个 | 0 | 271ms | 7.6% | 河北 | 228个 | 0 | 301ms | 7.0%  
陕西 | 145个 | 3个 | 274ms | 10.5% | 山西 | 169个 | 3个 | 348ms | 9.7%  
贵州 | 126个 | 4个 | 279ms | 6.3% | 甘肃 | 104个 | 0 | 351ms | 14.3%  
云南 | 119个 | 0 | 279ms | 13.7% | 内蒙古 | 204个 | 0 | 354ms | 9.5%  
江苏 | 334个 | 18个 | 281ms | 19.3% | 青海 | 16个 | 0 | 366ms | 17.0%  
海南 | 32个 | 0 | 289ms | 9.9% | 宁夏 | 32个 | 0 | 370ms | 17.2%  
江西 | 131个 | 8个 | 291ms | 30.2% | 西藏 | 4个 | 0 | 373ms | 20.0%  
北京 | 36个 | 0 | 291ms | 8.2% | 辽宁 | 210个 | 6个 | 382ms | 12.7%  
山东 | 358个 | 0 | 292ms | 11.4% | 新疆 | 123个 | 0 | 412ms | 14.9%  
福建 | 152个 | 6个 | 292ms | 27.6% | 吉林 | 68个 | 0 | 421ms | 11.9%  
...
海外线路到Digital Ocean新加坡-新加坡机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
印度尼西亚 | 6个 | 0 | 28ms | 1.0% | 荷兰 | 3个 | 0 | 185ms | 0  
新加坡 | 15个 | 0 | 33ms | 0 | 巴西 | 3个 | 0 | 191ms | 0  
台湾 | 3个 | 0 | 73ms | 0 | 俄罗斯 | 3个 | 0 | 208ms | -  
马来西亚 | 12个 | 0 | 74ms | 1.3% | 南非 | 6个 | 0 | 210ms | 0.5%  
香港 | 66个 | 3个 | 89ms | 0 | 德国 | 9个 | 0 | 229ms | 0  
日本 | 6个 | 0 | 101ms | 1.7% | 英国 | 6个 | 0 | 236ms | 1.0%  
澳大利亚 | 6个 | 0 | 109ms | 0 | 加拿大 | 15个 | 0 | 245ms | 0  
韩国 | 21个 | 3个 | 113ms | 0 | 菲律宾 | 6个 | 0 | 264ms | 13.0%  
均值 | 237个 | 6个 | 159ms | 1.5% | 意大利 | 3个 | 0 | 314ms | -  
美国 | 48个 | 0 | 164ms | 5.5% |  |  |  |  |   
