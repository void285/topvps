...
大陆各省份到Digital Ocean新加坡-新加坡机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广西 | 54个 | 0 | 169ms | 3.2% | 江苏 | 86个 | 4个 | 264ms | 6.1%  
天津 | 6个 | 0 | 213ms | 2.8% | 北京 | 7个 | 0 | 265ms | 3.0%  
湖南 | 67个 | 0 | 214ms | 3.7% | 贵州 | 39个 | 1个 | 266ms | 6.8%  
陕西 | 43个 | 0 | 216ms | 3.5% | 上海 | 8个 | 0 | 273ms | 7.5%  
安徽 | 71个 | 0 | 219ms | 3.3% | 河北 | 58个 | 0 | 275ms | 12.0%  
福建 | 46个 | 0 | 224ms | 3.2% | 湖北 | 48个 | 0 | 276ms | 4.0%  
浙江 | 63个 | 3个 | 224ms | 7.0% | 四川 | 69个 | 0 | 277ms | 5.4%  
江西 | 37个 | 0 | 233ms | 3.8% | 甘肃 | 33个 | 0 | 284ms | 2.8%  
云南 | 26个 | 0 | 233ms | 2.8% | 山西 | 47个 | 1个 | 287ms | 13.9%  
广东 | 114个 | 3个 | 241ms | 4.9% | 内蒙古 | 55个 | 0 | 289ms | 16.0%  
黑龙江 | 53个 | 0 | 242ms | 14.4% | 新疆 | 34个 | 0 | 317ms | 5.6%  
河南 | 83个 | 0 | 250ms | 15.8% | 青海 | 5个 | 0 | 320ms | 2.7%  
海南 | 14个 | 0 | 250ms | 8.1% | 辽宁 | 55个 | 0 | 333ms | 19.5%  
均值 | 1353个 | 12个 | 256ms | 8.2% | 宁夏 | 6个 | 0 | 349ms | 0.7%  
重庆 | 7个 | 0 | 257ms | 15.8% | 西藏 | 4个 | 0 | 361ms | 6.8%  
山东 | 93个 | 0 | 264ms | 11.4% | 吉林 | 22个 | 0 | 390ms | 21.9%  
...
海外线路到Digital Ocean新加坡-新加坡机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 4个 | 0 | 44ms | 0 | 澳大利亚 | 2个 | 0 | 153ms | 0.5%  
马来西亚 | 3个 | 0 | 52ms | 0 | 均值 | 56个 | 0 | 166ms | 2.0%  
越南 | 2个 | 0 | 53ms | 0 | 菲律宾 | 2个 | 0 | 176ms | 21.7%  
日本 | 2个 | 0 | 75ms | 3.3% | 加拿大 | 2个 | 0 | 232ms | -  
香港 | 15个 | 0 | 100ms | 0 | 德国 | 3个 | 0 | 234ms | 0  
台湾 | 2个 | 0 | 117ms | 0 | 荷兰 | 1个 | 0 | 253ms | 0  
美国 | 9个 | 0 | 140ms | 0 | 意大利 | 1个 | 0 | 313ms | -  
韩国 | 7个 | 0 | 151ms | 0 | 赞比亚 | 1个 | 0 | 400ms | 0  
