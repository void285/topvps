...
大陆各省份到Digital Ocean新加坡-新加坡机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
青海 | 3个 | 0 | 201ms | 6.7% | 福建 | 36个 | 1个 | 249ms | 15.8%  
北京 | 8个 | 1个 | 208ms | 6.7% | 均值 | 979个 | 17个 | 252ms | 13.8%  
湖南 | 43个 | 0 | 208ms | 11.4% | 云南 | 20个 | 0 | 260ms | 19.6%  
黑龙江 | 39个 | 0 | 226ms | 9.3% | 山西 | 36个 | 0 | 261ms | 9.1%  
浙江 | 51个 | 2个 | 227ms | 12.4% | 湖北 | 43个 | 1个 | 269ms | 16.7%  
江西 | 24个 | 0 | 228ms | 14.5% | 陕西 | 33个 | 2个 | 269ms | 13.0%  
广东 | 84个 | 2个 | 231ms | 11.6% | 宁夏 | 12个 | 0 | 274ms | 13.6%  
广西 | 38个 | 0 | 232ms | 14.2% | 重庆 | 15个 | 0 | 278ms | 17.8%  
河南 | 58个 | 1个 | 233ms | 12.6% | 河北 | 36个 | 0 | 280ms | 13.3%  
山东 | 53个 | 1个 | 233ms | 12.5% | 新疆 | 29个 | 0 | 281ms | 10.0%  
安徽 | 40个 | 0 | 233ms | 20.2% | 甘肃 | 23个 | 0 | 283ms | 14.4%  
江苏 | 62个 | 3个 | 236ms | 17.2% | 辽宁 | 39个 | 1个 | 297ms | 11.6%  
天津 | 5个 | 0 | 236ms | 12.2% | 吉林 | 19个 | 0 | 298ms | 16.6%  
上海 | 7个 | 0 | 243ms | 24.8% | 四川 | 48个 | 0 | 300ms | 16.7%  
海南 | 14个 | 0 | 243ms | 13.0% | 内蒙古 | 33个 | 0 | 305ms | 15.2%  
...
海外线路到Digital Ocean新加坡-新加坡机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 6个 | 0 | 1ms | 0 | 均值 | 86个 | 0 | 159ms | 0.4%  
印度尼西亚 | 1个 | 0 | 24ms | 2.0% | 法国 | 1个 | 0 | 174ms | 0  
马来西亚 | 4个 | 0 | 50ms | 0 | 荷兰 | 1个 | 0 | 179ms | 0  
越南 | 2个 | 0 | 62ms | 0 | 英国 | 2个 | 0 | 180ms | 0  
香港 | 18个 | 0 | 70ms | 0 | 美国 | 21个 | 0 | 181ms | 2.8%  
日本 | 1个 | 0 | 81ms | 0 | 加拿大 | 4个 | 0 | 242ms | 0  
柬埔寨 | 1个 | 0 | 93ms | 0 | 俄罗斯 | 1个 | 0 | 259ms | 0  
台湾 | 1个 | 0 | 99ms | - | 德国 | 3个 | 0 | 265ms | 0  
菲律宾 | 1个 | 0 | 102ms | 0 | 意大利 | 1个 | 0 | 328ms | -  
韩国 | 12个 | 0 | 113ms | 1.7% | 南非 | 2个 | 0 | 341ms | 0.5%  
澳大利亚 | 2个 | 0 | 150ms | 0 | 巴西 | 1个 | 0 | 346ms | 0  
