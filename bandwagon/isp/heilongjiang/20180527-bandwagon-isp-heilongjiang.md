...
黑龙江全部运营商到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 4个 | 0 | 197ms | 0 | 佛罗里达 | 4个 | 0 | 249ms | 2%  
洛杉矶 | 16个 | 0 | 205ms | 6% | 纽约 | 4个 | 0 | 306ms | 11%  
温哥华 | 4个 | 1个 | 225ms | 16% | 阿姆斯特丹 | 4个 | 1个 | 363ms | 26%  
凤凰城 | 4个 | 0 | 237ms | 0 | 香港 | 4个 | 4个 | - | -  
均值 | 44个 | 6个 | 240ms | 8% |  |  |  |  |   
...
黑龙江电信到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 1个 | 0 | 205ms | 0 | 佛罗里达 | 1个 | 0 | 254ms | 0  
洛杉矶 | 4个 | 0 | 225ms | 8% | 纽约 | 1个 | 0 | 343ms | 0  
温哥华 | 1个 | 0 | 222ms | 3% | 阿姆斯特丹 | 1个 | 0 | 287ms | 13%  
凤凰城 | 1个 | 0 | 257ms | 0 | 香港 | 1个 | 1个 | - | -  
均值 | 11个 | 1个 | 246ms | 5% |  |  |  |  |   
...
黑龙江联通到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 3个 | 0 | 190ms | 0 | 佛罗里达 | 3个 | 0 | 244ms | 5%  
洛杉矶 | 12个 | 0 | 186ms | 4% | 纽约 | 3个 | 0 | 270ms | 23%  
温哥华 | 3个 | 1个 | 228ms | 30% | 阿姆斯特丹 | 3个 | 1个 | 440ms | 40%  
凤凰城 | 3个 | 0 | 218ms | 0 | 香港 | 3个 | 3个 | - | -  
均值 | 33个 | 5个 | 233ms | 11% |  |  |  |  |   
