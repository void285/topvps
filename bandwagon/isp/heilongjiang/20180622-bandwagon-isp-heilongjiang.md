#  黑龙江到BandwagonHost各机房的测速数据（20180622） 
...
黑龙江全部运营商到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 3个 | 0 | 60ms | 0 | 温哥华 | 3个 | 0 | 225ms | 0  
佛利蒙 | 3个 | 0 | 189ms | 0 | 纽约 | 3个 | 0 | 260ms | 0  
洛杉矶 | 12个 | 0 | 196ms | 0 | 佛罗里达 | 3个 | 0 | 262ms | 4%  
凤凰城 | 3个 | 0 | 202ms | 0 | 阿姆斯特丹 | 3个 | 0 | 348ms | 28%  
均值 | 33个 | 0 | 212ms | 3% |  |  |  |  |   
...
黑龙江电信到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 57ms | 0 | 温哥华 | 1个 | 0 | 218ms | 0  
佛利蒙 | 1个 | 0 | 188ms | 0 | 纽约 | 1个 | 0 | 245ms | 0  
洛杉矶 | 4个 | 0 | 206ms | 0 | 佛罗里达 | 1个 | 0 | 282ms | 6%  
凤凰城 | 1个 | 0 | 189ms | 0 | 阿姆斯特丹 | 1个 | 0 | 365ms | 56%  
均值 | 11个 | 0 | 215ms | 5% |  |  |  |  |   
...
黑龙江联通到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 64ms | 0 | 温哥华 | 2个 | 0 | 232ms | 0  
佛利蒙 | 2个 | 0 | 191ms | 0 | 纽约 | 2个 | 0 | 275ms | 0  
洛杉矶 | 8个 | 0 | 185ms | 0 | 佛罗里达 | 2个 | 0 | 242ms | 1%  
凤凰城 | 2个 | 0 | 215ms | 0 | 阿姆斯特丹 | 2个 | 0 | 331ms | 0  
均值 | 22个 | 0 | 208ms | 0 |  |  |  |  |   
