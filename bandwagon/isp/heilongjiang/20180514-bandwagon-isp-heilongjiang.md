#  黑龙江到BandwagonHost各机房的测速数据（20180514） 
...
黑龙江全部运营商到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 4个 | 0 | 58ms | 0 | 温哥华 | 4个 | 0 | 233ms | 0  
洛杉矶 | 16个 | 0 | 186ms | 0 | 佛罗里达 | 4个 | 0 | 256ms | 0  
佛利蒙 | 4个 | 0 | 208ms | 1% | 纽约 | 4个 | 0 | 310ms | 1%  
均值 | 44个 | 0 | 212ms | 0 | 阿姆斯特丹 | 4个 | 0 | 335ms | 0  
凤凰城 | 4个 | 0 | 222ms | 0 |  |  |  |  |   
...
黑龙江电信到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 57ms | 0 | 温哥华 | 1个 | 0 | 219ms | 0  
洛杉矶 | 4个 | 0 | 191ms | 0 | 佛罗里达 | 1个 | 0 | 254ms | 0  
佛利蒙 | 1个 | 0 | 205ms | 0 | 纽约 | 1个 | 0 | 346ms | 3%  
均值 | 11个 | 0 | 210ms | 0 | 阿姆斯特丹 | 1个 | 0 | 267ms | 0  
凤凰城 | 1个 | 0 | 199ms | 0 |  |  |  |  |   
...
黑龙江联通到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 3个 | 0 | 60ms | 0 | 温哥华 | 3个 | 0 | 247ms | 0  
洛杉矶 | 12个 | 0 | 180ms | 0 | 佛罗里达 | 3个 | 0 | 258ms | 0  
佛利蒙 | 3个 | 0 | 211ms | 3% | 纽约 | 3个 | 0 | 274ms | 0  
均值 | 33个 | 0 | 214ms | 0 | 阿姆斯特丹 | 3个 | 0 | 403ms | 0  
凤凰城 | 3个 | 0 | 245ms | 0 |  |  |  |  |   
