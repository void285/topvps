#  新疆到BandwagonHost各机房的测速数据（20180426） 
...
新疆移动到BandwagonHost各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 1个 | 0 | 245ms | 0 | 均值 | 11个 | 0 | 295ms | 3%  
凤凰城 | 1个 | 0 | 252ms | 0 | 纽约 | 1个 | 0 | 307ms | 0  
香港 | 1个 | 0 | 263ms | 0 | 温哥华 | 1个 | 0 | 309ms | 3%  
洛杉矶 | 4个 | 0 | 281ms | 5% | 阿姆斯特丹 | 1个 | 0 | 451ms | 6%  
佛罗里达 | 1个 | 0 | 295ms | 10% |  |  |  |  |   
