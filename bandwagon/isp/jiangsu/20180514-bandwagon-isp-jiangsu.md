#  江苏到BandwagonHost各机房的测速数据（20180514） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![江苏到BandwagonHost各机房的测速数据（20180514）](/images/thumbnails/Jiangsu_to_bandwagon.png)
...
本文提供20180514江苏到BandwagonHost各机房的PING测试结果，测速点的运营商线路为电信、联通、移动，有效样本点237个，其中超时点15个。连通概况如下：大陆线路响应均值为199毫秒，最快的三个机房所在地为香港、洛杉矶、温哥华，最慢的三个为佛罗里达、纽约、阿姆斯特丹；洛杉矶、阿姆斯特丹、佛罗里达、纽约、香港等8处有响应超时情况；纽约、阿姆斯特丹丢包率较高。

[注册 BandwagonHost](https://vps123.top/go/bwg/_btn1)

## 江苏图表数据

![大陆省份江苏到VPS提供商BandwagonHost各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180514](/images/pingtests/bwg_20180514/plot_isp_jiangsu_bwg_20180514.png)

### 全部运营商

江苏全部运营商到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 22个 | 1个 | 41ms | 0 | 凤凰城 | 22个 | 1个 | 246ms | 0  
洛杉矶 | 88个 | 4个 | 169ms | 0 | 佛罗里达 | 22个 | 2个 | 268ms | 0  
温哥华 | 22个 | 1个 | 184ms | 1% | 纽约 | 20个 | 2个 | 340ms | 22%  
均值 | 237个 | 15个 | 199ms | 3% | 阿姆斯特丹 | 21个 | 3个 | 353ms | 8%  
佛利蒙 | 20个 | 1个 | 207ms | 0 |  |  |  |  |   
  
简评：本表展示了江苏的 **电信、联通、移动** 线路到BandwagonHost各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻江苏，可从此表了解你常用的网络到BandwagonHost各个机房的平均响应速度以及丢包率。从表中数据可以看到， **香港、洛杉矶、温哥华、佛利蒙、凤凰城** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

江苏电信到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 15个 | 1个 | 46ms | 0 | 凤凰城 | 15个 | 1个 | 200ms | 0  
洛杉矶 | 60个 | 4个 | 157ms | 0 | 佛罗里达 | 15个 | 2个 | 258ms | 0  
温哥华 | 15个 | 1个 | 191ms | 3% | 纽约 | 14个 | 2个 | 335ms | 28%  
均值 | 163个 | 14个 | 192ms | 4% | 阿姆斯特丹 | 15个 | 2个 | 299ms | 16%  
佛利蒙 | 14个 | 1个 | 169ms | 0 |  |  |  |  |   
  
简评：如果你是来自江苏的 **电信** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **香港、洛杉矶、佛利蒙、温哥华、凤凰城** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_1)吧！

### 联通

江苏联通到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 6个 | 0 | 39ms | 0 | 凤凰城 | 6个 | 0 | 237ms | 1%  
洛杉矶 | 24个 | 0 | 189ms | 0 | 佛罗里达 | 6个 | 0 | 273ms | 0  
温哥华 | 6个 | 0 | 195ms | 0 | 纽约 | 5个 | 0 | 290ms | 16%  
均值 | 63个 | 1个 | 206ms | 1% | 阿姆斯特丹 | 5个 | 1个 | 297ms | 0  
佛利蒙 | 5个 | 0 | 200ms | 1% |  |  |  |  |   
  
简评：如果你是来自江苏的 **联通** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **香港、洛杉矶、温哥华、佛利蒙、凤凰城** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_2)吧！

### 移动

江苏移动到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 39ms | - | 凤凰城 | 1个 | 0 | 301ms | -  
洛杉矶 | 4个 | 0 | 163ms | - | 佛罗里达 | 1个 | 0 | 273ms | -  
温哥华 | 1个 | 0 | 167ms | - | 纽约 | 1个 | 0 | 396ms | -  
均值 | 11个 | 0 | - | - | 阿姆斯特丹 | 1个 | 0 | 464ms | -  
佛利蒙 | 1个 | 0 | 254ms | - |  |  |  |  |   
...
## 相关测速报告
  ...
  * 江苏到BandwagonHost各机房的 _其他近期报告_ ： 
    ...
    * [20180804](/bandwagon/isp/jiangsu/20180804-bandwagon-isp-jiangsu.md "江苏到BandwagonHost各机房的Ping测试 20180804")
...
本文最初发表于[江苏到BandwagonHost各机房的测速数据（20180514）](https://vps123.top/pingtest/20180514-bandwagon-isp-jiangsu.html)
