#  湖南到BandwagonHost各机房的测速数据（20180918） 
...
湖南全部运营商到BandwagonHost各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 4个 | 0 | 30ms | 0 | 温哥华 | 4个 | 0 | 258ms | 50%  
佛利蒙 | 4个 | 0 | 183ms | 0 | 纽约 | 4个 | 0 | 281ms | 0  
洛杉矶 | 14个 | 0 | 193ms | 7% | 阿姆斯特丹 | 2个 | 0 | 286ms | 0  
凤凰城 | 4个 | 0 | 208ms | 20% | 佛罗里达 | 4个 | 4个 | - | -  
均值 | 40个 | 4个 | 219ms | 10% |  |  |  |  |   
...
湖南电信到BandwagonHost各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 21ms | - | 温哥华 | 2个 | 0 | 253ms | -  
佛利蒙 | 2个 | 0 | 174ms | - | 纽约 | 2个 | 0 | 278ms | -  
洛杉矶 | 6个 | 0 | 180ms | - | 阿姆斯特丹 | - | - | - | -  
凤凰城 | 2个 | 0 | 199ms | - | 佛罗里达 | 2个 | 2个 | - | -  
均值 | 18个 | 2个 | - | - |  |  |  |  |   
...
湖南联通到BandwagonHost各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 39ms | 0 | 温哥华 | 2个 | 0 | 262ms | 50%  
佛利蒙 | 2个 | 0 | 192ms | 0 | 纽约 | 2个 | 0 | 284ms | 0  
洛杉矶 | 8个 | 0 | 207ms | 7% | 阿姆斯特丹 | 2个 | 0 | 286ms | 0  
凤凰城 | 2个 | 0 | 218ms | 20% | 佛罗里达 | 2个 | 2个 | - | -  
均值 | 22个 | 2个 | 219ms | 10% |  |  |  |  |   
