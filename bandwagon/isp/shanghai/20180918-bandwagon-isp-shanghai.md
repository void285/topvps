#  上海到BandwagonHost各机房的测速数据（20180918） 
...
上海电信到BandwagonHost各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 3个 | 0 | 38ms | 0 | 均值 | 33个 | 3个 | 202ms | 8%  
佛利蒙 | 3个 | 0 | 155ms | 0 | 阿姆斯特丹 | 3个 | 0 | 310ms | 5%  
凤凰城 | 3个 | 0 | 184ms | 15% | 纽约 | 3个 | 0 | 316ms | 25%  
洛杉矶 | 12个 | 0 | 189ms | 3% | 佛罗里达 | 3个 | 3个 | - | -  
温哥华 | 3个 | 0 | 193ms | 20% |  |  |  |  |   
