#  上海到BandwagonHost各机房的测速数据（20180514） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![上海到BandwagonHost各机房的测速数据（20180514）](/images/thumbnails/Shanghai_to_bandwagon.png)
...
本文提供20180514上海到BandwagonHost各机房的PING测试结果，测速点的运营商线路为电信，有效样本点32个，无超时点。连通概况如下：大陆线路响应均值为180毫秒，最快的三个机房所在地为香港、洛杉矶、佛利蒙，最慢的三个为佛罗里达、纽约、阿姆斯特丹。

[注册 BandwagonHost](https://vps123.top/go/bwg/_btn1)

## 上海图表数据

![大陆省份上海到VPS提供商BandwagonHost各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180514](/images/pingtests/bwg_20180514/plot_isp_shanghai_bwg_20180514.png)

### 电信

上海电信到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 3个 | 0 | 31ms | 0 | 凤凰城 | 3个 | 0 | 204ms | 3%  
洛杉矶 | 12个 | 0 | 150ms | 0 | 佛罗里达 | 3个 | 0 | 245ms | 0  
佛利蒙 | 2个 | 0 | 152ms | 0 | 纽约 | 3个 | 0 | 256ms | 0  
均值 | 32个 | 0 | 180ms | 0 | 阿姆斯特丹 | 3个 | 0 | 284ms | 3%  
温哥华 | 3个 | 0 | 203ms | 0 |  |  |  |  |   
  
简评：如果你是来自上海的 **电信** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **香港、洛杉矶、佛利蒙、温哥华、凤凰城、佛罗里达** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_1)吧！
...
本文最初发表于[上海到BandwagonHost各机房的测速数据（20180514）](https://vps123.top/pingtest/20180514-bandwagon-isp-shanghai.html)
