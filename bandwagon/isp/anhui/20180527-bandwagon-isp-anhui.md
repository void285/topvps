...
![安徽到BandwagonHost各机房的测速数据（20180527）](/images/thumbnails/Anhui_to_bandwagon.png)
...
![大陆省份安徽到VPS提供商BandwagonHost各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180527](/images/pingtests/bwg_20180527/plot_isp_anhui_bwg_20180527.png)

### 全部运营商

安徽全部运营商到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 5个 | 0 | 187ms | 0 | 佛罗里达 | 5个 | 0 | 256ms | 11%  
洛杉矶 | 20个 | 0 | 191ms | 6% | 纽约 | 5个 | 0 | 270ms | 1%  
凤凰城 | 5个 | 0 | 208ms | 0 | 阿姆斯特丹 | 5个 | 0 | 345ms | 16%  
温哥华 | 5个 | 0 | 212ms | 5% | 香港 | 6个 | 6个 | - | -  
均值 | 56个 | 6个 | 224ms | 6% |  |  |  |  |   
  
简评：本表展示了安徽的 **电信、联通、移动** 线路到BandwagonHost各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻安徽，可从此表了解你常用的网络到BandwagonHost各个机房的平均响应速度以及丢包率。从表中数据可以看到， **佛利蒙、凤凰城、温哥华** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

安徽电信到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 3个 | 0 | 166ms | 1% | 佛罗里达 | 3个 | 0 | 247ms | 0  
洛杉矶 | 12个 | 0 | 163ms | 0 | 纽约 | 3个 | 0 | 321ms | 0  
凤凰城 | 3个 | 0 | 172ms | 0 | 阿姆斯特丹 | 3个 | 0 | 227ms | 0  
温哥华 | 3个 | 0 | 188ms | 0 | 香港 | 4个 | 4个 | - | -  
均值 | 34个 | 4个 | 201ms | 0 |  |  |  |  |   
  
简评：如果你是来自安徽的 **电信** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **洛杉矶、佛利蒙、凤凰城、温哥华、阿姆斯特丹、佛罗里达** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_1)吧！

### 联通

安徽联通到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 1个 | 0 | 189ms | - | 佛罗里达 | 1个 | 0 | 251ms | -  
洛杉矶 | 4个 | 0 | 203ms | - | 纽约 | 1个 | 0 | 227ms | -  
凤凰城 | 1个 | 0 | 208ms | - | 阿姆斯特丹 | 1个 | 0 | 399ms | -  
温哥华 | 1个 | 0 | 203ms | - | 香港 | 1个 | 1个 | - | -  
均值 | 11个 | 1个 | - | - |  |  |  |  |   
...
安徽移动到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 1个 | 0 | 208ms | 0 | 佛罗里达 | 1个 | 0 | 272ms | 23%  
洛杉矶 | 4个 | 0 | 206ms | 13% | 纽约 | 1个 | 0 | 263ms | 3%  
凤凰城 | 1个 | 0 | 245ms | 0 | 阿姆斯特丹 | 1个 | 0 | 410ms | 33%  
温哥华 | 1个 | 0 | 245ms | 10% | 香港 | 1个 | 1个 | - | -  
均值 | 11个 | 1个 | 247ms | 12% |  |  |  |  |   
  
简评：如果你是来自安徽的 **移动** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **佛利蒙、凤凰城** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **洛杉矶、温哥华** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_5)吧！
...
本文最初发表于[安徽到BandwagonHost各机房的测速数据（20180527）](https://vps123.top/pingtest/20180527-bandwagon-isp-anhui.html)
