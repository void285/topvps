#  陕西到BandwagonHost各机房的测速数据（20180527） 
...
陕西全部运营商到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 7个 | 0 | 187ms | 0 | 佛罗里达 | 6个 | 1个 | 255ms | 2%  
凤凰城 | 6个 | 1个 | 190ms | 0 | 纽约 | 7个 | 0 | 275ms | 14%  
洛杉矶 | 26个 | 5个 | 206ms | 4% | 阿姆斯特丹 | 6个 | 1个 | 364ms | 20%  
温哥华 | 6个 | 1个 | 207ms | 10% | 香港 | 7个 | 7个 | - | -  
均值 | 71个 | 16个 | 235ms | 6% |  |  |  |  |   
...
陕西电信到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 4个 | 0 | 190ms | 0 | 佛罗里达 | 3个 | 1个 | 266ms | 0  
凤凰城 | 3个 | 1个 | 187ms | 0 | 纽约 | 4个 | 0 | 307ms | 1%  
洛杉矶 | 14个 | 5个 | 213ms | 5% | 阿姆斯特丹 | 3个 | 1个 | 319ms | 13%  
温哥华 | 3个 | 1个 | 201ms | 0 | 香港 | 4个 | 4个 | - | -  
均值 | 38个 | 13个 | 239ms | 3% |  |  |  |  |   
...
陕西联通到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 3个 | 0 | 185ms | 0 | 佛罗里达 | 3个 | 0 | 245ms | 5%  
凤凰城 | 3个 | 0 | 193ms | 0 | 纽约 | 3个 | 0 | 243ms | 26%  
洛杉矶 | 12个 | 0 | 200ms | 3% | 阿姆斯特丹 | 3个 | 0 | 410ms | 28%  
温哥华 | 3个 | 0 | 214ms | 21% | 香港 | 3个 | 3个 | - | -  
均值 | 33个 | 3个 | 230ms | 9% |  |  |  |  |   
