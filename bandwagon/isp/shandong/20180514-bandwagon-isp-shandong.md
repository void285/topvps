#  山东到BandwagonHost各机房的测速数据（20180514） 
...
山东全部运营商到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 6个 | 0 | 63ms | 0 | 温哥华 | 6个 | 1个 | 264ms | 6%  
洛杉矶 | 24个 | 0 | 181ms | 0 | 佛罗里达 | 6个 | 1个 | 288ms | 0  
均值 | 66个 | 4个 | 207ms | 1% | 阿姆斯特丹 | 6个 | 1个 | 294ms | 6%  
佛利蒙 | 6个 | 1个 | 234ms | 3% | 纽约 | 6个 | 0 | 295ms | 0  
凤凰城 | 6个 | 0 | 257ms | 3% |  |  |  |  |   
  
简评：本表展示了山东的 **电信、联通、移动** 线路到BandwagonHost各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻山东，可从此表了解你常用的网络到BandwagonHost各个机房的平均响应速度以及丢包率。从表中数据可以看到， **香港、洛杉矶、佛利蒙** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

山东电信到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 45ms | - | 温哥华 | 2个 | 0 | 188ms | -  
洛杉矶 | 8个 | 0 | 167ms | - | 佛罗里达 | 2个 | 0 | 281ms | -  
均值 | 22个 | 0 | - | - | 阿姆斯特丹 | 2个 | 0 | 270ms | -  
佛利蒙 | 2个 | 0 | 192ms | - | 纽约 | 2个 | 0 | 334ms | -  
凤凰城 | 2个 | 0 | 246ms | - |  |  |  |  |   
...
山东联通到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 3个 | 0 | 40ms | 0 | 温哥华 | 3个 | 1个 | 265ms | 6%  
洛杉矶 | 12个 | 0 | 177ms | 0 | 佛罗里达 | 3个 | 0 | 296ms | 0  
均值 | 33个 | 3个 | 207ms | 1% | 阿姆斯特丹 | 3个 | 1个 | 326ms | 6%  
佛利蒙 | 3个 | 1个 | 253ms | 3% | 纽约 | 3个 | 0 | 284ms | 0  
凤凰城 | 3个 | 0 | 238ms | 3% |  |  |  |  |   
  
简评：如果你是来自山东的 **联通** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **香港、洛杉矶、凤凰城** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_4)吧！

### 移动

山东移动到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 106ms | - | 温哥华 | 1个 | 0 | 340ms | -  
洛杉矶 | 4个 | 0 | 200ms | - | 佛罗里达 | 1个 | 1个 | - | -  
均值 | 11个 | 1个 | - | - | 阿姆斯特丹 | 1个 | 0 | 287ms | -  
佛利蒙 | 1个 | 0 | 259ms | - | 纽约 | 1个 | 0 | 268ms | -  
凤凰城 | 1个 | 0 | 288ms | - |  |  |  |  |   
