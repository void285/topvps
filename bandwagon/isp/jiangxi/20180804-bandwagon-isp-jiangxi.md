#  江西到BandwagonHost各机房的测速数据（20180804） 
...
江西电信到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 6个 | 0 | 51ms | 0 | 凤凰城 | 7个 | 0 | 283ms | 10%  
佛利蒙 | 6个 | 0 | 169ms | 0 | 阿姆斯特丹 | 6个 | 0 | 305ms | 0  
温哥华 | 7个 | 0 | 186ms | 0 | 佛罗里达 | 6个 | 0 | 371ms | 10%  
均值 | 70个 | 0 | 241ms | 10% | 纽约 | 7个 | 0 | 373ms | 20%  
洛杉矶 | 25个 | 0 | 251ms | 20% |  |  |  |  |   
