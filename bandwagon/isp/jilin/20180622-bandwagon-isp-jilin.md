#  吉林到BandwagonHost各机房的测速数据（20180622） 
...
吉林全部运营商到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 61ms | 0 | 均值 | 22个 | 0 | 223ms | 4%  
佛利蒙 | 2个 | 0 | 191ms | 0 | 佛罗里达 | 2个 | 0 | 271ms | 15%  
洛杉矶 | 8个 | 0 | 202ms | 0 | 纽约 | 2个 | 0 | 289ms | 6%  
温哥华 | 2个 | 0 | 207ms | 1% | 阿姆斯特丹 | 2个 | 0 | 414ms | 28%  
凤凰城 | 2个 | 0 | 214ms | 0 |  |  |  |  |   
...
吉林电信到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 61ms | 0 | 均值 | 11个 | 0 | 237ms | 8%  
佛利蒙 | 1个 | 0 | 195ms | 0 | 佛罗里达 | 1个 | 0 | 297ms | 20%  
洛杉矶 | 4个 | 0 | 212ms | 0 | 纽约 | 1个 | 0 | 301ms | 13%  
温哥华 | 1个 | 0 | 198ms | 0 | 阿姆斯特丹 | 1个 | 0 | 513ms | 56%  
凤凰城 | 1个 | 0 | 196ms | 0 |  |  |  |  |   
...
吉林联通到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 61ms | 0 | 均值 | 11个 | 0 | 209ms | 1%  
佛利蒙 | 1个 | 0 | 187ms | 0 | 佛罗里达 | 1个 | 0 | 246ms | 10%  
洛杉矶 | 4个 | 0 | 191ms | 0 | 纽约 | 1个 | 0 | 277ms | 0  
温哥华 | 1个 | 0 | 216ms | 3% | 阿姆斯特丹 | 1个 | 0 | 315ms | 0  
凤凰城 | 1个 | 0 | 232ms | 0 |  |  |  |  |   
