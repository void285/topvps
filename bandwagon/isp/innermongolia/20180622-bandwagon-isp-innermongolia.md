#  内蒙古到BandwagonHost各机房的测速数据（20180622） 
...
内蒙古全部运营商到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 4个 | 0 | 68ms | 0 | 温哥华 | 4个 | 0 | 228ms | 0  
洛杉矶 | 16个 | 0 | 200ms | 1% | 纽约 | 4个 | 0 | 271ms | 5%  
佛利蒙 | 4个 | 0 | 202ms | 0 | 佛罗里达 | 4个 | 0 | 272ms | 4%  
凤凰城 | 4个 | 2个 | 202ms | 0 | 阿姆斯特丹 | 4个 | 0 | 299ms | 0  
均值 | 44个 | 2个 | 214ms | 1% |  |  |  |  |   
...
内蒙古电信到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 85ms | 0 | 温哥华 | 2个 | 0 | 234ms | 0  
洛杉矶 | 8个 | 0 | 230ms | 0 | 纽约 | 2个 | 0 | 296ms | 10%  
佛利蒙 | 2个 | 0 | 219ms | 0 | 佛罗里达 | 2个 | 0 | 320ms | 5%  
凤凰城 | 2个 | 2个 | - | - | 阿姆斯特丹 | 2个 | 0 | 296ms | 0  
均值 | 22个 | 2个 | 237ms | 1% |  |  |  |  |   
...
内蒙古联通到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 52ms | 0 | 温哥华 | 2个 | 0 | 221ms | 1%  
洛杉矶 | 8个 | 0 | 170ms | 2% | 纽约 | 2个 | 0 | 247ms | 0  
佛利蒙 | 2个 | 0 | 184ms | 0 | 佛罗里达 | 2个 | 0 | 224ms | 3%  
凤凰城 | 2个 | 0 | 202ms | 0 | 阿姆斯特丹 | 2个 | 0 | 302ms | 0  
均值 | 22个 | 0 | 192ms | 1% |  |  |  |  |   
