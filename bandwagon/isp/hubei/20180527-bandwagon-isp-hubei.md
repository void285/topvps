...
![湖北到BandwagonHost各机房的测速数据（20180527）](/images/thumbnails/Hubei_to_bandwagon.png)
...
![大陆省份湖北到VPS提供商BandwagonHost各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180527](/images/pingtests/bwg_20180527/plot_isp_hubei_bwg_20180527.png)

### 电信

湖北电信到BandwagonHost各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
洛杉矶 | 24个 | 0 | 200ms | 5% | 纽约 | 7个 | 0 | 283ms | 1%  
温哥华 | 6个 | 0 | 233ms | 3% | 佛罗里达 | 5个 | 1个 | 285ms | 6%  
凤凰城 | 6个 | 0 | 233ms | 0 | 阿姆斯特丹 | 5个 | 0 | 326ms | 10%  
佛利蒙 | 6个 | 1个 | 235ms | 3% | 香港 | 5个 | 5个 | - | -  
均值 | 64个 | 7个 | 260ms | 4% |  |  |  |  |   
  
简评：如果你是来自湖北的 **电信** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **洛杉矶、温哥华、凤凰城、佛利蒙** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_1)吧！
...
本文最初发表于[湖北到BandwagonHost各机房的测速数据（20180527）](https://vps123.top/pingtest/20180527-bandwagon-isp-hubei.html)
