...
湖北电信到BandwagonHost各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 8个 | 0 | 26ms | 0 | 凤凰城 | 8个 | 1个 | 296ms | 18%  
洛杉矶 | 31个 | 0 | 203ms | 3% | 佛罗里达 | 8个 | 0 | 316ms | 3%  
温哥华 | 8个 | 0 | 219ms | 0 | 纽约 | 8个 | 1个 | 379ms | 27%  
佛利蒙 | 8个 | 0 | 238ms | 6% | 阿姆斯特丹 | 7个 | 0 | 407ms | 44%  
均值 | 86个 | 2个 | 258ms | 10% |  |  |  |  |   
