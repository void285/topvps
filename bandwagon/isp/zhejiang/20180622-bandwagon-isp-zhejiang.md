#  浙江到BandwagonHost各机房的测速数据（20180622） 
...
浙江全部运营商到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 25个 | 1个 | 45ms | 0 | 温哥华 | 26个 | 1个 | 207ms | 0  
洛杉矶 | 103个 | 1个 | 178ms | 0 | 纽约 | 26个 | 2个 | 264ms | 2%  
凤凰城 | 27个 | 2个 | 200ms | 0 | 佛罗里达 | 26个 | 2个 | 276ms | 3%  
佛利蒙 | 26个 | 1个 | 201ms | 0 | 阿姆斯特丹 | 26个 | 2个 | 299ms | 10%  
均值 | 285个 | 12个 | 201ms | 1% |  |  |  |  |   
...
浙江电信到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 16个 | 0 | 34ms | 0 | 温哥华 | 17个 | 0 | 184ms | 0  
洛杉矶 | 67个 | 1个 | 162ms | 0 | 纽约 | 17个 | 1个 | 267ms | 8%  
凤凰城 | 18个 | 1个 | 196ms | 0 | 佛罗里达 | 17个 | 1个 | 294ms | 9%  
佛利蒙 | 17个 | 0 | 193ms | 0 | 阿姆斯特丹 | 17个 | 1个 | 277ms | 29%  
均值 | 186个 | 5个 | 188ms | 4% |  |  |  |  |   
...
浙江联通到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 6个 | 0 | 37ms | 0 | 温哥华 | 6个 | 0 | 208ms | 0  
洛杉矶 | 24个 | 0 | 194ms | 0 | 纽约 | 6个 | 0 | 264ms | 0  
凤凰城 | 6个 | 0 | 191ms | 0 | 佛罗里达 | 6个 | 0 | 268ms | 0  
佛利蒙 | 6个 | 0 | 189ms | 0 | 阿姆斯特丹 | 6个 | 0 | 321ms | 2%  
均值 | 66个 | 0 | 213ms | 0 |  |  |  |  |   
...
浙江移动到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 3个 | 1个 | 65ms | 0 | 温哥华 | 3个 | 1个 | 231ms | 0  
洛杉矶 | 12个 | 0 | 180ms | 0 | 纽约 | 3个 | 1个 | 261ms | 0  
凤凰城 | 3个 | 1个 | 213ms | 0 | 佛罗里达 | 3个 | 1个 | 268ms | 0  
佛利蒙 | 3个 | 1个 | 223ms | 0 | 阿姆斯特丹 | 3个 | 1个 | 298ms | 0  
均值 | 33个 | 7个 | 203ms | 0 |  |  |  |  |   
