#  浙江到BandwagonHost各机房的测速数据（20180804） 
...
浙江全部运营商到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 48个 | 6个 | 82ms | 0 | 洛杉矶 | 192个 | 13个 | 257ms | 3%  
佛利蒙 | 48个 | 6个 | 184ms | 0 | 佛罗里达 | 48个 | 6个 | 291ms | 11%  
凤凰城 | 58个 | 7个 | 203ms | 3% | 纽约 | 58个 | 13个 | 296ms | 6%  
温哥华 | 58个 | 7个 | 254ms | 10% | 阿姆斯特丹 | 48个 | 8个 | 401ms | 13%  
均值 | 558个 | 66个 | 255ms | 4% |  |  |  |  |   
...
浙江电信到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 28个 | 2个 | 43ms | 0 | 洛杉矶 | 114个 | 13个 | 233ms | 10%  
佛利蒙 | 28个 | 2个 | 177ms | 0 | 佛罗里达 | 28个 | 2个 | 320ms | 20%  
凤凰城 | 36个 | 3个 | 206ms | 6% | 纽约 | 36个 | 9个 | 387ms | 13%  
温哥华 | 36个 | 3个 | 193ms | 0 | 阿姆斯特丹 | 28个 | 2个 | 310ms | 6%  
均值 | 334个 | 36个 | 240ms | 7% |  |  |  |  |   
...
浙江联通到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 14个 | 0 | 138ms | 0 | 洛杉矶 | 53个 | 0 | 300ms | 0  
佛利蒙 | 14个 | 0 | 190ms | 0 | 佛罗里达 | 14个 | 0 | 286ms | 3%  
凤凰城 | 15个 | 0 | 204ms | 0 | 纽约 | 15个 | 0 | 252ms | 0  
温哥华 | 15个 | 0 | 307ms | 20% | 阿姆斯特丹 | 14个 | 0 | 493ms | 20%  
均值 | 154个 | 0 | 278ms | 4% |  |  |  |  |   
...
浙江移动到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 6个 | 4个 | 64ms | - | 洛杉矶 | 25个 | 0 | 237ms | 0  
佛利蒙 | 6个 | 4个 | 187ms | - | 佛罗里达 | 6个 | 4个 | 268ms | -  
凤凰城 | 7个 | 4个 | 200ms | - | 纽约 | 7个 | 4个 | 251ms | -  
温哥华 | 7个 | 4个 | 261ms | - | 阿姆斯特丹 | 6个 | 6个 | - | -  
均值 | 70个 | 30个 | 249ms | 0 |  |  |  |  |   
