#  天津到BandwagonHost各机房的测速数据（20180918） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![天津到BandwagonHost各机房的测速数据（20180918）](/images/thumbnails/Tianjin_to_bandwagon.png)
...
本文提供20180918天津到BandwagonHost各机房的PING测试结果，测速点的运营商线路为联通，有效样本点11个，其中超时点1个。连通概况如下：大陆线路响应均值为215毫秒，最快的三个机房所在地为香港、洛杉矶、佛利蒙，最慢的三个为温哥华、阿姆斯特丹、佛罗里达；佛罗里达有响应超时情况；温哥华、纽约、阿姆斯特丹丢包率较高。

[注册 BandwagonHost](https://vps123.top/go/bwg/_btn1)

## 天津图表数据

![大陆省份天津到VPS提供商BandwagonHost各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180918](/images/pingtests/bwg_20180918/plot_isp_tianjin_bwg_20180918.png)

### 联通

天津联通到BandwagonHost各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 21ms | 0 | 纽约 | 1个 | 0 | 264ms | 10%  
洛杉矶 | 4个 | 0 | 191ms | 0 | 温哥华 | 1个 | 0 | 273ms | 30%  
佛利蒙 | 1个 | 0 | 203ms | 0 | 阿姆斯特丹 | 1个 | 0 | 371ms | 10%  
均值 | 11个 | 1个 | 215ms | 5% | 佛罗里达 | 1个 | 1个 | - | -  
凤凰城 | 1个 | 0 | 255ms | 0 |  |  |  |  |   
  
简评：如果你是来自天津的 **联通** 用户，想运行BandwagonHost的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **香港、洛杉矶、佛利蒙** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_1)吧！
...
本文最初发表于[天津到BandwagonHost各机房的测速数据（20180918）](https://vps123.top/pingtest/20180918-bandwagon-isp-tianjin.html)
