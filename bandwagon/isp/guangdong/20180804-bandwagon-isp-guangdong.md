...
广东全部运营商到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 38个 | 4个 | 73ms | 0 | 洛杉矶 | 155个 | 0 | 227ms | 0  
佛利蒙 | 38个 | 0 | 191ms | 0 | 佛罗里达 | 38个 | 0 | 277ms | 0  
凤凰城 | 37个 | 0 | 198ms | 0 | 纽约 | 37个 | 0 | 298ms | 7%  
均值 | 430个 | 8个 | 214ms | 1% | 阿姆斯特丹 | 38个 | 4个 | 396ms | 7%  
温哥华 | 49个 | 0 | 223ms | 5% |  |  |  |  |   
...
广东电信到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 30个 | 4个 | 24ms | 0 | 洛杉矶 | 122个 | 0 | 193ms | 0  
佛利蒙 | 30个 | 0 | 183ms | 0 | 佛罗里达 | 30个 | 0 | 286ms | 0  
凤凰城 | 28个 | 0 | 194ms | 0 | 纽约 | 28个 | 0 | 335ms | 7%  
均值 | 335个 | 8个 | 214ms | 1% | 阿姆斯特丹 | 30个 | 4个 | 325ms | 7%  
温哥华 | 37个 | 0 | 213ms | 5% |  |  |  |  |   
...
广东联通到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 4个 | 0 | 116ms | - | 洛杉矶 | 18个 | 0 | 277ms | -  
佛利蒙 | 4个 | 0 | 219ms | - | 佛罗里达 | 4个 | 0 | 305ms | -  
凤凰城 | 6个 | 0 | 215ms | - | 纽约 | 6个 | 0 | 301ms | -  
均值 | 52个 | 0 | - | - | 阿姆斯特丹 | 4个 | 0 | 580ms | -  
温哥华 | 6个 | 0 | 205ms | - |  |  |  |  |   
...
广东移动到BandwagonHost各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 4个 | 0 | 79ms | - | 洛杉矶 | 15个 | 0 | 212ms | -  
佛利蒙 | 4个 | 0 | 170ms | - | 佛罗里达 | 4个 | 0 | 240ms | -  
凤凰城 | 3个 | 0 | 186ms | - | 纽约 | 3个 | 0 | 258ms | -  
均值 | 43个 | 0 | - | - | 阿姆斯特丹 | 4个 | 0 | 282ms | -  
温哥华 | 6个 | 0 | 253ms | - |  |  |  |  |   
