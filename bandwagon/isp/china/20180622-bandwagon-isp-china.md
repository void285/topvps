#  大陆到BandwagonHost各机房的测速数据（20180622） 
...
大陆全部运营商到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 197个 | 9个 | 43ms | 0 | 温哥华 | 198个 | 12个 | 202ms | 0  
洛杉矶 | 800个 | 20个 | 186ms | 0 | 纽约 | 200个 | 9个 | 260ms | 5%  
佛利蒙 | 200个 | 6个 | 187ms | 0 | 佛罗里达 | 199个 | 11个 | 262ms | 4%  
凤凰城 | 200个 | 11个 | 191ms | 0 | 阿姆斯特丹 | 200个 | 10个 | 306ms | 16%  
...
大陆电信到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 129个 | 6个 | 36ms | 0 | 温哥华 | 134个 | 6个 | 196ms | 0  
洛杉矶 | 534个 | 16个 | 173ms | 0 | 纽约 | 135个 | 7个 | 279ms | 8%  
佛利蒙 | 134个 | 2个 | 185ms | 0 | 佛罗里达 | 133个 | 8个 | 280ms | 6%  
凤凰城 | 135个 | 8个 | 188ms | 0 | 阿姆斯特丹 | 133个 | 5个 | 281ms | 21%  
...
大陆联通到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 51个 | 2个 | 42ms | 0 | 温哥华 | 49个 | 4个 | 217ms | 1%  
洛杉矶 | 198个 | 4个 | 207ms | 0 | 纽约 | 49个 | 1个 | 281ms | 0  
佛利蒙 | 49个 | 2个 | 199ms | 0 | 佛罗里达 | 50个 | 2个 | 242ms | 1%  
凤凰城 | 49个 | 2个 | 210ms | 0 | 阿姆斯特丹 | 50个 | 4个 | 352ms | 5%  
均值 | 545个 | 21个 | 211ms | 1% |  |  |  |  |   
  
简评：如果你关注联通的网络到BandwagonHost各机房的连通性，此表数据提供了一个不错的概览， **香港、佛利蒙、洛杉矶、凤凰城、温哥华、佛罗里达** 的整体的连通速度、丢包率都比较不错，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_2)吧！

### 移动

大陆移动到BandwagonHost各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 17个 | 1个 | 81ms | 1% | 温哥华 | 15个 | 2个 | 237ms | 0  
洛杉矶 | 68个 | 0 | 194ms | 1% | 纽约 | 16个 | 1个 | 260ms | 0  
佛利蒙 | 17个 | 2个 | 215ms | 0 | 佛罗里达 | 16个 | 1个 | 264ms | 0  
凤凰城 | 16个 | 1个 | 214ms | 0 | 阿姆斯特丹 | 17个 | 1个 | 294ms | 6%  
均值 | 182个 | 9个 | 217ms | 1% |  |  |  |  |   
