#  大陆到BandwagonHost各机房的测速数据（20180527） 
...
**大陆全部运营商到BandwagonHost各机房的测速数据 [20180527]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
佛利蒙 | 170个 | 2个 | 191ms | 1%  
洛杉矶 | 690个 | 17个 | 195ms | 3%  
凤凰城 | 167个 | 5个 | 195ms | 1%  
温哥华 | 175个 | 7个 | 221ms | 10%  
均值 | 1884个 | 219个 | 223ms | 5%  
佛罗里达 | 168个 | 6个 | 255ms | 4%  
纽约 | 177个 | 4个 | 267ms | 8%  
阿姆斯特丹 | 168个 | 9个 | 322ms | 9%  
香港 | 169个 | 169个 | - | -  
...
在这里， **佛利蒙、洛杉矶、凤凰城** 的响应速度小于250ms，且丢包率在5%以内，值得关注。如果你主要关心某运营商的网络概况，后面几个表格的数据更有参考价值。  
如果你打算将VPS用作科学上网、云存储、远程任务、游戏服务器等用途，请 **关注你所在的省份** 到BandwagonHost各机房的测速数据，它们可以给你更有益的参考。

### 电信

**大陆电信到BandwagonHost各机房的测速数据 [20180527]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
佛利蒙 | 99个 | 2个 | 183ms | 1%  
洛杉矶 | 410个 | 12个 | 181ms | 3%  
凤凰城 | 96个 | 4个 | 186ms | 1%  
温哥华 | 104个 | 2个 | 199ms | 1%  
均值 | 1111个 | 131个 | 213ms | 2%  
佛罗里达 | 98个 | 5个 | 250ms | 1%  
纽约 | 106个 | 4个 | 282ms | 3%  
阿姆斯特丹 | 98个 | 2个 | 279ms | 5%  
香港 | 100个 | 100个 | - | -  
  
**简评：** 如果你关注电信的网络到BandwagonHost各机房的连通性，此表数据提供了一个不错的概览， **洛杉矶、佛利蒙、凤凰城、温哥华、佛罗里达** 的整体的连通速度、丢包率都比较不错，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_1)吧！

### 联通

**大陆联通到BandwagonHost各机房的测速数据 [20180527]**
...
佛罗里达 | 56个 | 1个 | 247ms | 2%  
纽约 | 56个 | 0 | 248ms | 18%  
阿姆斯特丹 | 56个 | 7个 | 365ms | 15%  
香港 | 55个 | 55个 | - | -  
  
**简评：** 如果你关注联通的网络到BandwagonHost各机房的连通性，此表数据提供了一个不错的概览， **佛利蒙、凤凰城、洛杉矶、佛罗里达** 的整体的连通速度、丢包率都比较不错， **温哥华、纽约** 也值得关注，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_2)吧！

### 移动

**大陆移动到BandwagonHost各机房的测速数据 [20180527]**
...
佛罗里达 | 14个 | 0 | 300ms | 27%  
纽约 | 15个 | 0 | 265ms | 0  
阿姆斯特丹 | 14个 | 0 | 333ms | 16%  
香港 | 14个 | 14个 | - | -  
  
**简评：** 如果你关注移动的网络到BandwagonHost各机房的连通性，此表数据提供了一个不错的概览， **凤凰城、佛利蒙** 的整体的连通速度、丢包率都比较不错， **洛杉矶、温哥华** 也值得关注，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/bwg/_3)吧！
