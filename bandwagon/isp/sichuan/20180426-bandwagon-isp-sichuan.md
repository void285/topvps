#  四川到BandwagonHost各机房的测速数据（20180426） 
...
四川全部运营商到BandwagonHost各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 2个 | 0 | 42ms | 0 | 温哥华 | 2个 | 0 | 231ms | 0  
洛杉矶 | 8个 | 0 | 200ms | 5% | 佛罗里达 | 2个 | 0 | 255ms | 0  
凤凰城 | 2个 | 0 | 201ms | 0 | 纽约 | 2个 | 0 | 256ms | 3%  
佛利蒙 | 2个 | 0 | 212ms | 0 | 阿姆斯特丹 | 2个 | 0 | 344ms | 1%  
均值 | 22个 | 0 | 213ms | 2% |  |  |  |  |   
...
四川电信到BandwagonHost各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 37ms | 0 | 温哥华 | 1个 | 0 | 226ms | 0  
洛杉矶 | 4个 | 0 | 186ms | 2% | 佛罗里达 | 1个 | 0 | 258ms | 0  
凤凰城 | 1个 | 0 | 190ms | 0 | 纽约 | 1个 | 0 | 256ms | 0  
佛利蒙 | 1个 | 0 | 205ms | 0 | 阿姆斯特丹 | 1个 | 0 | 269ms | 0  
均值 | 11个 | 0 | 198ms | 0 |  |  |  |  |   
...
四川联通到BandwagonHost各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
香港 | 1个 | 0 | 48ms | 0 | 温哥华 | 1个 | 0 | 236ms | 0  
洛杉矶 | 4个 | 0 | 214ms | 7% | 佛罗里达 | 1个 | 0 | 253ms | 0  
凤凰城 | 1个 | 0 | 212ms | 0 | 纽约 | 1个 | 0 | 257ms | 6%  
佛利蒙 | 1个 | 0 | 219ms | 0 | 阿姆斯特丹 | 1个 | 0 | 419ms | 3%  
均值 | 11个 | 0 | 227ms | 3% |  |  |  |  |   
