...
大陆各省份到Vultr德国-法兰克福机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 8个 | 1个 | 245ms | 0 | 江西 | 23个 | 2个 | 279ms | 2.9%  
青海 | 4个 | 0 | 246ms | 2.3% | 均值 | 962个 | 34个 | 280ms | 3.5%  
天津 | 5个 | 0 | 250ms | 0.2% | 福建 | 32个 | 1个 | 281ms | 2.1%  
河北 | 35个 | 0 | 256ms | 14.2% | 甘肃 | 22个 | 0 | 282ms | 1.6%  
海南 | 14个 | 0 | 257ms | 1.6% | 四川 | 45个 | 2个 | 283ms | 2.3%  
上海 | 7个 | 0 | 262ms | 0 | 湖南 | 45个 | 1个 | 283ms | 5.7%  
广西 | 40个 | 1个 | 264ms | 2.9% | 浙江 | 49个 | 3个 | 284ms | 2.0%  
内蒙古 | 33个 | 0 | 265ms | 1.9% | 江苏 | 62个 | 9个 | 288ms | 1.6%  
广东 | 81个 | 5个 | 266ms | 1.7% | 河南 | 57个 | 2个 | 290ms | 4.4%  
重庆 | 15个 | 1个 | 267ms | 4.1% | 贵州 | 25个 | 0 | 291ms | 5.4%  
安徽 | 38个 | 1个 | 268ms | 1.5% | 陕西 | 31个 | 0 | 291ms | 2.0%  
辽宁 | 40个 | 1个 | 268ms | 12.3% | 山东 | 52个 | 1个 | 302ms | 2.2%  
湖北 | 45个 | 3个 | 270ms | 2.6% | 新疆 | 27个 | 0 | 312ms | 5.5%  
云南 | 19个 | 0 | 272ms | 0.9% | 黑龙江 | 39个 | 0 | 315ms | 3.6%  
宁夏 | 13个 | 0 | 273ms | 2.1% | 吉林 | 18个 | 0 | 326ms | 1.9%  
山西 | 38个 | 0 | 273ms | 1.9% |  |  |  |  |   
...
海外线路到Vultr德国-法兰克福机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 1个 | 0 | 9ms | 0 | 巴西 | 1个 | 0 | 210ms | 0  
荷兰 | 1个 | 0 | 13ms | 0 | 马来西亚 | 5个 | 0 | 217ms | 0.2%  
德国 | 3个 | 0 | 14ms | 0 | 香港 | 18个 | 0 | 220ms | 0  
意大利 | 1个 | 0 | 14ms | - | 菲律宾 | 1个 | 0 | 248ms | 0  
英国 | 1个 | 0 | 51ms | 0 | 日本 | 2个 | 0 | 262ms | 1.5%  
俄罗斯 | 1个 | 0 | 83ms | 0 | 越南 | 2个 | 0 | 267ms | 0  
加拿大 | 4个 | 0 | 107ms | 0 | 韩国 | 12个 | 0 | 299ms | 0  
美国 | 21个 | 0 | 156ms | 3.0% | 台湾 | 1个 | 0 | 300ms | -  
新加坡 | 5个 | 0 | 176ms | 0 | 印度尼西亚 | 1个 | 0 | 316ms | 0  
均值 | 85个 | 0 | 185ms | 0.6% | 澳大利亚 | 1个 | 0 | 350ms | 0  
南非 | 2个 | 0 | 193ms | 2.0% | 柬埔寨 | 1个 | 0 | 392ms | 4.0%  
