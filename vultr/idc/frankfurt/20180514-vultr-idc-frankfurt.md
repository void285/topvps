...
大陆各省份到Vultr德国-法兰克福机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
甘肃 | 14个 | 0 | 239ms | 0.6% | 河南 | 50个 | 0 | 286ms | 3.4%  
天津 | 4个 | 0 | 240ms | 9.0% | 河北 | 31个 | 0 | 290ms | 4.4%  
安徽 | 32个 | 0 | 256ms | 1.8% | 均值 | 868个 | 9个 | 293ms | 4.7%  
青海 | 3个 | 0 | 261ms | 0 | 辽宁 | 31个 | 0 | 296ms | 8.8%  
宁夏 | 12个 | 0 | 261ms | 0.3% | 福建 | 33个 | 1个 | 298ms | 5.3%  
内蒙古 | 30个 | 0 | 272ms | 3.1% | 四川 | 44个 | 0 | 299ms | 4.1%  
重庆 | 15个 | 1个 | 275ms | 0.4% | 浙江 | 51个 | 3个 | 304ms | 8.8%  
海南 | 11个 | 0 | 275ms | 3.8% | 江苏 | 60个 | 1个 | 306ms | 11.6%  
北京 | 6个 | 0 | 276ms | 1.7% | 山西 | 31个 | 0 | 306ms | 7.4%  
广东 | 75个 | 2个 | 279ms | 2.5% | 贵州 | 26个 | 0 | 309ms | 5.2%  
湖北 | 42个 | 0 | 280ms | 3.4% | 陕西 | 26个 | 0 | 310ms | 4.2%  
上海 | 7个 | 0 | 282ms | 1.4% | 新疆 | 22个 | 0 | 320ms | 4.8%  
江西 | 17个 | 0 | 283ms | 7.0% | 山东 | 50个 | 1个 | 323ms | 5.5%  
广西 | 31个 | 0 | 283ms | 4.1% | 黑龙江 | 35个 | 0 | 329ms | 5.9%  
湖南 | 42个 | 0 | 284ms | 3.3% | 吉林 | 17个 | 0 | 329ms | 2.1%  
云南 | 19个 | 0 | 285ms | 1.5% | 西藏 | 1个 | 0 | 371ms | 0  
...
海外线路到Vultr德国-法兰克福机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 2个 | 0 | 11ms | 0 | 南非 | 1个 | 0 | 222ms | 0  
德国 | 1个 | 0 | 27ms | 0 | 香港 | 18个 | 0 | 226ms | 0  
英国 | 2个 | 0 | 33ms | 0 | 菲律宾 | 1个 | 0 | 247ms | 0  
俄罗斯 | 1个 | 0 | 91ms | 0 | 日本 | 2个 | 0 | 266ms | 2.0%  
加拿大 | 3个 | 0 | 111ms | 0 | 印度尼西亚 | 1个 | 0 | 275ms | 2.0%  
美国 | 18个 | 0 | 153ms | 0 | 台湾 | 1个 | 0 | 282ms | -  
新加坡 | 6个 | 0 | 177ms | 0 | 韩国 | 13个 | 0 | 286ms | 0  
均值 | 75个 | 0 | 199ms | 2.3% | 澳大利亚 | 1个 | 0 | 307ms | 0  
马来西亚 | 3个 | 0 | 218ms | 1.0% | 柬埔寨 | 1个 | 0 | 457ms | 32.0%  
