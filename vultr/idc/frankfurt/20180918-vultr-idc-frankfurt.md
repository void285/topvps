...
大陆各省份到Vultr德国-法兰克福机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 9个 | 0 | 226ms | 0.1% | 均值 | 1408个 | 9个 | 273ms | 4.6%  
宁夏 | 7个 | 0 | 227ms | 0 | 广西 | 60个 | 0 | 275ms | 7.7%  
江苏 | 92个 | 4个 | 230ms | 2.2% | 天津 | 7个 | 0 | 283ms | 2.2%  
河北 | 58个 | 0 | 233ms | 1.9% | 湖南 | 71个 | 0 | 283ms | 7.7%  
辽宁 | 57个 | 0 | 236ms | 2.0% | 新疆 | 32个 | 0 | 287ms | 3.9%  
浙江 | 65个 | 2个 | 237ms | 2.1% | 湖北 | 53个 | 0 | 291ms | 11.4%  
青海 | 5个 | 0 | 241ms | 0 | 海南 | 13个 | 0 | 303ms | 4.2%  
甘肃 | 32个 | 0 | 246ms | 1.6% | 山东 | 92个 | 0 | 305ms | 3.7%  
江西 | 39个 | 0 | 247ms | 0.6% | 吉林 | 19个 | 0 | 307ms | 0.9%  
安徽 | 67个 | 0 | 250ms | 0.9% | 重庆 | 8个 | 0 | 310ms | 9.8%  
陕西 | 44个 | 0 | 260ms | 3.9% | 山西 | 58个 | 1个 | 310ms | 5.0%  
广东 | 126个 | 2个 | 262ms | 6.9% | 黑龙江 | 53个 | 0 | 311ms | 3.9%  
上海 | 8个 | 0 | 263ms | 0 | 云南 | 33个 | 0 | 311ms | 11.2%  
内蒙古 | 54个 | 0 | 267ms | 2.7% | 贵州 | 43个 | 0 | 313ms | 7.8%  
河南 | 85个 | 0 | 269ms | 3.3% | 四川 | 76个 | 0 | 314ms | 10.4%  
福建 | 41个 | 0 | 269ms | 3.2% | 西藏 | 1个 | 0 | 409ms | 14.0%  
...
海外线路到Vultr德国-法兰克福机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 1个 | 0 | 15ms | - | 台湾 | 2个 | 0 | 213ms | 0  
德国 | 3个 | 0 | 25ms | 0 | 越南 | 2个 | 0 | 217ms | 0  
荷兰 | 1个 | 0 | 90ms | 0 | 马来西亚 | 6个 | 0 | 229ms | 0  
加拿大 | 3个 | 0 | 103ms | 0 | 菲律宾 | 1个 | 0 | 250ms | 1.0%  
美国 | 16个 | 0 | 149ms | 0 | 韩国 | 12个 | 0 | 256ms | 0  
香港 | 20个 | 0 | 180ms | 0 | 日本 | 3个 | 0 | 264ms | 1.8%  
新加坡 | 5个 | 0 | 198ms | 0 | 澳大利亚 | 2个 | 0 | 332ms | 3.3%  
均值 | 80个 | 0 | 201ms | 1.0% | 印度尼西亚 | 1个 | 0 | 489ms | 0  
赞比亚 | 2个 | 0 | 211ms | 9.0% |  |  |  |  |   
