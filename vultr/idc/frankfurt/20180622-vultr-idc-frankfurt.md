...
大陆各省份到Vultr德国-法兰克福机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 3个 | 0 | 226ms | 0 | 河南 | 51个 | 2个 | 270ms | 0.2%  
内蒙古 | 32个 | 0 | 242ms | 1.7% | 山西 | 37个 | 3个 | 270ms | 0  
甘肃 | 21个 | 0 | 244ms | 0 | 江苏 | 70个 | 14个 | 272ms | 0.7%  
宁夏 | 13个 | 0 | 245ms | 0 | 浙江 | 52个 | 10个 | 273ms | 2.5%  
青海 | 3个 | 0 | 248ms | 0 | 湖南 | 39个 | 3个 | 273ms | 0.9%  
北京 | 10个 | 1个 | 248ms | 0.4% | 福建 | 32个 | 5个 | 276ms | 1.1%  
广西 | 44个 | 2个 | 249ms | 1.2% | 四川 | 40个 | 3个 | 277ms | 0.6%  
广东 | 80个 | 13个 | 256ms | 0.1% | 贵州 | 25个 | 1个 | 278ms | 0.3%  
安徽 | 36个 | 3个 | 256ms | 2.1% | 河北 | 28个 | 0 | 281ms | 18.7%  
湖北 | 36个 | 3个 | 258ms | 0.1% | 黑龙江 | 32个 | 0 | 283ms | 0.1%  
陕西 | 32个 | 2个 | 261ms | 0.1% | 辽宁 | 29个 | 4个 | 286ms | 14.5%  
海南 | 12个 | 0 | 261ms | 0 | 新疆 | 27个 | 1个 | 288ms | 2.3%  
云南 | 14个 | 0 | 262ms | 0 | 吉林 | 19个 | 0 | 295ms | 0.2%  
上海 | 7个 | 1个 | 264ms | 0 | 山东 | 45个 | 3个 | 300ms | 0.3%  
重庆 | 12个 | 2个 | 265ms | 0 | 西藏 | 1个 | 0 | 328ms | 58.0%  
江西 | 23个 | 1个 | 267ms | 0.3% | 香港 | 20个 | 2个 | - | -  
...
海外线路到Vultr德国-法兰克福机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 1个 | 0 | 0 | 0 | 英国 | 2个 | 0 | 182ms | 0  
巴西 | 1个 | 0 | 15ms | 0 | 香港 | 20个 | 2个 | 223ms | 0  
德国 | 1个 | 0 | 17ms | - | 菲律宾 | 1个 | 0 | 247ms | 0  
意大利 | 1个 | 0 | 19ms | - | 印度尼西亚 | 1个 | 0 | 248ms | 0  
加拿大 | 2个 | 0 | 114ms | 0 | 越南 | 2个 | 0 | 266ms | 0.5%  
美国 | 20个 | 1个 | 142ms | 0 | 韩国 | 12个 | 0 | 266ms | 0  
新加坡 | 5个 | 0 | 169ms | 0 | 日本 | 2个 | 0 | 277ms | 2.0%  
均值 | 76个 | 3个 | 174ms | 0.6% | 台湾 | 2个 | 0 | 300ms | 0  
南非 | 2个 | 0 | 179ms | 0 | 澳大利亚 | 1个 | 0 | 308ms | 6.0%  
