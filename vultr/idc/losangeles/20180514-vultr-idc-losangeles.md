...
大陆各省份到Vultr美国-洛杉矶机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 7个 | 0 | 174ms | 7.9% | 陕西 | 33个 | 0 | 223ms | 11.8%  
天津 | 5个 | 0 | 190ms | 5.6% | 安徽 | 37个 | 0 | 229ms | 11.1%  
辽宁 | 40个 | 0 | 205ms | 10.0% | 甘肃 | 20个 | 0 | 233ms | 14.5%  
河北 | 30个 | 0 | 206ms | 9.6% | 均值 | 966个 | 19个 | 235ms | 12.8%  
宁夏 | 10个 | 0 | 206ms | 11.3% | 江西 | 23个 | 0 | 249ms | 12.0%  
河南 | 60个 | 0 | 207ms | 11.3% | 湖南 | 46个 | 2个 | 253ms | 15.0%  
北京 | 7个 | 1个 | 210ms | 8.5% | 广东 | 79个 | 3个 | 254ms | 16.2%  
吉林 | 15个 | 0 | 211ms | 4.1% | 贵州 | 28个 | 2个 | 256ms | 17.5%  
山西 | 37个 | 0 | 214ms | 10.8% | 广西 | 37个 | 1个 | 262ms | 21.4%  
江苏 | 63个 | 1个 | 215ms | 9.1% | 湖北 | 48个 | 3个 | 263ms | 17.7%  
福建 | 34个 | 1个 | 219ms | 6.8% | 新疆 | 27个 | 0 | 265ms | 12.9%  
内蒙古 | 34个 | 0 | 219ms | 10.5% | 海南 | 12个 | 0 | 268ms | 20.9%  
青海 | 4个 | 0 | 220ms | 14.0% | 重庆 | 16个 | 1个 | 274ms | 8.5%  
黑龙江 | 37个 | 0 | 221ms | 10.2% | 四川 | 50个 | 0 | 279ms | 15.2%  
浙江 | 51个 | 3个 | 222ms | 8.3% | 云南 | 23个 | 0 | 285ms | 23.0%  
山东 | 52个 | 1个 | 223ms | 14.6% | 西藏 | 1个 | 0 | 317ms | 23.0%  
...
海外线路到Vultr美国-洛杉矶机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 18个 | 0 | 8ms | 3.3% | 均值 | 78个 | 2个 | 180ms | 1.3%  
加拿大 | 3个 | 0 | 72ms | 0.5% | 菲律宾 | 1个 | 0 | 181ms | 0  
日本 | 2个 | 0 | 121ms | 0 | 香港 | 19个 | 2个 | 184ms | 6.0%  
韩国 | 13个 | 0 | 138ms | 0 | 新加坡 | 6个 | 0 | 187ms | 0  
法国 | 2个 | 0 | 147ms | 0 | 马来西亚 | 3个 | 0 | 193ms | 0  
英国 | 2个 | 0 | 159ms | 0 | 俄罗斯 | 1个 | 0 | 226ms | 0  
台湾 | 1个 | 0 | 161ms | - | 印度尼西亚 | 1个 | 0 | 234ms | 0  
澳大利亚 | 2个 | 0 | 163ms | 0.5% | 南非 | 1个 | 0 | 359ms | 0  
德国 | 1个 | 0 | 167ms | 0 | 柬埔寨 | 1个 | 0 | 381ms | 11.0%  
巴西 | 1个 | 0 | 172ms | 0 |  |  |  |  |   
