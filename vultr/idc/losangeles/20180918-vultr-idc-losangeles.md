...
大陆各省份到Vultr美国-洛杉矶机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
福建 | 43个 | 0 | 186ms | 5.1% | 均值 | 1418个 | 22个 | 210ms | 5.9%  
广东 | 128个 | 2个 | 187ms | 3.3% | 河北 | 60个 | 0 | 213ms | 5.3%  
海南 | 14个 | 0 | 187ms | 0.1% | 山西 | 58个 | 1个 | 214ms | 3.9%  
北京 | 10个 | 0 | 189ms | 24.1% | 吉林 | 19个 | 0 | 216ms | 2.9%  
浙江 | 66个 | 2个 | 195ms | 10.1% | 湖北 | 51个 | 1个 | 218ms | 8.8%  
上海 | 8个 | 0 | 195ms | 9.0% | 辽宁 | 57个 | 1个 | 218ms | 5.6%  
重庆 | 8个 | 1个 | 196ms | 5.0% | 云南 | 34个 | 0 | 220ms | 4.7%  
山东 | 93个 | 0 | 199ms | 4.6% | 宁夏 | 6个 | 0 | 222ms | 5.0%  
江西 | 38个 | 1个 | 199ms | 2.8% | 内蒙古 | 57个 | 0 | 224ms | 4.2%  
河南 | 86个 | 0 | 201ms | 4.4% | 四川 | 77个 | 1个 | 227ms | 6.1%  
安徽 | 66个 | 0 | 202ms | 7.4% | 青海 | 5个 | 0 | 230ms | 5.3%  
江苏 | 93个 | 10个 | 203ms | 8.3% | 陕西 | 43个 | 0 | 236ms | 5.6%  
贵州 | 41个 | 0 | 208ms | 3.2% | 天津 | 7个 | 0 | 237ms | 16.2%  
黑龙江 | 56个 | 0 | 208ms | 3.7% | 新疆 | 33个 | 1个 | 270ms | 8.8%  
湖南 | 69个 | 0 | 208ms | 5.6% | 甘肃 | 31个 | 0 | 272ms | 15.6%  
广西 | 59个 | 1个 | 209ms | 7.6% | 西藏 | 2个 | 0 | 287ms | 1.5%  
...
海外线路到Vultr美国-洛杉矶机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 15个 | 0 | 29ms | 0 | 澳大利亚 | 2个 | 0 | 169ms | 0  
加拿大 | 3个 | 0 | 69ms | 0 | 均值 | 77个 | 1个 | 178ms | 0.7%  
台湾 | 2个 | 0 | 73ms | 0 | 俄罗斯 | 1个 | 0 | 185ms | -  
韩国 | 12个 | 0 | 131ms | 0 | 菲律宾 | 1个 | 0 | 192ms | 0  
意大利 | 1个 | 0 | 131ms | - | 越南 | 2个 | 0 | 214ms | 0  
日本 | 3个 | 0 | 150ms | 0.7% | 马来西亚 | 6个 | 0 | 229ms | 0  
香港 | 18个 | 1个 | 151ms | 0 | 荷兰 | 1个 | 0 | 233ms | 0  
新加坡 | 5个 | 0 | 154ms | 0 | 赞比亚 | 1个 | 0 | 325ms | 10.0%  
德国 | 3个 | 0 | 156ms | 0 | 印度尼西亚 | 1个 | 0 | 446ms | 0  
