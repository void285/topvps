...
大陆各省份到Vultr美国-洛杉矶机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广东 | 277个 | 3个 | 195ms | 1.2% | 重庆 | 41个 | 3个 | 222ms | 3.0%  
北京 | 32个 | 0 | 198ms | 2.9% | 山西 | 109个 | 0 | 225ms | 2.4%  
湖南 | 141个 | 3个 | 202ms | 1.6% | 辽宁 | 154个 | 0 | 225ms | 5.5%  
山东 | 186个 | 0 | 203ms | 1.3% | 陕西 | 101个 | 3个 | 227ms | 2.6%  
海南 | 28个 | 0 | 203ms | 2.1% | 安徽 | 115个 | 3个 | 227ms | 6.4%  
青海 | 8个 | 0 | 209ms | 0 | 云南 | 67个 | 0 | 228ms | 6.2%  
湖北 | 113个 | 6个 | 210ms | 2.2% | 黑龙江 | 112个 | 0 | 230ms | 2.8%  
天津 | 20个 | 0 | 210ms | 3.1% | 四川 | 169个 | 0 | 232ms | 1.8%  
广西 | 124个 | 0 | 210ms | 1.9% | 福建 | 92个 | 0 | 236ms | 6.8%  
河南 | 191个 | 0 | 211ms | 3.7% | 内蒙古 | 104个 | 0 | 237ms | 3.9%  
浙江 | 158个 | 10个 | 214ms | 3.2% | 吉林 | 60个 | 0 | 241ms | 4.5%  
上海 | 31个 | 4个 | 214ms | 9.4% | 江西 | 75个 | 0 | 257ms | 4.6%  
江苏 | 235个 | 9个 | 215ms | 3.6% | 甘肃 | 60个 | 0 | 270ms | 6.7%  
河北 | 128个 | 0 | 215ms | 4.5% | 新疆 | 75个 | 0 | 275ms | 3.3%  
贵州 | 94个 | 0 | 221ms | 1.9% | 宁夏 | 16个 | 0 | 289ms | 8.8%  
均值 | 3120个 | 44个 | 221ms | 3.3% | 西藏 | 4个 | 0 | 383ms | 2.0%  
...
海外线路到Vultr美国-洛杉矶机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 3个 | 0 | 11ms | 0 | 香港 | 66个 | 6个 | 161ms | 0  
美国 | 45个 | 0 | 35ms | 7.6% | 均值 | 210个 | 6个 | 164ms | 4.0%  
加拿大 | 9个 | 0 | 74ms | 0 | 澳大利亚 | 3个 | 0 | 165ms | 0  
意大利 | 3个 | 0 | 132ms | - | 南非 | 6个 | 0 | 175ms | 0  
巴西 | 3个 | 0 | 140ms | 0 | 英国 | 3个 | 0 | 176ms | 0  
新加坡 | 15个 | 0 | 140ms | 0 | 俄罗斯 | 3个 | 0 | 179ms | -  
日本 | 3个 | 0 | 141ms | 3.0% | 台湾 | 3个 | 0 | 194ms | 0  
韩国 | 21个 | 0 | 147ms | 0 | 马来西亚 | 9个 | 0 | 214ms | 0  
德国 | 6个 | 0 | 151ms | 0 | 印度尼西亚 | 3个 | 0 | 229ms | 1.0%  
法国 | 3个 | 0 | 156ms | 0 | 菲律宾 | 3个 | 0 | 495ms | 56.0%  
