...
大陆各省份到Vultr美国-迈阿密机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 16个 | 0 | 261ms | 5.5% | 贵州 | 94个 | 0 | 332ms | 7.9%  
上海 | 27个 | 4个 | 271ms | 0.2% | 内蒙古 | 112个 | 0 | 333ms | 6.6%  
山东 | 210个 | 0 | 292ms | 7.1% | 广西 | 132个 | 0 | 334ms | 5.5%  
湖北 | 125个 | 0 | 295ms | 6.2% | 陕西 | 97个 | 0 | 336ms | 5.7%  
北京 | 36个 | 0 | 303ms | 2.4% | 河南 | 207个 | 0 | 339ms | 10.4%  
河北 | 132个 | 0 | 304ms | 7.7% | 云南 | 67个 | 0 | 339ms | 12.2%  
广东 | 282个 | 0 | 308ms | 3.3% | 吉林 | 64个 | 0 | 339ms | 8.9%  
江苏 | 242个 | 12个 | 309ms | 6.6% | 福建 | 96个 | 0 | 341ms | 6.5%  
湖南 | 141个 | 6个 | 309ms | 6.3% | 安徽 | 128个 | 0 | 341ms | 12.5%  
浙江 | 182个 | 16个 | 311ms | 6.9% | 江西 | 75个 | 0 | 345ms | 6.9%  
黑龙江 | 112个 | 0 | 311ms | 12.8% | 四川 | 165个 | 0 | 358ms | 4.6%  
山西 | 113个 | 0 | 311ms | 5.4% | 甘肃 | 60个 | 0 | 373ms | 7.1%  
重庆 | 41个 | 0 | 321ms | 13.5% | 宁夏 | 16个 | 0 | 373ms | 19.5%  
海南 | 28个 | 0 | 322ms | 3.9% | 新疆 | 79个 | 0 | 400ms | 5.1%  
均值 | 3245个 | 38个 | 325ms | 7.2% | 青海 | 8个 | 0 | 418ms | 7.5%  
辽宁 | 154个 | 0 | 328ms | 5.6% | 西藏 | 4个 | 0 | 481ms | 95.0%  
...
海外线路到Vultr美国-迈阿密机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 12个 | 0 | 44ms | 0 | 南非 | 6个 | 0 | 192ms | 0  
荷兰 | 3个 | 0 | 65ms | 0 | 新加坡 | 15个 | 0 | 212ms | 0  
美国 | 48个 | 0 | 97ms | 6.0% | 法国 | 3个 | 0 | 213ms | 0  
巴西 | 3个 | 0 | 100ms | 0 | 香港 | 63个 | 3个 | 213ms | 0  
意大利 | 3个 | 0 | 104ms | - | 台湾 | 3个 | 0 | 231ms | 0  
德国 | 6个 | 0 | 121ms | 0 | 韩国 | 21个 | 0 | 233ms | 0  
英国 | 3个 | 0 | 137ms | 1.0% | 澳大利亚 | 3个 | 0 | 234ms | 0  
俄罗斯 | 3个 | 0 | 148ms | - | 印度尼西亚 | 3个 | 0 | 271ms | 0  
日本 | 3个 | 0 | 180ms | 0 | 马来西亚 | 9个 | 0 | 306ms | 0.7%  
均值 | 213个 | 3个 | 187ms | 4.6% | 菲律宾 | 3个 | 0 | 449ms | 71.0%  
