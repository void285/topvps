#  多地到Vultr迈阿密[Miami]机房的Ping测试（20180622） 
...
大陆各省份到Vultr美国-迈阿密机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 10个 | 0 | 282ms | 7.0% | 重庆 | 12个 | 0 | 307ms | 12.0%  
浙江 | 52个 | 2个 | 283ms | 7.4% | 江西 | 26个 | 0 | 308ms | 9.5%  
安徽 | 37个 | 1个 | 290ms | 10.1% | 辽宁 | 35个 | 0 | 308ms | 22.8%  
上海 | 7个 | 1个 | 291ms | 2.3% | 河南 | 52个 | 1个 | 312ms | 23.9%  
江苏 | 67个 | 3个 | 295ms | 17.1% | 海南 | 10个 | 0 | 313ms | 13.3%  
福建 | 33个 | 0 | 295ms | 12.4% | 黑龙江 | 32个 | 0 | 316ms | 22.5%  
陕西 | 31个 | 0 | 295ms | 7.8% | 宁夏 | 13个 | 0 | 320ms | 16.9%  
湖北 | 35个 | 1个 | 297ms | 13.1% | 天津 | 3个 | 0 | 322ms | 19.3%  
湖南 | 38个 | 0 | 297ms | 17.7% | 云南 | 25个 | 11个 | 323ms | 10.2%  
山东 | 43个 | 0 | 298ms | 29.1% | 甘肃 | 18个 | 1个 | 324ms | 2.9%  
河北 | 35个 | 0 | 298ms | 24.3% | 四川 | 40个 | 0 | 325ms | 12.7%  
广东 | 70个 | 1个 | 299ms | 13.5% | 内蒙古 | 34个 | 0 | 325ms | 17.5%  
山西 | 34个 | 0 | 301ms | 24.4% | 吉林 | 18个 | 0 | 326ms | 27.9%  
广西 | 45个 | 0 | 302ms | 14.1% | 青海 | 5个 | 0 | 327ms | 3.6%  
均值 | 926个 | 24个 | 305ms | 16.4% | 新疆 | 20个 | 0 | 347ms | 17.5%  
贵州 | 22个 | 0 | 307ms | 22.0% | 香港 | 24个 | 2个 | - | -  
...
海外线路到Vultr美国-迈阿密机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 2个 | 0 | 54ms | 0 | 南非 | 2个 | 0 | 182ms | 0  
美国 | 19个 | 0 | 58ms | 0 | 台湾 | 2个 | 0 | 197ms | 0  
德国 | 1个 | 0 | 101ms | - | 新加坡 | 5个 | 0 | 212ms | 0  
巴西 | 1个 | 0 | 102ms | 0 | 香港 | 24个 | 2个 | 213ms | 0  
法国 | 1个 | 0 | 108ms | 0 | 韩国 | 14个 | 0 | 214ms | 0  
意大利 | 1个 | 0 | 110ms | - | 菲律宾 | 2个 | 0 | 240ms | 0.5%  
英国 | 1个 | 0 | 136ms | 0 | 澳大利亚 | 1个 | 0 | 250ms | 7.0%  
均值 | 81个 | 2个 | 170ms | 0.5% | 越南 | 2个 | 0 | 257ms | 0  
日本 | 2个 | 0 | 176ms | 0 | 印度尼西亚 | 1个 | 0 | 291ms | 0  
