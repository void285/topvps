...
大陆各省份到Vultr美国-迈阿密机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 8个 | 0 | 253ms | 8.6% | 四川 | 76个 | 1个 | 285ms | 3.3%  
山东 | 90个 | 0 | 263ms | 3.3% | 湖北 | 54个 | 2个 | 285ms | 9.7%  
江苏 | 92个 | 6个 | 265ms | 6.2% | 青海 | 5个 | 0 | 286ms | 0  
吉林 | 20个 | 0 | 268ms | 5.8% | 黑龙江 | 53个 | 0 | 286ms | 1.2%  
辽宁 | 62个 | 1个 | 269ms | 4.3% | 海南 | 13个 | 0 | 287ms | 6.9%  
安徽 | 69个 | 0 | 271ms | 5.7% | 湖南 | 72个 | 1个 | 289ms | 6.3%  
山西 | 57个 | 3个 | 271ms | 1.8% | 内蒙古 | 54个 | 0 | 289ms | 4.6%  
河北 | 58个 | 0 | 275ms | 5.5% | 贵州 | 43个 | 1个 | 294ms | 8.1%  
北京 | 8个 | 0 | 276ms | 5.1% | 河南 | 85个 | 0 | 297ms | 4.6%  
天津 | 7个 | 0 | 277ms | 3.9% | 重庆 | 8个 | 0 | 302ms | 8.3%  
浙江 | 66个 | 3个 | 278ms | 8.5% | 陕西 | 43个 | 0 | 304ms | 6.0%  
福建 | 43个 | 1个 | 280ms | 7.6% | 云南 | 33个 | 0 | 306ms | 7.0%  
江西 | 41个 | 0 | 280ms | 4.1% | 新疆 | 31个 | 1个 | 331ms | 8.3%  
广东 | 122个 | 5个 | 280ms | 6.7% | 甘肃 | 32个 | 0 | 344ms | 16.7%  
广西 | 60个 | 0 | 280ms | 7.3% | 宁夏 | 7个 | 0 | 352ms | 17.6%  
均值 | 1413个 | 25个 | 284ms | 5.9% | 西藏 | 1个 | 0 | 416ms | 2.0%  
...
海外线路到Vultr美国-迈阿密机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 2个 | 46ms | 0 | 日本 | 3个 | 0 | 203ms | 1.8%  
台湾 | 2个 | 1个 | 64ms | 0 | 澳大利亚 | 2个 | 0 | 246ms | 0.5%  
美国 | 16个 | 11个 | 139ms | 0 | 印度尼西亚 | 1个 | 0 | 286ms | 3.3%  
德国 | 3个 | 1个 | 139ms | 0 | 越南 | 2个 | 0 | 295ms | 0  
香港 | 20个 | 13个 | 155ms | 0 | 马来西亚 | 6个 | 0 | 302ms | 0  
新加坡 | 5个 | 3个 | 155ms | 0 | 赞比亚 | 2个 | 0 | 306ms | 6.5%  
韩国 | 12个 | 6个 | 157ms | 0 | 菲律宾 | 2个 | 0 | 346ms | 18.8%  
荷兰 | 1个 | 0 | 197ms | 0 | 俄罗斯 | 1个 | 1个 | - | -  
均值 | 82个 | 39个 | 202ms | 2.1% | 意大利 | 1个 | 1个 | - | -  
