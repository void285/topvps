...
大陆各省份到Vultr日本-东京机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广东 | 454个 | 0 | 144ms | 6.7% | 均值 | 5257个 | 72个 | 192ms | 18.0%  
湖南 | 249个 | 3个 | 147ms | 10.0% | 河北 | 244个 | 0 | 194ms | 12.4%  
贵州 | 150个 | 3个 | 159ms | 12.7% | 江苏 | 346个 | 12个 | 201ms | 26.3%  
福建 | 144个 | 0 | 159ms | 25.6% | 黑龙江 | 180个 | 0 | 209ms | 14.2%  
海南 | 48个 | 0 | 162ms | 16.9% | 四川 | 281个 | 3个 | 210ms | 16.0%  
重庆 | 45个 | 0 | 169ms | 15.2% | 陕西 | 149个 | 6个 | 210ms | 15.0%  
广西 | 236个 | 0 | 175ms | 15.4% | 山西 | 193个 | 0 | 212ms | 17.2%  
上海 | 31个 | 7个 | 175ms | 30.4% | 天津 | 16个 | 0 | 213ms | 18.7%  
江西 | 131个 | 7个 | 176ms | 28.4% | 甘肃 | 112个 | 0 | 222ms | 26.2%  
云南 | 123个 | 0 | 176ms | 12.1% | 宁夏 | 32个 | 0 | 223ms | 26.0%  
安徽 | 224个 | 0 | 176ms | 32.9% | 内蒙古 | 208个 | 0 | 236ms | 22.5%  
北京 | 36个 | 0 | 177ms | 21.2% | 青海 | 16个 | 0 | 237ms | 31.6%  
河南 | 339个 | 0 | 185ms | 14.0% | 辽宁 | 222个 | 9个 | 239ms | 22.0%  
湖北 | 197个 | 0 | 188ms | 12.4% | 吉林 | 100个 | 0 | 263ms | 24.4%  
浙江 | 242个 | 19个 | 191ms | 23.1% | 新疆 | 135个 | 3个 | 266ms | 24.5%  
山东 | 366个 | 0 | 192ms | 18.4% | 西藏 | 8个 | 0 | 360ms | 44.5%  
...
海外线路到Vultr日本-东京机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
日本 | 6个 | 0 | 23ms | 6.5% | 加拿大 | 15个 | 0 | 200ms | 0.3%  
韩国 | 21个 | 0 | 53ms | 0 | 俄罗斯 | 3个 | 0 | 202ms | -  
台湾 | 3个 | 0 | 59ms | 0 | 印度尼西亚 | 6个 | 0 | 208ms | 3.2%  
香港 | 66个 | 3个 | 96ms | 0 | 巴西 | 3个 | 0 | 225ms | 0  
新加坡 | 15个 | 0 | 101ms | 0 | 英国 | 6个 | 0 | 268ms | 0.5%  
美国 | 48个 | 0 | 113ms | 1.2% | 德国 | 9个 | 0 | 269ms | 0  
荷兰 | 3个 | 0 | 113ms | 0 | 南非 | 6个 | 0 | 272ms | 2.5%  
马来西亚 | 12个 | 0 | 114ms | 0.5% | 澳大利亚 | 6个 | 0 | 284ms | 0  
法国 | 3个 | 0 | 143ms | 0 | 菲律宾 | 6个 | 0 | 288ms | 30.5%  
均值 | 240个 | 3个 | 176ms | 2.7% | 意大利 | 3个 | 0 | 315ms | -  
