...
大陆各省份到Vultr日本-东京机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 4个 | 1个 | 118ms | 15.7% | 广东 | 55个 | 0 | 167ms | 11.3%  
天津 | 5个 | 0 | 121ms | 16.0% | 浙江 | 36个 | 2个 | 168ms | 12.9%  
山西 | 28个 | 0 | 132ms | 13.7% | 广西 | 29个 | 0 | 168ms | 15.2%  
福建 | 27个 | 0 | 140ms | 11.8% | 安徽 | 38个 | 0 | 170ms | 18.0%  
河南 | 50个 | 0 | 149ms | 12.9% | 吉林 | 12个 | 0 | 171ms | 17.1%  
江苏 | 48个 | 1个 | 150ms | 18.1% | 青海 | 4个 | 0 | 172ms | 2.8%  
湖南 | 36个 | 0 | 153ms | 13.7% | 江西 | 22个 | 0 | 172ms | 13.6%  
河北 | 33个 | 0 | 156ms | 16.1% | 海南 | 10个 | 0 | 172ms | 18.0%  
内蒙古 | 25个 | 0 | 158ms | 13.7% | 重庆 | 9个 | 0 | 173ms | 15.2%  
黑龙江 | 30个 | 0 | 159ms | 16.0% | 湖北 | 37个 | 0 | 174ms | 19.1%  
陕西 | 26个 | 1个 | 160ms | 9.5% | 宁夏 | 9个 | 0 | 177ms | 15.8%  
西藏 | 1个 | 0 | 163ms | 0 | 云南 | 25个 | 0 | 178ms | 12.0%  
辽宁 | 34个 | 0 | 163ms | 14.8% | 贵州 | 22个 | 0 | 183ms | 14.0%  
上海 | 8个 | 0 | 165ms | 22.6% | 甘肃 | 21个 | 0 | 183ms | 12.3%  
均值 | 789个 | 5个 | 166ms | 15.3% | 四川 | 35个 | 0 | 205ms | 24.8%  
山东 | 47个 | 0 | 167ms | 20.9% | 新疆 | 23个 | 0 | 215ms | 12.3%  
...
海外线路到Vultr日本-东京机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
日本 | 3个 | 0 | 10ms | 0.3% | 加拿大 | 4个 | 0 | 201ms | 0  
台湾 | 1个 | 0 | 41ms | - | 英国 | 3个 | 0 | 238ms | 0  
香港 | 20个 | 1个 | 64ms | 0 | 德国 | 1个 | 0 | 239ms | 0  
韩国 | 12个 | 0 | 78ms | 5.5% | 荷兰 | 2个 | 0 | 248ms | 0  
新加坡 | 5个 | 0 | 98ms | 0 | 法国 | 2个 | 0 | 257ms | 0  
美国 | 16个 | 1个 | 123ms | 0 | 俄罗斯 | 1个 | 0 | 260ms | 0  
越南 | 1个 | 0 | 129ms | 0 | 印度尼西亚 | 1个 | 0 | 325ms | 3.0%  
马来西亚 | 4个 | 0 | 131ms | 0 | 南非 | 1个 | 0 | 380ms | 0  
均值 | 80个 | 2个 | 189ms | 2.5% | 柬埔寨 | 1个 | 0 | 393ms | 33.0%  
澳大利亚 | 2个 | 0 | 196ms | 0 |  |  |  |  |   
