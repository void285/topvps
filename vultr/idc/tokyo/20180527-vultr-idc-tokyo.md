...
大陆各省份到Vultr日本-东京机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
湖南 | 46个 | 0 | 155ms | 9.6% | 黑龙江 | 40个 | 1个 | 178ms | 10.8%  
北京 | 8个 | 1个 | 159ms | 11.0% | 陕西 | 32个 | 0 | 178ms | 11.0%  
福建 | 36个 | 0 | 160ms | 11.3% | 河南 | 55个 | 1个 | 179ms | 11.5%  
广东 | 78个 | 3个 | 163ms | 11.6% | 云南 | 21个 | 0 | 180ms | 11.3%  
广西 | 40个 | 0 | 163ms | 11.1% | 辽宁 | 40个 | 0 | 181ms | 11.6%  
江西 | 23个 | 0 | 164ms | 17.2% | 山东 | 52个 | 2个 | 182ms | 11.1%  
安徽 | 36个 | 0 | 164ms | 14.2% | 湖北 | 42个 | 2个 | 182ms | 13.5%  
山西 | 37个 | 0 | 164ms | 9.2% | 宁夏 | 12个 | 0 | 182ms | 12.0%  
江苏 | 62个 | 4个 | 167ms | 16.1% | 甘肃 | 22个 | 0 | 192ms | 11.8%  
青海 | 4个 | 0 | 169ms | 8.3% | 内蒙古 | 33个 | 0 | 193ms | 12.1%  
浙江 | 47个 | 1个 | 170ms | 16.0% | 四川 | 45个 | 0 | 196ms | 14.7%  
海南 | 14个 | 0 | 171ms | 14.8% | 河北 | 33个 | 0 | 197ms | 11.5%  
天津 | 5个 | 0 | 174ms | 17.9% | 重庆 | 14个 | 1个 | 198ms | 13.6%  
上海 | 7个 | 0 | 175ms | 24.1% | 新疆 | 27个 | 0 | 205ms | 9.7%  
贵州 | 24个 | 0 | 176ms | 10.6% | 吉林 | 19个 | 0 | 209ms | 14.5%  
...
海外线路到Vultr日本-东京机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
日本 | 2个 | 0 | 12ms | 1.0% | 均值 | 87个 | 0 | 176ms | 1.5%  
台湾 | 1个 | 0 | 41ms | - | 意大利 | 1个 | 0 | 231ms | -  
韩国 | 12个 | 0 | 67ms | 7.0% | 德国 | 3个 | 0 | 238ms | 0  
香港 | 18个 | 0 | 71ms | 0 | 澳大利亚 | 2个 | 0 | 239ms | 0  
菲律宾 | 1个 | 0 | 79ms | 0 | 英国 | 2个 | 0 | 248ms | 0  
越南 | 2个 | 0 | 80ms | 0 | 巴西 | 1个 | 0 | 261ms | 0  
新加坡 | 5个 | 0 | 94ms | 0 | 俄罗斯 | 1个 | 0 | 266ms | 0  
印度尼西亚 | 1个 | 0 | 100ms | 0 | 荷兰 | 1个 | 0 | 268ms | 0  
马来西亚 | 5个 | 0 | 104ms | 0.2% | 法国 | 1个 | 0 | 284ms | 0  
美国 | 21个 | 0 | 117ms | 2.1% | 柬埔寨 | 1个 | 0 | 335ms | 16.0%  
加拿大 | 4个 | 0 | 158ms | 0 | 南非 | 2个 | 0 | 403ms | 1.5%  
