...
大陆各省份到Vultr日本-东京机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
山西 | 56个 | 2个 | 109ms | 0.9% | 福建 | 42个 | 0 | 140ms | 2.5%  
吉林 | 23个 | 0 | 113ms | 0.9% | 江苏 | 91个 | 6个 | 142ms | 2.4%  
上海 | 8个 | 1个 | 113ms | 3.1% | 安徽 | 69个 | 1个 | 142ms | 2.5%  
辽宁 | 59个 | 0 | 118ms | 3.2% | 重庆 | 8个 | 0 | 143ms | 2.0%  
广西 | 59个 | 1个 | 121ms | 1.8% | 陕西 | 43个 | 0 | 144ms | 1.4%  
黑龙江 | 54个 | 0 | 124ms | 0.7% | 浙江 | 66个 | 3个 | 145ms | 1.7%  
内蒙古 | 54个 | 0 | 124ms | 2.7% | 广东 | 123个 | 1个 | 146ms | 1.3%  
山东 | 92个 | 0 | 126ms | 7.2% | 贵州 | 43个 | 1个 | 153ms | 1.9%  
河北 | 58个 | 0 | 126ms | 1.0% | 湖北 | 52个 | 1个 | 160ms | 1.7%  
河南 | 87个 | 0 | 127ms | 7.6% | 宁夏 | 7个 | 0 | 162ms | 4.5%  
北京 | 8个 | 0 | 133ms | 5.8% | 四川 | 72个 | 1个 | 168ms | 3.4%  
湖南 | 71个 | 0 | 133ms | 2.9% | 青海 | 5个 | 0 | 168ms | 4.7%  
天津 | 7个 | 0 | 136ms | 3.7% | 甘肃 | 32个 | 0 | 170ms | 4.2%  
江西 | 39个 | 0 | 136ms | 1.9% | 云南 | 33个 | 0 | 176ms | 2.8%  
海南 | 13个 | 0 | 139ms | 1.8% | 新疆 | 31个 | 0 | 182ms | 5.3%  
均值 | 1406个 | 18个 | 139ms | 2.9% | 西藏 | 1个 | 0 | 310ms | 7.0%  
...
海外线路到Vultr日本-东京机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
日本 | 3个 | 0 | 33ms | 1.3% | 加拿大 | 3个 | 0 | 163ms | 0  
韩国 | 10个 | 0 | 100ms | 0 | 均值 | 72个 | 0 | 184ms | 2.4%  
越南 | 2个 | 0 | 101ms | 0 | 印度尼西亚 | 1个 | 0 | 213ms | 3.3%  
美国 | 12个 | 0 | 102ms | 0 | 俄罗斯 | 1个 | 0 | 218ms | -  
新加坡 | 5个 | 0 | 103ms | 0 | 意大利 | 1个 | 0 | 242ms | -  
台湾 | 1个 | 0 | 113ms | 10.0% | 德国 | 3个 | 0 | 258ms | 0  
香港 | 17个 | 0 | 126ms | 0 | 荷兰 | 1个 | 0 | 335ms | 0  
马来西亚 | 6个 | 0 | 129ms | 0.3% | 澳大利亚 | 2个 | 0 | 342ms | 0  
菲律宾 | 2个 | 0 | 140ms | 15.0% | 赞比亚 | 2个 | 0 | 414ms | 5.8%  
