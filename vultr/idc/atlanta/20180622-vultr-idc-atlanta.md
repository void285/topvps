...
大陆各省份到Vultr美国-亚特兰大机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 10个 | 0 | 255ms | 12.0% | 辽宁 | 34个 | 1个 | 288ms | 23.9%  
浙江 | 52个 | 2个 | 265ms | 5.1% | 河南 | 48个 | 1个 | 292ms | 19.4%  
海南 | 8个 | 0 | 265ms | 17.8% | 内蒙古 | 33个 | 1个 | 292ms | 23.6%  
江苏 | 66个 | 3个 | 269ms | 14.3% | 四川 | 40个 | 1个 | 295ms | 12.8%  
山东 | 41个 | 0 | 274ms | 31.9% | 福建 | 32个 | 1个 | 295ms | 13.4%  
上海 | 7个 | 1个 | 275ms | 3.0% | 江西 | 23个 | 0 | 295ms | 12.0%  
广西 | 43个 | 0 | 276ms | 13.9% | 重庆 | 13个 | 0 | 296ms | 16.2%  
湖南 | 37个 | 1个 | 277ms | 16.1% | 黑龙江 | 27个 | 1个 | 299ms | 18.5%  
河北 | 34个 | 0 | 279ms | 25.8% | 陕西 | 26个 | 0 | 300ms | 11.2%  
天津 | 3个 | 0 | 280ms | 21.3% | 宁夏 | 13个 | 0 | 304ms | 15.2%  
安徽 | 35个 | 1个 | 282ms | 10.3% | 甘肃 | 17个 | 1个 | 309ms | 2.8%  
山西 | 35个 | 1个 | 283ms | 29.2% | 青海 | 5个 | 0 | 310ms | 2.2%  
广东 | 70个 | 0 | 286ms | 16.6% | 云南 | 24个 | 10个 | 311ms | 10.1%  
均值 | 893个 | 28个 | 287ms | 16.9% | 吉林 | 18个 | 0 | 315ms | 27.0%  
贵州 | 22个 | 1个 | 288ms | 19.5% | 新疆 | 18个 | 0 | 329ms | 19.4%  
湖北 | 34个 | 0 | 288ms | 13.2% | 香港 | 25个 | 1个 | - | -  
...
海外线路到Vultr美国-亚特兰大机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 2个 | 0 | 42ms | 0 | 台湾 | 2个 | 0 | 187ms | 0  
美国 | 19个 | 0 | 53ms | 0 | 香港 | 25个 | 1个 | 190ms | 0  
意大利 | 1个 | 0 | 91ms | - | 新加坡 | 5个 | 0 | 206ms | 0  
德国 | 1个 | 0 | 91ms | - | 韩国 | 14个 | 0 | 207ms | 0  
巴西 | 1个 | 0 | 93ms | 0 | 澳大利亚 | 1个 | 0 | 219ms | 2.0%  
法国 | 1个 | 0 | 102ms | 0 | 菲律宾 | 2个 | 0 | 224ms | 0  
英国 | 2个 | 0 | 164ms | 0 | 越南 | 2个 | 0 | 252ms | 0  
均值 | 84个 | 1个 | 166ms | 0.2% | 印度尼西亚 | 1个 | 0 | 266ms | 0  
日本 | 1个 | 0 | 168ms | - | 马来西亚 | 2个 | 0 | 273ms | 1.0%  
南非 | 2个 | 0 | 168ms | 0.5% |  |  |  |  |   
