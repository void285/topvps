...
大陆各省份到Vultr美国-亚特兰大机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
江苏 | 62个 | 1个 | 252ms | 2.8% | 均值 | 981个 | 16个 | 282ms | 12.3%  
天津 | 5个 | 0 | 260ms | 8.2% | 广西 | 40个 | 0 | 283ms | 14.2%  
浙江 | 52个 | 2个 | 261ms | 4.5% | 山西 | 39个 | 0 | 285ms | 15.1%  
吉林 | 19个 | 0 | 261ms | 4.6% | 湖北 | 46个 | 0 | 289ms | 11.9%  
上海 | 7个 | 0 | 262ms | 9.4% | 贵州 | 28个 | 0 | 291ms | 13.8%  
山东 | 53个 | 1个 | 264ms | 11.0% | 四川 | 47个 | 2个 | 291ms | 11.8%  
河北 | 36个 | 0 | 266ms | 13.0% | 陕西 | 33个 | 0 | 291ms | 12.6%  
广东 | 80个 | 2个 | 270ms | 12.7% | 安徽 | 38个 | 0 | 291ms | 15.5%  
北京 | 8个 | 1个 | 270ms | 4.1% | 重庆 | 15个 | 1个 | 292ms | 12.9%  
福建 | 36个 | 0 | 271ms | 9.1% | 湖南 | 44个 | 1个 | 292ms | 19.7%  
海南 | 14个 | 0 | 272ms | 12.9% | 黑龙江 | 39个 | 0 | 302ms | 16.4%  
内蒙古 | 33个 | 0 | 275ms | 10.4% | 云南 | 19个 | 1个 | 317ms | 20.5%  
辽宁 | 41个 | 0 | 276ms | 11.1% | 甘肃 | 22个 | 0 | 318ms | 12.7%  
宁夏 | 12个 | 0 | 280ms | 11.6% | 青海 | 4个 | 0 | 325ms | 15.0%  
河南 | 58个 | 3个 | 281ms | 13.7% | 新疆 | 27个 | 1个 | 355ms | 20.0%  
江西 | 24个 | 0 | 282ms | 14.1% |  |  |  |  |   
...
海外线路到Vultr美国-亚特兰大机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 43ms | 0 | 日本 | 2个 | 0 | 198ms | 2.0%  
美国 | 21个 | 0 | 48ms | 2.1% | 韩国 | 12个 | 0 | 200ms | 0  
法国 | 1个 | 0 | 93ms | 0 | 澳大利亚 | 2个 | 0 | 215ms | 0  
荷兰 | 1个 | 0 | 94ms | 0 | 香港 | 19个 | 1个 | 227ms | 0  
英国 | 2个 | 0 | 101ms | 0 | 新加坡 | 6个 | 0 | 239ms | 0  
意大利 | 1个 | 0 | 103ms | - | 越南 | 2个 | 0 | 251ms | 0  
德国 | 3个 | 0 | 104ms | 0 | 马来西亚 | 5个 | 0 | 252ms | 0  
巴西 | 1个 | 0 | 121ms | 0 | 菲律宾 | 1个 | 0 | 265ms | 0  
均值 | 88个 | 1个 | 186ms | 1.0% | 南非 | 2个 | 0 | 272ms | 2.5%  
俄罗斯 | 1个 | 0 | 192ms | 10.0% | 印度尼西亚 | 1个 | 0 | 278ms | 0  
台湾 | 1个 | 0 | 198ms | - | 柬埔寨 | 1个 | 0 | 421ms | 2.0%  
