...
大陆各省份到Vultr美国-亚特兰大机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 242ms | 10.8% | 陕西 | 25个 | 1个 | 303ms | 4.6%  
江苏 | 49个 | 1个 | 255ms | 2.4% | 贵州 | 22个 | 0 | 304ms | 3.9%  
吉林 | 14个 | 0 | 257ms | 1.4% | 江西 | 22个 | 0 | 308ms | 4.2%  
广东 | 52个 | 0 | 274ms | 4.4% | 宁夏 | 9个 | 0 | 308ms | 4.8%  
山西 | 26个 | 0 | 275ms | 4.0% | 内蒙古 | 27个 | 0 | 308ms | 4.6%  
湖南 | 35个 | 0 | 278ms | 3.6% | 重庆 | 10个 | 1个 | 314ms | 4.9%  
湖北 | 37个 | 0 | 285ms | 3.8% | 四川 | 33个 | 0 | 316ms | 4.2%  
黑龙江 | 29个 | 0 | 286ms | 2.4% | 河南 | 46个 | 0 | 317ms | 6.1%  
浙江 | 37个 | 2个 | 287ms | 2.5% | 安徽 | 37个 | 0 | 318ms | 4.7%  
河北 | 32个 | 0 | 290ms | 4.1% | 云南 | 23个 | 1个 | 323ms | 5.9%  
海南 | 10个 | 0 | 291ms | 2.9% | 甘肃 | 21个 | 0 | 330ms | 5.0%  
辽宁 | 34个 | 0 | 292ms | 8.4% | 上海 | 8个 | 0 | 334ms | 7.4%  
福建 | 26个 | 0 | 293ms | 3.6% | 新疆 | 22个 | 1个 | 342ms | 5.6%  
山东 | 42个 | 0 | 294ms | 4.3% | 北京 | 3个 | 1个 | 366ms | 5.5%  
均值 | 770个 | 8个 | 296ms | 4.5% | 青海 | 4个 | 0 | 375ms | 6.3%  
广西 | 29个 | 0 | 302ms | 7.5% | 西藏 | 1个 | 0 | 412ms | 8.0%  
...
海外线路到Vultr美国-亚特兰大机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 4个 | 1个 | 39ms | 0 | 香港 | 20个 | 0 | 211ms | 0  
美国 | 16个 | 0 | 46ms | 0 | 台湾 | 1个 | 0 | 212ms | -  
法国 | 2个 | 0 | 93ms | 0 | 澳大利亚 | 2个 | 0 | 216ms | 0  
荷兰 | 2个 | 0 | 95ms | 0 | 新加坡 | 5个 | 0 | 241ms | 0  
英国 | 3个 | 0 | 100ms | 0 | 南非 | 1个 | 0 | 246ms | 0  
德国 | 1个 | 0 | 101ms | 0 | 马来西亚 | 4个 | 0 | 251ms | 0  
日本 | 3个 | 0 | 184ms | 1.0% | 越南 | 1个 | 0 | 275ms | 0  
俄罗斯 | 1个 | 0 | 189ms | 0 | 印度尼西亚 | 1个 | 0 | 401ms | 6.0%  
韩国 | 12个 | 0 | 201ms | 0 | 柬埔寨 | 1个 | 0 | 519ms | 33.0%  
均值 | 80个 | 1个 | 201ms | 2.4% |  |  |  |  |   
