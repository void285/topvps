...
大陆各省份到Vultr法国-巴黎机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 7个 | 0 | 229ms | 0 | 内蒙古 | 30个 | 0 | 263ms | 0.1%  
青海 | 4个 | 1个 | 235ms | 0 | 辽宁 | 35个 | 0 | 266ms | 2.5%  
河南 | 50个 | 1个 | 238ms | 0.1% | 均值 | 836个 | 7个 | 269ms | 1.0%  
安徽 | 37个 | 0 | 238ms | 0.7% | 云南 | 25个 | 0 | 270ms | 0.5%  
重庆 | 9个 | 1个 | 242ms | 0 | 广西 | 35个 | 0 | 279ms | 3.7%  
河北 | 33个 | 0 | 246ms | 1.3% | 贵州 | 23个 | 0 | 282ms | 1.6%  
湖北 | 39个 | 0 | 248ms | 0.2% | 海南 | 11个 | 0 | 283ms | 0.9%  
江西 | 21个 | 0 | 251ms | 0.5% | 四川 | 45个 | 0 | 285ms | 0.7%  
甘肃 | 20个 | 0 | 251ms | 0.1% | 福建 | 25个 | 0 | 285ms | 2.4%  
江苏 | 49个 | 1个 | 253ms | 1.4% | 山东 | 42个 | 0 | 293ms | 0.8%  
宁夏 | 10个 | 0 | 253ms | 2.5% | 湖南 | 40个 | 0 | 294ms | 2.0%  
广东 | 61个 | 0 | 258ms | 0.3% | 山西 | 33个 | 0 | 294ms | 0.2%  
浙江 | 40个 | 2个 | 259ms | 0.9% | 新疆 | 27个 | 0 | 298ms | 0.6%  
陕西 | 26个 | 0 | 260ms | 0 | 黑龙江 | 34个 | 0 | 309ms | 1.1%  
天津 | 5个 | 0 | 261ms | 2.5% | 吉林 | 15个 | 0 | 321ms | 0.3%  
北京 | 4个 | 1个 | 263ms | 3.3% | 西藏 | 1个 | 0 | 322ms | 4.0%  
...
海外线路到Vultr法国-巴黎机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 2个 | 0 | 7ms | 0 | 均值 | 77个 | 0 | 193ms | 2.4%  
德国 | 1个 | 0 | 9ms | 0 | 香港 | 19个 | 0 | 224ms | 0  
荷兰 | 2个 | 0 | 11ms | 0 | 马来西亚 | 4个 | 0 | 242ms | 0.3%  
英国 | 3个 | 0 | 20ms | 0 | 越南 | 1个 | 0 | 255ms | 0  
俄罗斯 | 1个 | 0 | 96ms | 0 | 日本 | 3个 | 0 | 267ms | 1.0%  
加拿大 | 3个 | 0 | 104ms | 0 | 韩国 | 12个 | 0 | 284ms | 0  
美国 | 16个 | 0 | 142ms | 0 | 台湾 | 1个 | 0 | 302ms | -  
南非 | 1个 | 0 | 168ms | 0 | 澳大利亚 | 2个 | 0 | 351ms | 1.0%  
新加坡 | 5个 | 0 | 192ms | 0 | 柬埔寨 | 1个 | 0 | 605ms | 36.0%  
