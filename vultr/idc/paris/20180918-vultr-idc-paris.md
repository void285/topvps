...
大陆各省份到Vultr法国-巴黎机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
河北 | 62个 | 0 | 214ms | 3.9% | 湖南 | 67个 | 0 | 275ms | 9.7%  
宁夏 | 7个 | 0 | 225ms | 0 | 上海 | 8个 | 0 | 277ms | 1.4%  
甘肃 | 30个 | 0 | 245ms | 0.3% | 天津 | 7个 | 0 | 279ms | 1.6%  
安徽 | 69个 | 1个 | 246ms | 1.8% | 广西 | 63个 | 0 | 281ms | 9.4%  
江西 | 40个 | 0 | 247ms | 0.3% | 山西 | 55个 | 2个 | 285ms | 3.8%  
浙江 | 66个 | 2个 | 253ms | 3.5% | 河南 | 91个 | 0 | 287ms | 4.1%  
陕西 | 44个 | 0 | 256ms | 1.3% | 西藏 | 2个 | 0 | 291ms | 4.0%  
江苏 | 94个 | 5个 | 257ms | 1.8% | 重庆 | 8个 | 0 | 296ms | 10.2%  
辽宁 | 59个 | 0 | 257ms | 1.3% | 海南 | 14个 | 0 | 298ms | 12.2%  
青海 | 5个 | 0 | 260ms | 0 | 贵州 | 42个 | 0 | 300ms | 6.9%  
内蒙古 | 56个 | 0 | 262ms | 2.5% | 湖北 | 53个 | 0 | 300ms | 11.8%  
广东 | 127个 | 2个 | 264ms | 6.4% | 新疆 | 34个 | 0 | 303ms | 2.0%  
北京 | 10个 | 0 | 265ms | 0.1% | 黑龙江 | 56个 | 0 | 308ms | 4.6%  
福建 | 42个 | 0 | 270ms | 5.6% | 四川 | 77个 | 0 | 313ms | 10.1%  
山东 | 90个 | 0 | 271ms | 2.8% | 云南 | 34个 | 0 | 315ms | 9.1%  
均值 | 1430个 | 12个 | 273ms | 4.8% | 吉林 | 18个 | 0 | 320ms | 0  
...
海外线路到Vultr法国-巴黎机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 1个 | 0 | 14ms | - | 越南 | 2个 | 0 | 204ms | 0  
德国 | 3个 | 0 | 30ms | 0 | 赞比亚 | 2个 | 0 | 205ms | 4.8%  
俄罗斯 | 1个 | 0 | 48ms | - | 菲律宾 | 1个 | 0 | 220ms | 0  
荷兰 | 1个 | 0 | 99ms | 0 | 台湾 | 2个 | 0 | 230ms | 0  
加拿大 | 3个 | 0 | 104ms | 0 | 马来西亚 | 6个 | 0 | 248ms | 0.3%  
美国 | 16个 | 0 | 147ms | 0 | 韩国 | 12个 | 0 | 250ms | 0  
香港 | 21个 | 0 | 179ms | 0 | 日本 | 2个 | 0 | 267ms | 1.0%  
均值 | 81个 | 0 | 181ms | 0.7% | 澳大利亚 | 2个 | 0 | 317ms | 1.7%  
新加坡 | 5个 | 0 | 194ms | 0 | 印度尼西亚 | 1个 | 0 | 320ms | 3.3%  
