...
大陆各省份到Vultr法国-巴黎机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
青海 | 8个 | 0 | 220ms | 0 | 云南 | 67个 | 0 | 294ms | 7.1%  
宁夏 | 16个 | 0 | 239ms | 1.5% | 吉林 | 64个 | 0 | 294ms | 0.6%  
河北 | 128个 | 0 | 259ms | 5.1% | 均值 | 3157个 | 36个 | 294ms | 2.9%  
辽宁 | 154个 | 0 | 261ms | 2.0% | 山西 | 109个 | 0 | 297ms | 1.4%  
天津 | 16个 | 0 | 264ms | 0 | 黑龙江 | 100个 | 0 | 303ms | 3.4%  
重庆 | 41个 | 3个 | 265ms | 3.3% | 江苏 | 238个 | 9个 | 308ms | 2.4%  
甘肃 | 60个 | 0 | 265ms | 2.1% | 贵州 | 94个 | 0 | 310ms | 4.4%  
广西 | 128个 | 4个 | 266ms | 2.8% | 山东 | 214个 | 0 | 315ms | 1.5%  
河南 | 199个 | 0 | 269ms | 3.0% | 福建 | 88个 | 0 | 315ms | 4.9%  
陕西 | 97个 | 0 | 273ms | 2.9% | 浙江 | 174个 | 7个 | 315ms | 3.7%  
北京 | 36个 | 0 | 279ms | 1.3% | 广东 | 282个 | 6个 | 315ms | 2.6%  
内蒙古 | 104个 | 0 | 279ms | 1.9% | 海南 | 28个 | 0 | 316ms | 2.3%  
湖南 | 133个 | 3个 | 281ms | 4.3% | 上海 | 31个 | 4个 | 324ms | 5.6%  
新疆 | 79个 | 0 | 282ms | 2.2% | 江西 | 75个 | 0 | 340ms | 3.9%  
湖北 | 121个 | 0 | 287ms | 3.5% | 安徽 | 104个 | 0 | 348ms | 4.1%  
四川 | 165个 | 0 | 293ms | 1.4% | 西藏 | 4个 | 0 | 427ms | 9.0%  
...
海外线路到Vultr法国-巴黎机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
巴西 | 3个 | 0 | 8ms | 0 | 香港 | 66个 | 0 | 196ms | 0  
意大利 | 3个 | 0 | 8ms | - | 新加坡 | 15个 | 0 | 197ms | 0  
德国 | 6个 | 0 | 25ms | 0 | 马来西亚 | 9个 | 0 | 258ms | 0  
英国 | 3个 | 0 | 52ms | 0 | 日本 | 3个 | 0 | 264ms | 0  
俄罗斯 | 3个 | 0 | 52ms | - | 印度尼西亚 | 3个 | 0 | 268ms | 0  
加拿大 | 12个 | 0 | 94ms | 0 | 韩国 | 21个 | 0 | 282ms | 0  
荷兰 | 3个 | 0 | 146ms | 0 | 台湾 | 3个 | 0 | 284ms | 0  
美国 | 48个 | 0 | 159ms | 0 | 澳大利亚 | 3个 | 0 | 308ms | 0  
南非 | 6个 | 0 | 179ms | 1.0% | 菲律宾 | 3个 | 0 | 596ms | 65.0%  
均值 | 213个 | 0 | 187ms | 4.1% |  |  |  |  |   
