#  多地到Vultr巴黎[Paris]机房的Ping测试（20180527） 
...
大陆各省份到Vultr法国-巴黎机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 7个 | 0 | 217ms | 0.6% | 内蒙古 | 34个 | 0 | 279ms | 5.4%  
河南 | 55个 | 1个 | 254ms | 1.9% | 均值 | 981个 | 10个 | 279ms | 5.1%  
北京 | 8个 | 1个 | 257ms | 1.4% | 江西 | 25个 | 0 | 280ms | 1.6%  
河北 | 36个 | 0 | 262ms | 2.7% | 宁夏 | 13个 | 0 | 280ms | 5.0%  
广西 | 40个 | 0 | 266ms | 5.5% | 浙江 | 51个 | 1个 | 281ms | 2.9%  
安徽 | 38个 | 0 | 268ms | 1.9% | 甘肃 | 22个 | 0 | 283ms | 3.1%  
辽宁 | 41个 | 0 | 270ms | 2.8% | 重庆 | 14个 | 2个 | 283ms | 6.0%  
湖北 | 45个 | 0 | 271ms | 1.8% | 江苏 | 63个 | 1个 | 285ms | 2.2%  
海南 | 14个 | 0 | 271ms | 5.1% | 山西 | 37个 | 0 | 285ms | 6.8%  
天津 | 5个 | 0 | 273ms | 7.3% | 陕西 | 31个 | 0 | 288ms | 8.2%  
青海 | 4个 | 0 | 275ms | 1.5% | 贵州 | 28个 | 0 | 293ms | 13.4%  
云南 | 20个 | 0 | 275ms | 5.5% | 山东 | 53个 | 2个 | 299ms | 9.0%  
福建 | 36个 | 0 | 276ms | 8.7% | 吉林 | 19个 | 0 | 306ms | 2.4%  
广东 | 86个 | 1个 | 276ms | 5.1% | 黑龙江 | 39个 | 0 | 310ms | 4.2%  
湖南 | 43个 | 1个 | 277ms | 12.0% | 新疆 | 28个 | 0 | 319ms | 6.2%  
四川 | 46个 | 0 | 278ms | 7.5% |  |  |  |  |   
...
海外线路到Vultr法国-巴黎机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 1个 | 0 | 0 | 0 | 巴西 | 1个 | 0 | 205ms | 0  
意大利 | 1个 | 0 | 8ms | - | 马来西亚 | 5个 | 0 | 215ms | 0  
荷兰 | 1个 | 0 | 14ms | 0 | 香港 | 21个 | 0 | 219ms | 0  
德国 | 3个 | 0 | 19ms | 0 | 菲律宾 | 1个 | 0 | 244ms | 0  
英国 | 2个 | 0 | 24ms | 0 | 日本 | 2个 | 0 | 267ms | 1.0%  
俄罗斯 | 1个 | 0 | 99ms | 0 | 印度尼西亚 | 1个 | 0 | 273ms | 0  
加拿大 | 3个 | 0 | 104ms | 0 | 韩国 | 12个 | 0 | 283ms | 0  
美国 | 21个 | 0 | 143ms | 2.7% | 台湾 | 1个 | 0 | 294ms | -  
新加坡 | 5个 | 0 | 158ms | 0 | 越南 | 2个 | 0 | 303ms | 0  
均值 | 89个 | 0 | 180ms | 0.6% | 澳大利亚 | 2个 | 0 | 321ms | 0  
南非 | 2个 | 0 | 190ms | 3.5% | 柬埔寨 | 1个 | 0 | 403ms | 4.0%  
