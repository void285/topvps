...
大陆各省份到Vultr澳大利亚-悉尼机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广西 | 62个 | 0 | 244ms | 0.5% | 山西 | 57个 | 1个 | 272ms | 0.2%  
陕西 | 43个 | 0 | 245ms | 0.2% | 均值 | 1410个 | 12个 | 272ms | 1.7%  
上海 | 7个 | 0 | 249ms | 4.7% | 黑龙江 | 53个 | 0 | 273ms | 2.8%  
天津 | 7个 | 0 | 250ms | 4.9% | 吉林 | 22个 | 0 | 273ms | 0.1%  
江西 | 42个 | 1个 | 256ms | 0.2% | 江苏 | 92个 | 6个 | 274ms | 1.1%  
浙江 | 65个 | 2个 | 257ms | 0.9% | 重庆 | 8个 | 0 | 275ms | 0  
安徽 | 66个 | 0 | 257ms | 0.2% | 北京 | 8个 | 0 | 281ms | 3.3%  
广东 | 119个 | 1个 | 261ms | 0.8% | 云南 | 32个 | 0 | 285ms | 0.2%  
湖南 | 65个 | 0 | 261ms | 0.6% | 贵州 | 43个 | 1个 | 293ms | 0.5%  
辽宁 | 61个 | 0 | 264ms | 0.6% | 四川 | 73个 | 0 | 298ms | 1.4%  
河南 | 88个 | 0 | 267ms | 5.1% | 湖北 | 52个 | 0 | 306ms | 0.5%  
山东 | 91个 | 0 | 268ms | 7.2% | 新疆 | 36个 | 0 | 310ms | 2.2%  
河北 | 60个 | 0 | 269ms | 3.6% | 甘肃 | 32个 | 0 | 312ms | 0.3%  
福建 | 43个 | 0 | 270ms | 1.9% | 西藏 | 2个 | 0 | 323ms | 1.5%  
海南 | 14个 | 0 | 270ms | 0.3% | 宁夏 | 6个 | 0 | 326ms | 0  
内蒙古 | 55个 | 0 | 272ms | 1.6% | 青海 | 6个 | 0 | 340ms | 0.2%  
...
海外线路到Vultr澳大利亚-悉尼机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
澳大利亚 | 2个 | 0 | 20ms | 0 | 均值 | 81个 | 1个 | 244ms | 3.0%  
日本 | 3个 | 0 | 139ms | 0.3% | 印度尼西亚 | 1个 | 0 | 288ms | 6.7%  
新加坡 | 5个 | 0 | 162ms | 0 | 越南 | 2个 | 0 | 294ms | 0  
美国 | 15个 | 0 | 164ms | 0 | 意大利 | 1个 | 0 | 294ms | -  
韩国 | 12个 | 1个 | 188ms | 0 | 荷兰 | 1个 | 0 | 295ms | 0  
马来西亚 | 6个 | 0 | 188ms | 0.5% | 德国 | 3个 | 0 | 312ms | 0  
台湾 | 2个 | 0 | 188ms | 0 | 俄罗斯 | 1个 | 0 | 337ms | -  
香港 | 20个 | 0 | 216ms | 0 | 菲律宾 | 2个 | 0 | 356ms | 28.3%  
加拿大 | 3个 | 0 | 227ms | 0 | 赞比亚 | 2个 | 0 | 490ms | 8.7%  
