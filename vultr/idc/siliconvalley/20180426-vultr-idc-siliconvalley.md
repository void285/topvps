#  多地到Vultr硅谷[SiliconValley]机房的Ping测试（20180426） 
...
大陆各省份到Vultr美国-硅谷机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 184ms | 1.0% | 辽宁 | 36个 | 0 | 222ms | 3.3%  
北京 | 3个 | 0 | 185ms | 0.7% | 陕西 | 27个 | 0 | 223ms | 3.4%  
上海 | 8个 | 0 | 203ms | 4.5% | 安徽 | 38个 | 0 | 223ms | 2.2%  
山东 | 40个 | 0 | 206ms | 1.8% | 云南 | 24个 | 0 | 225ms | 3.8%  
浙江 | 35个 | 2个 | 207ms | 1.2% | 江西 | 20个 | 0 | 226ms | 2.0%  
广东 | 51个 | 0 | 207ms | 1.8% | 黑龙江 | 29个 | 0 | 226ms | 2.4%  
湖南 | 33个 | 0 | 207ms | 1.5% | 海南 | 10个 | 0 | 227ms | 1.9%  
山西 | 29个 | 0 | 208ms | 2.0% | 内蒙古 | 26个 | 0 | 230ms | 1.4%  
江苏 | 49个 | 1个 | 209ms | 1.5% | 重庆 | 10个 | 1个 | 232ms | 2.6%  
福建 | 27个 | 0 | 209ms | 1.3% | 贵州 | 22个 | 0 | 241ms | 2.9%  
广西 | 27个 | 1个 | 212ms | 3.5% | 四川 | 33个 | 0 | 242ms | 2.5%  
河北 | 34个 | 1个 | 212ms | 1.0% | 宁夏 | 9个 | 0 | 252ms | 7.3%  
湖北 | 38个 | 0 | 215ms | 1.9% | 甘肃 | 21个 | 1个 | 256ms | 2.9%  
吉林 | 14个 | 0 | 216ms | 1.0% | 西藏 | 1个 | 0 | 260ms | 0  
河南 | 50个 | 0 | 217ms | 1.6% | 青海 | 4个 | 0 | 260ms | 0.5%  
均值 | 776个 | 7个 | 220ms | 2.2% | 新疆 | 23个 | 0 | 276ms | 4.4%  
...
海外线路到Vultr美国-硅谷机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 16个 | 0 | 18ms | 0 | 台湾 | 1个 | 0 | 171ms | -  
加拿大 | 4个 | 0 | 73ms | 0 | 新加坡 | 5个 | 0 | 177ms | 0  
日本 | 3个 | 0 | 123ms | 0.7% | 均值 | 79个 | 1个 | 192ms | 2.7%  
荷兰 | 2个 | 0 | 145ms | 0 | 俄罗斯 | 1个 | 0 | 238ms | 0  
韩国 | 12个 | 0 | 146ms | 0.2% | 马来西亚 | 4个 | 0 | 239ms | 1.0%  
法国 | 2个 | 0 | 150ms | 0 | 越南 | 1个 | 0 | 258ms | 0  
香港 | 19个 | 1个 | 153ms | 0 | 南非 | 1个 | 0 | 295ms | 0  
英国 | 3个 | 0 | 156ms | 0 | 印度尼西亚 | 1个 | 0 | 316ms | 3.0%  
德国 | 1个 | 0 | 159ms | 0 | 柬埔寨 | 1个 | 0 | 479ms | 41.0%  
澳大利亚 | 2个 | 0 | 166ms | 0 |  |  |  |  |   
