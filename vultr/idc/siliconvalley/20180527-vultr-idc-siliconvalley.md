#  多地到Vultr硅谷[SiliconValley]机房的Ping测试（20180527） 
...
大陆各省份到Vultr美国-硅谷机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 4个 | 0 | 189ms | 12.3% | 辽宁 | 40个 | 1个 | 216ms | 14.6%  
上海 | 7个 | 0 | 199ms | 9.6% | 均值 | 971个 | 15个 | 216ms | 11.1%  
广东 | 79个 | 0 | 201ms | 6.9% | 陕西 | 33个 | 1个 | 218ms | 11.7%  
山东 | 51个 | 1个 | 203ms | 13.9% | 浙江 | 52个 | 1个 | 220ms | 9.6%  
河北 | 34个 | 0 | 203ms | 4.3% | 江西 | 25个 | 0 | 220ms | 6.8%  
山西 | 40个 | 0 | 203ms | 12.2% | 海南 | 14个 | 0 | 221ms | 15.8%  
北京 | 9个 | 1个 | 205ms | 7.5% | 黑龙江 | 39个 | 0 | 222ms | 12.5%  
江苏 | 63个 | 1个 | 206ms | 11.2% | 内蒙古 | 32个 | 0 | 223ms | 12.0%  
安徽 | 38个 | 0 | 208ms | 7.4% | 吉林 | 18个 | 0 | 226ms | 13.7%  
河南 | 57个 | 4个 | 209ms | 12.0% | 云南 | 20个 | 1个 | 227ms | 8.4%  
福建 | 33个 | 1个 | 210ms | 12.8% | 湖北 | 44个 | 1个 | 234ms | 9.1%  
贵州 | 27个 | 0 | 211ms | 12.8% | 青海 | 3个 | 0 | 241ms | 5.0%  
湖南 | 45个 | 0 | 211ms | 16.9% | 四川 | 46个 | 1个 | 242ms | 12.6%  
宁夏 | 13个 | 0 | 215ms | 9.8% | 甘肃 | 22个 | 0 | 245ms | 8.9%  
广西 | 39个 | 0 | 216ms | 10.9% | 新疆 | 29个 | 0 | 257ms | 12.9%  
...
海外线路到Vultr美国-硅谷机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 21个 | 0 | 13ms | 4.8% | 巴西 | 1个 | 0 | 172ms | 0  
加拿大 | 3个 | 0 | 75ms | 0 | 澳大利亚 | 2个 | 0 | 172ms | 0  
日本 | 2个 | 0 | 123ms | 0.5% | 新加坡 | 5个 | 0 | 176ms | 0  
意大利 | 1个 | 0 | 140ms | - | 均值 | 87个 | 1个 | 179ms | 1.3%  
法国 | 1个 | 0 | 146ms | 0 | 越南 | 2个 | 0 | 180ms | 0  
荷兰 | 1个 | 0 | 146ms | 0 | 菲律宾 | 1个 | 0 | 210ms | 0  
台湾 | 1个 | 0 | 149ms | - | 马来西亚 | 5个 | 0 | 213ms | 0.2%  
英国 | 2个 | 0 | 151ms | 0 | 俄罗斯 | 1个 | 0 | 239ms | 0  
德国 | 2个 | 0 | 161ms | 0 | 印度尼西亚 | 1个 | 0 | 273ms | 0  
香港 | 20个 | 1个 | 162ms | 0 | 南非 | 2个 | 0 | 332ms | 3.5%  
韩国 | 12个 | 0 | 164ms | 0 | 柬埔寨 | 1个 | 0 | 360ms | 16.0%  
