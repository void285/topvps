...
大陆各省份到Vultr美国-硅谷机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 9个 | 0 | 190ms | 0.2% | 湖南 | 71个 | 0 | 210ms | 2.3%  
重庆 | 9个 | 0 | 193ms | 1.4% | 湖北 | 53个 | 0 | 212ms | 6.2%  
海南 | 14个 | 0 | 193ms | 1.2% | 均值 | 1426个 | 10个 | 212ms | 2.5%  
江苏 | 93个 | 4个 | 197ms | 2.0% | 江西 | 39个 | 0 | 213ms | 2.1%  
安徽 | 70个 | 0 | 197ms | 2.6% | 天津 | 7个 | 0 | 217ms | 3.0%  
浙江 | 66个 | 2个 | 198ms | 2.2% | 内蒙古 | 57个 | 0 | 218ms | 2.7%  
山东 | 93个 | 0 | 200ms | 2.9% | 黑龙江 | 55个 | 0 | 219ms | 2.3%  
广东 | 123个 | 2个 | 201ms | 2.1% | 贵州 | 42个 | 0 | 221ms | 2.5%  
山西 | 58个 | 2个 | 203ms | 1.1% | 陕西 | 42个 | 0 | 223ms | 0.9%  
广西 | 63个 | 0 | 205ms | 2.9% | 云南 | 34个 | 0 | 228ms | 2.5%  
吉林 | 20个 | 0 | 206ms | 1.0% | 河南 | 88个 | 0 | 234ms | 1.1%  
上海 | 8个 | 0 | 206ms | 0 | 四川 | 71个 | 0 | 234ms | 4.0%  
福建 | 40个 | 0 | 207ms | 2.4% | 甘肃 | 33个 | 0 | 237ms | 2.1%  
辽宁 | 60个 | 0 | 207ms | 2.3% | 青海 | 5个 | 0 | 253ms | 6.7%  
河北 | 62个 | 0 | 208ms | 4.4% | 新疆 | 33个 | 0 | 261ms | 4.1%  
宁夏 | 7个 | 0 | 209ms | 2.9% | 西藏 | 1个 | 0 | 399ms | 7.0%  
...
海外线路到Vultr美国-硅谷机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 16个 | 0 | 31ms | 0 | 德国 | 3个 | 0 | 168ms | 0  
加拿大 | 3个 | 0 | 71ms | 0 | 均值 | 81个 | 0 | 174ms | 0.9%  
台湾 | 2个 | 0 | 87ms | 0 | 菲律宾 | 1个 | 0 | 189ms | 0  
韩国 | 12个 | 0 | 126ms | 0 | 俄罗斯 | 1个 | 0 | 197ms | -  
日本 | 3个 | 0 | 139ms | 0 | 越南 | 2个 | 0 | 209ms | 0  
新加坡 | 5个 | 0 | 146ms | 0 | 马来西亚 | 6个 | 0 | 215ms | 0  
意大利 | 1个 | 0 | 149ms | - | 荷兰 | 1个 | 0 | 234ms | 0  
香港 | 21个 | 0 | 157ms | 0 | 印度尼西亚 | 1个 | 0 | 328ms | 3.3%  
澳大利亚 | 2个 | 0 | 167ms | 1.7% | 赞比亚 | 1个 | 0 | 345ms | 9.0%  
