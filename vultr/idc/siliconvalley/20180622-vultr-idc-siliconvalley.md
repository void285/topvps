...
大陆各省份到Vultr美国-硅谷机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
山东 | 42个 | 0 | 188ms | 0.4% | 重庆 | 12个 | 0 | 219ms | 1.9%  
北京 | 9个 | 0 | 189ms | 0 | 吉林 | 18个 | 0 | 221ms | 1.1%  
海南 | 12个 | 0 | 192ms | 0.6% | 湖北 | 36个 | 0 | 222ms | 1.9%  
河北 | 34个 | 0 | 193ms | 0.2% | 黑龙江 | 33个 | 0 | 224ms | 1.8%  
江苏 | 69个 | 1个 | 201ms | 1.4% | 安徽 | 34个 | 1个 | 225ms | 2.2%  
上海 | 8个 | 1个 | 201ms | 0.7% | 贵州 | 25个 | 1个 | 228ms | 1.8%  
河南 | 52个 | 0 | 206ms | 0.7% | 江西 | 23个 | 0 | 228ms | 1.8%  
浙江 | 53个 | 1个 | 206ms | 1.5% | 四川 | 40个 | 0 | 230ms | 1.7%  
天津 | 3个 | 0 | 206ms | 3.3% | 宁夏 | 13个 | 0 | 231ms | 2.2%  
辽宁 | 36个 | 0 | 207ms | 0.8% | 陕西 | 30个 | 0 | 233ms | 1.6%  
广东 | 80个 | 1个 | 208ms | 1.6% | 甘肃 | 21个 | 0 | 241ms | 1.2%  
广西 | 43个 | 0 | 214ms | 1.9% | 云南 | 14个 | 0 | 250ms | 3.8%  
山西 | 38个 | 0 | 214ms | 1.2% | 青海 | 3个 | 0 | 252ms | 1.7%  
福建 | 30个 | 0 | 216ms | 3.3% | 新疆 | 26个 | 0 | 268ms | 1.6%  
湖南 | 37个 | 0 | 216ms | 1.0% | 西藏 | 1个 | 0 | 303ms | 5.0%  
均值 | 929个 | 9个 | 216ms | 1.5% | 香港 | 22个 | 3个 | - | -  
内蒙古 | 32个 | 0 | 217ms | 1.3% |  |  |  |  |   
...
海外线路到Vultr美国-硅谷机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 19个 | 0 | 30ms | 0 | 意大利 | 1个 | 0 | 156ms | -  
加拿大 | 2个 | 0 | 77ms | 0 | 韩国 | 13个 | 0 | 158ms | 0  
日本 | 2个 | 0 | 119ms | 1.0% | 法国 | 1个 | 0 | 159ms | 0  
香港 | 22个 | 3个 | 134ms | 0 | 澳大利亚 | 1个 | 0 | 167ms | 0  
台湾 | 2个 | 0 | 137ms | 0 | 菲律宾 | 2个 | 0 | 175ms | 0  
巴西 | 1个 | 0 | 141ms | 0 | 英国 | 1个 | 0 | 176ms | 0  
新加坡 | 5个 | 0 | 144ms | 0 | 南非 | 2个 | 0 | 180ms | 0  
均值 | 78个 | 3个 | 149ms | 0.1% | 越南 | 2个 | 0 | 183ms | 0  
德国 | 1个 | 0 | 152ms | - | 印度尼西亚 | 1个 | 0 | 256ms | 1.0%  
