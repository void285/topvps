...
大陆各省份到Vultr美国-新泽西机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 8个 | 0 | 247ms | 3.1% | 山东 | 94个 | 0 | 271ms | 8.2%  
北京 | 8个 | 0 | 250ms | 1.4% | 甘肃 | 32个 | 0 | 272ms | 0.1%  
安徽 | 71个 | 1个 | 251ms | 2.8% | 均值 | 1439个 | 11个 | 273ms | 5.6%  
广东 | 124个 | 1个 | 252ms | 4.4% | 海南 | 14个 | 0 | 275ms | 6.3%  
宁夏 | 7个 | 0 | 255ms | 0 | 陕西 | 43个 | 0 | 277ms | 3.6%  
江苏 | 93个 | 4个 | 256ms | 4.5% | 辽宁 | 60个 | 0 | 277ms | 11.3%  
福建 | 47个 | 0 | 257ms | 2.2% | 贵州 | 43个 | 1个 | 279ms | 6.8%  
青海 | 5个 | 0 | 260ms | 0 | 云南 | 34个 | 0 | 282ms | 1.3%  
浙江 | 65个 | 2个 | 261ms | 2.6% | 内蒙古 | 57个 | 0 | 283ms | 8.5%  
江西 | 40个 | 0 | 261ms | 4.3% | 山西 | 59个 | 1个 | 286ms | 9.2%  
天津 | 7个 | 0 | 265ms | 0 | 四川 | 71个 | 1个 | 287ms | 2.8%  
湖北 | 52个 | 0 | 266ms | 3.9% | 河南 | 87个 | 0 | 294ms | 9.7%  
湖南 | 71个 | 0 | 267ms | 5.6% | 黑龙江 | 56个 | 0 | 306ms | 8.1%  
广西 | 64个 | 0 | 268ms | 3.0% | 吉林 | 21个 | 0 | 308ms | 18.7%  
重庆 | 9个 | 0 | 269ms | 2.2% | 新疆 | 35个 | 0 | 329ms | 4.5%  
河北 | 60个 | 0 | 269ms | 7.4% | 西藏 | 2个 | 0 | 351ms | 7.0%  
...
海外线路到Vultr美国-新泽西机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 23ms | 0 | 香港 | 21个 | 0 | 189ms | 0  
意大利 | 1个 | 0 | 74ms | - | 日本 | 3个 | 0 | 194ms | 3.3%  
美国 | 16个 | 0 | 82ms | 0 | 新加坡 | 5个 | 0 | 212ms | 0  
德国 | 3个 | 0 | 97ms | 0 | 菲律宾 | 1个 | 0 | 224ms | 1.0%  
俄罗斯 | 1个 | 0 | 122ms | - | 澳大利亚 | 2个 | 0 | 240ms | 0.5%  
台湾 | 2个 | 0 | 127ms | 0 | 越南 | 2个 | 0 | 241ms | 0  
荷兰 | 1个 | 0 | 171ms | 0 | 马来西亚 | 6个 | 0 | 278ms | 0  
均值 | 80个 | 0 | 180ms | 0.6% | 印度尼西亚 | 1个 | 0 | 427ms | 3.3%  
韩国 | 12个 | 0 | 185ms | 0 |  |  |  |  |   
