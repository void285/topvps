...
大陆各省份到Vultr美国-新泽西机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 4个 | 1个 | 265ms | 11.0% | 辽宁 | 35个 | 1个 | 307ms | 1.9%  
广东 | 57个 | 0 | 280ms | 1.5% | 福建 | 27个 | 0 | 308ms | 2.6%  
黑龙江 | 30个 | 0 | 287ms | 0.7% | 安徽 | 37个 | 0 | 308ms | 1.3%  
山西 | 28个 | 0 | 288ms | 2.2% | 天津 | 5个 | 0 | 309ms | 3.5%  
山东 | 48个 | 0 | 292ms | 1.3% | 江西 | 23个 | 0 | 309ms | 1.9%  
河北 | 32个 | 0 | 292ms | 1.0% | 浙江 | 35个 | 2个 | 310ms | 4.6%  
湖北 | 36个 | 0 | 293ms | 1.4% | 广西 | 31个 | 0 | 310ms | 2.4%  
河南 | 50个 | 0 | 295ms | 0.6% | 青海 | 4个 | 1个 | 314ms | 0.3%  
江苏 | 49个 | 1个 | 295ms | 3.4% | 吉林 | 12个 | 1个 | 319ms | 1.4%  
海南 | 11个 | 0 | 296ms | 1.9% | 贵州 | 22个 | 0 | 322ms | 1.7%  
湖南 | 33个 | 0 | 297ms | 2.0% | 重庆 | 9个 | 1个 | 323ms | 1.5%  
陕西 | 27个 | 1个 | 300ms | 1.6% | 西藏 | 1个 | 0 | 325ms | 0  
内蒙古 | 30个 | 0 | 300ms | 1.9% | 四川 | 40个 | 0 | 329ms | 2.6%  
云南 | 26个 | 0 | 301ms | 1.2% | 甘肃 | 20个 | 0 | 330ms | 2.0%  
上海 | 8个 | 0 | 303ms | 0.9% | 宁夏 | 10个 | 0 | 334ms | 3.7%  
均值 | 805个 | 9个 | 303ms | 1.9% | 新疆 | 25个 | 0 | 347ms | 1.2%  
...
海外线路到Vultr美国-新泽西机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 4个 | 0 | 18ms | 0 | 韩国 | 12个 | 0 | 226ms | 0.3%  
美国 | 16个 | 0 | 64ms | 0 | 南非 | 1个 | 0 | 229ms | 0  
法国 | 2个 | 0 | 78ms | 0 | 香港 | 19个 | 0 | 230ms | 0  
荷兰 | 2个 | 0 | 81ms | 0 | 澳大利亚 | 2个 | 0 | 233ms | 0  
英国 | 3个 | 0 | 84ms | 0 | 越南 | 1个 | 0 | 259ms | 0  
德国 | 1个 | 0 | 87ms | 0 | 新加坡 | 5个 | 0 | 265ms | 0  
俄罗斯 | 1个 | 0 | 171ms | 0 | 马来西亚 | 4个 | 0 | 292ms | 0.3%  
日本 | 3个 | 0 | 178ms | 0.3% | 印度尼西亚 | 1个 | 0 | 369ms | 3.0%  
台湾 | 1个 | 0 | 196ms | - | 柬埔寨 | 1个 | 0 | 480ms | 43.0%  
均值 | 79个 | 0 | 196ms | 2.8% |  |  |  |  |   
