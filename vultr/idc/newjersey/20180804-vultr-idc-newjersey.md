...
大陆各省份到Vultr美国-新泽西机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 27个 | 4个 | 261ms | 0.2% | 广西 | 240个 | 0 | 326ms | 4.0%  
湖北 | 193个 | 0 | 302ms | 2.3% | 陕西 | 150个 | 0 | 327ms | 3.8%  
湖南 | 246个 | 0 | 302ms | 3.9% | 江苏 | 331个 | 9个 | 328ms | 6.9%  
浙江 | 220个 | 10个 | 305ms | 4.1% | 重庆 | 41个 | 3个 | 330ms | 7.3%  
河北 | 244个 | 0 | 305ms | 3.8% | 内蒙古 | 208个 | 0 | 330ms | 6.7%  
黑龙江 | 184个 | 0 | 306ms | 4.0% | 云南 | 123个 | 0 | 332ms | 4.0%  
海南 | 48个 | 0 | 307ms | 4.2% | 福建 | 160个 | 0 | 338ms | 6.4%  
天津 | 16个 | 0 | 308ms | 13.3% | 江西 | 131个 | 0 | 338ms | 2.7%  
山东 | 358个 | 0 | 310ms | 3.7% | 吉林 | 100个 | 0 | 340ms | 8.1%  
广东 | 437个 | 6个 | 310ms | 2.6% | 辽宁 | 226个 | 3个 | 344ms | 3.3%  
山西 | 193个 | 3个 | 311ms | 3.0% | 四川 | 277个 | 0 | 349ms | 3.5%  
贵州 | 146个 | 6个 | 318ms | 8.2% | 宁夏 | 32个 | 0 | 360ms | 2.2%  
北京 | 28个 | 0 | 320ms | 3.7% | 新疆 | 131个 | 0 | 373ms | 4.2%  
安徽 | 215个 | 0 | 324ms | 7.3% | 甘肃 | 112个 | 0 | 380ms | 2.6%  
均值 | 5208个 | 44个 | 324ms | 4.5% | 西藏 | 8个 | 0 | 390ms | 30.8%  
河南 | 367个 | 0 | 326ms | 5.5% | 青海 | 16个 | 0 | 404ms | 3.0%  
...
海外线路到Vultr美国-新泽西机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 15个 | 0 | 19ms | 0 | 日本 | 6个 | 0 | 190ms | 1.0%  
荷兰 | 3个 | 0 | 67ms | 0 | 香港 | 63个 | 3个 | 192ms | 0  
巴西 | 3个 | 0 | 72ms | 0 | 新加坡 | 15个 | 0 | 211ms | 0  
意大利 | 3个 | 0 | 72ms | - | 韩国 | 21个 | 0 | 213ms | 0  
美国 | 48个 | 0 | 94ms | 1.8% | 台湾 | 3个 | 0 | 216ms | 0  
德国 | 9个 | 0 | 96ms | 0 | 法国 | 3个 | 0 | 222ms | 0  
英国 | 6个 | 0 | 112ms | 1.0% | 澳大利亚 | 6个 | 0 | 233ms | 0  
俄罗斯 | 3个 | 0 | 117ms | - | 马来西亚 | 12个 | 0 | 265ms | 0.8%  
均值 | 237个 | 3个 | 169ms | 2.4% | 印度尼西亚 | 6个 | 0 | 270ms | 0  
南非 | 6个 | 0 | 173ms | 0 | 菲律宾 | 6个 | 0 | 390ms | 36.5%  
