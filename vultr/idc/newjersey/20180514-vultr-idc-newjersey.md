...
大陆各省份到Vultr美国-新泽西机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 8个 | 0 | 264ms | 0.5% | 贵州 | 28个 | 0 | 313ms | 6.8%  
北京 | 8个 | 1个 | 266ms | 0.5% | 广西 | 36个 | 0 | 313ms | 1.9%  
江西 | 23个 | 0 | 286ms | 13.2% | 均值 | 978个 | 12个 | 314ms | 6.1%  
浙江 | 51个 | 4个 | 289ms | 9.4% | 湖北 | 48个 | 0 | 315ms | 21.7%  
天津 | 5个 | 0 | 291ms | 7.7% | 辽宁 | 40个 | 0 | 320ms | 2.6%  
江苏 | 62个 | 2个 | 292ms | 16.7% | 内蒙古 | 36个 | 0 | 322ms | 3.9%  
广东 | 78个 | 2个 | 297ms | 1.1% | 云南 | 24个 | 0 | 327ms | 6.1%  
安徽 | 42个 | 1个 | 297ms | 9.6% | 重庆 | 15个 | 0 | 327ms | 2.0%  
宁夏 | 12个 | 0 | 298ms | 1.0% | 山西 | 38个 | 0 | 331ms | 3.3%  
陕西 | 33个 | 0 | 302ms | 1.9% | 河南 | 56个 | 0 | 333ms | 6.9%  
福建 | 35个 | 1个 | 304ms | 1.5% | 四川 | 49个 | 0 | 335ms | 4.2%  
黑龙江 | 39个 | 0 | 307ms | 2.1% | 青海 | 4个 | 0 | 337ms | 0.5%  
吉林 | 15个 | 0 | 309ms | 1.7% | 甘肃 | 22个 | 0 | 340ms | 1.8%  
海南 | 12个 | 0 | 310ms | 4.5% | 河北 | 34个 | 0 | 348ms | 10.2%  
山东 | 52个 | 1个 | 311ms | 2.4% | 新疆 | 29个 | 0 | 351ms | 1.6%  
湖南 | 43个 | 0 | 312ms | 10.3% | 西藏 | 1个 | 0 | 474ms | 0  
...
海外线路到Vultr美国-新泽西机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 17ms | 0 | 韩国 | 13个 | 0 | 204ms | 0  
美国 | 19个 | 0 | 60ms | 0 | 澳大利亚 | 1个 | 0 | 227ms | 0  
法国 | 2个 | 0 | 77ms | 0 | 菲律宾 | 1个 | 0 | 235ms | 2.0%  
英国 | 2个 | 0 | 85ms | 0 | 新加坡 | 6个 | 0 | 256ms | 0  
德国 | 2个 | 0 | 98ms | 0 | 香港 | 18个 | 0 | 260ms | 0  
巴西 | 1个 | 0 | 126ms | 0 | 马来西亚 | 3个 | 0 | 286ms | 0  
俄罗斯 | 1个 | 0 | 166ms | 0 | 南非 | 1个 | 0 | 299ms | 0  
日本 | 2个 | 0 | 174ms | 1.0% | 印度尼西亚 | 1个 | 0 | 332ms | 9.0%  
台湾 | 1个 | 0 | 192ms | - | 柬埔寨 | 1个 | 0 | 442ms | 35.0%  
均值 | 78个 | 0 | 196ms | 2.8% |  |  |  |  |   
