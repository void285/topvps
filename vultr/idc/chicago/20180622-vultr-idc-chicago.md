...
大陆各省份到Vultr美国-芝加哥机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 3个 | 0 | 254ms | 22.7% | 海南 | 10个 | 0 | 285ms | 16.0%  
福建 | 29个 | 0 | 259ms | 17.6% | 内蒙古 | 34个 | 1个 | 289ms | 21.0%  
北京 | 9个 | 0 | 262ms | 7.6% | 河北 | 34个 | 0 | 290ms | 28.6%  
浙江 | 52个 | 2个 | 265ms | 4.5% | 贵州 | 23个 | 0 | 291ms | 17.3%  
安徽 | 36个 | 1个 | 267ms | 10.4% | 广东 | 73个 | 2个 | 291ms | 15.2%  
上海 | 7个 | 1个 | 272ms | 2.9% | 黑龙江 | 32个 | 1个 | 292ms | 22.5%  
陕西 | 26个 | 0 | 273ms | 11.8% | 辽宁 | 35个 | 1个 | 293ms | 26.2%  
江苏 | 68个 | 2个 | 275ms | 15.7% | 甘肃 | 18个 | 0 | 294ms | 0.8%  
湖南 | 39个 | 0 | 275ms | 19.3% | 吉林 | 18个 | 1个 | 296ms | 33.2%  
湖北 | 38个 | 0 | 277ms | 12.8% | 四川 | 41个 | 0 | 298ms | 14.2%  
江西 | 26个 | 0 | 277ms | 12.6% | 河南 | 51个 | 1个 | 300ms | 22.6%  
重庆 | 13个 | 0 | 278ms | 12.2% | 宁夏 | 13个 | 0 | 302ms | 17.0%  
山西 | 34个 | 0 | 279ms | 30.8% | 青海 | 5个 | 0 | 308ms | 0  
广西 | 44个 | 0 | 280ms | 14.3% | 新疆 | 18个 | 0 | 312ms | 21.5%  
均值 | 923个 | 24个 | 284ms | 17.6% | 云南 | 25个 | 10个 | 318ms | 10.8%  
山东 | 45个 | 0 | 285ms | 29.3% | 香港 | 24个 | 1个 | - | -  
...
海外线路到Vultr美国-芝加哥机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 2个 | 0 | 27ms | 0 | 英国 | 2个 | 0 | 182ms | 0  
美国 | 18个 | 0 | 50ms | 0 | 香港 | 24个 | 1个 | 183ms | 0  
德国 | 1个 | 0 | 96ms | - | 新加坡 | 5个 | 0 | 187ms | 0  
法国 | 1个 | 0 | 98ms | 0 | 韩国 | 14个 | 0 | 195ms | 0  
意大利 | 1个 | 0 | 98ms | - | 菲律宾 | 2个 | 0 | 199ms | 0.5%  
巴西 | 1个 | 0 | 99ms | 0 | 越南 | 2个 | 0 | 210ms | 0  
均值 | 82个 | 1个 | 162ms | 0.3% | 澳大利亚 | 1个 | 0 | 217ms | 2.0%  
南非 | 2个 | 0 | 170ms | 0 | 印度尼西亚 | 1个 | 0 | 265ms | 0  
日本 | 1个 | 0 | 174ms | - | 马来西亚 | 2个 | 0 | 288ms | 2.5%  
台湾 | 2个 | 0 | 176ms | 0 |  |  |  |  |   
