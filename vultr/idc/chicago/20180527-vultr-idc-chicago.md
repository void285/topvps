...
大陆各省份到Vultr美国-芝加哥机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
河南 | 58个 | 2个 | 254ms | 5.7% | 广西 | 40个 | 0 | 277ms | 10.2%  
山东 | 53个 | 1个 | 255ms | 5.7% | 上海 | 7个 | 0 | 280ms | 4.3%  
河北 | 35个 | 0 | 262ms | 5.8% | 湖北 | 46个 | 1个 | 281ms | 10.1%  
山西 | 37个 | 0 | 262ms | 7.2% | 吉林 | 19个 | 0 | 281ms | 13.8%  
天津 | 5个 | 0 | 263ms | 17.5% | 内蒙古 | 33个 | 0 | 281ms | 10.4%  
黑龙江 | 39个 | 0 | 268ms | 14.3% | 江西 | 25个 | 0 | 282ms | 6.4%  
北京 | 8个 | 1个 | 268ms | 4.8% | 安徽 | 39个 | 0 | 282ms | 5.1%  
湖南 | 43个 | 2个 | 268ms | 12.2% | 贵州 | 27个 | 0 | 287ms | 13.2%  
江苏 | 62个 | 1个 | 271ms | 8.5% | 重庆 | 14个 | 1个 | 287ms | 7.3%  
广东 | 79个 | 2个 | 271ms | 5.0% | 云南 | 18个 | 1个 | 291ms | 11.6%  
福建 | 37个 | 0 | 273ms | 9.5% | 宁夏 | 13个 | 0 | 291ms | 10.5%  
海南 | 14个 | 0 | 275ms | 12.8% | 四川 | 46个 | 1个 | 295ms | 10.8%  
浙江 | 51个 | 0 | 276ms | 9.3% | 甘肃 | 22个 | 0 | 304ms | 5.5%  
陕西 | 32个 | 0 | 276ms | 10.2% | 青海 | 4个 | 0 | 306ms | 11.5%  
辽宁 | 40个 | 0 | 276ms | 7.9% | 新疆 | 29个 | 0 | 314ms | 7.7%  
...
海外线路到Vultr美国-芝加哥机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 4个 | 0 | 29ms | 0 | 俄罗斯 | 1个 | 0 | 190ms | 0  
美国 | 21个 | 0 | 52ms | 3.4% | 韩国 | 12个 | 0 | 194ms | 0  
意大利 | 1个 | 0 | 95ms | - | 香港 | 18个 | 0 | 211ms | 0  
荷兰 | 1个 | 0 | 97ms | 0 | 越南 | 2个 | 0 | 211ms | 0  
法国 | 1个 | 0 | 99ms | 0 | 新加坡 | 6个 | 0 | 222ms | 0  
英国 | 2个 | 0 | 103ms | 0 | 澳大利亚 | 1个 | 0 | 229ms | 0  
德国 | 3个 | 0 | 110ms | 0 | 菲律宾 | 1个 | 0 | 244ms | 1.0%  
巴西 | 1个 | 0 | 140ms | 0 | 马来西亚 | 5个 | 0 | 245ms | 0.2%  
日本 | 2个 | 0 | 165ms | 0 | 南非 | 2个 | 0 | 279ms | 3.5%  
均值 | 87个 | 0 | 179ms | 0.7% | 印度尼西亚 | 1个 | 0 | 284ms | 0  
台湾 | 1个 | 0 | 181ms | - | 柬埔寨 | 1个 | 0 | 385ms | 5.0%  
