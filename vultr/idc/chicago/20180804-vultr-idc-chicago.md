#  多地到Vultr芝加哥[Chicago]机房的Ping测试（20180804） 
...
大陆各省份到Vultr美国-芝加哥机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 27个 | 4个 | 225ms | 0 | 山西 | 109个 | 0 | 280ms | 2.5%  
天津 | 20个 | 0 | 228ms | 7.3% | 辽宁 | 154个 | 3个 | 281ms | 6.0%  
河北 | 128个 | 0 | 263ms | 14.4% | 均值 | 3113个 | 32个 | 283ms | 7.2%  
山东 | 178个 | 0 | 265ms | 4.5% | 吉林 | 64个 | 0 | 290ms | 9.3%  
湖北 | 117个 | 0 | 265ms | 8.4% | 重庆 | 41个 | 3个 | 293ms | 10.4%  
江苏 | 238个 | 9个 | 268ms | 8.5% | 贵州 | 90个 | 0 | 294ms | 11.4%  
广东 | 273个 | 0 | 268ms | 2.8% | 内蒙古 | 116个 | 0 | 294ms | 8.4%  
海南 | 28个 | 0 | 268ms | 4.1% | 云南 | 67个 | 0 | 296ms | 10.8%  
湖南 | 129个 | 3个 | 270ms | 5.5% | 江西 | 75个 | 0 | 299ms | 7.5%  
安徽 | 114个 | 3个 | 272ms | 9.6% | 四川 | 161个 | 0 | 310ms | 9.4%  
福建 | 92个 | 0 | 275ms | 5.6% | 河南 | 195个 | 0 | 311ms | 8.3%  
浙江 | 158个 | 7个 | 275ms | 7.0% | 甘肃 | 60个 | 0 | 327ms | 7.1%  
黑龙江 | 112个 | 0 | 275ms | 9.3% | 新疆 | 79个 | 0 | 336ms | 8.9%  
北京 | 32个 | 0 | 276ms | 5.0% | 青海 | 8个 | 0 | 343ms | 5.5%  
广西 | 131个 | 0 | 278ms | 3.4% | 宁夏 | 16个 | 0 | 347ms | 23.8%  
陕西 | 97个 | 0 | 279ms | 2.7% | 西藏 | 4个 | 0 | 434ms | 8.0%  
...
海外线路到Vultr美国-芝加哥机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 12个 | 0 | 21ms | 0 | 南非 | 6个 | 0 | 181ms | 0.5%  
荷兰 | 3个 | 0 | 54ms | 0 | 新加坡 | 15个 | 0 | 183ms | 0  
美国 | 48个 | 0 | 86ms | 4.2% | 香港 | 63个 | 0 | 185ms | 0  
巴西 | 3个 | 0 | 89ms | 0 | 韩国 | 21个 | 0 | 196ms | 0  
意大利 | 3个 | 0 | 95ms | - | 台湾 | 3个 | 0 | 198ms | 0  
德国 | 6个 | 0 | 110ms | 0 | 澳大利亚 | 3个 | 0 | 213ms | 0  
英国 | 3个 | 0 | 131ms | 0 | 法国 | 3个 | 0 | 228ms | 0  
俄罗斯 | 3个 | 0 | 143ms | - | 马来西亚 | 9个 | 0 | 260ms | 1.0%  
均值 | 213个 | 0 | 177ms | 3.9% | 印度尼西亚 | 3个 | 0 | 276ms | 0  
日本 | 3个 | 0 | 179ms | 1.0% | 菲律宾 | 3个 | 0 | 533ms | 60.0%  
