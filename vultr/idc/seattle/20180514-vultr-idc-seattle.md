#  多地到Vultr西雅图[Seattle]机房的Ping测试（20180514） 
...
大陆各省份到Vultr美国-西雅图机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
福建 | 35个 | 1个 | 197ms | 2.1% | 湖北 | 46个 | 0 | 218ms | 3.4%  
北京 | 7个 | 1个 | 200ms | 6.7% | 安徽 | 37个 | 1个 | 219ms | 2.5%  
上海 | 9个 | 0 | 200ms | 7.7% | 辽宁 | 39个 | 0 | 219ms | 9.6%  
广东 | 76个 | 1个 | 202ms | 1.8% | 均值 | 962个 | 13个 | 220ms | 5.8%  
海南 | 11个 | 0 | 207ms | 1.1% | 陕西 | 32个 | 0 | 222ms | 8.0%  
广西 | 39个 | 1个 | 208ms | 1.5% | 山东 | 49个 | 1个 | 223ms | 11.5%  
湖南 | 44个 | 1个 | 210ms | 1.7% | 贵州 | 27个 | 0 | 224ms | 5.8%  
浙江 | 51个 | 4个 | 211ms | 2.1% | 宁夏 | 12个 | 0 | 227ms | 9.8%  
天津 | 5个 | 0 | 211ms | 1.4% | 重庆 | 15个 | 0 | 234ms | 2.1%  
河北 | 32个 | 0 | 211ms | 6.9% | 四川 | 51个 | 0 | 236ms | 1.9%  
江苏 | 63个 | 1个 | 212ms | 4.3% | 黑龙江 | 39个 | 0 | 237ms | 11.0%  
江西 | 22个 | 0 | 215ms | 7.2% | 内蒙古 | 36个 | 0 | 239ms | 9.2%  
吉林 | 16个 | 0 | 215ms | 3.4% | 甘肃 | 21个 | 0 | 245ms | 12.8%  
山西 | 37个 | 0 | 215ms | 7.2% | 青海 | 4个 | 0 | 271ms | 17.3%  
河南 | 55个 | 0 | 216ms | 11.5% | 新疆 | 27个 | 0 | 279ms | 11.2%  
云南 | 25个 | 1个 | 217ms | 0.5% |  |  |  |  |   
...
海外线路到Vultr美国-西雅图机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 18个 | 0 | 32ms | 0.4% | 菲律宾 | 1个 | 0 | 166ms | 0  
加拿大 | 3个 | 0 | 79ms | 5.5% | 巴西 | 1个 | 0 | 172ms | 0  
日本 | 2个 | 0 | 120ms | 0.5% | 均值 | 81个 | 0 | 176ms | 1.3%  
台湾 | 1个 | 0 | 125ms | - | 澳大利亚 | 2个 | 0 | 183ms | 0  
韩国 | 13个 | 0 | 149ms | 0 | 马来西亚 | 3个 | 0 | 193ms | 0  
香港 | 19个 | 0 | 155ms | 0 | 新加坡 | 6个 | 0 | 195ms | 0  
法国 | 2个 | 0 | 157ms | 6.0% | 俄罗斯 | 1个 | 0 | 228ms | 0  
英国 | 2个 | 0 | 157ms | 0 | 印度尼西亚 | 1个 | 0 | 268ms | 7.0%  
荷兰 | 1个 | 0 | 159ms | 0 | 柬埔寨 | 1个 | 0 | 312ms | 4.0%  
德国 | 2个 | 0 | 163ms | 0 | 南非 | 2个 | 0 | 325ms | 0  
