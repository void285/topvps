...
大陆各省份到Vultr美国-西雅图机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
海南 | 14个 | 0 | 190ms | 0.1% | 河北 | 61个 | 0 | 222ms | 7.1%  
上海 | 9个 | 0 | 200ms | 5.0% | 均值 | 1434个 | 21个 | 223ms | 6.1%  
广东 | 124个 | 4个 | 205ms | 5.8% | 云南 | 35个 | 0 | 226ms | 5.1%  
重庆 | 8个 | 0 | 205ms | 3.3% | 贵州 | 41个 | 0 | 228ms | 7.8%  
浙江 | 66个 | 3个 | 206ms | 6.3% | 陕西 | 44个 | 0 | 235ms | 5.9%  
湖南 | 68个 | 0 | 208ms | 4.8% | 黑龙江 | 55个 | 0 | 238ms | 3.5%  
福建 | 44个 | 1个 | 209ms | 4.6% | 湖北 | 53个 | 0 | 239ms | 11.2%  
江西 | 41个 | 0 | 209ms | 4.5% | 内蒙古 | 57个 | 0 | 239ms | 3.4%  
河南 | 88个 | 0 | 211ms | 3.2% | 四川 | 75个 | 2个 | 241ms | 7.8%  
山东 | 92个 | 2个 | 211ms | 3.2% | 宁夏 | 7个 | 0 | 244ms | 13.3%  
江苏 | 92个 | 7个 | 212ms | 6.7% | 天津 | 7个 | 0 | 245ms | 12.4%  
北京 | 10个 | 0 | 213ms | 8.1% | 青海 | 5个 | 0 | 249ms | 10.5%  
山西 | 57个 | 2个 | 214ms | 2.6% | 安徽 | 68个 | 0 | 252ms | 15.7%  
辽宁 | 61个 | 0 | 219ms | 4.0% | 甘肃 | 33个 | 0 | 257ms | 13.2%  
广西 | 63个 | 0 | 220ms | 7.0% | 西藏 | 2个 | 0 | 275ms | 1.5%  
吉林 | 20个 | 0 | 220ms | 0.5% | 新疆 | 34个 | 0 | 281ms | 6.1%  
...
海外线路到Vultr美国-西雅图机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 16个 | 0 | 47ms | 0 | 均值 | 82个 | 0 | 184ms | 3.1%  
加拿大 | 3个 | 0 | 84ms | 0 | 澳大利亚 | 2个 | 0 | 188ms | 0  
台湾 | 2个 | 0 | 90ms | 0 | 俄罗斯 | 1个 | 0 | 190ms | -  
韩国 | 11个 | 0 | 130ms | 0 | 越南 | 2个 | 0 | 193ms | 0  
日本 | 3个 | 0 | 140ms | 1.0% | 荷兰 | 1个 | 0 | 225ms | 0  
意大利 | 1个 | 0 | 156ms | - | 印度尼西亚 | 1个 | 0 | 243ms | 3.3%  
香港 | 21个 | 0 | 157ms | 0 | 马来西亚 | 6个 | 0 | 259ms | 0.5%  
新加坡 | 5个 | 0 | 169ms | 0 | 赞比亚 | 2个 | 0 | 329ms | 7.3%  
德国 | 3个 | 0 | 172ms | 0 | 菲律宾 | 2个 | 0 | 354ms | 35.0%  
