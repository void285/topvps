...
大陆各省份到Vultr美国-西雅图机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广西 | 43个 | 1个 | 204ms | 1.6% | 均值 | 914个 | 39个 | 221ms | 3.5%  
湖南 | 36个 | 0 | 205ms | 1.9% | 安徽 | 36个 | 5个 | 223ms | 2.7%  
福建 | 34个 | 1个 | 207ms | 2.1% | 四川 | 42个 | 3个 | 225ms | 1.2%  
江苏 | 68个 | 6个 | 208ms | 3.3% | 宁夏 | 14个 | 0 | 226ms | 3.7%  
北京 | 10个 | 0 | 210ms | 2.9% | 甘肃 | 17个 | 0 | 229ms | 4.2%  
河南 | 51个 | 2个 | 211ms | 5.4% | 重庆 | 12个 | 1个 | 232ms | 7.9%  
广东 | 70个 | 1个 | 211ms | 5.0% | 黑龙江 | 33个 | 0 | 233ms | 3.3%  
浙江 | 49个 | 3个 | 213ms | 5.9% | 山西 | 35个 | 0 | 235ms | 1.5%  
湖北 | 36个 | 1个 | 215ms | 2.1% | 天津 | 3个 | 0 | 238ms | 4.8%  
山东 | 37个 | 1个 | 216ms | 3.5% | 内蒙古 | 34个 | 0 | 238ms | 3.3%  
江西 | 24个 | 0 | 216ms | 4.3% | 吉林 | 19个 | 0 | 239ms | 2.7%  
贵州 | 25个 | 0 | 220ms | 4.5% | 海南 | 10个 | 0 | 243ms | 11.4%  
河北 | 31个 | 0 | 220ms | 3.1% | 云南 | 24个 | 10个 | 244ms | 2.5%  
辽宁 | 35个 | 0 | 220ms | 3.8% | 青海 | 5个 | 0 | 252ms | 3.0%  
陕西 | 28个 | 0 | 221ms | 6.2% | 新疆 | 20个 | 0 | 268ms | 1.9%  
上海 | 8个 | 1个 | 221ms | 2.8% | 香港 | 25个 | 3个 | - | -  
...
海外线路到Vultr美国-西雅图机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 20个 | 0 | 44ms | 0 | 英国 | 1个 | 0 | 162ms | 0  
加拿大 | 2个 | 0 | 78ms | 0 | 新加坡 | 5个 | 0 | 162ms | 0  
日本 | 2个 | 0 | 134ms | 4.0% | 巴西 | 1个 | 0 | 163ms | 0  
香港 | 25个 | 3个 | 136ms | 0 | 德国 | 1个 | 0 | 165ms | -  
法国 | 1个 | 0 | 151ms | 0 | 意大利 | 1个 | 0 | 169ms | -  
台湾 | 2个 | 0 | 153ms | 0 | 南非 | 2个 | 0 | 180ms | 0  
韩国 | 14个 | 0 | 156ms | 0 | 澳大利亚 | 1个 | 0 | 183ms | 0  
均值 | 88个 | 3个 | 158ms | 0.3% | 马来西亚 | 4个 | 0 | 199ms | 0.3%  
越南 | 2个 | 0 | 160ms | 0 | 印度尼西亚 | 1个 | 0 | 225ms | 0  
菲律宾 | 2个 | 0 | 161ms | 0.5% | 柬埔寨 | 1个 | 0 | 233ms | 0  
