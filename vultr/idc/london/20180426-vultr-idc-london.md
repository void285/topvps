...
大陆各省份到Vultr英国-伦敦机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 268ms | 3.0% | 山西 | 34个 | 0 | 339ms | 2.7%  
北京 | 3个 | 1个 | 268ms | 15.0% | 湖南 | 39个 | 0 | 340ms | 3.9%  
上海 | 8个 | 0 | 284ms | 0.5% | 广西 | 34个 | 0 | 342ms | 3.5%  
浙江 | 39个 | 3个 | 299ms | 11.7% | 江西 | 23个 | 0 | 343ms | 12.1%  
海南 | 11个 | 0 | 312ms | 3.2% | 安徽 | 37个 | 0 | 344ms | 4.4%  
内蒙古 | 30个 | 0 | 316ms | 1.6% | 吉林 | 14个 | 0 | 346ms | 1.0%  
辽宁 | 35个 | 1个 | 317ms | 3.6% | 河南 | 46个 | 1个 | 348ms | 1.7%  
湖北 | 39个 | 0 | 321ms | 16.1% | 贵州 | 23个 | 0 | 348ms | 2.9%  
山东 | 44个 | 0 | 326ms | 1.4% | 云南 | 25个 | 0 | 351ms | 2.4%  
广东 | 63个 | 0 | 326ms | 1.4% | 福建 | 25个 | 0 | 352ms | 4.8%  
江苏 | 48个 | 3个 | 329ms | 15.2% | 新疆 | 27个 | 0 | 354ms | 3.3%  
宁夏 | 10个 | 0 | 335ms | 3.9% | 河北 | 32个 | 0 | 354ms | 1.6%  
均值 | 832个 | 11个 | 335ms | 4.6% | 四川 | 45个 | 0 | 356ms | 2.3%  
陕西 | 25个 | 0 | 337ms | 2.7% | 甘肃 | 20个 | 1个 | 358ms | 2.6%  
黑龙江 | 34个 | 0 | 339ms | 1.7% | 青海 | 4个 | 0 | 358ms | 2.8%  
重庆 | 9个 | 1个 | 339ms | 1.1% | 西藏 | 1个 | 0 | 405ms | 9.0%  
...
海外线路到Vultr英国-伦敦机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 2个 | 0 | 7ms | 0 | 香港 | 18个 | 1个 | 225ms | 0  
荷兰 | 2个 | 0 | 7ms | 0 | 越南 | 1个 | 0 | 231ms | 0  
英国 | 3个 | 0 | 14ms | 0 | 日本 | 3个 | 0 | 253ms | 0.7%  
德国 | 1个 | 0 | 15ms | 0 | 马来西亚 | 4个 | 0 | 255ms | 0.3%  
加拿大 | 4个 | 0 | 88ms | 0 | 台湾 | 1个 | 0 | 270ms | -  
俄罗斯 | 1个 | 0 | 105ms | 0 | 韩国 | 12个 | 0 | 283ms | 0  
美国 | 16个 | 0 | 131ms | 0 | 澳大利亚 | 2个 | 0 | 303ms | 0  
南非 | 1个 | 0 | 161ms | 0 | 印度尼西亚 | 1个 | 0 | 324ms | 3.0%  
均值 | 78个 | 1个 | 184ms | 2.3% | 柬埔寨 | 1个 | 0 | 453ms | 36.0%  
新加坡 | 5个 | 0 | 194ms | 0 |  |  |  |  |   
