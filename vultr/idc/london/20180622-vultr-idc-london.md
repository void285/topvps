#  多地到Vultr伦敦[London]机房的Ping测试（20180622） 
...
大陆各省份到Vultr英国-伦敦机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
河北 | 33个 | 0 | 269ms | 17.6% | 福建 | 34个 | 0 | 309ms | 7.9%  
天津 | 3个 | 0 | 278ms | 17.6% | 山东 | 39个 | 0 | 310ms | 21.9%  
内蒙古 | 34个 | 0 | 282ms | 13.6% | 广西 | 40个 | 0 | 313ms | 9.4%  
上海 | 8个 | 1个 | 294ms | 6.9% | 四川 | 40个 | 0 | 315ms | 7.4%  
安徽 | 37个 | 1个 | 296ms | 5.2% | 河南 | 52个 | 1个 | 318ms | 14.1%  
陕西 | 31个 | 0 | 298ms | 4.9% | 北京 | 9个 | 0 | 318ms | 5.6%  
海南 | 11个 | 0 | 299ms | 8.4% | 甘肃 | 17个 | 0 | 318ms | 1.0%  
辽宁 | 33个 | 1个 | 299ms | 16.4% | 黑龙江 | 31个 | 1个 | 322ms | 16.2%  
浙江 | 50个 | 1个 | 302ms | 3.8% | 贵州 | 23个 | 0 | 323ms | 13.0%  
广东 | 75个 | 0 | 304ms | 8.9% | 新疆 | 19个 | 0 | 323ms | 12.8%  
山西 | 36个 | 0 | 304ms | 18.9% | 江西 | 25个 | 0 | 324ms | 7.8%  
湖北 | 38个 | 0 | 305ms | 9.4% | 重庆 | 12个 | 0 | 324ms | 4.8%  
湖南 | 39个 | 0 | 306ms | 11.9% | 宁夏 | 13个 | 0 | 329ms | 10.8%  
青海 | 5个 | 0 | 307ms | 0 | 云南 | 23个 | 9个 | 331ms | 3.3%  
江苏 | 68个 | 2个 | 307ms | 10.5% | 吉林 | 19个 | 0 | 347ms | 18.9%  
均值 | 919个 | 17个 | 308ms | 10.9% | 香港 | 22个 | 0 | - | -  
...
海外线路到Vultr英国-伦敦机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
德国 | 1个 | 0 | 4ms | - | 香港 | 22个 | 0 | 202ms | 0  
意大利 | 1个 | 0 | 7ms | - | 印度尼西亚 | 1个 | 0 | 210ms | 0  
巴西 | 1个 | 0 | 8ms | 0 | 菲律宾 | 2个 | 0 | 229ms | 0  
法国 | 1个 | 0 | 14ms | 0 | 马来西亚 | 5个 | 0 | 235ms | 0.4%  
英国 | 1个 | 0 | 32ms | 0 | 韩国 | 13个 | 0 | 253ms | 0  
加拿大 | 2个 | 0 | 89ms | 0 | 日本 | 2个 | 0 | 265ms | 4.0%  
美国 | 19个 | 0 | 120ms | 0 | 越南 | 2个 | 0 | 267ms | 0  
新加坡 | 5个 | 0 | 165ms | 5.0% | 台湾 | 1个 | 0 | 270ms | 0  
均值 | 83个 | 0 | 166ms | 0.6% | 澳大利亚 | 1个 | 0 | 297ms | 0  
南非 | 2个 | 0 | 179ms | 0 | 柬埔寨 | 1个 | 0 | 322ms | 1.0%  
