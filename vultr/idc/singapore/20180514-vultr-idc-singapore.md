...
大陆各省份到Vultr新加坡-新加坡机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
福建 | 35个 | 1个 | 144ms | 1.7% | 宁夏 | 12个 | 0 | 179ms | 5.9%  
湖南 | 48个 | 0 | 144ms | 3.2% | 浙江 | 52个 | 3个 | 180ms | 5.0%  
广西 | 36个 | 1个 | 146ms | 4.4% | 河南 | 59个 | 0 | 185ms | 8.4%  
广东 | 83个 | 1个 | 148ms | 2.7% | 均值 | 972个 | 13个 | 186ms | 7.7%  
海南 | 12个 | 0 | 149ms | 3.6% | 山东 | 50个 | 1个 | 191ms | 10.2%  
安徽 | 39个 | 0 | 150ms | 6.9% | 重庆 | 15个 | 0 | 191ms | 4.1%  
云南 | 24个 | 0 | 151ms | 2.5% | 湖北 | 47个 | 0 | 196ms | 11.1%  
北京 | 8个 | 1个 | 155ms | 3.6% | 吉林 | 13个 | 0 | 200ms | 10.1%  
天津 | 5个 | 0 | 157ms | 8.9% | 黑龙江 | 40个 | 0 | 206ms | 11.9%  
上海 | 9个 | 0 | 157ms | 6.7% | 陕西 | 30个 | 0 | 211ms | 15.6%  
贵州 | 27个 | 0 | 159ms | 4.3% | 四川 | 49个 | 0 | 219ms | 9.9%  
江西 | 22个 | 0 | 163ms | 8.8% | 辽宁 | 37个 | 0 | 228ms | 11.1%  
甘肃 | 21个 | 0 | 169ms | 4.8% | 内蒙古 | 33个 | 0 | 231ms | 11.2%  
西藏 | 1个 | 0 | 170ms | 0 | 新疆 | 28个 | 0 | 239ms | 10.0%  
江苏 | 63个 | 5个 | 171ms | 6.0% | 山西 | 38个 | 0 | 240ms | 12.8%  
青海 | 3个 | 0 | 175ms | 3.7% | 河北 | 33个 | 0 | 262ms | 12.3%  
...
海外线路到Vultr新加坡-新加坡机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 6个 | 0 | 1ms | 2.7% | 美国 | 19个 | 0 | 198ms | 0  
马来西亚 | 3个 | 0 | 25ms | 5.3% | 柬埔寨 | 1个 | 0 | 222ms | 2.0%  
香港 | 19个 | 0 | 47ms | 0 | 德国 | 2个 | 0 | 229ms | 3.5%  
菲律宾 | 1个 | 0 | 59ms | 8.0% | 英国 | 2个 | 0 | 235ms | 3.5%  
台湾 | 1个 | 0 | 62ms | - | 法国 | 2个 | 0 | 248ms | 4.0%  
日本 | 2个 | 0 | 87ms | 4.0% | 加拿大 | 3个 | 0 | 249ms | 8.0%  
韩国 | 13个 | 0 | 93ms | 2.3% | 澳大利亚 | 2个 | 0 | 260ms | 4.0%  
印度尼西亚 | 1个 | 0 | 126ms | 22.0% | 巴西 | 1个 | 0 | 365ms | 0  
俄罗斯 | 1个 | 0 | 168ms | 0 | 南非 | 1个 | 0 | 379ms | 11.0%  
均值 | 80个 | 0 | 169ms | 4.7% |  |  |  |  |   
