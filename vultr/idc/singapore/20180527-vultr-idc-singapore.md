#  多地到Vultr新加坡[Singapore]机房的Ping测试（20180527） 
...
大陆各省份到Vultr新加坡-新加坡机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
青海 | 4个 | 0 | 191ms | 8.3% | 天津 | 5个 | 0 | 227ms | 15.3%  
北京 | 8个 | 1个 | 197ms | 14.3% | 均值 | 972个 | 22个 | 230ms | 13.3%  
湖南 | 43个 | 0 | 197ms | 10.6% | 上海 | 8个 | 0 | 233ms | 21.5%  
安徽 | 38个 | 1个 | 202ms | 12.6% | 湖北 | 44个 | 1个 | 235ms | 14.8%  
江西 | 25个 | 0 | 203ms | 12.9% | 山西 | 36个 | 0 | 244ms | 8.6%  
广东 | 83个 | 3个 | 207ms | 11.3% | 甘肃 | 22个 | 0 | 247ms | 13.6%  
广西 | 41个 | 2个 | 209ms | 11.5% | 宁夏 | 13个 | 0 | 249ms | 13.2%  
福建 | 37个 | 0 | 210ms | 12.6% | 重庆 | 14个 | 1个 | 253ms | 15.3%  
浙江 | 50个 | 4个 | 211ms | 16.9% | 新疆 | 26个 | 0 | 254ms | 13.8%  
黑龙江 | 39个 | 0 | 211ms | 10.9% | 陕西 | 34个 | 0 | 262ms | 18.0%  
海南 | 14个 | 0 | 211ms | 13.8% | 四川 | 46个 | 1个 | 263ms | 19.1%  
江苏 | 61个 | 5个 | 217ms | 15.3% | 内蒙古 | 32个 | 0 | 266ms | 18.3%  
云南 | 20个 | 0 | 219ms | 13.6% | 吉林 | 19个 | 0 | 269ms | 14.2%  
河南 | 56个 | 1个 | 221ms | 10.9% | 河北 | 35个 | 0 | 273ms | 10.8%  
山东 | 52个 | 2个 | 226ms | 12.0% | 辽宁 | 40个 | 0 | 280ms | 12.5%  
贵州 | 27个 | 0 | 226ms | 10.2% |  |  |  |  |   
...
海外线路到Vultr新加坡-新加坡机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 5个 | 0 | 1ms | 0 | 俄罗斯 | 1个 | 0 | 165ms | 0  
印度尼西亚 | 1个 | 0 | 21ms | 0 | 美国 | 21个 | 0 | 185ms | 0.2%  
马来西亚 | 5个 | 0 | 26ms | 0 | 法国 | 1个 | 0 | 190ms | 0  
越南 | 2个 | 0 | 52ms | 0 | 荷兰 | 1个 | 0 | 192ms | 0  
香港 | 19个 | 0 | 57ms | 0 | 英国 | 2个 | 0 | 228ms | 0  
菲律宾 | 1个 | 0 | 60ms | 0 | 德国 | 3个 | 0 | 241ms | 0  
台湾 | 1个 | 0 | 62ms | - | 意大利 | 1个 | 0 | 244ms | -  
日本 | 2个 | 0 | 85ms | 0 | 加拿大 | 3个 | 0 | 253ms | 0  
韩国 | 12个 | 0 | 93ms | 0 | 澳大利亚 | 1个 | 0 | 272ms | 0  
均值 | 86个 | 0 | 159ms | 0.2% | 巴西 | 1个 | 0 | 358ms | 0  
柬埔寨 | 1个 | 0 | 163ms | 1.0% | 南非 | 2个 | 0 | 399ms | 2.5%  
