...
大陆各省份到Vultr新加坡-新加坡机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广东 | 282个 | 3个 | 178ms | 7.0% | 北京 | 36个 | 0 | 240ms | 10.9%  
湖南 | 141个 | 0 | 191ms | 12.4% | 均值 | 3157个 | 68个 | 243ms | 18.8%  
重庆 | 41个 | 0 | 196ms | 10.0% | 陕西 | 97个 | 0 | 255ms | 16.7%  
上海 | 27个 | 4个 | 206ms | 30.1% | 河北 | 132个 | 0 | 262ms | 13.8%  
江西 | 75个 | 0 | 215ms | 32.0% | 四川 | 169个 | 3个 | 274ms | 16.5%  
海南 | 28个 | 0 | 215ms | 14.1% | 甘肃 | 60个 | 0 | 278ms | 30.0%  
浙江 | 174个 | 22个 | 218ms | 25.4% | 黑龙江 | 84个 | 0 | 280ms | 18.2%  
河南 | 199个 | 0 | 223ms | 14.4% | 宁夏 | 16个 | 0 | 285ms | 32.8%  
云南 | 67个 | 0 | 223ms | 15.1% | 天津 | 20个 | 0 | 288ms | 22.3%  
安徽 | 112个 | 0 | 223ms | 35.0% | 山西 | 113个 | 0 | 291ms | 14.3%  
贵州 | 94个 | 3个 | 226ms | 19.3% | 新疆 | 75个 | 0 | 298ms | 27.3%  
广西 | 124个 | 0 | 227ms | 14.7% | 西藏 | 4个 | 0 | 306ms | 4.0%  
福建 | 88个 | 3个 | 228ms | 26.9% | 青海 | 8个 | 0 | 308ms | 36.0%  
湖北 | 113个 | 0 | 228ms | 14.4% | 内蒙古 | 112个 | 0 | 314ms | 20.1%  
山东 | 210个 | 0 | 234ms | 17.8% | 辽宁 | 150个 | 6个 | 315ms | 22.5%  
江苏 | 242个 | 24个 | 239ms | 25.7% | 吉林 | 64个 | 0 | 338ms | 23.8%  
...
海外线路到Vultr新加坡-新加坡机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
印度尼西亚 | 3个 | 0 | 28ms | 0 | 均值 | 216个 | 0 | 179ms | 3.0%  
新加坡 | 15个 | 0 | 33ms | 0 | 澳大利亚 | 3个 | 0 | 180ms | 0  
台湾 | 3个 | 0 | 72ms | 0 | 荷兰 | 3个 | 0 | 183ms | 0  
马来西亚 | 9个 | 0 | 80ms | 1.0% | 加拿大 | 12个 | 0 | 246ms | 0  
韩国 | 21个 | 0 | 86ms | 0 | 意大利 | 3个 | 0 | 250ms | -  
香港 | 66个 | 0 | 90ms | 0 | 德国 | 6个 | 0 | 254ms | 0  
日本 | 3个 | 0 | 101ms | 0 | 英国 | 3个 | 0 | 272ms | 0  
巴西 | 3个 | 0 | 155ms | 0 | 南非 | 6个 | 0 | 282ms | 0.5%  
美国 | 48个 | 0 | 164ms | 0 | 俄罗斯 | 3个 | 0 | 284ms | -  
法国 | 3个 | 0 | 168ms | 0 | 菲律宾 | 3个 | 0 | 477ms | 49.0%  
