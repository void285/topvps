#  多地到Vultr新加坡[Singapore]机房的Ping测试（20180426） 
...
大陆各省份到Vultr新加坡-新加坡机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
福建 | 27个 | 0 | 151ms | 4.0% | 宁夏 | 10个 | 0 | 195ms | 10.3%  
上海 | 8个 | 0 | 158ms | 7.3% | 天津 | 5个 | 0 | 200ms | 2.8%  
安徽 | 38个 | 0 | 162ms | 5.2% | 均值 | 844个 | 6个 | 200ms | 4.6%  
海南 | 11个 | 0 | 163ms | 4.6% | 河南 | 52个 | 0 | 202ms | 3.9%  
广东 | 63个 | 0 | 163ms | 1.6% | 湖北 | 39个 | 0 | 205ms | 5.8%  
湖南 | 41个 | 0 | 163ms | 4.8% | 西藏 | 1个 | 0 | 210ms | 4.0%  
云南 | 24个 | 0 | 164ms | 3.0% | 山东 | 44个 | 0 | 215ms | 4.3%  
重庆 | 9个 | 0 | 169ms | 5.2% | 陕西 | 26个 | 1个 | 215ms | 3.6%  
北京 | 4个 | 1个 | 172ms | 5.3% | 四川 | 45个 | 0 | 225ms | 6.4%  
广西 | 35个 | 0 | 174ms | 7.9% | 黑龙江 | 34个 | 1个 | 230ms | 3.8%  
浙江 | 38个 | 2个 | 178ms | 3.4% | 吉林 | 15个 | 0 | 236ms | 3.4%  
贵州 | 22个 | 0 | 179ms | 6.4% | 辽宁 | 35个 | 0 | 248ms | 6.1%  
青海 | 4个 | 0 | 180ms | 4.3% | 内蒙古 | 30个 | 0 | 249ms | 3.7%  
江苏 | 49个 | 1个 | 180ms | 4.2% | 新疆 | 27个 | 0 | 253ms | 4.0%  
江西 | 23个 | 0 | 183ms | 3.8% | 山西 | 34个 | 0 | 255ms | 4.7%  
甘肃 | 20个 | 0 | 195ms | 6.8% | 河北 | 31个 | 0 | 261ms | 3.5%  
...
海外线路到Vultr新加坡-新加坡机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 5个 | 0 | 1ms | 1.0% | 俄罗斯 | 1个 | 0 | 170ms | 0  
香港 | 20个 | 0 | 56ms | 0 | 美国 | 16个 | 0 | 181ms | 0  
台湾 | 1个 | 0 | 61ms | - | 澳大利亚 | 2个 | 0 | 183ms | 0  
马来西亚 | 4个 | 0 | 68ms | 0.3% | 荷兰 | 2个 | 0 | 192ms | 0  
越南 | 1个 | 0 | 72ms | 0 | 法国 | 2个 | 0 | 202ms | 0  
日本 | 2个 | 0 | 85ms | 0 | 英国 | 3个 | 0 | 226ms | 0  
韩国 | 12个 | 0 | 87ms | 1.7% | 加拿大 | 4个 | 0 | 241ms | 0  
均值 | 78个 | 0 | 160ms | 1.2% | 柬埔寨 | 1个 | 0 | 333ms | 16.0%  
德国 | 1个 | 0 | 161ms | 0 | 南非 | 1个 | 0 | 400ms | 0  
