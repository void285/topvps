...
大陆各省份到Vultr美国-达拉斯机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 222ms | 15.6% | 均值 | 938个 | 14个 | 289ms | 14.0%  
北京 | 8个 | 1个 | 226ms | 1.0% | 内蒙古 | 32个 | 0 | 291ms | 14.7%  
江苏 | 58个 | 1个 | 246ms | 12.2% | 山西 | 35个 | 1个 | 299ms | 17.4%  
浙江 | 49个 | 2个 | 251ms | 9.2% | 湖北 | 48个 | 0 | 300ms | 13.1%  
吉林 | 16个 | 0 | 252ms | 11.2% | 广东 | 76个 | 3个 | 302ms | 14.5%  
辽宁 | 38个 | 0 | 260ms | 13.0% | 青海 | 4个 | 0 | 307ms | 14.5%  
福建 | 34个 | 2个 | 271ms | 10.3% | 海南 | 12个 | 0 | 309ms | 11.8%  
河北 | 34个 | 0 | 271ms | 15.8% | 甘肃 | 17个 | 0 | 311ms | 15.9%  
上海 | 7个 | 0 | 271ms | 1.3% | 湖南 | 47个 | 0 | 311ms | 14.6%  
陕西 | 30个 | 0 | 272ms | 12.9% | 贵州 | 27个 | 2个 | 313ms | 18.9%  
宁夏 | 12个 | 0 | 273ms | 12.3% | 广西 | 36个 | 0 | 315ms | 17.5%  
山东 | 52个 | 1个 | 277ms | 17.5% | 重庆 | 15个 | 1个 | 316ms | 10.6%  
黑龙江 | 38个 | 0 | 280ms | 14.7% | 四川 | 48个 | 0 | 324ms | 13.4%  
江西 | 22个 | 0 | 283ms | 12.6% | 新疆 | 28个 | 0 | 324ms | 13.0%  
河南 | 49个 | 0 | 285ms | 16.6% | 云南 | 22个 | 0 | 353ms | 19.6%  
安徽 | 38个 | 0 | 288ms | 11.9% | 西藏 | 1个 | 0 | 421ms | 29.0%  
...
海外线路到Vultr美国-达拉斯机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 19个 | 0 | 34ms | 0.4% | 澳大利亚 | 1个 | 0 | 192ms | 0  
加拿大 | 3个 | 0 | 52ms | 0.5% | 新加坡 | 6个 | 0 | 206ms | 0  
法国 | 2个 | 0 | 112ms | 0 | 菲律宾 | 1个 | 0 | 207ms | 1.0%  
巴西 | 1个 | 0 | 136ms | 0 | 俄罗斯 | 1个 | 0 | 207ms | 0  
德国 | 2个 | 0 | 145ms | 0 | 香港 | 18个 | 0 | 209ms | 0  
日本 | 2个 | 0 | 158ms | 2.0% | 马来西亚 | 3个 | 0 | 235ms | 1.3%  
英国 | 1个 | 0 | 174ms | 0 | 印度尼西亚 | 1个 | 0 | 272ms | 3.0%  
台湾 | 1个 | 0 | 184ms | - | 南非 | 1个 | 0 | 326ms | 0  
韩国 | 13个 | 0 | 185ms | 0.3% | 柬埔寨 | 1个 | 0 | 414ms | 30.0%  
均值 | 77个 | 0 | 191ms | 2.3% |  |  |  |  |   
