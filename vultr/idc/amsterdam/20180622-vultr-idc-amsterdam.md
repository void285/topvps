#  多地到Vultr阿姆斯特丹[Amsterdam]机房的Ping测试（20180622） 
...
大陆各省份到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 2个 | 0 | 279ms | 0 | 福建 | 29个 | 1个 | 322ms | 0.4%  
河北 | 30个 | 1个 | 283ms | 0.3% | 河南 | 43个 | 3个 | 324ms | 3.1%  
内蒙古 | 27个 | 1个 | 295ms | 2.1% | 黑龙江 | 32个 | 1个 | 324ms | 2.9%  
安徽 | 28个 | 1个 | 299ms | 0.7% | 贵州 | 24个 | 0 | 326ms | 4.1%  
上海 | 7个 | 1个 | 300ms | 1.2% | 北京 | 10个 | 0 | 327ms | 2.5%  
广东 | 75个 | 0 | 301ms | 1.1% | 湖南 | 37个 | 0 | 327ms | 2.3%  
江苏 | 69个 | 2个 | 305ms | 0.3% | 青海 | 5个 | 0 | 329ms | 0.4%  
广西 | 41个 | 0 | 306ms | 1.9% | 江西 | 25个 | 0 | 329ms | 1.2%  
浙江 | 51个 | 2个 | 307ms | 0.8% | 云南 | 21个 | 9个 | 331ms | 0.7%  
辽宁 | 35个 | 1个 | 307ms | 2.2% | 宁夏 | 13个 | 0 | 332ms | 0.5%  
山西 | 32个 | 0 | 310ms | 0.2% | 甘肃 | 15个 | 0 | 343ms | 0.6%  
陕西 | 25个 | 0 | 311ms | 0.8% | 四川 | 43个 | 0 | 347ms | 0.7%  
海南 | 12个 | 0 | 312ms | 0.4% | 吉林 | 20个 | 0 | 348ms | 1.3%  
湖北 | 30个 | 0 | 315ms | 0.3% | 新疆 | 24个 | 0 | 358ms | 2.9%  
均值 | 886个 | 24个 | 317ms | 1.3% | 西藏 | 1个 | 0 | 407ms | 5.0%  
重庆 | 12个 | 0 | 319ms | 0.1% | 香港 | 24个 | 1个 | - | -  
山东 | 44个 | 0 | 320ms | 0.9% |  |  |  |  |   
...
海外线路到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
德国 | 1个 | 0 | 6ms | - | 印度尼西亚 | 1个 | 0 | 183ms | 0  
意大利 | 1个 | 0 | 7ms | - | 香港 | 24个 | 1个 | 220ms | 1.0%  
法国 | 1个 | 0 | 8ms | 0 | 马来西亚 | 5个 | 0 | 258ms | 0  
巴西 | 1个 | 0 | 15ms | 0 | 菲律宾 | 2个 | 0 | 266ms | 0  
加拿大 | 2个 | 0 | 96ms | 0 | 日本 | 2个 | 0 | 267ms | 3.0%  
美国 | 21个 | 0 | 134ms | 0.3% | 韩国 | 14个 | 0 | 268ms | 0  
英国 | 2个 | 0 | 175ms | 0 | 越南 | 2个 | 0 | 272ms | 0  
新加坡 | 5个 | 0 | 176ms | 0 | 台湾 | 2个 | 0 | 273ms | 0  
南非 | 2个 | 0 | 177ms | 0 | 澳大利亚 | 1个 | 0 | 304ms | 0  
均值 | 90个 | 1个 | 179ms | 0.3% | 柬埔寨 | 1个 | 0 | 307ms | 1.0%  
