...
大陆各省份到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 20个 | 0 | 238ms | 1.9% | 均值 | 3244个 | 38个 | 330ms | 5.4%  
河北 | 132个 | 0 | 273ms | 7.2% | 黑龙江 | 112个 | 0 | 333ms | 5.9%  
重庆 | 41个 | 0 | 298ms | 5.0% | 河南 | 203个 | 3个 | 334ms | 10.4%  
内蒙古 | 116个 | 0 | 299ms | 4.2% | 江苏 | 242个 | 15个 | 340ms | 3.5%  
上海 | 31个 | 4个 | 303ms | 4.3% | 福建 | 96个 | 0 | 340ms | 6.3%  
辽宁 | 145个 | 0 | 303ms | 2.9% | 浙江 | 182个 | 13个 | 342ms | 3.5%  
宁夏 | 16个 | 0 | 307ms | 6.8% | 山西 | 113个 | 0 | 342ms | 5.2%  
湖北 | 125个 | 0 | 315ms | 6.0% | 贵州 | 94个 | 0 | 344ms | 5.8%  
陕西 | 93个 | 0 | 315ms | 5.4% | 广东 | 282个 | 0 | 345ms | 4.3%  
广西 | 132个 | 0 | 319ms | 4.4% | 山东 | 214个 | 0 | 347ms | 4.7%  
北京 | 36个 | 0 | 321ms | 3.0% | 吉林 | 64个 | 0 | 349ms | 2.4%  
湖南 | 141个 | 0 | 321ms | 5.1% | 四川 | 165个 | 3个 | 352ms | 3.8%  
云南 | 67个 | 0 | 323ms | 9.0% | 新疆 | 79个 | 0 | 359ms | 8.9%  
安徽 | 128个 | 0 | 325ms | 7.3% | 甘肃 | 60个 | 0 | 359ms | 4.7%  
江西 | 75个 | 0 | 328ms | 7.1% | 青海 | 8个 | 0 | 359ms | 6.0%  
海南 | 28个 | 0 | 330ms | 2.1% | 西藏 | 4个 | 0 | 464ms | 13.0%  
...
海外线路到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
巴西 | 3个 | 0 | 7ms | 0 | 均值 | 216个 | 3个 | 187ms | 4.0%  
意大利 | 3个 | 0 | 7ms | - | 印度尼西亚 | 3个 | 0 | 190ms | 0  
德国 | 6个 | 0 | 19ms | 0 | 香港 | 66个 | 3个 | 204ms | 0  
俄罗斯 | 3个 | 0 | 41ms | - | 马来西亚 | 9个 | 0 | 258ms | 0.7%  
英国 | 3个 | 0 | 48ms | 1.0% | 日本 | 3个 | 0 | 273ms | 1.0%  
加拿大 | 12个 | 0 | 90ms | 0 | 韩国 | 21个 | 0 | 275ms | 0  
荷兰 | 3个 | 0 | 143ms | 0 | 澳大利亚 | 3个 | 0 | 301ms | 0  
美国 | 48个 | 0 | 161ms | 0 | 台湾 | 3个 | 0 | 313ms | 0  
新加坡 | 15个 | 0 | 177ms | 0 | 法国 | 3个 | 0 | 322ms | 0  
南非 | 6个 | 0 | 183ms | 0 | 菲律宾 | 3个 | 0 | 539ms | 66.0%  
