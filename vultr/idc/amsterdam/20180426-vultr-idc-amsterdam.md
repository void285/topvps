...
大陆各省份到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 7个 | 0 | 212ms | 0 | 贵州 | 23个 | 0 | 298ms | 1.7%  
北京 | 3个 | 1个 | 236ms | 25.0% | 均值 | 834个 | 6个 | 299ms | 1.3%  
河北 | 34个 | 0 | 275ms | 0.4% | 浙江 | 40个 | 2个 | 301ms | 2.0%  
内蒙古 | 27个 | 0 | 275ms | 0.5% | 陕西 | 28个 | 0 | 301ms | 0.2%  
安徽 | 36个 | 0 | 278ms | 0.7% | 四川 | 46个 | 0 | 302ms | 1.4%  
海南 | 11个 | 0 | 281ms | 0.3% | 河南 | 45个 | 1个 | 303ms | 0.5%  
青海 | 4个 | 0 | 284ms | 0 | 江苏 | 49个 | 1个 | 305ms | 1.8%  
天津 | 4个 | 0 | 285ms | 3.3% | 甘肃 | 20个 | 0 | 305ms | 0.1%  
广东 | 58个 | 0 | 285ms | 0.4% | 山西 | 33个 | 0 | 307ms | 0.6%  
辽宁 | 36个 | 0 | 285ms | 2.8% | 湖南 | 40个 | 1个 | 309ms | 4.3%  
江西 | 22个 | 0 | 287ms | 0.6% | 云南 | 25个 | 0 | 317ms | 0.5%  
湖北 | 38个 | 0 | 288ms | 0.8% | 山东 | 46个 | 0 | 318ms | 0.7%  
重庆 | 10个 | 0 | 291ms | 0.3% | 吉林 | 15个 | 0 | 321ms | 0.3%  
宁夏 | 10个 | 0 | 292ms | 2.2% | 黑龙江 | 34个 | 0 | 327ms | 1.1%  
福建 | 27个 | 0 | 293ms | 3.3% | 新疆 | 27个 | 0 | 338ms | 0.5%  
广西 | 35个 | 0 | 297ms | 3.7% | 西藏 | 1个 | 0 | 347ms | 4.0%  
...
海外线路到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 2个 | 0 | 1ms | 0 | 越南 | 1个 | 0 | 234ms | 0  
法国 | 2个 | 0 | 9ms | 0 | 日本 | 3个 | 0 | 263ms | 0.3%  
德国 | 1个 | 0 | 12ms | 0 | 香港 | 20个 | 0 | 280ms | 0  
英国 | 3个 | 0 | 20ms | 0 | 马来西亚 | 4个 | 0 | 281ms | 0.3%  
俄罗斯 | 1个 | 0 | 94ms | 0 | 韩国 | 12个 | 0 | 283ms | 0.3%  
加拿大 | 4个 | 0 | 95ms | 0 | 台湾 | 1个 | 0 | 305ms | -  
美国 | 16个 | 0 | 140ms | 0 | 澳大利亚 | 2个 | 0 | 314ms | 0  
南非 | 1个 | 0 | 168ms | 0 | 印度尼西亚 | 1个 | 0 | 419ms | 6.0%  
新加坡 | 5个 | 0 | 202ms | 0 | 柬埔寨 | 1个 | 0 | 574ms | 36.0%  
均值 | 80个 | 0 | 205ms | 2.5% |  |  |  |  |   
