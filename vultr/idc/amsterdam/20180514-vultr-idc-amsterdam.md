...
大陆各省份到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 9个 | 0 | 234ms | 7.9% | 河北 | 30个 | 0 | 284ms | 3.1%  
青海 | 4个 | 0 | 256ms | 0.8% | 湖南 | 42个 | 0 | 285ms | 2.8%  
安徽 | 37个 | 1个 | 259ms | 2.1% | 均值 | 913个 | 11个 | 289ms | 4.0%  
天津 | 5个 | 0 | 260ms | 4.2% | 陕西 | 33个 | 0 | 291ms | 2.8%  
甘肃 | 20个 | 0 | 261ms | 0.9% | 福建 | 35个 | 1个 | 297ms | 2.7%  
重庆 | 16个 | 0 | 269ms | 0.2% | 浙江 | 48个 | 3个 | 299ms | 8.7%  
北京 | 8个 | 1个 | 270ms | 0 | 山西 | 37个 | 0 | 299ms | 7.7%  
宁夏 | 12个 | 0 | 270ms | 1.5% | 四川 | 46个 | 0 | 300ms | 3.0%  
内蒙古 | 34个 | 0 | 272ms | 2.1% | 江苏 | 53个 | 1个 | 300ms | 9.5%  
广东 | 75个 | 1个 | 273ms | 3.1% | 河南 | 50个 | 0 | 302ms | 3.7%  
广西 | 33个 | 0 | 274ms | 2.1% | 贵州 | 24个 | 0 | 308ms | 8.6%  
海南 | 11个 | 0 | 274ms | 3.1% | 新疆 | 28个 | 0 | 312ms | 2.5%  
云南 | 21个 | 0 | 280ms | 1.8% | 山东 | 49个 | 2个 | 315ms | 4.2%  
湖北 | 45个 | 1个 | 281ms | 3.4% | 黑龙江 | 36个 | 0 | 321ms | 5.5%  
辽宁 | 34个 | 0 | 281ms | 5.8% | 吉林 | 16个 | 0 | 323ms | 2.1%  
江西 | 21个 | 0 | 283ms | 3.1% | 西藏 | 1个 | 0 | 368ms | 0  
...
海外线路到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 2个 | 0 | 9ms | 0 | 南非 | 1个 | 0 | 215ms | 0  
德国 | 2个 | 0 | 21ms | 0 | 菲律宾 | 1个 | 0 | 229ms | 0  
英国 | 2个 | 0 | 22ms | 0 | 日本 | 2个 | 0 | 266ms | 0  
加拿大 | 3个 | 0 | 96ms | 0 | 韩国 | 13个 | 0 | 281ms | 0  
俄罗斯 | 1个 | 0 | 98ms | 0 | 马来西亚 | 3个 | 0 | 284ms | 0.7%  
美国 | 19个 | 0 | 142ms | 0 | 香港 | 18个 | 1个 | 289ms | 0  
新加坡 | 6个 | 0 | 187ms | 0 | 澳大利亚 | 2个 | 0 | 298ms | 0  
印度尼西亚 | 1个 | 0 | 194ms | 5.0% | 台湾 | 1个 | 0 | 311ms | -  
均值 | 79个 | 1个 | 199ms | 1.6% | 柬埔寨 | 1个 | 0 | 442ms | 22.0%  
巴西 | 1个 | 0 | 205ms | 0 |  |  |  |  |   
