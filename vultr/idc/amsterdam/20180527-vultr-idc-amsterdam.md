...
大陆各省份到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 7个 | 0 | 220ms | 0.1% | 均值 | 980个 | 12个 | 299ms | 3.9%  
天津 | 5个 | 0 | 263ms | 0.8% | 江苏 | 63个 | 1个 | 300ms | 2.1%  
北京 | 8个 | 1个 | 268ms | 0.5% | 云南 | 18个 | 0 | 300ms | 2.4%  
内蒙古 | 33个 | 0 | 271ms | 1.8% | 甘肃 | 22个 | 0 | 301ms | 1.6%  
河北 | 36个 | 0 | 275ms | 16.2% | 陕西 | 33个 | 0 | 303ms | 2.1%  
广东 | 78个 | 3个 | 280ms | 1.0% | 浙江 | 52个 | 0 | 305ms | 1.6%  
辽宁 | 41个 | 1个 | 281ms | 15.4% | 宁夏 | 13个 | 0 | 306ms | 1.8%  
湖北 | 43个 | 0 | 287ms | 2.5% | 贵州 | 28个 | 0 | 307ms | 9.9%  
重庆 | 15个 | 1个 | 287ms | 1.8% | 湖南 | 46个 | 0 | 307ms | 7.3%  
海南 | 14个 | 0 | 287ms | 2.6% | 河南 | 58个 | 1个 | 311ms | 3.0%  
广西 | 40个 | 0 | 288ms | 4.1% | 山东 | 53个 | 3个 | 316ms | 2.4%  
安徽 | 39个 | 0 | 290ms | 1.4% | 山西 | 39个 | 1个 | 321ms | 3.6%  
四川 | 48个 | 0 | 291ms | 2.0% | 吉林 | 19个 | 0 | 322ms | 2.1%  
福建 | 35个 | 0 | 296ms | 2.6% | 黑龙江 | 39个 | 0 | 335ms | 3.2%  
江西 | 23个 | 0 | 297ms | 1.9% | 新疆 | 28个 | 0 | 355ms | 5.7%  
青海 | 4个 | 0 | 298ms | 0.5% |  |  |  |  |   
...
海外线路到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 1个 | 0 | 0 | 0 | 巴西 | 1个 | 0 | 205ms | 0  
意大利 | 1个 | 0 | 12ms | - | 印度尼西亚 | 1个 | 0 | 226ms | 1.0%  
法国 | 1个 | 0 | 13ms | 0 | 菲律宾 | 1个 | 0 | 241ms | 0  
德国 | 3个 | 0 | 15ms | 0 | 日本 | 2个 | 0 | 266ms | 1.0%  
英国 | 2个 | 0 | 23ms | 0 | 香港 | 21个 | 0 | 278ms | 0  
加拿大 | 4个 | 0 | 96ms | 0 | 台湾 | 1个 | 0 | 280ms | -  
俄罗斯 | 1个 | 0 | 106ms | 0 | 韩国 | 12个 | 0 | 292ms | 0  
美国 | 21个 | 0 | 149ms | 4.5% | 马来西亚 | 5个 | 0 | 293ms | 0  
新加坡 | 5个 | 0 | 183ms | 0 | 澳大利亚 | 1个 | 0 | 297ms | 0  
南非 | 2个 | 0 | 190ms | 1.0% | 越南 | 2个 | 0 | 334ms | 0  
均值 | 89个 | 0 | 191ms | 1.2% | 柬埔寨 | 1个 | 0 | 523ms | 16.0%  
