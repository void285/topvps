#  多地到Vultr阿姆斯特丹[Amsterdam]机房的Ping测试（20180918） 
...
大陆各省份到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
河北 | 61个 | 0 | 271ms | 2.3% | 湖北 | 57个 | 0 | 312ms | 6.4%  
浙江 | 62个 | 3个 | 273ms | 7.5% | 天津 | 7个 | 0 | 312ms | 7.2%  
内蒙古 | 60个 | 0 | 273ms | 3.1% | 山东 | 97个 | 0 | 313ms | 9.2%  
安徽 | 71个 | 0 | 274ms | 5.6% | 海南 | 14个 | 0 | 315ms | 6.9%  
江苏 | 96个 | 4个 | 277ms | 6.5% | 四川 | 73个 | 1个 | 320ms | 4.2%  
宁夏 | 8个 | 0 | 284ms | 2.2% | 北京 | 10个 | 0 | 321ms | 9.0%  
福建 | 45个 | 0 | 286ms | 5.5% | 贵州 | 46个 | 0 | 321ms | 10.7%  
江西 | 40个 | 0 | 288ms | 2.6% | 甘肃 | 35个 | 0 | 321ms | 3.9%  
广西 | 59个 | 0 | 290ms | 8.0% | 河南 | 88个 | 0 | 322ms | 3.9%  
陕西 | 45个 | 0 | 295ms | 7.1% | 山西 | 58个 | 1个 | 324ms | 14.0%  
上海 | 9个 | 0 | 295ms | 4.8% | 重庆 | 9个 | 0 | 325ms | 12.2%  
湖南 | 71个 | 1个 | 296ms | 9.1% | 黑龙江 | 57个 | 0 | 333ms | 14.8%  
辽宁 | 62个 | 0 | 299ms | 2.4% | 新疆 | 34个 | 0 | 336ms | 5.0%  
均值 | 1457个 | 12个 | 303ms | 6.4% | 青海 | 6个 | 0 | 361ms | 1.4%  
云南 | 38个 | 0 | 306ms | 4.5% | 西藏 | 1个 | 0 | 364ms | 13.0%  
广东 | 119个 | 2个 | 310ms | 1.9% | 吉林 | 19个 | 0 | 389ms | 18.4%  
...
海外线路到Vultr荷兰-阿姆斯特丹机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 1个 | 0 | 7ms | - | 印度尼西亚 | 1个 | 0 | 204ms | 0  
德国 | 3个 | 0 | 25ms | 0 | 台湾 | 2个 | 0 | 217ms | 0  
俄罗斯 | 1个 | 0 | 40ms | - | 赞比亚 | 2个 | 0 | 218ms | 10.2%  
加拿大 | 3个 | 0 | 83ms | 0 | 越南 | 2个 | 0 | 225ms | 0  
荷兰 | 1个 | 0 | 101ms | 0 | 马来西亚 | 6个 | 0 | 243ms | 0  
美国 | 16个 | 0 | 147ms | 0 | 日本 | 3个 | 0 | 250ms | 1.3%  
均值 | 82个 | 0 | 177ms | 2.2% | 韩国 | 12个 | 0 | 255ms | 0  
香港 | 20个 | 0 | 186ms | 0 | 澳大利亚 | 2个 | 0 | 311ms | 0  
新加坡 | 5个 | 0 | 187ms | 0 | 菲律宾 | 2个 | 0 | 311ms | 21.0%  
