...
天津全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
洛杉矶 | 3个 | 0 | 197ms | 5% | 伦敦 | 3个 | 0 | 270ms | 24%  
硅谷 | 3个 | 0 | 199ms | 2% | 巴黎 | 3个 | 0 | 271ms | 0  
东京 | 3个 | 0 | 200ms | 28% | 阿姆斯特丹 | 2个 | 0 | 279ms | 0  
西雅图 | 3个 | 0 | 226ms | 3% | 新加坡 | 2个 | 0 | 280ms | 13%  
法兰克福 | 3个 | 0 | 228ms | 0 | 亚特兰大 | 3个 | 0 | 282ms | 32%  
达拉斯 | 3个 | 0 | 230ms | 0 | 悉尼 | 3个 | 0 | 283ms | 10%  
均值 | 43个 | 0 | 256ms | 12% | 新泽西 | 3个 | 0 | 313ms | 1%  
芝加哥 | 3个 | 0 | 268ms | 34% | 迈阿密 | 3个 | 0 | 331ms | 29%  
...
天津电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
洛杉矶 | 2个 | 0 | 206ms | 10% | 伦敦 | 2个 | 0 | 294ms | 3%  
硅谷 | 2个 | 0 | 221ms | 5% | 巴黎 | 2个 | 0 | 221ms | 0  
东京 | 2个 | 0 | 224ms | 48% | 阿姆斯特丹 | 1个 | 0 | 325ms | 0  
西雅图 | 2个 | 0 | 261ms | 6% | 新加坡 | 1个 | 0 | 285ms | 26%  
法兰克福 | 2个 | 0 | 222ms | 0 | 亚特兰大 | 2个 | 0 | 276ms | 0  
达拉斯 | 2个 | 0 | 256ms | 0 | 悉尼 | 2个 | 0 | 307ms | 18%  
均值 | 28个 | 0 | 263ms | 7% | 新泽西 | 2个 | 0 | 361ms | 2%  
芝加哥 | 2个 | 0 | 228ms | 0 | 迈阿密 | 2个 | 0 | 305ms | 0  
...
天津联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
洛杉矶 | 1个 | 0 | 188ms | 0 | 伦敦 | 1个 | 0 | 247ms | 46%  
硅谷 | 1个 | 0 | 177ms | 0 | 巴黎 | 1个 | 0 | 321ms | 0  
东京 | 1个 | 0 | 177ms | 8% | 阿姆斯特丹 | 1个 | 0 | 233ms | 0  
西雅图 | 1个 | 0 | 192ms | 1% | 新加坡 | 1个 | 0 | 276ms | 0  
法兰克福 | 1个 | 0 | 235ms | 0 | 亚特兰大 | 1个 | 0 | 288ms | 64%  
达拉斯 | 1个 | 0 | 205ms | 0 | 悉尼 | 1个 | 0 | 259ms | 2%  
均值 | 15个 | 0 | 248ms | 16% | 新泽西 | 1个 | 0 | 265ms | 1%  
芝加哥 | 1个 | 0 | 308ms | 68% | 迈阿密 | 1个 | 0 | 357ms | 58%  
