...
天津全部运营商到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 7个 | 0 | 138ms | 3% | 均值 | 105个 | 0 | 247ms | 6%  
新加坡 | 7个 | 0 | 188ms | 7% | 新泽西 | 7个 | 0 | 267ms | 0  
硅谷 | 7个 | 0 | 218ms | 2% | 伦敦 | 7个 | 0 | 268ms | 1%  
洛杉矶 | 7个 | 0 | 227ms | 12% | 巴黎 | 7个 | 0 | 271ms | 1%  
达拉斯 | 7个 | 0 | 241ms | 11% | 迈阿密 | 7个 | 0 | 278ms | 4%  
西雅图 | 7个 | 0 | 242ms | 11% | 法兰克福 | 7个 | 0 | 281ms | 2%  
芝加哥 | 7个 | 0 | 245ms | 11% | 亚特兰大 | 7个 | 0 | 286ms | 16%  
悉尼 | 7个 | 0 | 247ms | 5% | 阿姆斯特丹 | 7个 | 0 | 308ms | 7%  
...
天津电信到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 147ms | 4% | 均值 | 30个 | 0 | 250ms | 4%  
新加坡 | 2个 | 0 | 244ms | 6% | 新泽西 | 2个 | 0 | 264ms | 0  
硅谷 | 2个 | 0 | 230ms | 5% | 伦敦 | 2个 | 0 | 289ms | 0  
洛杉矶 | 2个 | 0 | 163ms | 0 | 巴黎 | 2个 | 0 | 319ms | 1%  
达拉斯 | 2个 | 0 | 245ms | 0 | 迈阿密 | 2个 | 0 | 261ms | 0  
西雅图 | 2个 | 0 | 193ms | 0 | 法兰克福 | 2个 | 0 | 279ms | 0  
芝加哥 | 2个 | 0 | 208ms | 0 | 亚特兰大 | 2个 | 0 | 331ms | 31%  
悉尼 | 2个 | 0 | 253ms | 11% | 阿姆斯特丹 | 2个 | 0 | 324ms | 0  
...
天津联通到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 3个 | 0 | 128ms | 5% | 均值 | 45个 | 0 | 255ms | 5%  
新加坡 | 3个 | 0 | 209ms | 2% | 新泽西 | 3个 | 0 | 250ms | 0  
硅谷 | 3个 | 0 | 211ms | 3% | 伦敦 | 3个 | 0 | 269ms | 3%  
洛杉矶 | 3个 | 0 | 297ms | 37% | 巴黎 | 3个 | 0 | 325ms | 2%  
达拉斯 | 3个 | 0 | 212ms | 0 | 迈阿密 | 3个 | 0 | 272ms | 0  
西雅图 | 3个 | 0 | 263ms | 18% | 法兰克福 | 3个 | 0 | 296ms | 0  
芝加哥 | 3个 | 0 | 249ms | 0 | 亚特兰大 | 3个 | 0 | 253ms | 0  
悉尼 | 3个 | 0 | 269ms | 3% | 阿姆斯特丹 | 3个 | 0 | 331ms | 7%  
...
天津移动到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 139ms | 0 | 均值 | 30个 | 0 | 236ms | 10%  
新加坡 | 2个 | 0 | 113ms | 14% | 新泽西 | 2个 | 0 | 288ms | 0  
硅谷 | 2个 | 0 | 214ms | 0 | 伦敦 | 2个 | 0 | 246ms | 0  
洛杉矶 | 2个 | 0 | 221ms | 0 | 巴黎 | 2个 | 0 | 170ms | 0  
达拉斯 | 2个 | 0 | 267ms | 35% | 迈阿密 | 2个 | 0 | 301ms | 12%  
西雅图 | 2个 | 0 | 270ms | 16% | 法兰克福 | 2个 | 0 | 270ms | 7%  
芝加哥 | 2个 | 0 | 279ms | 35% | 亚特兰大 | 2个 | 0 | 274ms | 18%  
悉尼 | 2个 | 0 | 220ms | 0 | 阿姆斯特丹 | 2个 | 0 | 271ms | 14%  
