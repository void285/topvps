...
青海全部运营商到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 4个 | 0 | 172ms | 2% | 均值 | 60个 | 2个 | 276ms | 2%  
新加坡 | 4个 | 0 | 180ms | 4% | 阿姆斯特丹 | 4个 | 0 | 284ms | 0  
洛杉矶 | 4个 | 0 | 216ms | 0 | 达拉斯 | 4个 | 0 | 311ms | 6%  
巴黎 | 4个 | 1个 | 238ms | 0 | 芝加哥 | 4个 | 0 | 326ms | 2%  
悉尼 | 4个 | 0 | 248ms | 0 | 新泽西 | 4个 | 1个 | 329ms | 0  
法兰克福 | 4个 | 0 | 254ms | 0 | 迈阿密 | 4个 | 0 | 352ms | 4%  
西雅图 | 4个 | 0 | 256ms | 1% | 伦敦 | 4个 | 0 | 358ms | 2%  
硅谷 | 4个 | 0 | 260ms | 0 | 亚特兰大 | 4个 | 0 | 375ms | 6%  
...
青海电信到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 214ms | 5% | 均值 | 30个 | 2个 | 284ms | 2%  
新加坡 | 2个 | 0 | 209ms | 8% | 阿姆斯特丹 | 2个 | 0 | 248ms | 0  
洛杉矶 | 2个 | 0 | 212ms | 0 | 达拉斯 | 2个 | 0 | 271ms | 4%  
巴黎 | 2个 | 1个 | 248ms | 0 | 芝加哥 | 2个 | 0 | 363ms | 4%  
悉尼 | 2个 | 0 | 276ms | 1% | 新泽西 | 2个 | 1个 | 373ms | 1%  
法兰克福 | 2个 | 0 | 266ms | 1% | 迈阿密 | 2个 | 0 | 362ms | 5%  
西雅图 | 2个 | 0 | 260ms | 1% | 伦敦 | 2个 | 0 | 351ms | 2%  
硅谷 | 2个 | 0 | 271ms | 1% | 亚特兰大 | 2个 | 0 | 369ms | 1%  
...
青海移动到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 130ms | 0 | 均值 | 30个 | 0 | 268ms | 1%  
新加坡 | 2个 | 0 | 151ms | 0 | 阿姆斯特丹 | 2个 | 0 | 320ms | 0  
洛杉矶 | 2个 | 0 | 220ms | 0 | 达拉斯 | 2个 | 0 | 352ms | 9%  
巴黎 | 2个 | 0 | 228ms | 0 | 芝加哥 | 2个 | 0 | 290ms | 0  
悉尼 | 2个 | 0 | 221ms | 0 | 新泽西 | 2个 | 0 | 285ms | 0  
法兰克福 | 2个 | 0 | 243ms | 0 | 迈阿密 | 2个 | 0 | 343ms | 3%  
西雅图 | 2个 | 0 | 252ms | 0 | 伦敦 | 2个 | 0 | 365ms | 3%  
硅谷 | 2个 | 0 | 248ms | 0 | 亚特兰大 | 2个 | 0 | 382ms | 11%  
