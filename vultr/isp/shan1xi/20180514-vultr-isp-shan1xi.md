...
山西全部运营商到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 32个 | 0 | 159ms | 16% | 芝加哥 | 34个 | 0 | 287ms | 13%  
洛杉矶 | 37个 | 0 | 211ms | 10% | 阿姆斯特丹 | 37个 | 0 | 298ms | 8%  
西雅图 | 37个 | 0 | 215ms | 7% | 巴黎 | 38个 | 0 | 306ms | 3%  
悉尼 | 38个 | 0 | 238ms | 4% | 法兰克福 | 31个 | 0 | 308ms | 8%  
新加坡 | 38个 | 0 | 245ms | 14% | 伦敦 | 36个 | 1个 | 317ms | 7%  
硅谷 | 39个 | 0 | 252ms | 13% | 迈阿密 | 35个 | 0 | 321ms | 7%  
均值 | 542个 | 2个 | 276ms | 9% | 亚特兰大 | 37个 | 0 | 322ms | 15%  
达拉斯 | 35个 | 1个 | 286ms | 17% | 新泽西 | 38个 | 0 | 325ms | 3%  
...
山西电信到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 147ms | 13% | 芝加哥 | 7个 | 0 | 290ms | 10%  
洛杉矶 | 10个 | 0 | 197ms | 7% | 阿姆斯特丹 | 10个 | 0 | 253ms | 3%  
西雅图 | 10个 | 0 | 216ms | 6% | 巴黎 | 10个 | 0 | 282ms | 1%  
悉尼 | 10个 | 0 | 238ms | 0 | 法兰克福 | 8个 | 0 | 290ms | 5%  
新加坡 | 10个 | 0 | 231ms | 12% | 伦敦 | 9个 | 0 | 315ms | 0  
硅谷 | 10个 | 0 | 267ms | 9% | 迈阿密 | 10个 | 0 | 322ms | 4%  
均值 | 141个 | 0 | 260ms | 6% | 亚特兰大 | 10个 | 0 | 288ms | 7%  
达拉斯 | 8个 | 0 | 255ms | 15% | 新泽西 | 10个 | 0 | 316ms | 1%  
...
山西联通到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 208ms | 29% | 芝加哥 | 13个 | 0 | 297ms | 13%  
洛杉矶 | 14个 | 0 | 199ms | 5% | 阿姆斯特丹 | 13个 | 0 | 367ms | 17%  
西雅图 | 14个 | 0 | 212ms | 2% | 巴黎 | 14个 | 0 | 373ms | 6%  
悉尼 | 14个 | 0 | 252ms | 12% | 法兰克福 | 11个 | 0 | 372ms | 19%  
新加坡 | 13个 | 0 | 358ms | 26% | 伦敦 | 13个 | 1个 | 374ms | 20%  
硅谷 | 14个 | 0 | 208ms | 6% | 迈阿密 | 11个 | 0 | 310ms | 11%  
均值 | 192个 | 2个 | 298ms | 13% | 亚特兰大 | 12个 | 0 | 282ms | 14%  
达拉斯 | 12个 | 1个 | 255ms | 18% | 新泽西 | 13个 | 0 | 303ms | 7%  
...
山西移动到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 123ms | 6% | 芝加哥 | 14个 | 0 | 275ms | 16%  
洛杉矶 | 13个 | 0 | 236ms | 18% | 阿姆斯特丹 | 14个 | 0 | 273ms | 2%  
西雅图 | 13个 | 0 | 216ms | 12% | 巴黎 | 14个 | 0 | 263ms | 2%  
悉尼 | 14个 | 0 | 224ms | 1% | 法兰克福 | 12个 | 0 | 261ms | 0  
新加坡 | 15个 | 0 | 147ms | 2% | 伦敦 | 14个 | 0 | 261ms | 2%  
硅谷 | 15个 | 0 | 280ms | 23% | 迈阿密 | 14个 | 0 | 333ms | 7%  
均值 | 209个 | 0 | 269ms | 9% | 亚特兰大 | 15个 | 0 | 395ms | 25%  
达拉斯 | 15个 | 0 | 348ms | 17% | 新泽西 | 15个 | 0 | 356ms | 1%  
