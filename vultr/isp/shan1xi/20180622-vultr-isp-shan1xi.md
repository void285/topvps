...
山西全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 34个 | 0 | 183ms | 10% | 巴黎 | 33个 | 0 | 276ms | 0  
洛杉矶 | 33个 | 0 | 204ms | 0 | 芝加哥 | 34个 | 0 | 277ms | 31%  
硅谷 | 38个 | 0 | 214ms | 1% | 亚特兰大 | 35个 | 1个 | 281ms | 30%  
西雅图 | 35个 | 0 | 238ms | 1% | 悉尼 | 33个 | 0 | 290ms | 5%  
新加坡 | 33个 | 0 | 256ms | 6% | 新泽西 | 35个 | 0 | 293ms | 1%  
达拉斯 | 35个 | 0 | 257ms | 0 | 迈阿密 | 34个 | 0 | 300ms | 27%  
均值 | 517个 | 4个 | 264ms | 9% | 伦敦 | 36个 | 0 | 312ms | 20%  
法兰克福 | 37个 | 3个 | 273ms | 0 | 阿姆斯特丹 | 32个 | 0 | 313ms | 0  
...
山西电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 226ms | 23% | 巴黎 | 11个 | 0 | 238ms | 0  
洛杉矶 | 11个 | 0 | 212ms | 0 | 芝加哥 | 8个 | 0 | 279ms | 17%  
硅谷 | 12个 | 0 | 228ms | 1% | 亚特兰大 | 9个 | 1个 | 288ms | 17%  
西雅图 | 9个 | 0 | 267ms | 1% | 悉尼 | 10个 | 0 | 373ms | 11%  
新加坡 | 10个 | 0 | 289ms | 15% | 新泽西 | 8个 | 0 | 326ms | 0  
达拉斯 | 8个 | 0 | 301ms | 0 | 迈阿密 | 9个 | 0 | 320ms | 15%  
均值 | 144个 | 2个 | 279ms | 7% | 伦敦 | 9个 | 0 | 336ms | 11%  
法兰克福 | 11个 | 1个 | 224ms | 0 | 阿姆斯特丹 | 10个 | 0 | 341ms | 0  
...
山西联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 198ms | 6% | 巴黎 | 11个 | 0 | 323ms | 0  
洛杉矶 | 11个 | 0 | 197ms | 0 | 芝加哥 | 12个 | 0 | 290ms | 61%  
硅谷 | 11个 | 0 | 199ms | 0 | 亚特兰大 | 12个 | 0 | 278ms | 59%  
西雅图 | 12个 | 0 | 219ms | 0 | 悉尼 | 11个 | 0 | 284ms | 4%  
新加坡 | 11个 | 0 | 304ms | 1% | 新泽西 | 12个 | 0 | 279ms | 0  
达拉斯 | 12个 | 0 | 219ms | 0 | 迈阿密 | 10个 | 0 | 287ms | 54%  
均值 | 169个 | 2个 | 275ms | 15% | 伦敦 | 12个 | 0 | 350ms | 39%  
法兰克福 | 11个 | 2个 | 334ms | 0 | 阿姆斯特丹 | 11个 | 0 | 334ms | 0  
...
山西移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 0 | 125ms | 1% | 巴黎 | 11个 | 0 | 266ms | 0  
洛杉矶 | 11个 | 0 | 203ms | 0 | 芝加哥 | 14个 | 0 | 263ms | 16%  
硅谷 | 15个 | 0 | 214ms | 1% | 亚特兰大 | 14个 | 0 | 276ms | 14%  
西雅图 | 14个 | 0 | 227ms | 2% | 悉尼 | 12个 | 0 | 212ms | 0  
新加坡 | 12个 | 0 | 175ms | 1% | 新泽西 | 15个 | 0 | 275ms | 3%  
达拉斯 | 15个 | 0 | 250ms | 0 | 迈阿密 | 15个 | 0 | 292ms | 13%  
均值 | 204个 | 0 | 238ms | 4% | 伦敦 | 15个 | 0 | 251ms | 9%  
法兰克福 | 15个 | 0 | 262ms | 0 | 阿姆斯特丹 | 11个 | 0 | 263ms | 0  
