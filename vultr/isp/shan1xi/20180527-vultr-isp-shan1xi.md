...
山西全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 37个 | 0 | 168ms | 10% | 法兰克福 | 38个 | 0 | 277ms | 1%  
硅谷 | 40个 | 0 | 204ms | 12% | 迈阿密 | 40个 | 0 | 280ms | 8%  
洛杉矶 | 37个 | 0 | 207ms | 2% | 亚特兰大 | 39个 | 0 | 282ms | 13%  
西雅图 | 37个 | 0 | 216ms | 12% | 新泽西 | 39个 | 0 | 283ms | 5%  
新加坡 | 36个 | 0 | 256ms | 9% | 巴黎 | 37个 | 0 | 288ms | 6%  
均值 | 573个 | 1个 | 262ms | 8% | 悉尼 | 37个 | 0 | 303ms | 9%  
芝加哥 | 37个 | 0 | 265ms | 7% | 阿姆斯特丹 | 39个 | 1个 | 316ms | 3%  
达拉斯 | 40个 | 0 | 270ms | 13% | 伦敦 | 40个 | 0 | 327ms | 7%  
...
山西电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 194ms | 15% | 法兰克福 | 11个 | 0 | 257ms | 0  
硅谷 | 12个 | 0 | 217ms | 9% | 迈阿密 | 12个 | 0 | 286ms | 7%  
洛杉矶 | 11个 | 0 | 223ms | 4% | 亚特兰大 | 12个 | 0 | 263ms | 6%  
西雅图 | 11个 | 0 | 239ms | 9% | 新泽西 | 12个 | 0 | 320ms | 7%  
新加坡 | 11个 | 0 | 285ms | 13% | 巴黎 | 11个 | 0 | 259ms | 4%  
均值 | 172个 | 0 | 268ms | 7% | 悉尼 | 11个 | 0 | 342ms | 14%  
芝加哥 | 11个 | 0 | 292ms | 5% | 阿姆斯特丹 | 12个 | 0 | 276ms | 1%  
达拉斯 | 12个 | 0 | 262ms | 6% | 伦敦 | 12个 | 0 | 302ms | 2%  
...
山西联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 187ms | 11% | 法兰克福 | 13个 | 0 | 324ms | 2%  
硅谷 | 13个 | 0 | 187ms | 15% | 迈阿密 | 13个 | 0 | 259ms | 8%  
洛杉矶 | 12个 | 0 | 198ms | 1% | 亚特兰大 | 12个 | 0 | 256ms | 6%  
西雅图 | 12个 | 0 | 207ms | 16% | 新泽西 | 12个 | 0 | 263ms | 6%  
新加坡 | 11个 | 0 | 329ms | 11% | 巴黎 | 12个 | 0 | 319ms | 10%  
均值 | 185个 | 1个 | 264ms | 8% | 悉尼 | 12个 | 0 | 307ms | 9%  
芝加哥 | 12个 | 0 | 255ms | 5% | 阿姆斯特丹 | 12个 | 1个 | 332ms | 6%  
达拉斯 | 14个 | 0 | 235ms | 6% | 伦敦 | 13个 | 0 | 343ms | 4%  
...
山西移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 14个 | 0 | 125ms | 2% | 法兰克福 | 14个 | 0 | 250ms | 1%  
硅谷 | 15个 | 0 | 207ms | 11% | 迈阿密 | 15个 | 0 | 294ms | 7%  
洛杉矶 | 14个 | 0 | 199ms | 0 | 亚特兰大 | 15个 | 0 | 328ms | 28%  
西雅图 | 14个 | 0 | 201ms | 12% | 新泽西 | 15个 | 0 | 268ms | 2%  
新加坡 | 14个 | 0 | 154ms | 2% | 巴黎 | 14个 | 0 | 286ms | 5%  
均值 | 216个 | 0 | 255ms | 8% | 悉尼 | 14个 | 0 | 260ms | 2%  
芝加哥 | 14个 | 0 | 250ms | 10% | 阿姆斯特丹 | 15个 | 0 | 339ms | 3%  
达拉斯 | 14个 | 0 | 313ms | 27% | 伦敦 | 15个 | 0 | 336ms | 13%  
