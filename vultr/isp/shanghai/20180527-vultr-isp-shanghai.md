...
上海全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 7个 | 0 | 163ms | 20% | 迈阿密 | 7个 | 0 | 263ms | 4%  
硅谷 | 7个 | 0 | 198ms | 9% | 亚特兰大 | 7个 | 0 | 264ms | 12%  
洛杉矶 | 7个 | 0 | 216ms | 1% | 法兰克福 | 7个 | 0 | 266ms | 0  
巴黎 | 7个 | 0 | 219ms | 1% | 芝加哥 | 7个 | 0 | 272ms | 5%  
新加坡 | 8个 | 0 | 221ms | 21% | 伦敦 | 7个 | 0 | 274ms | 3%  
阿姆斯特丹 | 7个 | 0 | 231ms | 0 | 达拉斯 | 7个 | 0 | 274ms | 11%  
西雅图 | 8个 | 0 | 243ms | 3% | 新泽西 | 7个 | 0 | 283ms | 1%  
均值 | 108个 | 0 | 250ms | 12% | 悉尼 | 8个 | 0 | 290ms | 28%  
...
上海电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 5个 | 0 | 191ms | 29% | 迈阿密 | 5个 | 0 | 252ms | 5%  
硅谷 | 5个 | 0 | 201ms | 9% | 亚特兰大 | 5个 | 0 | 259ms | 5%  
洛杉矶 | 5个 | 0 | 229ms | 2% | 法兰克福 | 5个 | 0 | 257ms | 0  
巴黎 | 5个 | 0 | 215ms | 0 | 芝加哥 | 5个 | 0 | 290ms | 2%  
新加坡 | 5个 | 0 | 258ms | 22% | 伦敦 | 5个 | 0 | 251ms | 0  
阿姆斯特丹 | 5个 | 0 | 206ms | 0 | 达拉斯 | 5个 | 0 | 253ms | 3%  
西雅图 | 5个 | 0 | 250ms | 1% | 新泽西 | 5个 | 0 | 289ms | 3%  
均值 | 75个 | 0 | 247ms | 7% | 悉尼 | 5个 | 0 | 298ms | 33%  
...
上海联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | - | - | - | - | 迈阿密 | - | - | - | -  
硅谷 | - | - | - | - | 亚特兰大 | - | - | - | -  
洛杉矶 | - | - | - | - | 法兰克福 | - | - | - | -  
巴黎 | - | - | - | - | 芝加哥 | - | - | - | -  
新加坡 | 1个 | 0 | 242ms | 22% | 伦敦 | - | - | - | -  
阿姆斯特丹 | - | - | - | - | 达拉斯 | - | - | - | -  
西雅图 | 1个 | 0 | 245ms | 2% | 新泽西 | - | - | - | -  
均值 | 3个 | 0 | 263ms | 20% | 悉尼 | 1个 | 0 | 302ms | 38%  
...
上海移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 135ms | 11% | 迈阿密 | 2个 | 0 | 274ms | 3%  
硅谷 | 2个 | 0 | 196ms | 9% | 亚特兰大 | 2个 | 0 | 270ms | 18%  
洛杉矶 | 2个 | 0 | 204ms | 0 | 法兰克福 | 2个 | 0 | 275ms | 0  
巴黎 | 2个 | 0 | 224ms | 2% | 芝加哥 | 2个 | 0 | 253ms | 9%  
新加坡 | 2个 | 0 | 165ms | 19% | 伦敦 | 2个 | 0 | 297ms | 6%  
阿姆斯特丹 | 2个 | 0 | 256ms | 0 | 达拉斯 | 2个 | 0 | 295ms | 19%  
西雅图 | 2个 | 0 | 235ms | 6% | 新泽西 | 2个 | 0 | 276ms | 0  
均值 | 30个 | 0 | 242ms | 8% | 悉尼 | 2个 | 0 | 271ms | 15%  
