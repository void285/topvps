...
四川全部运营商到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 46个 | 0 | 150ms | 12% | 法兰克福 | 44个 | 0 | 303ms | 4%  
新加坡 | 49个 | 0 | 222ms | 10% | 巴黎 | 48个 | 0 | 306ms | 3%  
西雅图 | 51个 | 0 | 230ms | 1% | 阿姆斯特丹 | 46个 | 0 | 308ms | 3%  
悉尼 | 49个 | 0 | 257ms | 2% | 达拉斯 | 48个 | 0 | 321ms | 13%  
硅谷 | 47个 | 0 | 270ms | 7% | 迈阿密 | 48个 | 1个 | 326ms | 2%  
洛杉矶 | 50个 | 0 | 273ms | 14% | 新泽西 | 49个 | 0 | 327ms | 5%  
均值 | 717个 | 2个 | 287ms | 6% | 伦敦 | 48个 | 1个 | 350ms | 3%  
芝加哥 | 47个 | 0 | 299ms | 3% | 亚特兰大 | 47个 | 0 | 351ms | 13%  
...
四川电信到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 23个 | 0 | 140ms | 8% | 法兰克福 | 20个 | 0 | 262ms | 0  
新加坡 | 24个 | 0 | 206ms | 8% | 巴黎 | 24个 | 0 | 263ms | 0  
西雅图 | 24个 | 0 | 256ms | 1% | 阿姆斯特丹 | 19个 | 0 | 268ms | 0  
悉尼 | 24个 | 0 | 272ms | 0 | 达拉斯 | 23个 | 0 | 328ms | 9%  
硅谷 | 22个 | 0 | 318ms | 4% | 迈阿密 | 23个 | 1个 | 364ms | 2%  
洛杉矶 | 24个 | 0 | 296ms | 16% | 新泽西 | 23个 | 0 | 376ms | 2%  
均值 | 340个 | 2个 | 297ms | 4% | 伦敦 | 23个 | 1个 | 374ms | 3%  
芝加哥 | 22个 | 0 | 336ms | 3% | 亚特兰大 | 22个 | 0 | 362ms | 7%  
...
四川联通到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 179ms | 19% | 法兰克福 | 11个 | 0 | 363ms | 10%  
新加坡 | 12个 | 0 | 278ms | 15% | 巴黎 | 9个 | 0 | 361ms | 9%  
西雅图 | 12个 | 0 | 216ms | 2% | 阿姆斯特丹 | 12个 | 0 | 366ms | 7%  
悉尼 | 11个 | 0 | 251ms | 4% | 达拉斯 | 11个 | 0 | 283ms | 11%  
硅谷 | 11个 | 0 | 228ms | 4% | 迈阿密 | 12个 | 0 | 309ms | 5%  
洛杉矶 | 11个 | 0 | 247ms | 5% | 新泽西 | 11个 | 0 | 296ms | 11%  
均值 | 168个 | 0 | 289ms | 8% | 伦敦 | 12个 | 0 | 368ms | 6%  
芝加哥 | 12个 | 0 | 298ms | 5% | 亚特兰大 | 10个 | 0 | 299ms | 7%  
...
四川移动到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 132ms | 10% | 法兰克福 | 13个 | 0 | 285ms | 3%  
新加坡 | 13个 | 0 | 182ms | 7% | 巴黎 | 15个 | 0 | 293ms | 1%  
西雅图 | 15个 | 0 | 218ms | 1% | 阿姆斯特丹 | 15个 | 0 | 291ms | 2%  
悉尼 | 14个 | 0 | 248ms | 3% | 达拉斯 | 14个 | 0 | 351ms | 20%  
硅谷 | 14个 | 0 | 262ms | 12% | 迈阿密 | 13个 | 0 | 306ms | 0  
洛杉矶 | 15个 | 0 | 277ms | 20% | 新泽西 | 15个 | 0 | 309ms | 1%  
均值 | 209个 | 0 | 276ms | 7% | 伦敦 | 13个 | 0 | 307ms | 1%  
芝加哥 | 13个 | 0 | 262ms | 0 | 亚特兰大 | 15个 | 0 | 392ms | 24%  
