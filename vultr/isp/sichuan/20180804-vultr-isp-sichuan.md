...
四川全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 281个 | 3个 | 212ms | 14% | 法兰克福 | 281个 | 0 | 306ms | 1%  
洛杉矶 | 169个 | 0 | 233ms | 1% | 芝加哥 | 161个 | 0 | 308ms | 9%  
硅谷 | 281个 | 6个 | 253ms | 8% | 伦敦 | 285个 | 0 | 323ms | 1%  
西雅图 | 157个 | 3个 | 257ms | 3% | 亚特兰大 | 165个 | 0 | 338ms | 2%  
达拉斯 | 285个 | 0 | 269ms | 1% | 新泽西 | 277个 | 0 | 342ms | 4%  
新加坡 | 169个 | 3个 | 275ms | 14% | 悉尼 | 157个 | 0 | 348ms | 8%  
均值 | 3163个 | 18个 | 295ms | 5% | 迈阿密 | 165个 | 0 | 351ms | 4%  
巴黎 | 165个 | 0 | 302ms | 1% | 阿姆斯特丹 | 165个 | 3个 | 357ms | 3%  
...
四川电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 149个 | 3个 | 239ms | 23% | 法兰克福 | 149个 | 0 | 279ms | 1%  
洛杉矶 | 85个 | 0 | 234ms | 2% | 芝加哥 | 85个 | 0 | 317ms | 6%  
硅谷 | 149个 | 6个 | 255ms | 4% | 伦敦 | 149个 | 0 | 331ms | 2%  
西雅图 | 85个 | 3个 | 297ms | 2% | 亚特兰大 | 85个 | 0 | 342ms | 2%  
达拉斯 | 149个 | 0 | 288ms | 1% | 新泽西 | 145个 | 0 | 378ms | 3%  
新加坡 | 85个 | 3个 | 306ms | 24% | 悉尼 | 85个 | 0 | 388ms | 9%  
均值 | 1655个 | 18个 | 307ms | 6% | 迈阿密 | 85个 | 0 | 383ms | 4%  
巴黎 | 85个 | 0 | 268ms | 2% | 阿姆斯特丹 | 85个 | 3个 | 344ms | 5%  
  
简评：如果你是来自四川的 **电信** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **洛杉矶** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **东京** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_1)吧！

### 联通

四川联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 48个 | 0 | 270ms | 16% | 法兰克福 | 52个 | 0 | 335ms | 4%  
洛杉矶 | 36个 | 0 | 244ms | 2% | 芝加哥 | 32个 | 0 | 313ms | 7%  
硅谷 | 56个 | 0 | 247ms | 2% | 伦敦 | 52个 | 0 | 362ms | 1%  
西雅图 | 28个 | 0 | 258ms | 7% | 亚特兰大 | 32个 | 0 | 337ms | 4%  
达拉斯 | 52个 | 0 | 270ms | 2% | 新泽西 | 52个 | 0 | 335ms | 8%  
新加坡 | 36个 | 0 | 357ms | 13% | 悉尼 | 32个 | 0 | 396ms | 12%  
均值 | 604个 | 0 | 316ms | 5% | 迈阿密 | 32个 | 0 | 349ms | 3%  
巴黎 | 32个 | 0 | 335ms | 1% | 阿姆斯特丹 | 32个 | 0 | 383ms | 2%  
  
简评：如果你是来自四川的 **联通** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **洛杉矶、硅谷** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_2)吧！

### 移动

四川移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 84个 | 0 | 126ms | 3% | 法兰克福 | 80个 | 0 | 303ms | 0  
洛杉矶 | 48个 | 0 | 220ms | 0 | 芝加哥 | 44个 | 0 | 295ms | 15%  
硅谷 | 76个 | 0 | 255ms | 19% | 伦敦 | 84个 | 0 | 276ms | 1%  
西雅图 | 44个 | 0 | 215ms | 1% | 亚特兰大 | 48个 | 0 | 336ms | 1%  
达拉斯 | 84个 | 0 | 249ms | 0 | 新泽西 | 80个 | 0 | 312ms | 0  
新加坡 | 48个 | 0 | 164ms | 5% | 悉尼 | 40个 | 0 | 261ms | 3%  
均值 | 904个 | 0 | 262ms | 3% | 迈阿密 | 48个 | 0 | 322ms | 5%  
巴黎 | 48个 | 0 | 302ms | 0 | 阿姆斯特丹 | 48个 | 0 | 344ms | 1%  
  
简评：如果你是来自四川的 **移动** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、新加坡、西雅图、洛杉矶、达拉斯** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_3)吧！
