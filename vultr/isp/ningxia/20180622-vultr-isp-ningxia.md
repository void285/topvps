...
宁夏全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 158ms | 13% | 巴黎 | 13个 | 0 | 282ms | 0  
洛杉矶 | 13个 | 0 | 215ms | 1% | 亚特兰大 | 13个 | 0 | 295ms | 21%  
硅谷 | 13个 | 0 | 222ms | 1% | 悉尼 | 13个 | 0 | 296ms | 6%  
西雅图 | 14个 | 0 | 224ms | 3% | 芝加哥 | 13个 | 0 | 303ms | 24%  
新加坡 | 13个 | 0 | 239ms | 6% | 新泽西 | 13个 | 0 | 304ms | 1%  
达拉斯 | 14个 | 0 | 249ms | 0 | 迈阿密 | 13个 | 0 | 317ms | 23%  
均值 | 197个 | 0 | 268ms | 8% | 伦敦 | 13个 | 0 | 325ms | 15%  
法兰克福 | 13个 | 0 | 270ms | 0 | 阿姆斯特丹 | 13个 | 0 | 329ms | 0  
...
宁夏电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 6个 | 0 | 241ms | 28% | 巴黎 | 6个 | 0 | 229ms | 0  
洛杉矶 | 6个 | 0 | 238ms | 0 | 亚特兰大 | 6个 | 0 | 334ms | 0  
硅谷 | 6个 | 0 | 256ms | 4% | 悉尼 | 6个 | 0 | 431ms | 15%  
西雅图 | 6个 | 0 | 224ms | 2% | 芝加哥 | 6个 | 0 | 308ms | 0  
新加坡 | 6个 | 0 | 314ms | 19% | 新泽西 | 6个 | 0 | 352ms | 0  
达拉斯 | 6个 | 0 | 274ms | 0 | 迈阿密 | 6个 | 0 | 331ms | 0  
均值 | 90个 | 0 | 298ms | 4% | 伦敦 | 6个 | 0 | 370ms | 0  
法兰克福 | 6个 | 0 | 208ms | 0 | 阿姆斯特丹 | 6个 | 0 | 353ms | 0  
...
宁夏联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 3个 | 0 | 95ms | 0 | 巴黎 | 3个 | 0 | 332ms | 0  
洛杉矶 | 3个 | 0 | 188ms | 1% | 亚特兰大 | 3个 | 0 | 268ms | 64%  
硅谷 | 2个 | 0 | 191ms | 0 | 悉尼 | 3个 | 0 | 253ms | 3%  
西雅图 | 3个 | 0 | 210ms | 0 | 芝加哥 | 3个 | 0 | 330ms | 68%  
新加坡 | 3个 | 0 | 264ms | 0 | 新泽西 | 3个 | 0 | 273ms | 0  
达拉斯 | 3个 | 0 | 216ms | 0 | 迈阿密 | 3个 | 0 | 304ms | 60%  
均值 | 43个 | 0 | 264ms | 17% | 伦敦 | 3个 | 0 | 357ms | 44%  
法兰克福 | 2个 | 0 | 357ms | 0 | 阿姆斯特丹 | 3个 | 0 | 337ms | 0  
...
宁夏移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 4个 | 0 | 139ms | 11% | 巴黎 | 4个 | 0 | 284ms | 0  
洛杉矶 | 4个 | 0 | 218ms | 1% | 亚特兰大 | 4个 | 0 | 285ms | 0  
硅谷 | 5个 | 0 | 218ms | 0 | 悉尼 | 4个 | 0 | 205ms | 0  
西雅图 | 5个 | 0 | 238ms | 7% | 芝加哥 | 4个 | 0 | 272ms | 4%  
新加坡 | 4个 | 0 | 137ms | 0 | 新泽西 | 4个 | 0 | 286ms | 3%  
达拉斯 | 5个 | 0 | 257ms | 0 | 迈阿密 | 4个 | 0 | 317ms | 9%  
均值 | 64个 | 0 | 243ms | 2% | 伦敦 | 4个 | 0 | 247ms | 1%  
法兰克福 | 5个 | 0 | 245ms | 0 | 阿姆斯特丹 | 4个 | 0 | 296ms | 1%  
