...
辽宁全部运营商到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 37个 | 1个 | 135ms | 12% | 达拉斯 | 38个 | 0 | 269ms | 14%  
洛杉矶 | 40个 | 0 | 214ms | 11% | 阿姆斯特丹 | 34个 | 0 | 283ms | 6%  
新加坡 | 37个 | 0 | 214ms | 9% | 芝加哥 | 41个 | 0 | 296ms | 9%  
西雅图 | 39个 | 0 | 229ms | 11% | 法兰克福 | 31个 | 0 | 296ms | 8%  
悉尼 | 37个 | 0 | 239ms | 3% | 伦敦 | 37个 | 0 | 300ms | 4%  
硅谷 | 38个 | 0 | 254ms | 17% | 迈阿密 | 37个 | 0 | 313ms | 9%  
均值 | 563个 | 1个 | 261ms | 9% | 亚特兰大 | 40个 | 0 | 326ms | 17%  
巴黎 | 37个 | 0 | 263ms | 7% | 新泽西 | 40个 | 0 | 327ms | 2%  
  
简评：本表展示了辽宁的 **电信、联通、移动** 线路到Vultr各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻辽宁，可从此表了解你常用的网络到Vultr各个机房的平均响应速度以及丢包率。从表中数据可以看到， **悉尼** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

辽宁电信到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 1个 | 141ms | 13% | 达拉斯 | 13个 | 0 | 245ms | 7%  
洛杉矶 | 13个 | 0 | 218ms | 5% | 阿姆斯特丹 | 12个 | 0 | 262ms | 2%  
新加坡 | 13个 | 0 | 197ms | 9% | 芝加哥 | 14个 | 0 | 307ms | 4%  
西雅图 | 14个 | 0 | 244ms | 7% | 法兰克福 | 11个 | 0 | 258ms | 3%  
悉尼 | 13个 | 0 | 257ms | 3% | 伦敦 | 13个 | 0 | 315ms | 2%  
硅谷 | 12个 | 0 | 276ms | 11% | 迈阿密 | 13个 | 0 | 336ms | 6%  
均值 | 194个 | 1个 | 258ms | 6% | 亚特兰大 | 13个 | 0 | 334ms | 12%  
巴黎 | 13个 | 0 | 236ms | 2% | 新泽西 | 14个 | 0 | 318ms | 1%  
  
简评：如果你是来自辽宁的 **电信** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **洛杉矶、巴黎** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **东京、新加坡、西雅图、达拉斯** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_1)吧！

### 联通

辽宁联通到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 0 | 152ms | 22% | 达拉斯 | 16个 | 0 | 230ms | 9%  
洛杉矶 | 18个 | 0 | 195ms | 7% | 阿姆斯特丹 | 16个 | 0 | 301ms | 7%  
新加坡 | 15个 | 0 | 322ms | 18% | 芝加哥 | 18个 | 0 | 302ms | 6%  
西雅图 | 17个 | 0 | 205ms | 6% | 法兰克福 | 13个 | 0 | 314ms | 14%  
悉尼 | 15个 | 0 | 224ms | 5% | 伦敦 | 15个 | 0 | 318ms | 9%  
硅谷 | 17个 | 0 | 214ms | 8% | 迈阿密 | 16个 | 0 | 294ms | 9%  
均值 | 242个 | 0 | 259ms | 9% | 亚特兰大 | 18个 | 0 | 256ms | 6%  
巴黎 | 16个 | 0 | 266ms | 9% | 新泽西 | 17个 | 0 | 318ms | 4%  
  
简评：如果你是来自辽宁的 **联通** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **悉尼** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **东京、洛杉矶、西雅图、硅谷、达拉斯** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_2)吧！

### 移动

辽宁移动到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 114ms | 1% | 达拉斯 | 9个 | 0 | 331ms | 25%  
洛杉矶 | 9个 | 0 | 231ms | 21% | 阿姆斯特丹 | 6个 | 0 | 286ms | 7%  
新加坡 | 9个 | 0 | 125ms | 0 | 芝加哥 | 9个 | 0 | 281ms | 18%  
西雅图 | 8个 | 0 | 237ms | 19% | 法兰克福 | 7个 | 0 | 316ms | 7%  
悉尼 | 9个 | 0 | 236ms | 0 | 伦敦 | 9个 | 0 | 266ms | 0  
硅谷 | 9个 | 0 | 272ms | 31% | 迈阿密 | 8个 | 0 | 310ms | 10%  
均值 | 127个 | 0 | 267ms | 12% | 亚特兰大 | 9个 | 0 | 388ms | 32%  
巴黎 | 8个 | 0 | 289ms | 10% | 新泽西 | 9个 | 0 | 345ms | 0  
  
简评：如果你是来自辽宁的 **移动** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、新加坡、悉尼** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **洛杉矶、西雅图** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_3)吧！
