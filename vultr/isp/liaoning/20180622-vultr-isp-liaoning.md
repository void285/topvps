...
**辽宁全部运营商到Vultr各机房的测速数据 [20180622]**
...
巴黎 | 36个 | 0 | 266ms | 1%  
均值 | 519个 | 12个 | 267ms | 9%  
法兰克福 | 29个 | 4个 | 285ms | 13%  
芝加哥 | 35个 | 1个 | 292ms | 24%  
亚特兰大 | 34个 | 1个 | 297ms | 22%  
伦敦 | 33个 | 1个 | 301ms | 15%  
迈阿密 | 35个 | 0 | 308ms | 21%  
新泽西 | 35个 | 0 | 309ms | 3%  
阿姆斯特丹 | 35个 | 1个 | 316ms | 2%  
悉尼 | 36个 | 0 | 316ms | 8%  
...
巴黎 | 12个 | 0 | 243ms | 0  
均值 | 183个 | 9个 | 284ms | 10%  
法兰克福 | 10个 | 2个 | 246ms | 12%  
芝加哥 | 13个 | 1个 | 333ms | 24%  
亚特兰大 | 13个 | 1个 | 312ms | 20%  
伦敦 | 11个 | 1个 | 326ms | 17%  
迈阿密 | 13个 | 0 | 339ms | 21%  
新泽西 | 13个 | 0 | 345ms | 5%  
阿姆斯特丹 | 12个 | 1个 | 326ms | 0  
悉尼 | 12个 | 0 | 372ms | 11%  
