...
贵州全部运营商到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 43个 | 1个 | 148ms | 1% | 新泽西 | 43个 | 1个 | 281ms | 7%  
新加坡 | 45个 | 0 | 180ms | 1% | 亚特兰大 | 42个 | 1个 | 281ms | 6%  
洛杉矶 | 41个 | 0 | 212ms | 3% | 悉尼 | 43个 | 1个 | 288ms | 0  
硅谷 | 42个 | 0 | 219ms | 2% | 迈阿密 | 43个 | 1个 | 293ms | 6%  
西雅图 | 41个 | 0 | 229ms | 6% | 巴黎 | 42个 | 0 | 297ms | 6%  
达拉斯 | 42个 | 1个 | 241ms | 2% | 法兰克福 | 43个 | 0 | 305ms | 7%  
均值 | 638个 | 7个 | 257ms | 4% | 伦敦 | 41个 | 1个 | 308ms | 3%  
芝加哥 | 41个 | 0 | 258ms | 0 | 阿姆斯特丹 | 46个 | 0 | 315ms | 11%  
...
贵州电信到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 21个 | 1个 | 198ms | 3% | 新泽西 | 21个 | 1个 | 262ms | 2%  
新加坡 | 21个 | 0 | 261ms | 2% | 亚特兰大 | 21个 | 1个 | 312ms | 14%  
洛杉矶 | 19个 | 0 | 220ms | 3% | 悉尼 | 21个 | 1个 | 339ms | 1%  
硅谷 | 21个 | 0 | 214ms | 4% | 迈阿密 | 21个 | 1个 | 315ms | 15%  
西雅图 | 20个 | 0 | 255ms | 14% | 巴黎 | 21个 | 0 | 282ms | 10%  
达拉斯 | 21个 | 1个 | 222ms | 1% | 法兰克福 | 21个 | 0 | 302ms | 11%  
均值 | 310个 | 7个 | 267ms | 6% | 伦敦 | 20个 | 1个 | 274ms | 0  
芝加哥 | 20个 | 0 | 246ms | 0 | 阿姆斯特丹 | 21个 | 0 | 300ms | 3%  
...
贵州联通到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 132ms | 0 | 新泽西 | 12个 | 0 | 316ms | 17%  
新加坡 | 12个 | 0 | 166ms | 0 | 亚特兰大 | 12个 | 0 | 268ms | 1%  
洛杉矶 | 11个 | 0 | 214ms | 0 | 悉尼 | 11个 | 0 | 316ms | 0  
硅谷 | 12个 | 0 | 214ms | 0 | 迈阿密 | 12个 | 0 | 294ms | 4%  
西雅图 | 10个 | 0 | 246ms | 2% | 巴黎 | 11个 | 0 | 345ms | 2%  
达拉斯 | 12个 | 0 | 262ms | 6% | 法兰克福 | 12个 | 0 | 356ms | 3%  
均值 | 174个 | 0 | 277ms | 5% | 伦敦 | 11个 | 0 | 379ms | 10%  
芝加哥 | 11个 | 0 | 273ms | 0 | 阿姆斯特丹 | 13个 | 0 | 372ms | 25%  
...
贵州移动到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 112ms | 0 | 新泽西 | 10个 | 0 | 266ms | 0  
新加坡 | 12个 | 0 | 114ms | 0 | 亚特兰大 | 9个 | 0 | 264ms | 5%  
洛杉矶 | 11个 | 0 | 203ms | 5% | 悉尼 | 11个 | 0 | 209ms | 0  
硅谷 | 9个 | 0 | 230ms | 1% | 迈阿密 | 10个 | 0 | 270ms | 0  
西雅图 | 11个 | 0 | 187ms | 2% | 巴黎 | 10个 | 0 | 264ms | 5%  
达拉斯 | 9个 | 0 | 240ms | 0 | 法兰克福 | 10个 | 0 | 258ms | 6%  
均值 | 154个 | 0 | 226ms | 2% | 伦敦 | 10个 | 0 | 272ms | 0  
芝加哥 | 10个 | 0 | 254ms | 0 | 阿姆斯特丹 | 12个 | 0 | 274ms | 5%  
