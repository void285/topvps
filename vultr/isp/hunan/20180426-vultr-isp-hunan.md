...
湖南全部运营商到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 35个 | 0 | 154ms | 13% | 亚特兰大 | 34个 | 0 | 283ms | 4%  
新加坡 | 40个 | 0 | 163ms | 4% | 芝加哥 | 33个 | 0 | 290ms | 1%  
洛杉矶 | 32个 | 0 | 191ms | 1% | 巴黎 | 39个 | 0 | 294ms | 1%  
硅谷 | 32个 | 0 | 207ms | 1% | 新泽西 | 32个 | 0 | 295ms | 1%  
西雅图 | 34个 | 0 | 218ms | 1% | 法兰克福 | 41个 | 0 | 296ms | 3%  
悉尼 | 35个 | 0 | 225ms | 1% | 迈阿密 | 35个 | 0 | 301ms | 2%  
达拉斯 | 33个 | 0 | 252ms | 4% | 阿姆斯特丹 | 39个 | 1个 | 307ms | 4%  
均值 | 532个 | 1个 | 255ms | 3% | 伦敦 | 38个 | 0 | 339ms | 3%  
...
湖南电信到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 213ms | 26% | 亚特兰大 | 11个 | 0 | 292ms | 3%  
新加坡 | 12个 | 0 | 175ms | 8% | 芝加哥 | 10个 | 0 | 329ms | 2%  
洛杉矶 | 11个 | 0 | 196ms | 1% | 巴黎 | 11个 | 0 | 272ms | 0  
硅谷 | 11个 | 0 | 228ms | 2% | 新泽西 | 12个 | 0 | 329ms | 2%  
西雅图 | 12个 | 0 | 253ms | 2% | 法兰克福 | 13个 | 0 | 274ms | 1%  
悉尼 | 12个 | 0 | 268ms | 1% | 迈阿密 | 12个 | 0 | 341ms | 2%  
达拉斯 | 12个 | 0 | 241ms | 2% | 阿姆斯特丹 | 12个 | 1个 | 270ms | 0  
均值 | 174个 | 1个 | 267ms | 4% | 伦敦 | 11个 | 0 | 328ms | 2%  
...
湖南联通到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 14个 | 0 | 112ms | 6% | 亚特兰大 | 14个 | 0 | 241ms | 1%  
新加坡 | 13个 | 0 | 143ms | 0 | 芝加哥 | 14个 | 0 | 253ms | 0  
洛杉矶 | 13个 | 0 | 181ms | 1% | 巴黎 | 13个 | 0 | 342ms | 0  
硅谷 | 12个 | 0 | 188ms | 1% | 新泽西 | 12个 | 0 | 276ms | 2%  
西雅图 | 13个 | 0 | 195ms | 0 | 法兰克福 | 13个 | 0 | 350ms | 4%  
悉尼 | 14个 | 0 | 190ms | 0 | 迈阿密 | 14个 | 0 | 266ms | 2%  
达拉斯 | 13个 | 0 | 222ms | 3% | 阿姆斯特丹 | 13个 | 0 | 335ms | 6%  
均值 | 198个 | 0 | 241ms | 2% | 伦敦 | 13个 | 0 | 325ms | 2%  
...
湖南移动到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 135ms | 7% | 亚特兰大 | 9个 | 0 | 318ms | 7%  
新加坡 | 15个 | 0 | 170ms | 5% | 芝加哥 | 9个 | 0 | 288ms | 1%  
洛杉矶 | 8个 | 0 | 198ms | 1% | 巴黎 | 15个 | 0 | 267ms | 4%  
硅谷 | 9个 | 0 | 206ms | 0 | 新泽西 | 8个 | 0 | 281ms | 0  
西雅图 | 9个 | 0 | 206ms | 0 | 法兰克福 | 15个 | 0 | 264ms | 5%  
悉尼 | 9个 | 0 | 216ms | 1% | 迈阿密 | 9个 | 0 | 295ms | 1%  
达拉斯 | 8个 | 0 | 292ms | 6% | 阿姆斯特丹 | 14个 | 0 | 317ms | 5%  
均值 | 160个 | 0 | 257ms | 4% | 伦敦 | 14个 | 0 | 364ms | 6%  
