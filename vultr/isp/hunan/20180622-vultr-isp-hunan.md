...
湖南全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 38个 | 0 | 134ms | 4% | 法兰克福 | 39个 | 3个 | 274ms | 0  
洛杉矶 | 36个 | 1个 | 195ms | 1% | 芝加哥 | 39个 | 0 | 275ms | 19%  
新加坡 | 33个 | 0 | 199ms | 7% | 亚特兰大 | 37个 | 1个 | 276ms | 17%  
西雅图 | 36个 | 0 | 203ms | 1% | 巴黎 | 34个 | 0 | 278ms | 2%  
硅谷 | 37个 | 0 | 213ms | 1% | 新泽西 | 36个 | 0 | 283ms | 2%  
达拉斯 | 33个 | 0 | 239ms | 0 | 迈阿密 | 38个 | 0 | 295ms | 18%  
均值 | 546个 | 5个 | 251ms | 6% | 伦敦 | 39个 | 0 | 304ms | 11%  
悉尼 | 34个 | 0 | 253ms | 2% | 阿姆斯特丹 | 37个 | 0 | 325ms | 2%  
...
湖南电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 0 | 193ms | 11% | 法兰克福 | 15个 | 2个 | 233ms | 0  
洛杉矶 | 14个 | 1个 | 203ms | 3% | 芝加哥 | 15个 | 0 | 294ms | 8%  
新加坡 | 12个 | 0 | 243ms | 11% | 亚特兰大 | 15个 | 1个 | 268ms | 7%  
西雅图 | 14个 | 0 | 219ms | 2% | 巴黎 | 12个 | 0 | 253ms | 4%  
硅谷 | 15个 | 0 | 226ms | 1% | 新泽西 | 14个 | 0 | 317ms | 3%  
达拉斯 | 12个 | 0 | 260ms | 1% | 迈阿密 | 15个 | 0 | 325ms | 8%  
均值 | 211个 | 4个 | 266ms | 5% | 伦敦 | 15个 | 0 | 320ms | 5%  
悉尼 | 13个 | 0 | 295ms | 4% | 阿姆斯特丹 | 15个 | 0 | 342ms | 3%  
...
湖南联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 85ms | 0 | 法兰克福 | 13个 | 1个 | 325ms | 2%  
洛杉矶 | 11个 | 0 | 186ms | 0 | 芝加哥 | 13个 | 0 | 274ms | 41%  
新加坡 | 11个 | 0 | 185ms | 5% | 亚特兰大 | 11个 | 0 | 282ms | 39%  
西雅图 | 11个 | 0 | 204ms | 2% | 巴黎 | 11个 | 0 | 307ms | 3%  
硅谷 | 12个 | 0 | 187ms | 0 | 新泽西 | 11个 | 0 | 261ms | 1%  
达拉斯 | 11个 | 0 | 220ms | 0 | 迈阿密 | 12个 | 0 | 278ms | 40%  
均值 | 174个 | 1个 | 249ms | 11% | 伦敦 | 13个 | 0 | 323ms | 25%  
悉尼 | 11个 | 0 | 229ms | 1% | 阿姆斯特丹 | 11个 | 0 | 331ms | 3%  
...
湖南移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 123ms | 1% | 法兰克福 | 11个 | 0 | 264ms | 0  
洛杉矶 | 11个 | 0 | 196ms | 0 | 芝加哥 | 11个 | 0 | 258ms | 9%  
新加坡 | 10个 | 0 | 170ms | 5% | 亚特兰大 | 11个 | 0 | 277ms | 6%  
西雅图 | 11个 | 0 | 187ms | 0 | 巴黎 | 11个 | 0 | 275ms | 0  
硅谷 | 10个 | 0 | 225ms | 1% | 新泽西 | 11个 | 0 | 271ms | 2%  
达拉斯 | 10个 | 0 | 236ms | 0 | 迈阿密 | 11个 | 0 | 283ms | 6%  
均值 | 161个 | 0 | 239ms | 2% | 伦敦 | 11个 | 0 | 270ms | 4%  
悉尼 | 10个 | 0 | 235ms | 0 | 阿姆斯特丹 | 11个 | 0 | 302ms | 0  
