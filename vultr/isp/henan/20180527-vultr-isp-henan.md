...
河南全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 55个 | 1个 | 174ms | 10% | 新泽西 | 58个 | 1个 | 264ms | 10%  
洛杉矶 | 56个 | 3个 | 209ms | 2% | 达拉斯 | 58个 | 2个 | 279ms | 15%  
硅谷 | 57个 | 4个 | 211ms | 11% | 迈阿密 | 58个 | 3个 | 284ms | 12%  
新加坡 | 56个 | 1个 | 212ms | 10% | 亚特兰大 | 58个 | 3个 | 287ms | 15%  
西雅图 | 56个 | 3个 | 214ms | 11% | 法兰克福 | 57个 | 2个 | 288ms | 4%  
巴黎 | 55个 | 1个 | 255ms | 2% | 悉尼 | 57个 | 1个 | 312ms | 11%  
芝加哥 | 58个 | 2个 | 257ms | 5% | 阿姆斯特丹 | 58个 | 1个 | 313ms | 2%  
均值 | 855个 | 29个 | 258ms | 8% | 伦敦 | 58个 | 1个 | 316ms | 6%  
...
河南电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 19个 | 0 | 177ms | 16% | 新泽西 | 20个 | 0 | 254ms | 18%  
洛杉矶 | 20个 | 1个 | 229ms | 1% | 达拉斯 | 20个 | 1个 | 291ms | 12%  
硅谷 | 20个 | 2个 | 217ms | 7% | 迈阿密 | 20个 | 2个 | 300ms | 11%  
新加坡 | 19个 | 0 | 224ms | 14% | 亚特兰大 | 20个 | 2个 | 289ms | 13%  
西雅图 | 19个 | 1个 | 225ms | 7% | 法兰克福 | 19个 | 1个 | 259ms | 1%  
巴黎 | 20个 | 0 | 254ms | 1% | 悉尼 | 20个 | 0 | 332ms | 15%  
芝加哥 | 20个 | 1个 | 278ms | 3% | 阿姆斯特丹 | 20个 | 0 | 294ms | 1%  
均值 | 296个 | 11个 | 259ms | 8% | 伦敦 | 20个 | 0 | 294ms | 7%  
...
河南联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 21个 | 0 | 217ms | 13% | 新泽西 | 22个 | 0 | 266ms | 11%  
洛杉矶 | 21个 | 1个 | 189ms | 1% | 达拉斯 | 22个 | 0 | 226ms | 2%  
硅谷 | 21个 | 1个 | 197ms | 16% | 迈阿密 | 22个 | 0 | 244ms | 10%  
新加坡 | 22个 | 0 | 282ms | 12% | 亚特兰大 | 22个 | 0 | 243ms | 3%  
西雅图 | 21个 | 1个 | 207ms | 16% | 法兰克福 | 22个 | 0 | 326ms | 7%  
巴黎 | 20个 | 0 | 267ms | 2% | 悉尼 | 21个 | 0 | 331ms | 13%  
芝加哥 | 22个 | 0 | 244ms | 6% | 阿姆斯特丹 | 22个 | 0 | 326ms | 4%  
均值 | 323个 | 3个 | 258ms | 8% | 伦敦 | 22个 | 0 | 320ms | 3%  
...
河南移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 1个 | 127ms | 2% | 新泽西 | 16个 | 1个 | 273ms | 1%  
洛杉矶 | 15个 | 1个 | 208ms | 5% | 达拉斯 | 16个 | 1个 | 320ms | 30%  
硅谷 | 16个 | 1个 | 219ms | 10% | 迈阿密 | 16个 | 1个 | 309ms | 14%  
新加坡 | 15个 | 1个 | 132ms | 3% | 亚特兰大 | 16个 | 1个 | 331ms | 28%  
西雅图 | 16个 | 1个 | 211ms | 10% | 法兰克福 | 16个 | 1个 | 279ms | 3%  
巴黎 | 15个 | 1个 | 245ms | 2% | 悉尼 | 16个 | 1个 | 274ms | 5%  
芝加哥 | 16个 | 1个 | 251ms | 7% | 阿姆斯特丹 | 16个 | 1个 | 319ms | 3%  
均值 | 236个 | 15个 | 257ms | 9% | 伦敦 | 16个 | 1个 | 334ms | 10%  
