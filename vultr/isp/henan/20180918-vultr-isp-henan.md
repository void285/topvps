...
河南全部运营商到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 87个 | 0 | 129ms | 7% | 法兰克福 | 85个 | 0 | 270ms | 3%  
新加坡 | 89个 | 0 | 179ms | 6% | 亚特兰大 | 88个 | 0 | 272ms | 4%  
洛杉矶 | 86个 | 0 | 202ms | 4% | 芝加哥 | 86个 | 0 | 273ms | 4%  
西雅图 | 88个 | 0 | 212ms | 3% | 巴黎 | 91个 | 0 | 284ms | 4%  
达拉斯 | 85个 | 0 | 232ms | 3% | 新泽西 | 87个 | 0 | 292ms | 9%  
硅谷 | 88个 | 0 | 235ms | 1% | 迈阿密 | 85个 | 0 | 299ms | 4%  
均值 | 1306个 | 0 | 251ms | 4% | 伦敦 | 85个 | 0 | 307ms | 8%  
悉尼 | 88个 | 0 | 265ms | 5% | 阿姆斯特丹 | 88个 | 0 | 320ms | 4%  
...
河南电信到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 26个 | 0 | 148ms | 4% | 法兰克福 | 26个 | 0 | 293ms | 2%  
新加坡 | 27个 | 0 | 215ms | 8% | 亚特兰大 | 26个 | 0 | 305ms | 8%  
洛杉矶 | 27个 | 0 | 225ms | 9% | 芝加哥 | 25个 | 0 | 283ms | 0  
西雅图 | 28个 | 0 | 227ms | 8% | 巴黎 | 28个 | 0 | 283ms | 3%  
达拉斯 | 26个 | 0 | 240ms | 4% | 新泽西 | 28个 | 0 | 289ms | 7%  
硅谷 | 28个 | 0 | 263ms | 0 | 迈阿密 | 26个 | 0 | 322ms | 3%  
均值 | 405个 | 0 | 268ms | 5% | 伦敦 | 27个 | 0 | 302ms | 5%  
悉尼 | 28个 | 0 | 301ms | 5% | 阿姆斯特丹 | 29个 | 0 | 322ms | 2%  
...
河南联通到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 33个 | 0 | 123ms | 8% | 法兰克福 | 33个 | 0 | 269ms | 2%  
新加坡 | 35个 | 0 | 200ms | 8% | 亚特兰大 | 35个 | 0 | 252ms | 0  
洛杉矶 | 32个 | 0 | 180ms | 0 | 芝加哥 | 33个 | 0 | 263ms | 1%  
西雅图 | 34个 | 0 | 199ms | 0 | 巴黎 | 35个 | 0 | 333ms | 3%  
达拉斯 | 32个 | 0 | 213ms | 4% | 新泽西 | 33个 | 0 | 315ms | 16%  
硅谷 | 34个 | 0 | 222ms | 0 | 迈阿密 | 33个 | 0 | 280ms | 4%  
均值 | 501个 | 0 | 256ms | 5% | 伦敦 | 32个 | 0 | 361ms | 16%  
悉尼 | 34个 | 0 | 278ms | 5% | 阿姆斯特丹 | 33个 | 0 | 363ms | 3%  
...
河南移动到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 28个 | 0 | 117ms | 10% | 法兰克福 | 26个 | 0 | 249ms | 4%  
新加坡 | 27个 | 0 | 124ms | 3% | 亚特兰大 | 27个 | 0 | 260ms | 4%  
洛杉矶 | 27个 | 0 | 201ms | 4% | 芝加哥 | 28个 | 0 | 274ms | 10%  
西雅图 | 26个 | 0 | 209ms | 1% | 巴黎 | 28个 | 0 | 235ms | 5%  
达拉斯 | 27个 | 0 | 242ms | 1% | 新泽西 | 26个 | 0 | 273ms | 3%  
硅谷 | 26个 | 0 | 219ms | 3% | 迈阿密 | 26个 | 0 | 294ms | 6%  
均值 | 400个 | 0 | 229ms | 4% | 伦敦 | 26个 | 0 | 259ms | 2%  
悉尼 | 26个 | 0 | 215ms | 3% | 阿姆斯特丹 | 26个 | 0 | 274ms | 5%  
