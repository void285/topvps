...
河南全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 339个 | 0 | 189ms | 14% | 均值 | 3905个 | 12个 | 279ms | 9%  
洛杉矶 | 191个 | 0 | 217ms | 3% | 悉尼 | 195个 | 3个 | 306ms | 14%  
新加坡 | 199个 | 0 | 222ms | 14% | 芝加哥 | 195个 | 0 | 310ms | 8%  
西雅图 | 195个 | 0 | 239ms | 22% | 亚特兰大 | 199个 | 3个 | 319ms | 6%  
达拉斯 | 367个 | 0 | 266ms | 3% | 伦敦 | 339个 | 3个 | 323ms | 4%  
法兰克福 | 355个 | 0 | 270ms | 3% | 新泽西 | 367个 | 0 | 326ms | 5%  
巴黎 | 199个 | 0 | 271ms | 3% | 阿姆斯特丹 | 203个 | 3个 | 331ms | 10%  
硅谷 | 355个 | 0 | 279ms | 16% | 迈阿密 | 207个 | 0 | 340ms | 10%  
...
河南电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 108个 | 0 | 209ms | 21% | 均值 | 1176个 | 0 | 299ms | 9%  
洛杉矶 | 48个 | 0 | 256ms | 3% | 悉尼 | 60个 | 0 | 349ms | 24%  
新加坡 | 60个 | 0 | 244ms | 25% | 芝加哥 | 56个 | 0 | 335ms | 5%  
西雅图 | 60个 | 0 | 269ms | 19% | 亚特兰大 | 60个 | 0 | 349ms | 2%  
达拉斯 | 112个 | 0 | 320ms | 5% | 伦敦 | 104个 | 0 | 298ms | 1%  
法兰克福 | 108个 | 0 | 265ms | 2% | 新泽西 | 108个 | 0 | 339ms | 2%  
巴黎 | 60个 | 0 | 289ms | 2% | 阿姆斯特丹 | 64个 | 0 | 301ms | 9%  
硅谷 | 104个 | 0 | 306ms | 11% | 迈阿密 | 64个 | 0 | 380ms | 7%  
...
河南联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 107个 | 0 | 228ms | 16% | 均值 | 1441个 | 12个 | 291ms | 8%  
洛杉矶 | 79个 | 0 | 187ms | 1% | 悉尼 | 75个 | 3个 | 330ms | 10%  
新加坡 | 75个 | 0 | 278ms | 9% | 芝加哥 | 79个 | 0 | 327ms | 10%  
西雅图 | 75个 | 0 | 208ms | 13% | 亚特兰大 | 79个 | 3个 | 287ms | 6%  
达拉斯 | 127个 | 0 | 223ms | 0 | 伦敦 | 115个 | 3个 | 397ms | 10%  
法兰克福 | 135个 | 0 | 284ms | 2% | 新泽西 | 131个 | 0 | 351ms | 11%  
巴黎 | 79个 | 0 | 255ms | 0 | 阿姆斯特丹 | 75个 | 3个 | 400ms | 11%  
硅谷 | 131个 | 0 | 279ms | 13% | 迈阿密 | 79个 | 0 | 331ms | 11%  
...
河南移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 124个 | 0 | 130ms | 5% | 均值 | 1288个 | 0 | 248ms | 9%  
洛杉矶 | 64个 | 0 | 207ms | 6% | 悉尼 | 60个 | 0 | 238ms | 8%  
新加坡 | 64个 | 0 | 144ms | 8% | 芝加哥 | 60个 | 0 | 268ms | 7%  
西雅图 | 60个 | 0 | 240ms | 34% | 亚特兰大 | 60个 | 0 | 320ms | 8%  
达拉斯 | 128个 | 0 | 255ms | 4% | 伦敦 | 120个 | 0 | 275ms | 2%  
法兰克福 | 112个 | 0 | 260ms | 5% | 新泽西 | 128个 | 0 | 289ms | 2%  
巴黎 | 60个 | 0 | 268ms | 7% | 阿姆斯特丹 | 64个 | 0 | 291ms | 10%  
硅谷 | 120个 | 0 | 253ms | 23% | 迈阿密 | 64个 | 0 | 310ms | 10%  
