...
江西全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 26个 | 0 | 160ms | 8% | 法兰克福 | 23个 | 1个 | 277ms | 0  
新加坡 | 25个 | 0 | 199ms | 9% | 悉尼 | 25个 | 0 | 282ms | 5%  
洛杉矶 | 24个 | 1个 | 200ms | 1% | 芝加哥 | 26个 | 0 | 289ms | 21%  
西雅图 | 24个 | 0 | 215ms | 3% | 亚特兰大 | 23个 | 0 | 295ms | 19%  
硅谷 | 23个 | 0 | 223ms | 1% | 新泽西 | 24个 | 0 | 298ms | 2%  
达拉斯 | 21个 | 0 | 245ms | 1% | 迈阿密 | 26个 | 0 | 311ms | 17%  
均值 | 365个 | 2个 | 262ms | 7% | 伦敦 | 25个 | 0 | 334ms | 13%  
巴黎 | 25个 | 0 | 276ms | 0 | 阿姆斯特丹 | 25个 | 0 | 336ms | 1%  
...
江西电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 215ms | 21% | 法兰克福 | 11个 | 1个 | 245ms | 0  
新加坡 | 13个 | 0 | 288ms | 17% | 悉尼 | 13个 | 0 | 406ms | 13%  
洛杉矶 | 12个 | 1个 | 228ms | 3% | 芝加哥 | 13个 | 0 | 296ms | 6%  
西雅图 | 12个 | 0 | 234ms | 3% | 亚特兰大 | 12个 | 0 | 306ms | 5%  
硅谷 | 11个 | 0 | 251ms | 3% | 新泽西 | 13个 | 0 | 326ms | 2%  
达拉斯 | 12个 | 0 | 295ms | 3% | 迈阿密 | 13个 | 0 | 327ms | 1%  
均值 | 187个 | 2个 | 288ms | 6% | 伦敦 | 13个 | 0 | 342ms | 3%  
巴黎 | 13个 | 0 | 224ms | 0 | 阿姆斯特丹 | 13个 | 0 | 350ms | 1%  
...
江西联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 3个 | 0 | 154ms | 4% | 法兰克福 | 3个 | 0 | 311ms | 0  
新加坡 | 3个 | 0 | 179ms | 9% | 悉尼 | 3个 | 0 | 244ms | 1%  
洛杉矶 | 3个 | 0 | 169ms | 0 | 芝加哥 | 3个 | 0 | 316ms | 48%  
西雅图 | 3个 | 0 | 208ms | 0 | 亚特兰大 | 3个 | 0 | 294ms | 45%  
硅谷 | 3个 | 0 | 197ms | 0 | 新泽西 | 3个 | 0 | 300ms | 1%  
达拉斯 | 3个 | 0 | 208ms | 0 | 迈阿密 | 3个 | 0 | 326ms | 42%  
均值 | 45个 | 0 | 265ms | 12% | 伦敦 | 3个 | 0 | 374ms | 32%  
巴黎 | 3个 | 0 | 327ms | 0 | 阿姆斯特丹 | 3个 | 0 | 374ms | 1%  
...
江西移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 111ms | 0 | 法兰克福 | 9个 | 0 | 276ms | 0  
新加坡 | 9个 | 0 | 130ms | 1% | 悉尼 | 9个 | 0 | 198ms | 0  
洛杉矶 | 9个 | 0 | 203ms | 0 | 芝加哥 | 10个 | 0 | 256ms | 9%  
西雅图 | 9个 | 0 | 201ms | 7% | 亚特兰大 | 8个 | 0 | 284ms | 8%  
硅谷 | 9个 | 0 | 221ms | 0 | 新泽西 | 8个 | 0 | 269ms | 2%  
达拉斯 | 6个 | 0 | 232ms | 0 | 迈阿密 | 10个 | 0 | 281ms | 9%  
均值 | 133个 | 0 | 233ms | 3% | 伦敦 | 9个 | 0 | 286ms | 5%  
巴黎 | 9个 | 0 | 278ms | 0 | 阿姆斯特丹 | 9个 | 0 | 283ms | 1%  
