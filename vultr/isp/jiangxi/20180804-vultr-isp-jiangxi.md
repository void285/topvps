...
江西全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 131个 | 7个 | 162ms | 19% | 芝加哥 | 75个 | 0 | 295ms | 6%  
新加坡 | 75个 | 0 | 195ms | 20% | 法兰克福 | 135个 | 4个 | 295ms | 1%  
西雅图 | 75个 | 0 | 243ms | 16% | 伦敦 | 139个 | 4个 | 302ms | 2%  
洛杉矶 | 75个 | 0 | 245ms | 3% | 亚特兰大 | 75个 | 0 | 315ms | 1%  
硅谷 | 139个 | 4个 | 257ms | 10% | 阿姆斯特丹 | 75个 | 0 | 318ms | 6%  
达拉斯 | 135个 | 4个 | 258ms | 3% | 新泽西 | 131个 | 0 | 320ms | 2%  
均值 | 1485个 | 23个 | 273ms | 7% | 巴黎 | 75个 | 0 | 324ms | 3%  
悉尼 | 75个 | 0 | 283ms | 17% | 迈阿密 | 75个 | 0 | 329ms | 6%  
...
江西电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 71个 | 3个 | 217ms | 49% | 芝加哥 | 43个 | 0 | 325ms | 7%  
新加坡 | 43个 | 0 | 280ms | 55% | 法兰克福 | 79个 | 0 | 318ms | 3%  
西雅图 | 43个 | 0 | 261ms | 0 | 伦敦 | 79个 | 0 | 321ms | 3%  
洛杉矶 | 43个 | 0 | 295ms | 8% | 亚特兰大 | 43个 | 0 | 340ms | 1%  
硅谷 | 79个 | 0 | 238ms | 3% | 阿姆斯特丹 | 43个 | 0 | 358ms | 7%  
达拉斯 | 75个 | 0 | 277ms | 7% | 新泽西 | 75个 | 0 | 386ms | 4%  
均值 | 845个 | 3个 | 309ms | 12% | 巴黎 | 43个 | 0 | 345ms | 4%  
悉尼 | 43个 | 0 | 396ms | 43% | 迈阿密 | 43个 | 0 | 384ms | 4%  
...
江西联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 16个 | 0 | 155ms | 7% | 芝加哥 | 8个 | 0 | 302ms | 2%  
新加坡 | 8个 | 0 | 189ms | 4% | 法兰克福 | 16个 | 0 | 229ms | 0  
西雅图 | 8个 | 0 | 237ms | 6% | 伦敦 | 16个 | 0 | 319ms | 1%  
洛杉矶 | 8个 | 0 | 233ms | 1% | 亚特兰大 | 8个 | 0 | 279ms | 2%  
硅谷 | 16个 | 0 | 296ms | 3% | 阿姆斯特丹 | 8个 | 0 | 309ms | 2%  
达拉斯 | 16个 | 0 | 259ms | 3% | 新泽西 | 16个 | 0 | 302ms | 3%  
均值 | 168个 | 0 | 263ms | 3% | 巴黎 | 8个 | 0 | 275ms | 1%  
悉尼 | 8个 | 0 | 261ms | 8% | 迈阿密 | 8个 | 0 | 314ms | 3%  
...
江西移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 44个 | 4个 | 116ms | 0 | 芝加哥 | 24个 | 0 | 257ms | 9%  
新加坡 | 24个 | 0 | 117ms | 1% | 法兰克福 | 40个 | 4个 | 339ms | 1%  
西雅图 | 24个 | 0 | 231ms | 40% | 伦敦 | 44个 | 4个 | 267ms | 2%  
洛杉矶 | 24个 | 0 | 207ms | 0 | 亚特兰大 | 24个 | 0 | 327ms | 0  
硅谷 | 44个 | 4个 | 238ms | 24% | 阿姆斯特丹 | 24个 | 0 | 286ms | 8%  
达拉斯 | 44个 | 4个 | 238ms | 0 | 新泽西 | 40个 | 0 | 271ms | 0  
均值 | 472个 | 20个 | 247ms | 6% | 巴黎 | 24个 | 0 | 353ms | 4%  
悉尼 | 24个 | 0 | 193ms | 0 | 迈阿密 | 24个 | 0 | 291ms | 12%  
