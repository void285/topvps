...
江西全部运营商到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 22个 | 0 | 153ms | 13% | 达拉斯 | 20个 | 0 | 277ms | 4%  
新加坡 | 23个 | 0 | 198ms | 3% | 法兰克福 | 21个 | 0 | 286ms | 1%  
洛杉矶 | 22个 | 0 | 208ms | 1% | 亚特兰大 | 22个 | 0 | 287ms | 3%  
西雅图 | 22个 | 0 | 218ms | 1% | 迈阿密 | 22个 | 0 | 290ms | 1%  
硅谷 | 20个 | 0 | 220ms | 1% | 芝加哥 | 23个 | 0 | 297ms | 5%  
悉尼 | 21个 | 0 | 227ms | 1% | 新泽西 | 23个 | 0 | 298ms | 1%  
巴黎 | 21个 | 0 | 258ms | 0 | 阿姆斯特丹 | 22个 | 0 | 300ms | 0  
均值 | 327个 | 0 | 258ms | 4% | 伦敦 | 23个 | 0 | 339ms | 19%  
...
江西电信到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 215ms | 21% | 达拉斯 | 9个 | 0 | 308ms | 3%  
新加坡 | 11个 | 0 | 190ms | 6% | 法兰克福 | 10个 | 0 | 263ms | 1%  
洛杉矶 | 11个 | 0 | 236ms | 1% | 亚特兰大 | 11个 | 0 | 310ms | 2%  
西雅图 | 11个 | 0 | 259ms | 3% | 迈阿密 | 11个 | 0 | 319ms | 1%  
硅谷 | 9个 | 0 | 249ms | 3% | 芝加哥 | 11个 | 0 | 381ms | 3%  
悉尼 | 10个 | 0 | 274ms | 2% | 新泽西 | 11个 | 0 | 347ms | 3%  
巴黎 | 10个 | 0 | 242ms | 0 | 阿姆斯特丹 | 11个 | 0 | 247ms | 0  
均值 | 158个 | 0 | 279ms | 4% | 伦敦 | 11个 | 0 | 343ms | 5%  
...
江西联通到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 3个 | 0 | 107ms | 15% | 达拉斯 | 3个 | 0 | 216ms | 0  
新加坡 | 3个 | 0 | 254ms | 0 | 法兰克福 | 3个 | 0 | 326ms | 1%  
洛杉矶 | 3个 | 0 | 191ms | 1% | 亚特兰大 | 2个 | 0 | 226ms | 0  
西雅图 | 3个 | 0 | 188ms | 0 | 迈阿密 | 3个 | 0 | 254ms | 0  
硅谷 | 3个 | 0 | 205ms | 1% | 芝加哥 | 3个 | 0 | 244ms | 11%  
悉尼 | 3个 | 0 | 203ms | 0 | 新泽西 | 3个 | 0 | 271ms | 0  
巴黎 | 3个 | 0 | 280ms | 0 | 阿姆斯特丹 | 3个 | 0 | 326ms | 0  
均值 | 44个 | 0 | 241ms | 5% | 伦敦 | 3个 | 0 | 323ms | 42%  
...
江西移动到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 8个 | 0 | 136ms | 2% | 达拉斯 | 8个 | 0 | 308ms | 8%  
新加坡 | 9个 | 0 | 150ms | 2% | 法兰克福 | 8个 | 0 | 268ms | 1%  
洛杉矶 | 8个 | 0 | 199ms | 0 | 亚特兰大 | 9个 | 0 | 325ms | 7%  
西雅图 | 8个 | 0 | 206ms | 0 | 迈阿密 | 8个 | 0 | 297ms | 2%  
硅谷 | 8个 | 0 | 208ms | 0 | 芝加哥 | 9个 | 0 | 266ms | 2%  
悉尼 | 8个 | 0 | 203ms | 0 | 新泽西 | 9个 | 0 | 275ms | 0  
巴黎 | 8个 | 0 | 253ms | 1% | 阿姆斯特丹 | 8个 | 0 | 328ms | 1%  
均值 | 125个 | 0 | 252ms | 2% | 伦敦 | 9个 | 0 | 351ms | 10%  
