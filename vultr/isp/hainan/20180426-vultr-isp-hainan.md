...
海南全部运营商到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 11个 | 0 | 140ms | 2% | 芝加哥 | 10个 | 0 | 258ms | 0  
东京 | 10个 | 0 | 147ms | 10% | 新泽西 | 11个 | 0 | 273ms | 1%  
洛杉矶 | 10个 | 0 | 179ms | 0 | 法兰克福 | 11个 | 0 | 276ms | 0  
悉尼 | 10个 | 0 | 209ms | 0 | 巴黎 | 11个 | 0 | 278ms | 1%  
硅谷 | 10个 | 0 | 212ms | 1% | 亚特兰大 | 10个 | 0 | 290ms | 3%  
西雅图 | 10个 | 0 | 215ms | 0 | 阿姆斯特丹 | 11个 | 0 | 316ms | 0  
均值 | 156个 | 0 | 246ms | 2% | 迈阿密 | 10个 | 0 | 319ms | 3%  
达拉斯 | 10个 | 0 | 257ms | 3% | 伦敦 | 11个 | 0 | 323ms | 2%  
...
海南电信到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 7个 | 0 | 182ms | 7% | 芝加哥 | 6个 | 0 | 320ms | 2%  
东京 | 6个 | 0 | 210ms | 29% | 新泽西 | 7个 | 0 | 319ms | 3%  
洛杉矶 | 6个 | 0 | 174ms | 0 | 法兰克福 | 7个 | 0 | 258ms | 0  
悉尼 | 6个 | 0 | 272ms | 2% | 巴黎 | 7个 | 0 | 268ms | 0  
硅谷 | 6个 | 0 | 245ms | 3% | 亚特兰大 | 6个 | 0 | 312ms | 3%  
西雅图 | 6个 | 0 | 249ms | 2% | 阿姆斯特丹 | 7个 | 0 | 245ms | 0  
均值 | 96个 | 0 | 263ms | 4% | 迈阿密 | 6个 | 0 | 351ms | 4%  
达拉斯 | 6个 | 0 | 241ms | 3% | 伦敦 | 7个 | 0 | 304ms | 4%  
...
海南联通到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 3个 | 0 | 138ms | 0 | 芝加哥 | 3个 | 0 | 235ms | 0  
东京 | 3个 | 0 | 114ms | 0 | 新泽西 | 3个 | 0 | 260ms | 0  
洛杉矶 | 3个 | 0 | 190ms | 0 | 法兰克福 | 3个 | 0 | 348ms | 0  
悉尼 | 3个 | 0 | 183ms | 0 | 巴黎 | 3个 | 0 | 335ms | 3%  
硅谷 | 3个 | 0 | 205ms | 0 | 亚特兰大 | 3个 | 0 | 239ms | 0  
西雅图 | 3个 | 0 | 223ms | 0 | 阿姆斯特丹 | 3个 | 0 | 339ms | 0  
均值 | 45个 | 0 | 240ms | 0 | 迈阿密 | 3个 | 0 | 253ms | 0  
达拉斯 | 3个 | 0 | 224ms | 0 | 伦敦 | 3个 | 0 | 321ms | 0  
...
海南移动到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 1个 | 0 | 99ms | 0 | 芝加哥 | 1个 | 0 | 219ms | 0  
东京 | 1个 | 0 | 118ms | 0 | 新泽西 | 1个 | 0 | 242ms | 0  
洛杉矶 | 1个 | 0 | 173ms | 0 | 法兰克福 | 1个 | 0 | 224ms | 0  
悉尼 | 1个 | 0 | 172ms | 0 | 巴黎 | 1个 | 0 | 232ms | 0  
硅谷 | 1个 | 0 | 187ms | 0 | 亚特兰大 | 1个 | 0 | 319ms | 7%  
西雅图 | 1个 | 0 | 175ms | 0 | 阿姆斯特丹 | 1个 | 0 | 366ms | 0  
均值 | 15个 | 0 | 235ms | 1% | 迈阿密 | 1个 | 0 | 354ms | 6%  
达拉斯 | 1个 | 0 | 307ms | 8% | 伦敦 | 1个 | 0 | 346ms | 4%  
