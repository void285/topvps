...
海南全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 120ms | 3% | 新泽西 | 11个 | 0 | 258ms | 1%  
新加坡 | 12个 | 0 | 182ms | 4% | 亚特兰大 | 8个 | 0 | 271ms | 24%  
洛杉矶 | 12个 | 0 | 185ms | 1% | 巴黎 | 12个 | 0 | 271ms | 0  
硅谷 | 12个 | 0 | 194ms | 0 | 法兰克福 | 12个 | 0 | 279ms | 0  
西雅图 | 10个 | 0 | 220ms | 5% | 芝加哥 | 10个 | 0 | 281ms | 26%  
达拉斯 | 9个 | 0 | 241ms | 0 | 伦敦 | 11个 | 0 | 298ms | 14%  
悉尼 | 12个 | 0 | 244ms | 2% | 阿姆斯特丹 | 12个 | 0 | 321ms | 0  
均值 | 164个 | 0 | 245ms | 6% | 迈阿密 | 10个 | 0 | 327ms | 21%  
...
海南电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 8个 | 0 | 198ms | 10% | 新泽西 | 8个 | 0 | 281ms | 0  
新加坡 | 8个 | 0 | 253ms | 11% | 亚特兰大 | 5个 | 0 | 246ms | 0  
洛杉矶 | 8个 | 0 | 209ms | 4% | 巴黎 | 8个 | 0 | 257ms | 0  
硅谷 | 8个 | 0 | 192ms | 0 | 法兰克福 | 8个 | 0 | 230ms | 0  
西雅图 | 7个 | 0 | 255ms | 16% | 芝加哥 | 7个 | 0 | 275ms | 2%  
达拉斯 | 6个 | 0 | 243ms | 0 | 伦敦 | 8个 | 0 | 292ms | 0  
悉尼 | 8个 | 0 | 336ms | 6% | 阿姆斯特丹 | 8个 | 0 | 302ms | 0  
均值 | 112个 | 0 | 257ms | 3% | 迈阿密 | 7个 | 0 | 287ms | 0  
...
海南联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 84ms | 0 | 新泽西 | 2个 | 0 | 253ms | 0  
新加坡 | 3个 | 0 | 189ms | 2% | 亚特兰大 | 2个 | 0 | 322ms | 66%  
洛杉矶 | 3个 | 0 | 172ms | 0 | 巴黎 | 3个 | 0 | 333ms | 0  
硅谷 | 3个 | 0 | 188ms | 0 | 法兰克福 | 3个 | 0 | 343ms | 0  
西雅图 | 2个 | 0 | 242ms | 0 | 芝加哥 | 2个 | 0 | 349ms | 67%  
达拉斯 | 2个 | 0 | 266ms | 0 | 伦敦 | 2个 | 0 | 357ms | 44%  
悉尼 | 3个 | 0 | 231ms | 1% | 阿姆斯特丹 | 3个 | 0 | 333ms | 0  
均值 | 37个 | 0 | 269ms | 13% | 迈阿密 | 2个 | 0 | 427ms | 65%  
...
海南移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 1个 | 0 | 79ms | 0 | 新泽西 | 1个 | 0 | 241ms | 3%  
新加坡 | 1个 | 0 | 103ms | 0 | 亚特兰大 | 1个 | 0 | 246ms | 8%  
洛杉矶 | 1个 | 0 | 175ms | 0 | 巴黎 | 1个 | 0 | 225ms | 0  
硅谷 | 1个 | 0 | 203ms | 0 | 法兰克福 | 1个 | 0 | 264ms | 0  
西雅图 | 1个 | 0 | 162ms | 0 | 芝加哥 | 1个 | 0 | 221ms | 8%  
达拉斯 | 1个 | 0 | 215ms | 0 | 伦敦 | 1个 | 0 | 246ms | 0  
悉尼 | 1个 | 0 | 166ms | 0 | 阿姆斯特丹 | 1个 | 0 | 329ms | 0  
均值 | 15个 | 0 | 209ms | 1% | 迈阿密 | 1个 | 0 | 269ms | 0  
