...
海南全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 48个 | 0 | 142ms | 13% | 悉尼 | 28个 | 0 | 265ms | 5%  
新加坡 | 28个 | 0 | 190ms | 11% | 法兰克福 | 48个 | 0 | 292ms | 5%  
洛杉矶 | 28个 | 0 | 197ms | 1% | 新泽西 | 48个 | 0 | 293ms | 3%  
硅谷 | 48个 | 0 | 214ms | 10% | 亚特兰大 | 28个 | 0 | 307ms | 2%  
西雅图 | 32个 | 0 | 215ms | 3% | 伦敦 | 48个 | 0 | 309ms | 4%  
达拉斯 | 48个 | 0 | 241ms | 1% | 迈阿密 | 28个 | 0 | 315ms | 3%  
均值 | 544个 | 0 | 256ms | 5% | 阿姆斯特丹 | 28个 | 0 | 319ms | 1%  
芝加哥 | 28个 | 0 | 259ms | 3% | 巴黎 | 28个 | 0 | 322ms | 2%  
...
海南电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 24个 | 0 | 190ms | 22% | 悉尼 | 12个 | 0 | 325ms | 7%  
新加坡 | 12个 | 0 | 242ms | 23% | 法兰克福 | 24个 | 0 | 289ms | 2%  
洛杉矶 | 12个 | 0 | 198ms | 1% | 新泽西 | 24个 | 0 | 329ms | 2%  
硅谷 | 24个 | 0 | 213ms | 1% | 亚特兰大 | 12个 | 0 | 306ms | 1%  
西雅图 | 16个 | 0 | 246ms | 1% | 伦敦 | 24个 | 0 | 292ms | 2%  
达拉斯 | 24个 | 0 | 255ms | 1% | 迈阿密 | 12个 | 0 | 337ms | 6%  
均值 | 256个 | 0 | 270ms | 5% | 阿姆斯特丹 | 12个 | 0 | 329ms | 2%  
芝加哥 | 12个 | 0 | 273ms | 4% | 巴黎 | 12个 | 0 | 298ms | 1%  
...
海南联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 16个 | 0 | 166ms | 16% | 悉尼 | 12个 | 0 | 299ms | 8%  
新加坡 | 12个 | 0 | 226ms | 10% | 法兰克福 | 16个 | 0 | 329ms | 5%  
洛杉矶 | 12个 | 0 | 216ms | 3% | 新泽西 | 16个 | 0 | 304ms | 8%  
硅谷 | 16个 | 0 | 222ms | 2% | 亚特兰大 | 12个 | 0 | 333ms | 6%  
西雅图 | 12个 | 0 | 241ms | 9% | 伦敦 | 16个 | 0 | 348ms | 2%  
达拉斯 | 16个 | 0 | 249ms | 2% | 迈阿密 | 12个 | 0 | 319ms | 3%  
均值 | 204个 | 0 | 279ms | 6% | 阿姆斯特丹 | 12个 | 0 | 348ms | 2%  
芝加哥 | 12个 | 0 | 277ms | 4% | 巴黎 | 12个 | 0 | 325ms | 3%  
...
海南移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 8个 | 0 | 72ms | 0 | 悉尼 | 4个 | 0 | 172ms | 0  
新加坡 | 4个 | 0 | 102ms | 0 | 法兰克福 | 8个 | 0 | 260ms | 9%  
洛杉矶 | 4个 | 0 | 179ms | 0 | 新泽西 | 8个 | 0 | 247ms | 0  
硅谷 | 8个 | 0 | 207ms | 26% | 亚特兰大 | 4个 | 0 | 281ms | 0  
西雅图 | 4个 | 0 | 160ms | 0 | 伦敦 | 8个 | 0 | 289ms | 10%  
达拉斯 | 8个 | 0 | 220ms | 0 | 迈阿密 | 4个 | 0 | 289ms | 0  
均值 | 84个 | 0 | 220ms | 4% | 阿姆斯特丹 | 4个 | 0 | 280ms | 1%  
芝加哥 | 4个 | 0 | 229ms | 2% | 巴黎 | 4个 | 0 | 343ms | 3%  
