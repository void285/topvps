...
吉林全部运营商到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 23个 | 0 | 130ms | 1% | 法兰克福 | 19个 | 0 | 268ms | 0  
新加坡 | 20个 | 0 | 220ms | 1% | 新泽西 | 21个 | 0 | 290ms | 11%  
西雅图 | 20个 | 0 | 221ms | 0 | 悉尼 | 22个 | 0 | 292ms | 0  
硅谷 | 20个 | 0 | 222ms | 2% | 巴黎 | 18个 | 0 | 293ms | 0  
洛杉矶 | 19个 | 0 | 236ms | 5% | 迈阿密 | 20个 | 0 | 295ms | 14%  
芝加哥 | 20个 | 0 | 243ms | 0 | 亚特兰大 | 22个 | 0 | 301ms | 13%  
达拉斯 | 21个 | 0 | 249ms | 2% | 伦敦 | 22个 | 0 | 334ms | 8%  
均值 | 306个 | 0 | 263ms | 5% | 阿姆斯特丹 | 19个 | 0 | 353ms | 11%  
...
吉林电信到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 6个 | 0 | 166ms | 3% | 法兰克福 | 4个 | 0 | 201ms | 0  
新加坡 | 3个 | 0 | 257ms | 2% | 新泽西 | 4个 | 0 | 259ms | 0  
西雅图 | 4个 | 0 | 222ms | 1% | 悉尼 | 5个 | 0 | 326ms | 0  
硅谷 | 4个 | 0 | 247ms | 5% | 巴黎 | 2个 | 0 | 259ms | 0  
洛杉矶 | 5个 | 0 | 278ms | 10% | 迈阿密 | 4个 | 0 | 339ms | 27%  
芝加哥 | 4个 | 0 | 242ms | 0 | 亚特兰大 | 5个 | 0 | 370ms | 24%  
达拉斯 | 5个 | 0 | 279ms | 0 | 伦敦 | 5个 | 0 | 268ms | 0  
均值 | 63个 | 0 | 267ms | 5% | 阿姆斯特丹 | 3个 | 0 | 301ms | 1%  
...
吉林联通到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 17个 | 0 | 95ms | 0 | 法兰克福 | 15个 | 0 | 336ms | 1%  
新加坡 | 17个 | 0 | 183ms | 0 | 新泽西 | 17个 | 0 | 320ms | 23%  
西雅图 | 16个 | 0 | 220ms | 0 | 悉尼 | 17个 | 0 | 258ms | 0  
硅谷 | 16个 | 0 | 196ms | 0 | 巴黎 | 16个 | 0 | 328ms | 0  
洛杉矶 | 14个 | 0 | 194ms | 0 | 迈阿密 | 16个 | 0 | 250ms | 0  
芝加哥 | 16个 | 0 | 245ms | 0 | 亚特兰大 | 17个 | 0 | 231ms | 1%  
达拉斯 | 16个 | 0 | 218ms | 5% | 伦敦 | 17个 | 0 | 401ms | 16%  
均值 | 243个 | 0 | 259ms | 4% | 阿姆斯特丹 | 16个 | 0 | 406ms | 21%  
