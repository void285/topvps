...
湖北全部运营商到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 48个 | 2个 | 147ms | 15% | 巴黎 | 43个 | 0 | 288ms | 5%  
新加坡 | 47个 | 0 | 198ms | 11% | 法兰克福 | 42个 | 0 | 292ms | 4%  
西雅图 | 46个 | 0 | 220ms | 3% | 阿姆斯特丹 | 45个 | 1个 | 295ms | 4%  
悉尼 | 45个 | 0 | 253ms | 6% | 达拉斯 | 48个 | 0 | 297ms | 13%  
洛杉矶 | 48个 | 3个 | 259ms | 17% | 新泽西 | 48个 | 0 | 310ms | 23%  
硅谷 | 47个 | 0 | 266ms | 10% | 迈阿密 | 44个 | 0 | 319ms | 21%  
均值 | 692个 | 6个 | 271ms | 14% | 伦敦 | 47个 | 0 | 330ms | 26%  
芝加哥 | 48个 | 0 | 285ms | 22% | 亚特兰大 | 46个 | 0 | 340ms | 23%  
...
湖北电信到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 26个 | 2个 | 123ms | 11% | 巴黎 | 22个 | 0 | 254ms | 1%  
新加坡 | 25个 | 0 | 192ms | 8% | 法兰克福 | 23个 | 0 | 262ms | 0  
西雅图 | 24个 | 0 | 228ms | 2% | 阿姆斯特丹 | 25个 | 1个 | 260ms | 0  
悉尼 | 24个 | 0 | 259ms | 1% | 达拉斯 | 26个 | 0 | 314ms | 11%  
洛杉矶 | 25个 | 3个 | 273ms | 18% | 新泽西 | 25个 | 0 | 351ms | 15%  
硅谷 | 25个 | 0 | 289ms | 9% | 迈阿密 | 23个 | 0 | 355ms | 15%  
均值 | 368个 | 6个 | 273ms | 9% | 伦敦 | 25个 | 0 | 349ms | 14%  
芝加哥 | 26个 | 0 | 311ms | 8% | 亚特兰大 | 24个 | 0 | 351ms | 19%  
...
湖北联通到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 174ms | 26% | 巴黎 | 10个 | 0 | 315ms | 7%  
新加坡 | 11个 | 0 | 250ms | 18% | 法兰克福 | 9个 | 0 | 326ms | 6%  
西雅图 | 11个 | 0 | 215ms | 3% | 阿姆斯特丹 | 11个 | 0 | 309ms | 4%  
悉尼 | 10个 | 0 | 257ms | 10% | 达拉斯 | 11个 | 0 | 239ms | 6%  
洛杉矶 | 11个 | 0 | 225ms | 9% | 新泽西 | 11个 | 0 | 287ms | 39%  
硅谷 | 11个 | 0 | 230ms | 4% | 迈阿密 | 11个 | 0 | 294ms | 30%  
均值 | 160个 | 0 | 266ms | 18% | 伦敦 | 10个 | 0 | 338ms | 49%  
芝加哥 | 11个 | 0 | 281ms | 41% | 亚特兰大 | 11个 | 0 | 273ms | 15%  
...
湖北移动到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 143ms | 7% | 巴黎 | 11个 | 0 | 295ms | 8%  
新加坡 | 11个 | 0 | 152ms | 8% | 法兰克福 | 10个 | 0 | 288ms | 6%  
西雅图 | 11个 | 0 | 217ms | 5% | 阿姆斯特丹 | 9个 | 0 | 317ms | 8%  
悉尼 | 11个 | 0 | 242ms | 8% | 达拉斯 | 11个 | 0 | 338ms | 22%  
洛杉矶 | 12个 | 0 | 281ms | 24% | 新泽西 | 12个 | 0 | 291ms | 16%  
硅谷 | 11个 | 0 | 278ms | 18% | 迈阿密 | 10个 | 0 | 309ms | 18%  
均值 | 164个 | 0 | 274ms | 15% | 伦敦 | 12个 | 0 | 303ms | 15%  
芝加哥 | 11个 | 0 | 264ms | 17% | 亚特兰大 | 11个 | 0 | 396ms | 34%  
