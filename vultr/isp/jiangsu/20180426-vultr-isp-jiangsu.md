...
江苏全部运营商到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 47个 | 0 | 146ms | 16% | 亚特兰大 | 48个 | 0 | 254ms | 2%  
新加坡 | 48个 | 0 | 183ms | 3% | 巴黎 | 48个 | 0 | 256ms | 1%  
硅谷 | 48个 | 0 | 205ms | 1% | 迈阿密 | 46个 | 0 | 284ms | 3%  
洛杉矶 | 48个 | 0 | 210ms | 1% | 新泽西 | 48个 | 0 | 291ms | 3%  
西雅图 | 48个 | 0 | 220ms | 1% | 芝加哥 | 47个 | 0 | 293ms | 6%  
悉尼 | 48个 | 0 | 224ms | 0 | 法兰克福 | 47个 | 0 | 301ms | 5%  
达拉斯 | 48个 | 0 | 243ms | 3% | 阿姆斯特丹 | 48个 | 0 | 313ms | 2%  
均值 | 714个 | 2个 | 250ms | 4% | 伦敦 | 47个 | 2个 | 329ms | 17%  
...
江苏电信到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 19个 | 0 | 185ms | 31% | 亚特兰大 | 19个 | 0 | 262ms | 0  
新加坡 | 19个 | 0 | 171ms | 8% | 巴黎 | 19个 | 0 | 229ms | 0  
硅谷 | 19个 | 0 | 238ms | 3% | 迈阿密 | 19个 | 0 | 313ms | 1%  
洛杉矶 | 19个 | 0 | 225ms | 2% | 新泽西 | 19个 | 0 | 333ms | 2%  
西雅图 | 19个 | 0 | 243ms | 3% | 芝加哥 | 19个 | 0 | 354ms | 4%  
悉尼 | 19个 | 0 | 262ms | 2% | 法兰克福 | 19个 | 0 | 274ms | 4%  
达拉斯 | 19个 | 0 | 258ms | 1% | 阿姆斯特丹 | 19个 | 0 | 232ms | 0  
均值 | 284个 | 0 | 261ms | 4% | 伦敦 | 18个 | 0 | 334ms | 4%  
...
江苏联通到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 135ms | 16% | 亚特兰大 | 14个 | 0 | 252ms | 6%  
新加坡 | 14个 | 0 | 249ms | 3% | 巴黎 | 14个 | 0 | 272ms | 4%  
硅谷 | 14个 | 0 | 179ms | 0 | 迈阿密 | 13个 | 0 | 265ms | 9%  
洛杉矶 | 14个 | 0 | 208ms | 2% | 新泽西 | 14个 | 0 | 274ms | 7%  
西雅图 | 14个 | 0 | 201ms | 0 | 芝加哥 | 13个 | 0 | 263ms | 13%  
悉尼 | 14个 | 0 | 202ms | 0 | 法兰克福 | 13个 | 0 | 351ms | 11%  
达拉斯 | 14个 | 0 | 238ms | 8% | 阿姆斯特丹 | 14个 | 0 | 345ms | 5%  
均值 | 206个 | 2个 | 250ms | 8% | 伦敦 | 14个 | 2个 | 326ms | 45%  
...
江苏移动到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 0 | 119ms | 2% | 亚特兰大 | 15个 | 0 | 249ms | 0  
新加坡 | 15个 | 0 | 128ms | 0 | 巴黎 | 15个 | 0 | 267ms | 0  
硅谷 | 15个 | 0 | 199ms | 0 | 迈阿密 | 14个 | 0 | 274ms | 0  
洛杉矶 | 15个 | 0 | 199ms | 0 | 新泽西 | 15个 | 0 | 265ms | 0  
西雅图 | 15个 | 0 | 217ms | 0 | 芝加哥 | 15个 | 0 | 261ms | 0  
悉尼 | 15个 | 0 | 209ms | 0 | 法兰克福 | 15个 | 0 | 277ms | 0  
达拉斯 | 15个 | 0 | 234ms | 0 | 阿姆斯特丹 | 15个 | 0 | 361ms | 0  
均值 | 224个 | 0 | 239ms | 0 | 伦敦 | 15个 | 0 | 326ms | 4%  
