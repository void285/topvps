...
**江苏全部运营商到Vultr各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 346个 | 12个 | 198ms | 23%  
洛杉矶 | 235个 | 9个 | 214ms | 3%  
西雅图 | 238个 | 9个 | 223ms | 4%  
新加坡 | 242个 | 24个 | 233ms | 23%  
硅谷 | 343个 | 9个 | 235ms | 10%  
达拉斯 | 350个 | 9个 | 261ms | 4%  
芝加哥 | 238个 | 9个 | 272ms | 9%  
均值 | 4198个 | 195个 | 274ms | 8%  
法兰克福 | 343个 | 12个 | 297ms | 1%  
亚特兰大 | 234个 | 12个 | 304ms | 3%  
迈阿密 | 242个 | 12个 | 309ms | 6%  
伦敦 | 338个 | 12个 | 311ms | 5%  
巴黎 | 238个 | 9个 | 316ms | 2%  
新泽西 | 331个 | 9个 | 318ms | 6%  
悉尼 | 238个 | 33个 | 336ms | 22%  
阿姆斯特丹 | 242个 | 15个 | 342ms | 3%  
...
**江苏电信到Vultr各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 162个 | 12个 | 207ms | 41%  
洛杉矶 | 118个 | 9个 | 236ms | 5%  
西雅图 | 118个 | 9个 | 242ms | 2%  
新加坡 | 118个 | 18个 | 268ms | 39%  
硅谷 | 162个 | 9个 | 249ms | 7%  
达拉斯 | 162个 | 9个 | 300ms | 6%  
芝加哥 | 118个 | 9个 | 286ms | 5%  
均值 | 2034个 | 174个 | 295ms | 12%  
法兰克福 | 162个 | 12个 | 301ms | 2%  
亚特兰大 | 118个 | 9个 | 334ms | 4%  
迈阿密 | 118个 | 9个 | 347ms | 5%  
伦敦 | 162个 | 9个 | 319ms | 9%  
巴黎 | 118个 | 9个 | 299ms | 3%  
新泽西 | 162个 | 9个 | 369ms | 8%  
悉尼 | 118个 | 27个 | 380ms | 38%  
阿姆斯特丹 | 118个 | 15个 | 342ms | 4%  
