...
**江苏全部运营商到Vultr各机房的测速数据 [20180514]**
...
达拉斯 | 58个 | 1个 | 238ms | 13%  
硅谷 | 62个 | 3个 | 243ms | 11%  
均值 | 910个 | 27个 | 253ms | 11%  
芝加哥 | 58个 | 2个 | 278ms | 17%  
亚特兰大 | 61个 | 2个 | 280ms | 19%  
新泽西 | 62个 | 2个 | 291ms | 17%  
迈阿密 | 61个 | 1个 | 300ms | 19%  
巴黎 | 63个 | 1个 | 303ms | 9%  
伦敦 | 57个 | 2个 | 304ms | 15%  
法兰克福 | 60个 | 1个 | 307ms | 12%  
阿姆斯特丹 | 53个 | 1个 | 312ms | 10%  
...
均值 | 230个 | 2个 | 254ms | 12%  
芝加哥 | 15个 | 0 | 280ms | 13%  
亚特兰大 | 15个 | 1个 | 302ms | 21%  
新泽西 | 17个 | 0 | 282ms | 6%  
迈阿密 | 15个 | 0 | 300ms | 14%  
巴黎 | 15个 | 0 | 321ms | 18%  
伦敦 | 14个 | 0 | 260ms | 0  
法兰克福 | 13个 | 0 | 323ms | 22%  
阿姆斯特丹 | 16个 | 0 | 331ms | 19%  
