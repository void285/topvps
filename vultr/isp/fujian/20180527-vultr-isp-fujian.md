...
福建全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 36个 | 0 | 151ms | 9% | 巴黎 | 36个 | 0 | 274ms | 8%  
新加坡 | 37个 | 0 | 196ms | 10% | 亚特兰大 | 36个 | 0 | 279ms | 11%  
硅谷 | 33个 | 1个 | 207ms | 13% | 法兰克福 | 32个 | 1个 | 280ms | 2%  
西雅图 | 36个 | 0 | 216ms | 8% | 迈阿密 | 33个 | 1个 | 282ms | 12%  
洛杉矶 | 36个 | 0 | 217ms | 1% | 新泽西 | 34个 | 0 | 285ms | 9%  
均值 | 522个 | 5个 | 256ms | 8% | 悉尼 | 36个 | 1个 | 290ms | 9%  
芝加哥 | 37个 | 0 | 268ms | 9% | 阿姆斯特丹 | 35个 | 0 | 307ms | 2%  
达拉斯 | 35个 | 1个 | 268ms | 12% | 伦敦 | 30个 | 0 | 329ms | 8%  
...
福建电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 0 | 184ms | 22% | 巴黎 | 14个 | 0 | 243ms | 1%  
新加坡 | 15个 | 0 | 258ms | 25% | 亚特兰大 | 15个 | 0 | 259ms | 3%  
硅谷 | 13个 | 0 | 226ms | 4% | 法兰克福 | 13个 | 0 | 251ms | 0  
西雅图 | 15个 | 0 | 252ms | 4% | 迈阿密 | 14个 | 0 | 289ms | 5%  
洛杉矶 | 14个 | 0 | 244ms | 2% | 新泽西 | 14个 | 0 | 320ms | 6%  
均值 | 212个 | 0 | 266ms | 8% | 悉尼 | 15个 | 0 | 360ms | 24%  
芝加哥 | 15个 | 0 | 310ms | 6% | 阿姆斯特丹 | 14个 | 0 | 234ms | 0  
达拉斯 | 14个 | 0 | 267ms | 4% | 伦敦 | 12个 | 0 | 288ms | 0  
...
福建联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 163ms | 2% | 巴黎 | 13个 | 0 | 313ms | 19%  
新加坡 | 13个 | 0 | 229ms | 1% | 亚特兰大 | 12个 | 0 | 253ms | 3%  
硅谷 | 11个 | 1个 | 204ms | 24% | 法兰克福 | 11个 | 1个 | 343ms | 5%  
西雅图 | 13个 | 0 | 214ms | 18% | 迈阿密 | 11个 | 0 | 245ms | 22%  
洛杉矶 | 13个 | 0 | 216ms | 2% | 新泽西 | 11个 | 0 | 253ms | 20%  
均值 | 182个 | 3个 | 254ms | 10% | 悉尼 | 13个 | 1个 | 269ms | 2%  
芝加哥 | 13个 | 0 | 250ms | 17% | 阿姆斯特丹 | 13个 | 0 | 332ms | 4%  
达拉斯 | 12个 | 0 | 230ms | 2% | 伦敦 | 10个 | 0 | 338ms | 6%  
...
福建移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 8个 | 0 | 104ms | 2% | 巴黎 | 9个 | 0 | 268ms | 4%  
新加坡 | 9个 | 0 | 102ms | 3% | 亚特兰大 | 9个 | 0 | 327ms | 27%  
硅谷 | 9个 | 0 | 191ms | 11% | 法兰克福 | 8个 | 0 | 247ms | 0  
西雅图 | 8个 | 0 | 183ms | 1% | 迈阿密 | 8个 | 1个 | 311ms | 10%  
洛杉矶 | 9个 | 0 | 191ms | 0 | 新泽西 | 9个 | 0 | 283ms | 0  
均值 | 128个 | 2个 | 248ms | 8% | 悉尼 | 8个 | 0 | 242ms | 2%  
芝加哥 | 9个 | 0 | 244ms | 3% | 阿姆斯特丹 | 8个 | 0 | 354ms | 4%  
达拉斯 | 9个 | 1个 | 307ms | 29% | 伦敦 | 8个 | 0 | 362ms | 19%  
