...
福建全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 144个 | 0 | 151ms | 22% | 悉尼 | 92个 | 3个 | 282ms | 23%  
新加坡 | 88个 | 3个 | 210ms | 23% | 伦敦 | 160个 | 0 | 306ms | 6%  
洛杉矶 | 92个 | 0 | 224ms | 5% | 巴黎 | 88个 | 0 | 312ms | 6%  
硅谷 | 156个 | 3个 | 228ms | 9% | 法兰克福 | 156个 | 0 | 317ms | 5%  
西雅图 | 92个 | 0 | 235ms | 4% | 新泽西 | 160个 | 0 | 324ms | 6%  
达拉斯 | 148个 | 0 | 259ms | 5% | 亚特兰大 | 96个 | 3个 | 328ms | 5%  
芝加哥 | 92个 | 0 | 270ms | 6% | 迈阿密 | 96个 | 0 | 330ms | 7%  
均值 | 1756个 | 12个 | 272ms | 9% | 阿姆斯特丹 | 96个 | 0 | 332ms | 7%  
...
福建电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 62个 | 0 | 204ms | 46% | 悉尼 | 46个 | 3个 | 386ms | 42%  
新加坡 | 42个 | 3个 | 280ms | 41% | 伦敦 | 78个 | 0 | 334ms | 6%  
洛杉矶 | 46个 | 0 | 273ms | 8% | 巴黎 | 42个 | 0 | 319ms | 1%  
硅谷 | 74个 | 0 | 259ms | 4% | 法兰克福 | 74个 | 0 | 324ms | 3%  
西雅图 | 46个 | 0 | 255ms | 0 | 新泽西 | 78个 | 0 | 391ms | 6%  
达拉斯 | 66个 | 0 | 312ms | 5% | 亚特兰大 | 50个 | 3个 | 352ms | 7%  
芝加哥 | 46个 | 0 | 294ms | 3% | 迈阿密 | 50个 | 0 | 377ms | 6%  
均值 | 850个 | 9个 | 319ms | 11% | 阿姆斯特丹 | 50个 | 0 | 363ms | 6%  
...
福建联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 47个 | 0 | 129ms | 7% | 悉尼 | 27个 | 0 | 244ms | 7%  
新加坡 | 27个 | 0 | 195ms | 8% | 伦敦 | 47个 | 0 | 311ms | 3%  
洛杉矶 | 27个 | 0 | 206ms | 7% | 巴黎 | 27个 | 0 | 308ms | 6%  
硅谷 | 47个 | 0 | 196ms | 3% | 法兰克福 | 47个 | 0 | 302ms | 6%  
西雅图 | 27个 | 0 | 217ms | 8% | 新泽西 | 47个 | 0 | 267ms | 8%  
达拉斯 | 47个 | 0 | 231ms | 4% | 亚特兰大 | 27个 | 0 | 308ms | 6%  
芝加哥 | 27个 | 0 | 251ms | 5% | 迈阿密 | 27个 | 0 | 282ms | 2%  
均值 | 525个 | 0 | 242ms | 5% | 阿姆斯特丹 | 27个 | 0 | 319ms | 2%  
...
福建移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 35个 | 0 | 119ms | 13% | 悉尼 | 19个 | 0 | 217ms | 19%  
新加坡 | 19个 | 0 | 155ms | 21% | 伦敦 | 35个 | 0 | 273ms | 8%  
洛杉矶 | 19个 | 0 | 193ms | 0 | 巴黎 | 19个 | 0 | 307ms | 10%  
硅谷 | 35个 | 3个 | 228ms | 19% | 法兰克福 | 35个 | 0 | 326ms | 6%  
西雅图 | 19个 | 0 | 233ms | 5% | 新泽西 | 35个 | 0 | 315ms | 5%  
达拉斯 | 35个 | 0 | 234ms | 7% | 亚特兰大 | 19个 | 0 | 323ms | 3%  
芝加哥 | 19个 | 0 | 265ms | 11% | 迈阿密 | 19个 | 0 | 332ms | 12%  
均值 | 381个 | 3个 | 256ms | 10% | 阿姆斯特丹 | 19个 | 0 | 313ms | 12%  
