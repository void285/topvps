...
山东全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 52个 | 2个 | 179ms | 10% | 亚特兰大 | 53个 | 1个 | 270ms | 11%  
洛杉矶 | 53个 | 1个 | 201ms | 2% | 迈阿密 | 53个 | 1个 | 271ms | 11%  
硅谷 | 51个 | 1个 | 203ms | 13% | 新泽西 | 52个 | 2个 | 279ms | 5%  
西雅图 | 51个 | 1个 | 218ms | 14% | 巴黎 | 53个 | 2个 | 299ms | 8%  
新加坡 | 52个 | 2个 | 221ms | 11% | 法兰克福 | 52个 | 1个 | 304ms | 2%  
达拉斯 | 52个 | 1个 | 255ms | 12% | 悉尼 | 53个 | 1个 | 308ms | 11%  
芝加哥 | 53个 | 1个 | 260ms | 5% | 阿姆斯特丹 | 53个 | 3个 | 315ms | 2%  
均值 | 786个 | 21个 | 260ms | 8% | 伦敦 | 53个 | 1个 | 319ms | 6%  
...
山东电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 17个 | 1个 | 205ms | 17% | 亚特兰大 | 17个 | 0 | 233ms | 0  
洛杉矶 | 17个 | 0 | 217ms | 2% | 迈阿密 | 17个 | 0 | 263ms | 6%  
硅谷 | 16个 | 0 | 214ms | 11% | 新泽西 | 16个 | 0 | 306ms | 6%  
西雅图 | 17个 | 0 | 235ms | 11% | 巴黎 | 17个 | 0 | 275ms | 7%  
新加坡 | 17个 | 1个 | 272ms | 19% | 法兰克福 | 17个 | 0 | 285ms | 0  
达拉斯 | 16个 | 0 | 238ms | 2% | 悉尼 | 17个 | 0 | 344ms | 19%  
芝加哥 | 17个 | 0 | 282ms | 6% | 阿姆斯特丹 | 17个 | 0 | 266ms | 3%  
均值 | 251个 | 2个 | 262ms | 8% | 伦敦 | 16个 | 0 | 301ms | 4%  
...
山东联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 19个 | 0 | 212ms | 10% | 亚特兰大 | 19个 | 0 | 234ms | 2%  
洛杉矶 | 19个 | 0 | 181ms | 2% | 迈阿密 | 19个 | 0 | 243ms | 12%  
硅谷 | 18个 | 0 | 182ms | 19% | 新泽西 | 19个 | 1个 | 256ms | 7%  
西雅图 | 18个 | 0 | 189ms | 19% | 巴黎 | 19个 | 1个 | 331ms | 16%  
新加坡 | 19个 | 0 | 273ms | 13% | 法兰克福 | 18个 | 0 | 332ms | 2%  
达拉斯 | 19个 | 0 | 207ms | 2% | 悉尼 | 18个 | 0 | 321ms | 12%  
芝加哥 | 19个 | 0 | 239ms | 4% | 阿姆斯特丹 | 19个 | 2个 | 329ms | 2%  
均值 | 281个 | 4个 | 254ms | 8% | 伦敦 | 19个 | 0 | 319ms | 2%  
...
山东移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 16个 | 1个 | 121ms | 4% | 亚特兰大 | 17个 | 1个 | 341ms | 31%  
洛杉矶 | 17个 | 1个 | 206ms | 3% | 迈阿密 | 17个 | 1个 | 308ms | 16%  
硅谷 | 17个 | 1个 | 214ms | 10% | 新泽西 | 17个 | 1个 | 275ms | 0  
西雅图 | 16个 | 1个 | 231ms | 11% | 巴黎 | 17个 | 1个 | 291ms | 2%  
新加坡 | 16个 | 1个 | 119ms | 1% | 法兰克福 | 17个 | 1个 | 293ms | 3%  
达拉斯 | 17个 | 1个 | 321ms | 31% | 悉尼 | 18个 | 1个 | 260ms | 2%  
芝加哥 | 17个 | 1个 | 260ms | 5% | 阿姆斯特丹 | 17个 | 1个 | 351ms | 2%  
均值 | 254个 | 15个 | 264ms | 9% | 伦敦 | 18个 | 1个 | 338ms | 12%  
