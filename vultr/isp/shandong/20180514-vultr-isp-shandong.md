...
**山东全部运营商到Vultr各机房的测速数据 [20180514]**
...
伦敦 | 52个 | 1个 | 303ms | 4%  
新泽西 | 52个 | 1个 | 313ms | 2%  
亚特兰大 | 53个 | 1个 | 313ms | 13%  
迈阿密 | 52个 | 2个 | 313ms | 11%  
阿姆斯特丹 | 49个 | 2个 | 315ms | 4%  
巴黎 | 49个 | 1个 | 318ms | 5%  
法兰克福 | 50个 | 1个 | 320ms | 5%  
...
硅谷 | 17个 | 2个 | 258ms | 26%  
悉尼 | 16个 | 1个 | 229ms | 1%  
均值 | 247个 | 18个 | 277ms | 13%  
达拉斯 | 16个 | 1个 | 348ms | 30%  
芝加哥 | 18个 | 2个 | 285ms | 15%  
伦敦 | 18个 | 1个 | 249ms | 1%  
新泽西 | 16个 | 1个 | 345ms | 3%  
亚特兰大 | 17个 | 1个 | 383ms | 30%  
迈阿密 | 17个 | 1个 | 334ms | 21%  
阿姆斯特丹 | 16个 | 2个 | 308ms | 2%  
巴黎 | 15个 | 1个 | 310ms | 2%  
法兰克福 | 17个 | 1个 | 309ms | 1%  
