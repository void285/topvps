...
陕西全部运营商到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 33个 | 1个 | 141ms | 12% | 芝加哥 | 33个 | 0 | 273ms | 3%  
新加坡 | 30个 | 0 | 208ms | 15% | 阿姆斯特丹 | 33个 | 0 | 292ms | 2%  
西雅图 | 32个 | 0 | 221ms | 9% | 巴黎 | 33个 | 0 | 294ms | 2%  
洛杉矶 | 33个 | 0 | 226ms | 13% | 新泽西 | 33个 | 0 | 303ms | 2%  
悉尼 | 32个 | 0 | 234ms | 3% | 法兰克福 | 26个 | 0 | 306ms | 4%  
硅谷 | 33个 | 0 | 243ms | 11% | 亚特兰大 | 33个 | 0 | 308ms | 11%  
均值 | 478个 | 1个 | 264ms | 8% | 伦敦 | 31个 | 0 | 313ms | 2%  
达拉斯 | 30个 | 0 | 271ms | 13% | 迈阿密 | 33个 | 0 | 320ms | 11%  
...
陕西电信到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 1个 | 148ms | 13% | 芝加哥 | 13个 | 0 | 296ms | 1%  
新加坡 | 11个 | 0 | 230ms | 12% | 阿姆斯特丹 | 14个 | 0 | 265ms | 3%  
西雅图 | 13个 | 0 | 234ms | 2% | 巴黎 | 14个 | 0 | 261ms | 2%  
洛杉矶 | 14个 | 0 | 207ms | 1% | 新泽西 | 14个 | 0 | 329ms | 1%  
悉尼 | 14个 | 0 | 253ms | 2% | 法兰克福 | 11个 | 0 | 259ms | 0  
硅谷 | 13个 | 0 | 252ms | 2% | 亚特兰大 | 14个 | 0 | 284ms | 1%  
均值 | 195个 | 1个 | 260ms | 3% | 伦敦 | 13个 | 0 | 324ms | 0  
达拉斯 | 11个 | 0 | 230ms | 2% | 迈阿密 | 13个 | 0 | 314ms | 3%  
...
陕西联通到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 141ms | 14% | 芝加哥 | 11个 | 0 | 252ms | 4%  
新加坡 | 11个 | 0 | 220ms | 22% | 阿姆斯特丹 | 11个 | 0 | 339ms | 4%  
西雅图 | 11个 | 0 | 195ms | 6% | 巴黎 | 11个 | 0 | 338ms | 4%  
洛杉矶 | 10个 | 0 | 223ms | 14% | 新泽西 | 10个 | 0 | 274ms | 1%  
悉尼 | 9个 | 0 | 205ms | 1% | 法兰克福 | 9个 | 0 | 355ms | 6%  
硅谷 | 11个 | 0 | 210ms | 9% | 亚特兰大 | 10个 | 0 | 290ms | 11%  
均值 | 156个 | 0 | 265ms | 9% | 伦敦 | 10个 | 0 | 317ms | 3%  
达拉斯 | 10个 | 0 | 272ms | 14% | 迈阿密 | 11个 | 0 | 311ms | 14%  
...
陕西移动到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 135ms | 10% | 芝加哥 | 9个 | 0 | 273ms | 3%  
新加坡 | 8个 | 0 | 174ms | 11% | 阿姆斯特丹 | 8个 | 0 | 273ms | 0  
西雅图 | 8个 | 0 | 235ms | 18% | 巴黎 | 8个 | 0 | 284ms | 1%  
洛杉矶 | 9个 | 0 | 249ms | 23% | 新泽西 | 9个 | 0 | 305ms | 2%  
悉尼 | 9个 | 0 | 243ms | 5% | 法兰克福 | 6个 | 0 | 303ms | 6%  
硅谷 | 9个 | 0 | 267ms | 22% | 亚特兰大 | 9个 | 0 | 351ms | 21%  
均值 | 127个 | 0 | 269ms | 11% | 伦敦 | 8个 | 0 | 298ms | 1%  
达拉斯 | 9个 | 0 | 310ms | 22% | 迈阿密 | 9个 | 0 | 336ms | 17%  
