...
大陆全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 5257个 | 72个 | 192ms | 18% | 法兰克福 | 5282个 | 33个 | 293ms | 3%  
洛杉矶 | 3120个 | 44个 | 221ms | 3% | 巴黎 | 3157个 | 36个 | 294ms | 2%  
硅谷 | 5228个 | 60个 | 239ms | 9% | 伦敦 | 5305个 | 42个 | 309ms | 3%  
西雅图 | 3089个 | 29个 | 239ms | 9% | 亚特兰大 | 3170个 | 45个 | 318ms | 4%  
新加坡 | 3157个 | 68个 | 243ms | 18% | 悉尼 | 3089个 | 83个 | 320ms | 15%  
达拉斯 | 5268个 | 33个 | 264ms | 3% | 新泽西 | 5208个 | 44个 | 324ms | 4%  
均值 | 59932个 | 697个 | 278ms | 7% | 迈阿密 | 3245个 | 38个 | 325ms | 7%  
芝加哥 | 3113个 | 32个 | 283ms | 7% | 阿姆斯特丹 | 3244个 | 38个 | 330ms | 5%  
...
大陆电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2175个 | 61个 | 225ms | 28% | 法兰克福 | 2203个 | 22个 | 276ms | 2%  
洛杉矶 | 1306个 | 37个 | 241ms | 4% | 巴黎 | 1335个 | 19个 | 276ms | 2%  
硅谷 | 2166个 | 46个 | 253ms | 5% | 伦敦 | 2203个 | 22个 | 323ms | 3%  
西雅图 | 1311个 | 19个 | 260ms | 4% | 亚特兰大 | 1357个 | 19个 | 341ms | 3%  
新加坡 | 1327个 | 58个 | 285ms | 32% | 悉尼 | 1307个 | 67个 | 376ms | 24%  
达拉斯 | 2166个 | 22个 | 291ms | 3% | 新泽西 | 2158个 | 34个 | 365ms | 4%  
均值 | 25107个 | 510个 | 299ms | 8% | 迈阿密 | 1375个 | 28个 | 368ms | 6%  
芝加哥 | 1344个 | 25个 | 305ms | 5% | 阿姆斯特丹 | 1374个 | 31个 | 335ms | 6%  
...
大陆联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 1459个 | 3个 | 212ms | 15% | 法兰克福 | 1479个 | 3个 | 306ms | 3%  
洛杉矶 | 903个 | 3个 | 205ms | 2% | 巴黎 | 895个 | 10个 | 305ms | 1%  
硅谷 | 1490个 | 0 | 222ms | 5% | 伦敦 | 1467个 | 12个 | 327ms | 3%  
西雅图 | 887个 | 6个 | 221ms | 10% | 亚特兰大 | 902个 | 19个 | 298ms | 5%  
新加坡 | 899个 | 3个 | 283ms | 12% | 悉尼 | 883个 | 9个 | 326ms | 14%  
达拉斯 | 1475个 | 3个 | 240ms | 3% | 新泽西 | 1490个 | 6个 | 304ms | 6%  
均值 | 16961个 | 89个 | 274ms | 6% | 迈阿密 | 915个 | 6个 | 288ms | 4%  
芝加哥 | 898个 | 3个 | 268ms | 6% | 阿姆斯特丹 | 919个 | 3个 | 335ms | 3%  
...
大陆移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 1623个 | 8个 | 133ms | 6% | 法兰克福 | 1600个 | 8个 | 304ms | 3%  
洛杉矶 | 911个 | 4个 | 208ms | 2% | 巴黎 | 927个 | 7个 | 309ms | 4%  
硅谷 | 1572个 | 14个 | 237ms | 17% | 伦敦 | 1635个 | 8个 | 279ms | 2%  
西雅图 | 891个 | 4个 | 229ms | 16% | 亚特兰大 | 911个 | 7个 | 309ms | 3%  
新加坡 | 931个 | 7个 | 153ms | 7% | 悉尼 | 899个 | 7个 | 238ms | 5%  
达拉斯 | 1627个 | 8个 | 250ms | 2% | 新泽西 | 1560个 | 4个 | 289ms | 2%  
均值 | 17864个 | 98个 | 254ms | 6% | 迈阿密 | 955个 | 4个 | 305ms | 10%  
芝加哥 | 871个 | 4个 | 268ms | 10% | 阿姆斯特丹 | 951个 | 4个 | 319ms | 6%  
