...
大陆全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 901个 | 29个 | 181ms | 11% | 法兰克福 | 906个 | 78个 | 269ms | 1%  
洛杉矶 | 858个 | 26个 | 212ms | 2% | 芝加哥 | 900个 | 23个 | 284ms | 17%  
硅谷 | 908个 | 6个 | 216ms | 1% | 亚特兰大 | 869个 | 27个 | 287ms | 16%  
西雅图 | 890个 | 36个 | 221ms | 3% | 新泽西 | 882个 | 26个 | 298ms | 2%  
新加坡 | 868个 | 35个 | 235ms | 9% | 悉尼 | 865个 | 31个 | 304ms | 7%  
达拉斯 | 862个 | 21个 | 247ms | 1% | 迈阿密 | 903个 | 22个 | 305ms | 16%  
均值 | 13235个 | 420个 | 263ms | 7% | 伦敦 | 898个 | 17个 | 308ms | 10%  
巴黎 | 862个 | 20个 | 265ms | 0 | 阿姆斯特丹 | 863个 | 23个 | 317ms | 1%  
...
大陆电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 401个 | 18个 | 219ms | 20% | 法兰克福 | 411个 | 54个 | 242ms | 1%  
洛杉矶 | 393个 | 12个 | 231ms | 4% | 芝加哥 | 403个 | 10个 | 295ms | 7%  
硅谷 | 411个 | 4个 | 231ms | 2% | 亚特兰大 | 393个 | 16个 | 291ms | 7%  
西雅图 | 403个 | 15个 | 237ms | 4% | 新泽西 | 394个 | 14个 | 328ms | 2%  
新加坡 | 397个 | 17个 | 282ms | 16% | 悉尼 | 401个 | 15个 | 364ms | 12%  
达拉斯 | 387个 | 9个 | 264ms | 2% | 迈阿密 | 406个 | 8个 | 315ms | 7%  
均值 | 5982个 | 217个 | 277ms | 6% | 伦敦 | 397个 | 6个 | 318ms | 4%  
巴黎 | 394个 | 8个 | 241ms | 0 | 阿姆斯特丹 | 391个 | 11个 | 333ms | 1%  
...
大陆联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 243个 | 5个 | 180ms | 6% | 法兰克福 | 243个 | 18个 | 316ms | 3%  
洛杉矶 | 235个 | 7个 | 200ms | 0 | 芝加哥 | 244个 | 7个 | 299ms | 43%  
硅谷 | 248个 | 1个 | 198ms | 0 | 亚特兰大 | 233个 | 4个 | 291ms | 42%  
西雅图 | 245个 | 10个 | 209ms | 1% | 新泽西 | 240个 | 5个 | 284ms | 2%  
新加坡 | 234个 | 11个 | 245ms | 6% | 悉尼 | 234个 | 8个 | 284ms | 4%  
达拉斯 | 235个 | 6个 | 229ms | 0 | 迈阿密 | 243个 | 6个 | 306ms | 41%  
均值 | 3599个 | 106个 | 265ms | 12% | 伦敦 | 246个 | 5个 | 331ms | 29%  
巴黎 | 237个 | 6个 | 293ms | 0 | 阿姆斯特丹 | 239个 | 7个 | 325ms | 1%  
...
大陆移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
