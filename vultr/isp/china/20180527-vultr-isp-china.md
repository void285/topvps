...
**大陆全部运营商到Vultr各机房的测速数据 [20180527]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 954个 | 16个 | 177ms | 12%  
硅谷 | 971个 | 15个 | 216ms | 11%  
洛杉矶 | 975个 | 15个 | 220ms | 3%  
新加坡 | 972个 | 22个 | 230ms | 13%  
西雅图 | 970个 | 12个 | 231ms | 9%  
均值 | 14559个 | 221个 | 265ms | 8%  
芝加哥 | 975个 | 13个 | 276ms | 8%  
达拉斯 | 973个 | 10个 | 276ms | 11%  
巴黎 | 981个 | 10个 | 279ms | 5%  
法兰克福 | 962个 | 34个 | 280ms | 3%  
亚特兰大 | 981个 | 16个 | 282ms | 12%  
迈阿密 | 965个 | 16个 | 282ms | 10%  
新泽西 | 962个 | 12个 | 293ms | 7%  
阿姆斯特丹 | 980个 | 12个 | 299ms | 3%  
悉尼 | 974个 | 13个 | 316ms | 13%  
伦敦 | 964个 | 5个 | 320ms | 6%  
...
**大陆电信到Vultr各机房的测速数据 [20180527]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 398个 | 12个 | 206ms | 19%  
硅谷 | 412个 | 8个 | 228ms | 7%  
洛杉矶 | 413个 | 9个 | 247ms | 5%  
新加坡 | 412个 | 15个 | 273ms | 20%  
西雅图 | 411个 | 6个 | 257ms | 6%  
均值 | 6143个 | 136个 | 274ms | 8%  
芝加哥 | 414个 | 7个 | 311ms | 6%  
达拉斯 | 406个 | 7个 | 279ms | 6%  
巴黎 | 417个 | 4个 | 253ms | 2%  
法兰克福 | 400个 | 28个 | 260ms | 2%  
亚特兰大 | 419个 | 9个 | 274ms | 7%  
迈阿密 | 405个 | 9个 | 286ms | 6%  
新泽西 | 404个 | 5个 | 329ms | 6%  
阿姆斯特丹 | 414个 | 6个 | 254ms | 2%  
悉尼 | 415个 | 8个 | 357ms | 20%  
伦敦 | 403个 | 3个 | 294ms | 3%  
...
硅谷 | 280个 | 5个 | 200ms | 16%  
洛杉矶 | 282个 | 4个 | 205ms | 2%  
新加坡 | 285个 | 4个 | 279ms | 13%  
西雅图 | 284个 | 4个 | 216ms | 17%  
均值 | 4252个 | 46个 | 262ms | 9%  
芝加哥 | 285个 | 4个 | 254ms | 13%  
达拉斯 | 287个 | 0 | 232ms | 3%  
巴黎 | 282个 | 3个 | 317ms | 9%  
法兰克福 | 284个 | 3个 | 321ms | 6%  
亚特兰大 | 284个 | 3个 | 253ms | 4%  
迈阿密 | 284个 | 3个 | 255ms | 14%  
新泽西 | 282个 | 5个 | 268ms | 12%  
阿姆斯特丹 | 286个 | 4个 | 323ms | 6%  
悉尼 | 282个 | 3个 | 310ms | 11%  
伦敦 | 284个 | 0 | 324ms | 5%  
...
新加坡 | 275个 | 3个 | 123ms | 3%  
西雅图 | 275个 | 2个 | 212ms | 6%  
均值 | 4164个 | 39个 | 258ms | 8%  
芝加哥 | 276个 | 2个 | 257ms | 7%  
达拉斯 | 280个 | 3个 | 314ms | 26%  
巴黎 | 282个 | 3个 | 281ms | 4%  
法兰克福 | 278个 | 3个 | 276ms | 2%  
亚特兰大 | 278个 | 4个 | 327ms | 26%  
迈阿密 | 276个 | 4个 | 302ms | 12%  
新泽西 | 276个 | 2个 | 275ms | 1%  
阿姆斯特丹 | 280个 | 2个 | 338ms | 3%  
悉尼 | 277个 | 2个 | 261ms | 4%  
伦敦 | 277个 | 2个 | 347ms | 12%  
