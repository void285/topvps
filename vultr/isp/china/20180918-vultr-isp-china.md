...
**大陆全部运营商到Vultr各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 1406个 | 18个 | 139ms | 2%  
新加坡 | 1459个 | 14个 | 201ms | 2%  
洛杉矶 | 1418个 | 22个 | 210ms | 5%  
硅谷 | 1426个 | 10个 | 212ms | 2%  
西雅图 | 1434个 | 21个 | 223ms | 6%  
达拉斯 | 1371个 | 11个 | 232ms | 2%  
均值 | 21251个 | 214个 | 247ms | 4%  
芝加哥 | 1399个 | 11个 | 251ms | 1%  
亚特兰大 | 1388个 | 15个 | 268ms | 7%  
悉尼 | 1410个 | 12个 | 272ms | 1%  
新泽西 | 1439个 | 11个 | 273ms | 5%  
巴黎 | 1430个 | 12个 | 273ms | 4%  
法兰克福 | 1408个 | 9个 | 273ms | 4%  
迈阿密 | 1413个 | 25个 | 284ms | 5%  
伦敦 | 1393个 | 11个 | 291ms | 5%  
阿姆斯特丹 | 1457个 | 12个 | 303ms | 6%  
...
**大陆电信到Vultr各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 589个 | 14个 | 176ms | 3%  
新加坡 | 603个 | 11个 | 250ms | 3%  
洛杉矶 | 589个 | 16个 | 228ms | 9%  
硅谷 | 588个 | 6个 | 217ms | 3%  
西雅图 | 595个 | 13个 | 241ms | 10%  
达拉斯 | 574个 | 8个 | 229ms | 1%  
均值 | 8834个 | 153个 | 257ms | 5%  
芝加哥 | 580个 | 6个 | 252ms | 0  
亚特兰大 | 575个 | 13个 | 291ms | 11%  
悉尼 | 593个 | 9个 | 313ms | 1%  
新泽西 | 599个 | 8个 | 262ms | 2%  
巴黎 | 587个 | 6个 | 269ms | 6%  
法兰克福 | 587个 | 6个 | 267ms | 5%  
迈阿密 | 591个 | 21个 | 297ms | 10%  
伦敦 | 583个 | 7个 | 274ms | 2%  
阿姆斯特丹 | 601个 | 9个 | 299ms | 3%  
...
西雅图 | 426个 | 7个 | 211ms | 2%  
达拉斯 | 407个 | 3个 | 224ms | 4%  
均值 | 6324个 | 55个 | 251ms | 4%  
芝加哥 | 419个 | 5个 | 245ms | 0  
亚特兰大 | 418个 | 2个 | 249ms | 3%  
悉尼 | 421个 | 2个 | 274ms | 1%  
新泽西 | 422个 | 3个 | 293ms | 13%  
巴黎 | 428个 | 6个 | 306ms | 2%  
法兰克福 | 422个 | 3个 | 300ms | 3%  
迈阿密 | 423个 | 4个 | 264ms | 2%  
伦敦 | 415个 | 2个 | 335ms | 11%  
阿姆斯特丹 | 430个 | 2个 | 339ms | 11%  
