...
浙江全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 47个 | 1个 | 167ms | 15% | 迈阿密 | 50个 | 2个 | 270ms | 6%  
新加坡 | 50个 | 4个 | 208ms | 16% | 芝加哥 | 51个 | 0 | 279ms | 9%  
西雅图 | 51个 | 1个 | 215ms | 6% | 巴黎 | 51个 | 1个 | 285ms | 3%  
硅谷 | 52个 | 1个 | 222ms | 10% | 新泽西 | 49个 | 1个 | 292ms | 5%  
洛杉矶 | 51个 | 0 | 228ms | 5% | 法兰克福 | 49个 | 3个 | 296ms | 2%  
达拉斯 | 53个 | 0 | 251ms | 3% | 悉尼 | 51个 | 1个 | 301ms | 15%  
均值 | 759个 | 17个 | 258ms | 7% | 伦敦 | 50个 | 0 | 303ms | 1%  
亚特兰大 | 52个 | 2个 | 266ms | 4% | 阿姆斯特丹 | 52个 | 0 | 312ms | 1%  
...
浙江电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 20个 | 1个 | 187ms | 23% | 迈阿密 | 21个 | 1个 | 264ms | 2%  
新加坡 | 22个 | 3个 | 239ms | 21% | 芝加哥 | 21个 | 0 | 303ms | 5%  
西雅图 | 22个 | 1个 | 229ms | 4% | 巴黎 | 23个 | 1个 | 249ms | 1%  
硅谷 | 23个 | 0 | 213ms | 4% | 新泽西 | 21个 | 0 | 335ms | 3%  
洛杉矶 | 22个 | 0 | 230ms | 3% | 法兰克福 | 21个 | 2个 | 264ms | 0  
达拉斯 | 23个 | 0 | 259ms | 5% | 悉尼 | 23个 | 0 | 319ms | 23%  
均值 | 327个 | 9个 | 257ms | 7% | 伦敦 | 21个 | 0 | 288ms | 1%  
亚特兰大 | 22个 | 0 | 267ms | 5% | 阿姆斯特丹 | 22个 | 0 | 252ms | 0  
...
浙江联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 0 | 190ms | 18% | 迈阿密 | 16个 | 0 | 256ms | 14%  
新加坡 | 15个 | 1个 | 259ms | 22% | 芝加哥 | 16个 | 0 | 280ms | 17%  
西雅图 | 15个 | 0 | 218ms | 13% | 巴黎 | 15个 | 0 | 314ms | 5%  
硅谷 | 16个 | 1个 | 228ms | 17% | 新泽西 | 16个 | 1个 | 268ms | 11%  
洛杉矶 | 15个 | 0 | 234ms | 9% | 法兰克福 | 16个 | 1个 | 310ms | 3%  
达拉斯 | 16个 | 0 | 245ms | 1% | 悉尼 | 15个 | 1个 | 310ms | 17%  
均值 | 234个 | 6个 | 266ms | 10% | 伦敦 | 16个 | 0 | 323ms | 2%  
亚特兰大 | 16个 | 1个 | 270ms | 4% | 阿姆斯特丹 | 16个 | 0 | 331ms | 2%  
...
浙江移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 124ms | 3% | 迈阿密 | 13个 | 1个 | 290ms | 3%  
新加坡 | 13个 | 0 | 125ms | 5% | 芝加哥 | 14个 | 0 | 256ms | 6%  
西雅图 | 14个 | 0 | 200ms | 0 | 巴黎 | 13个 | 0 | 290ms | 1%  
硅谷 | 13个 | 0 | 224ms | 8% | 新泽西 | 12个 | 0 | 272ms | 0  
洛杉矶 | 14个 | 0 | 221ms | 4% | 法兰克福 | 12个 | 0 | 313ms | 2%  
达拉斯 | 14个 | 0 | 249ms | 1% | 悉尼 | 13个 | 0 | 274ms | 5%  
均值 | 198个 | 2个 | 251ms | 3% | 伦敦 | 13个 | 0 | 298ms | 2%  
亚特兰大 | 14个 | 1个 | 262ms | 2% | 阿姆斯特丹 | 14个 | 0 | 355ms | 2%  
