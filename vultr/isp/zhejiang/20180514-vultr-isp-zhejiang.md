...
**浙江全部运营商到Vultr各机房的测速数据 [20180514]**
...
达拉斯 | 49个 | 2个 | 247ms | 10%  
硅谷 | 49个 | 4个 | 252ms | 10%  
均值 | 759个 | 51个 | 262ms | 11%  
芝加哥 | 53个 | 5个 | 285ms | 18%  
亚特兰大 | 50个 | 4个 | 300ms | 20%  
新泽西 | 51个 | 4个 | 305ms | 10%  
阿姆斯特丹 | 48个 | 3个 | 306ms | 9%  
迈阿密 | 50个 | 5个 | 309ms | 16%  
法兰克福 | 51个 | 3个 | 313ms | 9%  
巴黎 | 53个 | 3个 | 317ms | 14%  
伦敦 | 51个 | 3个 | 329ms | 19%  
...
达拉斯 | 16个 | 1个 | 250ms | 14%  
硅谷 | 15个 | 1个 | 219ms | 1%  
均值 | 236个 | 22个 | 274ms | 16%  
芝加哥 | 17个 | 3个 | 298ms | 36%  
亚特兰大 | 15个 | 2个 | 300ms | 32%  
新泽西 | 16个 | 2个 | 281ms | 30%  
阿姆斯特丹 | 16个 | 1个 | 332ms | 5%  
迈阿密 | 16个 | 3个 | 293ms | 36%  
法兰克福 | 15个 | 1个 | 345ms | 4%  
巴黎 | 17个 | 1个 | 346ms | 7%  
伦敦 | 16个 | 1个 | 340ms | 38%  
