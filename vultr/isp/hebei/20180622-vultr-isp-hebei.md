...
河北全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 35个 | 0 | 188ms | 10% | 伦敦 | 33个 | 0 | 270ms | 17%  
硅谷 | 34个 | 0 | 192ms | 0 | 亚特兰大 | 34个 | 0 | 278ms | 26%  
洛杉矶 | 30个 | 1个 | 202ms | 1% | 新泽西 | 31个 | 0 | 280ms | 1%  
西雅图 | 31个 | 0 | 220ms | 3% | 阿姆斯特丹 | 30个 | 1个 | 283ms | 0  
达拉斯 | 29个 | 0 | 232ms | 0 | 法兰克福 | 28个 | 0 | 286ms | 20%  
巴黎 | 30个 | 0 | 240ms | 0 | 悉尼 | 30个 | 0 | 287ms | 5%  
均值 | 475个 | 2个 | 253ms | 10% | 芝加哥 | 34个 | 0 | 290ms | 29%  
新加坡 | 31个 | 0 | 261ms | 7% | 迈阿密 | 35个 | 0 | 298ms | 25%  
...
河北电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 247ms | 22% | 伦敦 | 10个 | 0 | 303ms | 9%  
硅谷 | 11个 | 0 | 195ms | 0 | 亚特兰大 | 12个 | 0 | 294ms | 11%  
洛杉矶 | 11个 | 1个 | 208ms | 3% | 新泽西 | 9个 | 0 | 304ms | 2%  
西雅图 | 10个 | 0 | 222ms | 1% | 阿姆斯特丹 | 11个 | 1个 | 329ms | 0  
达拉斯 | 9个 | 0 | 232ms | 0 | 法兰克福 | 9个 | 0 | 258ms | 10%  
巴黎 | 11个 | 0 | 227ms | 0 | 悉尼 | 11个 | 0 | 363ms | 12%  
均值 | 162个 | 2个 | 274ms | 8% | 芝加哥 | 12个 | 0 | 293ms | 13%  
新加坡 | 12个 | 0 | 311ms | 16% | 迈阿密 | 12个 | 0 | 306ms | 10%  
...
河北联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 191ms | 5% | 伦敦 | 11个 | 0 | 263ms | 40%  
硅谷 | 11个 | 0 | 170ms | 0 | 亚特兰大 | 11个 | 0 | 270ms | 60%  
洛杉矶 | 10个 | 0 | 194ms | 0 | 新泽西 | 11个 | 0 | 261ms | 0  
西雅图 | 11个 | 0 | 217ms | 0 | 阿姆斯特丹 | 10个 | 0 | 248ms | 0  
达拉斯 | 11个 | 0 | 211ms | 0 | 法兰克福 | 8个 | 0 | 344ms | 46%  
巴黎 | 10个 | 0 | 246ms | 0 | 悉尼 | 9个 | 0 | 272ms | 3%  
均值 | 155个 | 0 | 250ms | 18% | 芝加哥 | 11个 | 0 | 301ms | 61%  
新加坡 | 9个 | 0 | 295ms | 0 | 迈阿密 | 11个 | 0 | 297ms | 55%  
...
河北移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 127ms | 3% | 伦敦 | 12个 | 0 | 246ms | 4%  
硅谷 | 12个 | 0 | 212ms | 0 | 亚特兰大 | 11个 | 0 | 270ms | 7%  
洛杉矶 | 9个 | 0 | 205ms | 0 | 新泽西 | 11个 | 0 | 276ms | 0  
西雅图 | 10个 | 0 | 222ms | 7% | 阿姆斯特丹 | 9个 | 0 | 271ms | 0  
达拉斯 | 9个 | 0 | 252ms | 2% | 法兰克福 | 11个 | 0 | 255ms | 5%  
巴黎 | 9个 | 0 | 247ms | 0 | 悉尼 | 10个 | 0 | 225ms | 1%  
均值 | 158个 | 0 | 236ms | 4% | 芝加哥 | 11个 | 0 | 274ms | 12%  
新加坡 | 10个 | 0 | 178ms | 5% | 迈阿密 | 12个 | 0 | 290ms | 9%  
