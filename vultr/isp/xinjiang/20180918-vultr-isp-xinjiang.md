...
新疆全部运营商到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 31个 | 0 | 178ms | 5% | 悉尼 | 36个 | 0 | 301ms | 2%  
新加坡 | 35个 | 0 | 257ms | 1% | 巴黎 | 34个 | 0 | 309ms | 2%  
硅谷 | 33个 | 0 | 262ms | 4% | 芝加哥 | 32个 | 0 | 310ms | 5%  
洛杉矶 | 33个 | 1个 | 265ms | 6% | 亚特兰大 | 29个 | 0 | 314ms | 5%  
西雅图 | 34个 | 0 | 285ms | 5% | 伦敦 | 33个 | 0 | 334ms | 4%  
达拉斯 | 29个 | 0 | 286ms | 2% | 新泽西 | 35个 | 0 | 334ms | 5%  
均值 | 491个 | 2个 | 294ms | 5% | 迈阿密 | 31个 | 1个 | 340ms | 8%  
法兰克福 | 32个 | 0 | 299ms | 5% | 阿姆斯特丹 | 34个 | 0 | 343ms | 7%  
  
简评：本表展示了新疆的 **电信、联通、移动** 线路到Vultr各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻新疆，可从此表了解你常用的网络到Vultr各个机房的平均响应速度以及丢包率。从表中数据可以看到， **东京** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

新疆电信到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 18个 | 0 | 192ms | 3% | 悉尼 | 21个 | 0 | 336ms | 1%  
新加坡 | 21个 | 0 | 296ms | 2% | 巴黎 | 19个 | 0 | 288ms | 0  
硅谷 | 19个 | 0 | 255ms | 2% | 芝加哥 | 17个 | 0 | 301ms | 0  
洛杉矶 | 18个 | 1个 | 279ms | 13% | 亚特兰大 | 16个 | 0 | 339ms | 13%  
西雅图 | 19个 | 0 | 278ms | 7% | 伦敦 | 19个 | 0 | 304ms | 3%  
达拉斯 | 18个 | 0 | 278ms | 1% | 新泽西 | 20个 | 0 | 317ms | 2%  
均值 | 280个 | 2个 | 291ms | 3% | 迈阿密 | 17个 | 1个 | 306ms | 6%  
法兰克福 | 18个 | 0 | 264ms | 0 | 阿姆斯特丹 | 20个 | 0 | 338ms | 1%  
  
简评：如果你是来自新疆的 **电信** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_1)吧！

### 联通

新疆联通到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 5个 | 0 | 162ms | 2% | 悉尼 | 7个 | 0 | 282ms | 1%  
新加坡 | 5个 | 0 | 306ms | 0 | 巴黎 | 7个 | 0 | 364ms | 1%  
硅谷 | 6个 | 0 | 251ms | 3% | 芝加哥 | 7个 | 0 | 288ms | 1%  
洛杉矶 | 7个 | 0 | 229ms | 0 | 亚特兰大 | 6个 | 0 | 297ms | 2%  
西雅图 | 7个 | 0 | 282ms | 6% | 伦敦 | 6个 | 0 | 388ms | 7%  
达拉斯 | 5个 | 0 | 269ms | 4% | 新泽西 | 7个 | 0 | 349ms | 10%  
均值 | 92个 | 0 | 303ms | 4% | 迈阿密 | 6个 | 0 | 343ms | 8%  
法兰克福 | 6个 | 0 | 331ms | 4% | 阿姆斯特丹 | 5个 | 0 | 394ms | 14%  
  
简评：如果你是来自新疆的 **联通** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、洛杉矶** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_2)吧！

### 移动

新疆移动到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 8个 | 0 | 181ms | 10% | 悉尼 | 8个 | 0 | 287ms | 5%  
新加坡 | 9个 | 0 | 170ms | 0 | 巴黎 | 8个 | 0 | 276ms | 7%  
硅谷 | 8个 | 0 | 281ms | 8% | 芝加哥 | 8个 | 0 | 339ms | 13%  
洛杉矶 | 8个 | 0 | 288ms | 7% | 亚特兰大 | 7个 | 0 | 307ms | 0  
西雅图 | 8个 | 0 | 295ms | 3% | 伦敦 | 8个 | 0 | 308ms | 4%  
达拉斯 | 6个 | 0 | 312ms | 2% | 新泽西 | 8个 | 0 | 336ms | 2%  
均值 | 119个 | 0 | 289ms | 6% | 迈阿密 | 8个 | 0 | 372ms | 11%  
法兰克福 | 8个 | 0 | 303ms | 12% | 阿姆斯特丹 | 9个 | 0 | 297ms | 6%  
