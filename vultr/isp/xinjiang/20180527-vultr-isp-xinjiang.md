...
新疆全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 27个 | 0 | 218ms | 10% | 巴黎 | 28个 | 0 | 328ms | 10%  
硅谷 | 29个 | 0 | 249ms | 14% | 新泽西 | 27个 | 0 | 330ms | 10%  
洛杉矶 | 28个 | 0 | 255ms | 5% | 亚特兰大 | 27个 | 1个 | 330ms | 14%  
西雅图 | 28个 | 0 | 269ms | 11% | 迈阿密 | 28个 | 0 | 333ms | 16%  
新加坡 | 26个 | 0 | 293ms | 18% | 法兰克福 | 27个 | 0 | 338ms | 4%  
芝加哥 | 29个 | 0 | 305ms | 10% | 悉尼 | 27个 | 0 | 353ms | 10%  
均值 | 416个 | 1个 | 309ms | 10% | 阿姆斯特丹 | 28个 | 0 | 360ms | 5%  
达拉斯 | 29个 | 0 | 317ms | 12% | 伦敦 | 28个 | 0 | 372ms | 7%  
...
新疆电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 247ms | 14% | 巴黎 | 12个 | 0 | 293ms | 0  
硅谷 | 12个 | 0 | 256ms | 4% | 新泽西 | 11个 | 0 | 379ms | 6%  
洛杉矶 | 12个 | 0 | 293ms | 7% | 亚特兰大 | 11个 | 1个 | 333ms | 9%  
西雅图 | 11个 | 0 | 299ms | 8% | 迈阿密 | 11个 | 0 | 346ms | 6%  
新加坡 | 11个 | 0 | 318ms | 15% | 法兰克福 | 11个 | 0 | 284ms | 4%  
芝加哥 | 12个 | 0 | 357ms | 3% | 悉尼 | 11个 | 0 | 412ms | 15%  
均值 | 170个 | 1个 | 316ms | 7% | 阿姆斯特丹 | 11个 | 0 | 302ms | 5%  
达拉斯 | 12个 | 0 | 332ms | 8% | 伦敦 | 11个 | 0 | 326ms | 4%  
...
新疆联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 3个 | 0 | 239ms | 11% | 巴黎 | 3个 | 0 | 367ms | 22%  
硅谷 | 4个 | 0 | 222ms | 19% | 新泽西 | 3个 | 0 | 293ms | 20%  
洛杉矶 | 3个 | 0 | 217ms | 0 | 亚特兰大 | 3个 | 0 | 266ms | 0  
西雅图 | 4个 | 0 | 249ms | 14% | 迈阿密 | 4个 | 0 | 283ms | 21%  
新加坡 | 3个 | 0 | 395ms | 33% | 法兰克福 | 3个 | 0 | 415ms | 3%  
芝加哥 | 4个 | 0 | 260ms | 19% | 悉尼 | 3个 | 0 | 349ms | 9%  
均值 | 52个 | 0 | 303ms | 12% | 阿姆斯特丹 | 4个 | 0 | 390ms | 3%  
达拉斯 | 4个 | 0 | 251ms | 0 | 伦敦 | 4个 | 0 | 384ms | 3%  
...
新疆移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 168ms | 5% | 巴黎 | 13个 | 0 | 325ms | 7%  
硅谷 | 13个 | 0 | 268ms | 18% | 新泽西 | 13个 | 0 | 317ms | 3%  
洛杉矶 | 13个 | 0 | 255ms | 8% | 亚特兰大 | 13个 | 0 | 392ms | 32%  
西雅图 | 13个 | 0 | 259ms | 10% | 迈阿密 | 13个 | 0 | 369ms | 19%  
新加坡 | 12个 | 0 | 166ms | 7% | 法兰克福 | 13个 | 0 | 314ms | 6%  
芝加哥 | 13个 | 0 | 297ms | 7% | 悉尼 | 13个 | 0 | 299ms | 6%  
均值 | 194个 | 0 | 307ms | 12% | 阿姆斯特丹 | 13个 | 0 | 388ms | 6%  
达拉斯 | 13个 | 0 | 369ms | 29% | 伦敦 | 13个 | 0 | 407ms | 15%  
