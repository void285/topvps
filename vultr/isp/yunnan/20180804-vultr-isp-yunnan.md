...
云南全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 123个 | 0 | 196ms | 11% | 均值 | 1329个 | 4个 | 297ms | 6%  
洛杉矶 | 67个 | 0 | 242ms | 4% | 芝加哥 | 67个 | 0 | 313ms | 8%  
新加坡 | 67个 | 0 | 251ms | 15% | 伦敦 | 123个 | 0 | 327ms | 1%  
硅谷 | 119个 | 4个 | 258ms | 8% | 阿姆斯特丹 | 67个 | 0 | 342ms | 7%  
西雅图 | 67个 | 0 | 279ms | 2% | 悉尼 | 63个 | 0 | 350ms | 9%  
巴黎 | 67个 | 0 | 287ms | 5% | 迈阿密 | 67个 | 0 | 357ms | 10%  
达拉斯 | 119个 | 0 | 290ms | 4% | 新泽西 | 123个 | 0 | 358ms | 4%  
法兰克福 | 123个 | 0 | 291ms | 5% | 亚特兰大 | 67个 | 0 | 363ms | 6%  
...
云南电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 55个 | 0 | 224ms | 25% | 均值 | 633个 | 4个 | 302ms | 11%  
洛杉矶 | 35个 | 0 | 252ms | 11% | 芝加哥 | 35个 | 0 | 305ms | 10%  
新加坡 | 35个 | 0 | 282ms | 25% | 伦敦 | 55个 | 0 | 321ms | 4%  
硅谷 | 51个 | 4个 | 248ms | 7% | 阿姆斯特丹 | 35个 | 0 | 340ms | 11%  
西雅图 | 35个 | 0 | 270ms | 4% | 悉尼 | 31个 | 0 | 366ms | 20%  
巴黎 | 35个 | 0 | 295ms | 9% | 迈阿密 | 35个 | 0 | 359ms | 15%  
达拉斯 | 51个 | 0 | 305ms | 9% | 新泽西 | 55个 | 0 | 355ms | 8%  
法兰克福 | 55个 | 0 | 306ms | 5% | 亚特兰大 | 35个 | 0 | 360ms | 11%  
...
云南联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 8个 | 0 | 240ms | 8% | 均值 | 84个 | 0 | 335ms | 4%  
洛杉矶 | 4个 | 0 | 268ms | 2% | 芝加哥 | 4个 | 0 | 366ms | 4%  
新加坡 | 4个 | 0 | 327ms | 19% | 伦敦 | 8个 | 0 | 385ms | 1%  
硅谷 | 8个 | 0 | 290ms | 3% | 阿姆斯特丹 | 4个 | 0 | 402ms | 5%  
西雅图 | 4个 | 0 | 313ms | 3% | 悉尼 | 4个 | 0 | 419ms | 7%  
巴黎 | 4个 | 0 | 264ms | 2% | 迈阿密 | 4个 | 0 | 409ms | 8%  
达拉斯 | 8个 | 0 | 311ms | 4% | 新泽西 | 8个 | 0 | 415ms | 3%  
法兰克福 | 8个 | 0 | 288ms | 2% | 亚特兰大 | 4个 | 0 | 424ms | 7%  
  
简评：如果你是来自云南的 **联通** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，请慎重选择部署在 **东京** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_2)吧！

### 移动

云南移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 60个 | 0 | 125ms | 1% | 均值 | 612个 | 0 | 252ms | 4%  
洛杉矶 | 28个 | 0 | 205ms | 0 | 芝加哥 | 28个 | 0 | 268ms | 11%  
新加坡 | 28个 | 0 | 145ms | 2% | 伦敦 | 60个 | 0 | 275ms | 0  
硅谷 | 60个 | 0 | 237ms | 16% | 阿姆斯特丹 | 28个 | 0 | 286ms | 6%  
西雅图 | 28个 | 0 | 255ms | 1% | 悉尼 | 28个 | 0 | 266ms | 1%  
巴黎 | 28个 | 0 | 303ms | 5% | 迈阿密 | 28个 | 0 | 302ms | 8%  
达拉斯 | 60个 | 0 | 255ms | 0 | 新泽西 | 60个 | 0 | 304ms | 0  
法兰克福 | 60个 | 0 | 281ms | 7% | 亚特兰大 | 28个 | 0 | 307ms | 0  
  
简评：如果你是来自云南的 **移动** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、新加坡、洛杉矶** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **硅谷** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_3)吧！
