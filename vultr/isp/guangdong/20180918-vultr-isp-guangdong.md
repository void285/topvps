...
**广东全部运营商到Vultr各机房的测速数据 [20180918]**
...
西雅图 | 124个 | 4个 | 203ms | 5%  
达拉斯 | 115个 | 1个 | 227ms | 2%  
均值 | 1839个 | 32个 | 234ms | 3%  
芝加哥 | 121个 | 1个 | 237ms | 0  
亚特兰大 | 124个 | 3个 | 254ms | 5%  
悉尼 | 119个 | 1个 | 256ms | 0  
新泽西 | 124个 | 1个 | 258ms | 5%  
法兰克福 | 126个 | 2个 | 261ms | 6%  
巴黎 | 127个 | 2个 | 263ms | 5%  
迈阿密 | 122个 | 5个 | 279ms | 6%  
伦敦 | 118个 | 1个 | 282ms | 3%  
阿姆斯特丹 | 119个 | 2个 | 311ms | 2%  
...
均值 | 815个 | 26个 | 252ms | 5%  
芝加哥 | 55个 | 1个 | 237ms | 0  
亚特兰大 | 54个 | 3个 | 285ms | 12%  
悉尼 | 51个 | 1个 | 313ms | 0  
新泽西 | 57个 | 1个 | 241ms | 0  
法兰克福 | 55个 | 1个 | 282ms | 14%  
巴黎 | 56个 | 1个 | 273ms | 12%  
迈阿密 | 55个 | 5个 | 294ms | 11%  
伦敦 | 51个 | 1个 | 256ms | 1%  
阿姆斯特丹 | 53个 | 1个 | 286ms | 1%  
