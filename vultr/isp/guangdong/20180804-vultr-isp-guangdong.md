...
广东全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 454个 | 0 | 138ms | 6% | 芝加哥 | 273个 | 0 | 271ms | 3%  
新加坡 | 282个 | 3个 | 174ms | 6% | 伦敦 | 446个 | 9个 | 308ms | 2%  
洛杉矶 | 277个 | 3个 | 193ms | 1% | 亚特兰大 | 281个 | 3个 | 308ms | 2%  
西雅图 | 270个 | 0 | 209ms | 3% | 新泽西 | 437个 | 6个 | 312ms | 2%  
硅谷 | 441个 | 8个 | 231ms | 2% | 迈阿密 | 282个 | 0 | 312ms | 3%  
达拉斯 | 430个 | 3个 | 241ms | 1% | 巴黎 | 282个 | 6个 | 320ms | 2%  
悉尼 | 274个 | 9个 | 248ms | 4% | 法兰克福 | 446个 | 3个 | 321ms | 3%  
均值 | 5157个 | 53个 | 262ms | 3% | 阿姆斯特丹 | 282个 | 0 | 352ms | 4%  
...
广东电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 178个 | 0 | 224ms | 12% | 芝加哥 | 113个 | 0 | 280ms | 2%  
新加坡 | 114个 | 3个 | 268ms | 12% | 伦敦 | 170个 | 6个 | 302ms | 2%  
洛杉矶 | 113个 | 3个 | 213ms | 1% | 亚特兰大 | 117个 | 0 | 323ms | 2%  
西雅图 | 110个 | 0 | 243ms | 1% | 新泽西 | 169个 | 3个 | 354ms | 2%  
硅谷 | 173个 | 8个 | 235ms | 2% | 迈阿密 | 114个 | 0 | 337ms | 3%  
达拉斯 | 166个 | 3个 | 271ms | 0 | 巴黎 | 114个 | 3个 | 256ms | 1%  
悉尼 | 114个 | 9个 | 329ms | 8% | 法兰克福 | 174个 | 3个 | 259ms | 0  
均值 | 2053个 | 41个 | 278ms | 3% | 阿姆斯特丹 | 114个 | 0 | 321ms | 4%  
...
广东联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 114个 | 0 | 112ms | 7% | 芝加哥 | 74个 | 0 | 310ms | 6%  
新加坡 | 74个 | 0 | 179ms | 7% | 伦敦 | 118个 | 3个 | 378ms | 4%  
洛杉矶 | 74个 | 0 | 193ms | 2% | 亚特兰大 | 74个 | 3个 | 320ms | 5%  
西雅图 | 74个 | 0 | 223ms | 8% | 新泽西 | 118个 | 3个 | 336ms | 6%  
硅谷 | 118个 | 0 | 274ms | 4% | 迈阿密 | 74个 | 0 | 336ms | 7%  
达拉斯 | 118个 | 0 | 240ms | 4% | 巴黎 | 74个 | 0 | 346ms | 3%  
悉尼 | 74个 | 0 | 243ms | 3% | 法兰克福 | 114个 | 0 | 356ms | 8%  
均值 | 1366个 | 9个 | 284ms | 5% | 阿姆斯特丹 | 74个 | 0 | 383ms | 7%  
...
广东移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 162个 | 0 | 78ms | 0 | 芝加哥 | 86个 | 0 | 223ms | 0  
新加坡 | 94个 | 0 | 74ms | 1% | 伦敦 | 158个 | 0 | 244ms | 0  
洛杉矶 | 90个 | 0 | 173ms | 0 | 亚特兰大 | 90个 | 0 | 282ms | 0  
西雅图 | 86个 | 0 | 160ms | 0 | 新泽西 | 150个 | 0 | 247ms | 0  
硅谷 | 150个 | 0 | 184ms | 0 | 迈阿密 | 94个 | 0 | 264ms | 0  
达拉斯 | 146个 | 0 | 211ms | 0 | 巴黎 | 94个 | 3个 | 360ms | 2%  
悉尼 | 86个 | 0 | 172ms | 0 | 法兰克福 | 158个 | 0 | 347ms | 2%  
均值 | 1738个 | 3个 | 224ms | 0 | 阿姆斯特丹 | 94个 | 0 | 351ms | 2%  
