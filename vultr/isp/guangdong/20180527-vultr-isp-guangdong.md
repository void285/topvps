...
广东全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 78个 | 3个 | 154ms | 9% | 达拉斯 | 78个 | 0 | 269ms | 14%  
新加坡 | 83个 | 3个 | 188ms | 8% | 悉尼 | 80个 | 1个 | 271ms | 9%  
硅谷 | 79个 | 0 | 196ms | 6% | 亚特兰大 | 80个 | 2个 | 273ms | 14%  
洛杉矶 | 83个 | 2个 | 206ms | 2% | 新泽西 | 73个 | 2个 | 275ms | 3%  
西雅图 | 79个 | 0 | 208ms | 7% | 法兰克福 | 81个 | 5个 | 281ms | 1%  
均值 | 1189个 | 25个 | 249ms | 6% | 巴黎 | 86个 | 1个 | 286ms | 5%  
芝加哥 | 79个 | 2个 | 262ms | 4% | 阿姆斯特丹 | 78个 | 3个 | 294ms | 0  
迈阿密 | 79个 | 1个 | 264ms | 8% | 伦敦 | 73个 | 0 | 315ms | 6%  
...
广东电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 40个 | 3个 | 215ms | 21% | 达拉斯 | 39个 | 0 | 271ms | 6%  
新加坡 | 44个 | 3个 | 282ms | 21% | 悉尼 | 44个 | 1个 | 329ms | 23%  
硅谷 | 39个 | 0 | 216ms | 6% | 亚特兰大 | 43个 | 1个 | 257ms | 6%  
洛杉矶 | 43个 | 2个 | 236ms | 6% | 新泽西 | 35个 | 1个 | 330ms | 5%  
西雅图 | 44个 | 0 | 248ms | 5% | 法兰克福 | 39个 | 5个 | 265ms | 2%  
均值 | 613个 | 21个 | 266ms | 8% | 巴黎 | 44个 | 0 | 245ms | 3%  
芝加哥 | 44个 | 1个 | 310ms | 6% | 阿姆斯特丹 | 40个 | 3个 | 237ms | 1%  
迈阿密 | 40个 | 1个 | 262ms | 6% | 伦敦 | 35个 | 0 | 287ms | 2%  
...
广东联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 16个 | 0 | 179ms | 7% | 达拉斯 | 18个 | 0 | 240ms | 4%  
新加坡 | 18个 | 0 | 230ms | 3% | 悉尼 | 16个 | 0 | 283ms | 6%  
硅谷 | 18个 | 0 | 197ms | 5% | 亚特兰大 | 18个 | 0 | 250ms | 3%  
洛杉矶 | 18个 | 0 | 214ms | 0 | 新泽西 | 17个 | 1个 | 259ms | 5%  
西雅图 | 16个 | 0 | 223ms | 16% | 法兰克福 | 18个 | 0 | 331ms | 1%  
均值 | 262个 | 3个 | 261ms | 4% | 巴黎 | 18个 | 1个 | 325ms | 2%  
芝加哥 | 18个 | 1个 | 259ms | 3% | 阿姆斯特丹 | 18个 | 0 | 334ms | 1%  
迈阿密 | 18个 | 0 | 255ms | 5% | 伦敦 | 17个 | 0 | 321ms | 1%  
...
广东移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 22个 | 0 | 67ms | 0 | 达拉斯 | 21个 | 0 | 297ms | 32%  
新加坡 | 21个 | 0 | 53ms | 0 | 悉尼 | 20个 | 0 | 200ms | 0  
硅谷 | 22个 | 0 | 174ms | 8% | 亚特兰大 | 19个 | 1个 | 311ms | 34%  
洛杉矶 | 22个 | 0 | 167ms | 0 | 新泽西 | 21个 | 0 | 237ms | 0  
西雅图 | 19个 | 0 | 153ms | 0 | 法兰克福 | 24个 | 0 | 248ms | 1%  
均值 | 314个 | 1个 | 222ms | 7% | 巴黎 | 24个 | 0 | 288ms | 10%  
芝加哥 | 17个 | 0 | 216ms | 3% | 阿姆斯特丹 | 20个 | 0 | 312ms | 0  
迈阿密 | 21个 | 0 | 274ms | 14% | 伦敦 | 21个 | 0 | 337ms | 14%  
