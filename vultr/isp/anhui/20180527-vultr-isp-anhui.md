...
安徽全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 36个 | 0 | 166ms | 13% | 芝加哥 | 39个 | 0 | 281ms | 6%  
硅谷 | 38个 | 0 | 206ms | 9% | 巴黎 | 38个 | 0 | 284ms | 2%  
新加坡 | 38个 | 1个 | 208ms | 12% | 达拉斯 | 39个 | 0 | 287ms | 15%  
洛杉矶 | 39个 | 1个 | 224ms | 2% | 新泽西 | 38个 | 0 | 289ms | 5%  
西雅图 | 38个 | 1个 | 252ms | 6% | 亚特兰大 | 38个 | 0 | 292ms | 13%  
均值 | 573个 | 5个 | 263ms | 8% | 阿姆斯特丹 | 39个 | 0 | 306ms | 1%  
迈阿密 | 39个 | 1个 | 269ms | 9% | 悉尼 | 38个 | 0 | 308ms | 14%  
法兰克福 | 38个 | 1个 | 280ms | 1% | 伦敦 | 38个 | 0 | 321ms | 5%  
...
安徽电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 16个 | 0 | 186ms | 25% | 芝加哥 | 18个 | 0 | 301ms | 5%  
硅谷 | 17个 | 0 | 201ms | 1% | 巴黎 | 17个 | 0 | 244ms | 0  
新加坡 | 17个 | 0 | 250ms | 22% | 达拉斯 | 18个 | 0 | 273ms | 3%  
洛杉矶 | 18个 | 1个 | 228ms | 5% | 新泽西 | 17个 | 0 | 318ms | 3%  
西雅图 | 17个 | 0 | 259ms | 3% | 亚特兰大 | 17个 | 0 | 266ms | 5%  
均值 | 259个 | 2个 | 258ms | 6% | 阿姆斯特丹 | 18个 | 0 | 244ms | 0  
迈阿密 | 18个 | 0 | 258ms | 2% | 悉尼 | 17个 | 0 | 340ms | 26%  
法兰克福 | 17个 | 1个 | 236ms | 0 | 伦敦 | 17个 | 0 | 275ms | 1%  
...
安徽联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 7个 | 0 | 186ms | 10% | 芝加哥 | 7个 | 0 | 271ms | 12%  
硅谷 | 7个 | 0 | 194ms | 14% | 巴黎 | 7个 | 0 | 321ms | 4%  
新加坡 | 7个 | 1个 | 254ms | 12% | 达拉斯 | 7个 | 0 | 256ms | 8%  
洛杉矶 | 7个 | 0 | 226ms | 0 | 新泽西 | 7个 | 0 | 282ms | 10%  
西雅图 | 7个 | 1个 | 229ms | 14% | 亚特兰大 | 7个 | 0 | 269ms | 6%  
均值 | 105个 | 3个 | 265ms | 8% | 阿姆斯特丹 | 7个 | 0 | 333ms | 1%  
迈阿密 | 7个 | 1个 | 266ms | 17% | 悉尼 | 7个 | 0 | 319ms | 14%  
法兰克福 | 7个 | 0 | 315ms | 2% | 伦敦 | 7个 | 0 | 328ms | 4%  
...
安徽移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 128ms | 2% | 芝加哥 | 14个 | 0 | 270ms | 1%  
硅谷 | 14个 | 0 | 225ms | 10% | 巴黎 | 14个 | 0 | 288ms | 2%  
新加坡 | 14个 | 0 | 122ms | 2% | 达拉斯 | 14个 | 0 | 332ms | 33%  
洛杉矶 | 14个 | 0 | 217ms | 2% | 新泽西 | 14个 | 0 | 267ms | 2%  
西雅图 | 14个 | 0 | 269ms | 3% | 亚特兰大 | 14个 | 0 | 341ms | 30%  
均值 | 209个 | 0 | 267ms | 8% | 阿姆斯特丹 | 14个 | 0 | 341ms | 2%  
迈阿密 | 14个 | 0 | 283ms | 9% | 悉尼 | 14个 | 0 | 266ms | 3%  
法兰克福 | 14个 | 0 | 288ms | 2% | 伦敦 | 14个 | 0 | 359ms | 10%  
