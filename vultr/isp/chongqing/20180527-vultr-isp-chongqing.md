...
重庆全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 14个 | 1个 | 200ms | 14% | 迈阿密 | 15个 | 0 | 280ms | 13%  
硅谷 | 15个 | 1个 | 215ms | 11% | 芝加哥 | 14个 | 1个 | 289ms | 8%  
洛杉矶 | 14个 | 2个 | 237ms | 4% | 亚特兰大 | 15个 | 1个 | 292ms | 11%  
西雅图 | 13个 | 0 | 241ms | 7% | 巴黎 | 14个 | 2个 | 293ms | 6%  
新加坡 | 14个 | 1个 | 259ms | 17% | 新泽西 | 15个 | 1个 | 302ms | 9%  
均值 | 216个 | 13个 | 273ms | 9% | 阿姆斯特丹 | 15个 | 1个 | 307ms | 1%  
达拉斯 | 15个 | 0 | 277ms | 14% | 悉尼 | 13个 | 1个 | 326ms | 14%  
法兰克福 | 15个 | 1个 | 279ms | 4% | 伦敦 | 15个 | 0 | 334ms | 8%  
...
重庆电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 5个 | 1个 | 241ms | 17% | 迈阿密 | 6个 | 0 | 279ms | 8%  
硅谷 | 6个 | 1个 | 213ms | 3% | 芝加哥 | 5个 | 0 | 309ms | 3%  
洛杉矶 | 5个 | 1个 | 251ms | 8% | 亚特兰大 | 6个 | 0 | 309ms | 18%  
西雅图 | 4个 | 0 | 283ms | 5% | 巴黎 | 5个 | 1个 | 245ms | 0  
新加坡 | 5个 | 0 | 277ms | 12% | 新泽西 | 6个 | 1个 | 358ms | 9%  
均值 | 81个 | 8个 | 281ms | 8% | 阿姆斯特丹 | 6个 | 1个 | 244ms | 0  
达拉斯 | 6个 | 0 | 299ms | 19% | 悉尼 | 4个 | 1个 | 354ms | 18%  
法兰克福 | 6个 | 1个 | 247ms | 4% | 伦敦 | 6个 | 0 | 304ms | 4%  
...
重庆联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 5个 | 0 | 213ms | 20% | 迈阿密 | 5个 | 0 | 241ms | 21%  
硅谷 | 5个 | 0 | 219ms | 22% | 芝加哥 | 5个 | 1个 | 292ms | 13%  
洛杉矶 | 5个 | 1个 | 245ms | 2% | 亚特兰大 | 5个 | 1个 | 270ms | 0  
西雅图 | 5个 | 0 | 230ms | 15% | 巴黎 | 5个 | 1个 | 335ms | 13%  
新加坡 | 5个 | 1个 | 347ms | 33% | 新泽西 | 5个 | 0 | 265ms | 17%  
均值 | 75个 | 5个 | 276ms | 13% | 阿姆斯特丹 | 5个 | 0 | 359ms | 2%  
达拉斯 | 5个 | 0 | 233ms | 3% | 悉尼 | 5个 | 0 | 346ms | 21%  
法兰克福 | 5个 | 0 | 338ms | 7% | 伦敦 | 5个 | 0 | 330ms | 7%  
...
重庆移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 4个 | 0 | 145ms | 5% | 迈阿密 | 4个 | 0 | 321ms | 10%  
硅谷 | 4个 | 0 | 215ms | 9% | 芝加哥 | 4个 | 0 | 267ms | 8%  
洛杉矶 | 4个 | 0 | 216ms | 1% | 亚特兰大 | 4个 | 0 | 298ms | 15%  
西雅图 | 4个 | 0 | 208ms | 2% | 巴黎 | 4个 | 0 | 301ms | 6%  
新加坡 | 4个 | 0 | 155ms | 5% | 新泽西 | 4个 | 0 | 284ms | 1%  
均值 | 60个 | 0 | 262ms | 7% | 阿姆斯特丹 | 4个 | 0 | 319ms | 3%  
达拉斯 | 4个 | 0 | 301ms | 20% | 悉尼 | 4个 | 0 | 278ms | 4%  
法兰克福 | 4个 | 0 | 253ms | 1% | 伦敦 | 4个 | 0 | 369ms | 13%  
