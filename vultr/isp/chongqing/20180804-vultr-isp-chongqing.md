...
重庆全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 45个 | 0 | 178ms | 12% | 悉尼 | 41个 | 0 | 279ms | 8%  
新加坡 | 41个 | 0 | 210ms | 6% | 芝加哥 | 41个 | 3个 | 292ms | 13%  
洛杉矶 | 41个 | 3个 | 212ms | 2% | 阿姆斯特丹 | 41个 | 0 | 302ms | 5%  
西雅图 | 37个 | 0 | 220ms | 0 | 伦敦 | 45个 | 0 | 306ms | 2%  
硅谷 | 41个 | 0 | 242ms | 12% | 迈阿密 | 41个 | 0 | 308ms | 17%  
均值 | 623个 | 12个 | 263ms | 6% | 法兰克福 | 45个 | 0 | 312ms | 1%  
巴黎 | 41个 | 3个 | 273ms | 4% | 亚特兰大 | 41个 | 0 | 313ms | 1%  
达拉斯 | 41个 | 0 | 277ms | 0 | 新泽西 | 41个 | 3个 | 321ms | 6%  
...
重庆电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 19个 | 0 | 216ms | 28% | 悉尼 | 19个 | 0 | 371ms | 25%  
新加坡 | 19个 | 0 | 287ms | 20% | 芝加哥 | 19个 | 0 | 295ms | 1%  
洛杉矶 | 19个 | 3个 | 243ms | 6% | 阿姆斯特丹 | 19个 | 0 | 329ms | 4%  
西雅图 | 15个 | 0 | 271ms | 2% | 伦敦 | 19个 | 0 | 318ms | 4%  
硅谷 | 15个 | 0 | 266ms | 5% | 迈阿密 | 19个 | 0 | 357ms | 3%  
均值 | 269个 | 6个 | 296ms | 8% | 法兰克福 | 19个 | 0 | 255ms | 0  
巴黎 | 19个 | 0 | 257ms | 1% | 亚特兰大 | 19个 | 0 | 360ms | 3%  
达拉斯 | 15个 | 0 | 311ms | 0 | 新泽西 | 15个 | 3个 | 376ms | 18%  
...
重庆联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 14个 | 0 | 172ms | 0 | 悉尼 | 14个 | 0 | 270ms | 0  
新加坡 | 14个 | 0 | 226ms | 0 | 芝加哥 | 14个 | 3个 | 260ms | 17%  
洛杉矶 | 14个 | 0 | 191ms | 0 | 阿姆斯特丹 | 14个 | 0 | 309ms | 7%  
西雅图 | 14个 | 0 | 200ms | 0 | 伦敦 | 14个 | 0 | 302ms | 0  
硅谷 | 14个 | 0 | 217ms | 21% | 迈阿密 | 14个 | 0 | 274ms | 26%  
均值 | 210个 | 6个 | 236ms | 5% | 法兰克福 | 14个 | 0 | 352ms | 1%  
巴黎 | 14个 | 3个 | 282ms | 8% | 亚特兰大 | 14个 | 0 | 294ms | 0  
达拉斯 | 14个 | 0 | 230ms | 0 | 新泽西 | 14个 | 0 | 258ms | 0  
...
重庆移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 147ms | 7% | 悉尼 | 8个 | 0 | 198ms | 0  
新加坡 | 8个 | 0 | 116ms | 0 | 芝加哥 | 8个 | 0 | 323ms | 22%  
洛杉矶 | 8个 | 0 | 204ms | 0 | 阿姆斯特丹 | 8个 | 0 | 270ms | 3%  
西雅图 | 8个 | 0 | 190ms | 0 | 伦敦 | 12个 | 0 | 299ms | 2%  
硅谷 | 12个 | 0 | 242ms | 11% | 迈阿密 | 8个 | 0 | 294ms | 21%  
均值 | 144个 | 0 | 256ms | 5% | 法兰克福 | 12个 | 0 | 330ms | 3%  
巴黎 | 8个 | 0 | 280ms | 3% | 亚特兰大 | 8个 | 0 | 284ms | 1%  
达拉斯 | 12个 | 0 | 291ms | 2% | 新泽西 | 12个 | 0 | 329ms | 1%  
