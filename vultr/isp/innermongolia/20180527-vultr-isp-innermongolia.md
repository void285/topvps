...
内蒙古全部运营商到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 33个 | 0 | 185ms | 11% | 阿姆斯特丹 | 33个 | 0 | 281ms | 2%  
洛杉矶 | 33个 | 0 | 223ms | 2% | 芝加哥 | 33个 | 0 | 283ms | 9%  
硅谷 | 32个 | 0 | 225ms | 10% | 亚特兰大 | 33个 | 0 | 288ms | 13%  
西雅图 | 33个 | 0 | 243ms | 10% | 达拉斯 | 31个 | 0 | 297ms | 14%  
新加坡 | 32个 | 0 | 245ms | 15% | 伦敦 | 32个 | 0 | 298ms | 4%  
法兰克福 | 33个 | 0 | 269ms | 2% | 迈阿密 | 33个 | 0 | 304ms | 14%  
均值 | 491个 | 0 | 270ms | 8% | 新泽西 | 33个 | 0 | 307ms | 7%  
巴黎 | 34个 | 0 | 278ms | 5% | 悉尼 | 33个 | 0 | 324ms | 10%  
...
内蒙古电信到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 225ms | 14% | 阿姆斯特丹 | 12个 | 0 | 253ms | 3%  
洛杉矶 | 12个 | 0 | 257ms | 3% | 芝加哥 | 12个 | 0 | 316ms | 6%  
硅谷 | 11个 | 0 | 237ms | 6% | 亚特兰大 | 12个 | 0 | 279ms | 6%  
西雅图 | 12个 | 0 | 269ms | 5% | 达拉斯 | 10个 | 0 | 294ms | 5%  
新加坡 | 11个 | 0 | 292ms | 19% | 伦敦 | 11个 | 0 | 291ms | 0  
法兰克福 | 12个 | 0 | 261ms | 1% | 迈阿密 | 12个 | 0 | 304ms | 8%  
均值 | 175个 | 0 | 285ms | 7% | 新泽西 | 12个 | 0 | 348ms | 5%  
巴黎 | 12个 | 0 | 261ms | 2% | 悉尼 | 12个 | 0 | 384ms | 15%  
...
内蒙古联通到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 14个 | 0 | 195ms | 13% | 阿姆斯特丹 | 14个 | 0 | 257ms | 0  
洛杉矶 | 14个 | 0 | 190ms | 0 | 芝加哥 | 14个 | 0 | 250ms | 15%  
硅谷 | 14个 | 0 | 210ms | 18% | 亚特兰大 | 14个 | 0 | 234ms | 3%  
西雅图 | 14个 | 0 | 219ms | 16% | 达拉斯 | 14个 | 0 | 241ms | 6%  
新加坡 | 14个 | 0 | 316ms | 25% | 伦敦 | 14个 | 0 | 270ms | 1%  
法兰克福 | 14个 | 0 | 257ms | 0 | 迈阿密 | 14个 | 0 | 255ms | 17%  
均值 | 210个 | 0 | 252ms | 10% | 新泽西 | 14个 | 0 | 278ms | 14%  
巴黎 | 14个 | 0 | 295ms | 8% | 悉尼 | 14个 | 0 | 312ms | 14%  
...
内蒙古移动到Vultr各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 7个 | 0 | 135ms | 6% | 阿姆斯特丹 | 7个 | 0 | 331ms | 2%  
洛杉矶 | 7个 | 0 | 222ms | 2% | 芝加哥 | 7个 | 0 | 283ms | 7%  
硅谷 | 7个 | 0 | 228ms | 6% | 亚特兰大 | 7个 | 0 | 351ms | 30%  
西雅图 | 7个 | 0 | 241ms | 8% | 达拉斯 | 7个 | 0 | 356ms | 30%  
新加坡 | 7个 | 0 | 128ms | 2% | 伦敦 | 7个 | 0 | 334ms | 11%  
法兰克福 | 7个 | 0 | 288ms | 4% | 迈阿密 | 7个 | 0 | 353ms | 17%  
均值 | 106个 | 0 | 273ms | 9% | 新泽西 | 7个 | 0 | 294ms | 1%  
巴黎 | 8个 | 0 | 278ms | 5% | 悉尼 | 7个 | 0 | 275ms | 2%  
