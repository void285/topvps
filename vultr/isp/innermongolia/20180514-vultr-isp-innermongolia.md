...
内蒙古全部运营商到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 33个 | 0 | 163ms | 14% | 阿姆斯特丹 | 34个 | 0 | 271ms | 2%  
洛杉矶 | 34个 | 0 | 220ms | 11% | 芝加哥 | 33个 | 0 | 288ms | 8%  
新加坡 | 33个 | 0 | 227ms | 10% | 巴黎 | 33个 | 0 | 288ms | 3%  
西雅图 | 36个 | 0 | 240ms | 9% | 伦敦 | 34个 | 0 | 292ms | 5%  
悉尼 | 32个 | 0 | 245ms | 3% | 达拉斯 | 32个 | 0 | 293ms | 15%  
硅谷 | 34个 | 0 | 251ms | 11% | 迈阿密 | 36个 | 0 | 311ms | 9%  
均值 | 504个 | 0 | 267ms | 8% | 亚特兰大 | 34个 | 0 | 317ms | 14%  
法兰克福 | 30个 | 0 | 269ms | 2% | 新泽西 | 36个 | 0 | 324ms | 3%  
  
简评：本表展示了内蒙古的 **电信、联通、移动** 线路到Vultr各机房的平均测速数据，这些数据绘制在前面柱状图的 **绿色** 柱位上；如果你常驻内蒙古，可从此表了解你常用的网络到Vultr各个机房的平均响应速度以及丢包率。从表中数据可以看到， **悉尼** 的响应速度小于250ms，且丢包率在5%以内，值得关注；如果你多数时间只使用某运营商的网络，后面的分运营商的表格数据对你更有参考价值。

### 电信

内蒙古电信到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 182ms | 18% | 阿姆斯特丹 | 11个 | 0 | 264ms | 1%  
洛杉矶 | 12个 | 0 | 215ms | 5% | 芝加哥 | 10个 | 0 | 298ms | 3%  
新加坡 | 9个 | 0 | 248ms | 10% | 巴黎 | 10个 | 0 | 281ms | 1%  
西雅图 | 12个 | 0 | 238ms | 4% | 伦敦 | 10个 | 0 | 307ms | 7%  
悉尼 | 10个 | 0 | 253ms | 2% | 达拉斯 | 11个 | 0 | 264ms | 8%  
硅谷 | 10个 | 0 | 257ms | 2% | 迈阿密 | 12个 | 0 | 301ms | 7%  
均值 | 160个 | 0 | 268ms | 6% | 亚特兰大 | 12个 | 0 | 308ms | 10%  
法兰克福 | 9个 | 0 | 269ms | 2% | 新泽西 | 12个 | 0 | 324ms | 7%  
  
简评：如果你是来自内蒙古的 **电信** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **洛杉矶、西雅图** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **东京、新加坡** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_1)吧！

### 联通

内蒙古联通到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 181ms | 22% | 阿姆斯特丹 | 12个 | 0 | 283ms | 4%  
洛杉矶 | 12个 | 0 | 204ms | 6% | 芝加哥 | 13个 | 0 | 263ms | 8%  
新加坡 | 13个 | 0 | 311ms | 19% | 巴黎 | 13个 | 0 | 325ms | 9%  
西雅图 | 13个 | 0 | 220ms | 4% | 伦敦 | 13个 | 0 | 275ms | 8%  
悉尼 | 13个 | 0 | 236ms | 7% | 达拉斯 | 11个 | 0 | 253ms | 10%  
硅谷 | 13个 | 0 | 203ms | 5% | 迈阿密 | 13个 | 0 | 305ms | 8%  
均值 | 189个 | 0 | 258ms | 8% | 亚特兰大 | 11个 | 0 | 242ms | 5%  
法兰克福 | 13个 | 0 | 284ms | 5% | 新泽西 | 13个 | 0 | 285ms | 2%  
  
简评：如果你是来自内蒙古的 **联通** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **硅谷、西雅图、亚特兰大** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **东京、洛杉矶、悉尼** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_2)吧！

### 移动

内蒙古移动到Vultr各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 125ms | 2% | 阿姆斯特丹 | 11个 | 0 | 268ms | 0  
洛杉矶 | 10个 | 0 | 241ms | 20% | 芝加哥 | 10个 | 0 | 304ms | 13%  
新加坡 | 11个 | 0 | 124ms | 2% | 巴黎 | 10个 | 0 | 257ms | 0  
西雅图 | 11个 | 0 | 263ms | 21% | 伦敦 | 11个 | 0 | 295ms | 0  
悉尼 | 9个 | 0 | 246ms | 0 | 达拉斯 | 10个 | 0 | 362ms | 25%  
硅谷 | 11个 | 0 | 292ms | 27% | 迈阿密 | 11个 | 0 | 329ms | 13%  
均值 | 155个 | 0 | 276ms | 10% | 亚特兰大 | 11个 | 0 | 402ms | 26%  
法兰克福 | 8个 | 0 | 254ms | 0 | 新泽西 | 11个 | 0 | 362ms | 0  
  
简评：如果你是来自内蒙古的 **移动** 用户，想运行Vultr的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **新加坡、东京、悉尼** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **洛杉矶** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/vultr/_3)吧！
