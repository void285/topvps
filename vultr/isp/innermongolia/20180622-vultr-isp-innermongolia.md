...
内蒙古全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 34个 | 0 | 204ms | 13% | 巴黎 | 27个 | 0 | 276ms | 0  
硅谷 | 32个 | 0 | 218ms | 1% | 伦敦 | 34个 | 0 | 282ms | 13%  
洛杉矶 | 28个 | 0 | 228ms | 2% | 芝加哥 | 34个 | 1个 | 289ms | 20%  
西雅图 | 34个 | 0 | 238ms | 3% | 亚特兰大 | 33个 | 1个 | 292ms | 22%  
法兰克福 | 32个 | 0 | 243ms | 1% | 阿姆斯特丹 | 27个 | 1个 | 293ms | 1%  
达拉斯 | 33个 | 0 | 255ms | 0 | 新泽西 | 33个 | 0 | 301ms | 2%  
新加坡 | 28个 | 0 | 255ms | 9% | 悉尼 | 28个 | 0 | 309ms | 8%  
均值 | 471个 | 3个 | 268ms | 8% | 迈阿密 | 34个 | 0 | 324ms | 16%  
...
内蒙古电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 241ms | 24% | 巴黎 | 11个 | 0 | 268ms | 1%  
硅谷 | 12个 | 0 | 221ms | 1% | 伦敦 | 12个 | 0 | 277ms | 9%  
洛杉矶 | 12个 | 0 | 251ms | 4% | 芝加哥 | 12个 | 1个 | 295ms | 12%  
西雅图 | 11个 | 0 | 240ms | 2% | 亚特兰大 | 12个 | 1个 | 293ms | 14%  
法兰克福 | 12个 | 0 | 235ms | 0 | 阿姆斯特丹 | 11个 | 1个 | 333ms | 3%  
达拉斯 | 10个 | 0 | 263ms | 0 | 新泽西 | 11个 | 0 | 310ms | 0  
新加坡 | 12个 | 0 | 298ms | 14% | 悉尼 | 12个 | 0 | 373ms | 14%  
均值 | 174个 | 3个 | 282ms | 7% | 迈阿密 | 12个 | 0 | 333ms | 11%  
...
内蒙古联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 213ms | 11% | 巴黎 | 11个 | 0 | 263ms | 0  
硅谷 | 12个 | 0 | 209ms | 1% | 伦敦 | 12个 | 0 | 287ms | 26%  
洛杉矶 | 11个 | 0 | 211ms | 0 | 芝加哥 | 12个 | 0 | 289ms | 39%  
西雅图 | 12个 | 0 | 219ms | 0 | 亚特兰大 | 12个 | 0 | 290ms | 38%  
法兰克福 | 12个 | 0 | 244ms | 4% | 阿姆斯特丹 | 11个 | 0 | 271ms | 1%  
达拉斯 | 12个 | 0 | 233ms | 0 | 新泽西 | 12个 | 0 | 295ms | 3%  
新加坡 | 11个 | 0 | 313ms | 8% | 悉尼 | 11个 | 0 | 332ms | 4%  
均值 | 175个 | 0 | 266ms | 12% | 迈阿密 | 12个 | 0 | 323ms | 36%  
...
内蒙古移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 158ms | 4% | 巴黎 | 5个 | 0 | 299ms | 0  
硅谷 | 8个 | 0 | 224ms | 0 | 伦敦 | 10个 | 0 | 282ms | 4%  
洛杉矶 | 5个 | 0 | 223ms | 2% | 芝加哥 | 10个 | 0 | 281ms | 8%  
西雅图 | 11个 | 0 | 257ms | 7% | 亚特兰大 | 9个 | 0 | 295ms | 15%  
法兰克福 | 8个 | 0 | 249ms | 0 | 阿姆斯特丹 | 5个 | 0 | 274ms | 0  
达拉斯 | 11个 | 0 | 269ms | 1% | 新泽西 | 10个 | 0 | 300ms | 4%  
新加坡 | 5个 | 0 | 156ms | 4% | 悉尼 | 5个 | 0 | 222ms | 6%  
均值 | 122个 | 0 | 258ms | 4% | 迈阿密 | 10个 | 0 | 317ms | 2%  
