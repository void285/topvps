...
黑龙江全部运营商到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 30个 | 0 | 161ms | 15% | 芝加哥 | 29个 | 1个 | 278ms | 1%  
洛杉矶 | 29个 | 0 | 208ms | 2% | 迈阿密 | 29个 | 0 | 281ms | 0  
硅谷 | 29个 | 0 | 228ms | 2% | 新泽西 | 30个 | 0 | 289ms | 0  
悉尼 | 29个 | 1个 | 230ms | 2% | 亚特兰大 | 29个 | 0 | 289ms | 2%  
新加坡 | 34个 | 1个 | 231ms | 3% | 巴黎 | 34个 | 0 | 310ms | 1%  
西雅图 | 29个 | 0 | 252ms | 3% | 法兰克福 | 34个 | 0 | 314ms | 1%  
达拉斯 | 29个 | 0 | 268ms | 3% | 阿姆斯特丹 | 34个 | 0 | 327ms | 1%  
均值 | 462个 | 3个 | 268ms | 2% | 伦敦 | 34个 | 0 | 339ms | 1%  
...
黑龙江电信到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 186ms | 16% | 芝加哥 | 9个 | 1个 | 288ms | 3%  
洛杉矶 | 9个 | 0 | 225ms | 5% | 迈阿密 | 9个 | 0 | 283ms | 1%  
硅谷 | 9个 | 0 | 240ms | 2% | 新泽西 | 9个 | 0 | 305ms | 1%  
悉尼 | 9个 | 1个 | 253ms | 3% | 亚特兰大 | 9个 | 0 | 299ms | 1%  
新加坡 | 11个 | 1个 | 228ms | 7% | 巴黎 | 11个 | 0 | 313ms | 0  
西雅图 | 9个 | 0 | 278ms | 6% | 法兰克福 | 11个 | 0 | 297ms | 0  
达拉斯 | 9个 | 0 | 277ms | 4% | 阿姆斯特丹 | 11个 | 0 | 298ms | 0  
均值 | 145个 | 3个 | 275ms | 3% | 伦敦 | 11个 | 0 | 330ms | 0  
...
黑龙江联通到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 138ms | 20% | 芝加哥 | 11个 | 0 | 250ms | 0  
洛杉矶 | 11个 | 0 | 181ms | 0 | 迈阿密 | 11个 | 0 | 262ms | 0  
硅谷 | 11个 | 0 | 200ms | 1% | 新泽西 | 11个 | 0 | 272ms | 0  
悉尼 | 11个 | 0 | 209ms | 0 | 亚特兰大 | 11个 | 0 | 242ms | 0  
新加坡 | 11个 | 0 | 266ms | 1% | 巴黎 | 11个 | 0 | 349ms | 1%  
西雅图 | 11个 | 0 | 218ms | 0 | 法兰克福 | 11个 | 0 | 353ms | 1%  
达拉斯 | 11个 | 0 | 223ms | 0 | 阿姆斯特丹 | 11个 | 0 | 351ms | 1%  
均值 | 165个 | 0 | 258ms | 2% | 伦敦 | 11个 | 0 | 349ms | 2%  
...
黑龙江移动到Vultr各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 159ms | 10% | 芝加哥 | 9个 | 0 | 296ms | 1%  
洛杉矶 | 9个 | 0 | 219ms | 0 | 迈阿密 | 9个 | 0 | 298ms | 1%  
硅谷 | 9个 | 0 | 244ms | 3% | 新泽西 | 10个 | 0 | 289ms | 0  
悉尼 | 9个 | 0 | 230ms | 2% | 亚特兰大 | 9个 | 0 | 325ms | 5%  
新加坡 | 12个 | 0 | 199ms | 2% | 巴黎 | 12个 | 0 | 270ms | 1%  
西雅图 | 9个 | 0 | 260ms | 2% | 法兰克福 | 12个 | 0 | 290ms | 1%  
达拉斯 | 9个 | 0 | 305ms | 6% | 阿姆斯特丹 | 12个 | 0 | 332ms | 1%  
均值 | 152个 | 0 | 271ms | 2% | 伦敦 | 12个 | 0 | 337ms | 2%  
