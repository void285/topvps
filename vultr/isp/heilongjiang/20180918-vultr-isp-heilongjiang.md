...
黑龙江全部运营商到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 54个 | 0 | 126ms | 0 | 亚特兰大 | 54个 | 0 | 271ms | 9%  
新加坡 | 58个 | 0 | 186ms | 3% | 悉尼 | 53个 | 0 | 272ms | 2%  
洛杉矶 | 56个 | 0 | 210ms | 3% | 迈阿密 | 53个 | 0 | 289ms | 1%  
硅谷 | 55个 | 0 | 220ms | 2% | 法兰克福 | 53个 | 0 | 300ms | 3%  
西雅图 | 55个 | 0 | 240ms | 3% | 巴黎 | 56个 | 0 | 301ms | 4%  
达拉斯 | 53个 | 0 | 254ms | 5% | 新泽西 | 56个 | 0 | 304ms | 7%  
均值 | 819个 | 0 | 259ms | 4% | 伦敦 | 52个 | 0 | 321ms | 8%  
芝加哥 | 54个 | 0 | 263ms | 0 | 阿姆斯特丹 | 57个 | 0 | 329ms | 13%  
...
黑龙江电信到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 14个 | 0 | 139ms | 1% | 亚特兰大 | 14个 | 0 | 303ms | 17%  
新加坡 | 15个 | 0 | 186ms | 4% | 悉尼 | 15个 | 0 | 279ms | 0  
洛杉矶 | 14个 | 0 | 230ms | 5% | 迈阿密 | 13个 | 0 | 305ms | 1%  
硅谷 | 14个 | 0 | 228ms | 1% | 法兰克福 | 12个 | 0 | 232ms | 2%  
西雅图 | 14个 | 0 | 252ms | 7% | 巴黎 | 14个 | 0 | 243ms | 2%  
达拉斯 | 14个 | 0 | 273ms | 4% | 新泽西 | 14个 | 0 | 283ms | 1%  
均值 | 208个 | 0 | 251ms | 3% | 伦敦 | 13个 | 0 | 255ms | 0  
芝加哥 | 14个 | 0 | 268ms | 0 | 阿姆斯特丹 | 14个 | 0 | 294ms | 4%  
...
黑龙江联通到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 20个 | 0 | 119ms | 0 | 亚特兰大 | 20个 | 0 | 244ms | 2%  
新加坡 | 21个 | 0 | 189ms | 1% | 悉尼 | 20个 | 0 | 294ms | 2%  
洛杉矶 | 20个 | 0 | 197ms | 1% | 迈阿密 | 20个 | 0 | 266ms | 1%  
硅谷 | 20个 | 0 | 203ms | 2% | 法兰克福 | 20个 | 0 | 341ms | 4%  
西雅图 | 19个 | 0 | 231ms | 3% | 巴黎 | 21个 | 0 | 363ms | 4%  
达拉斯 | 20个 | 0 | 236ms | 6% | 新泽西 | 20个 | 0 | 320ms | 11%  
均值 | 302个 | 0 | 267ms | 5% | 伦敦 | 20个 | 0 | 377ms | 15%  
芝加哥 | 20个 | 0 | 253ms | 1% | 阿姆斯特丹 | 21个 | 0 | 358ms | 17%  
...
黑龙江移动到Vultr各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 20个 | 0 | 119ms | 0 | 亚特兰大 | 20个 | 0 | 265ms | 9%  
新加坡 | 22个 | 0 | 184ms | 4% | 悉尼 | 18个 | 0 | 243ms | 5%  
洛杉矶 | 22个 | 0 | 204ms | 5% | 迈阿密 | 20个 | 0 | 296ms | 0  
硅谷 | 21个 | 0 | 227ms | 2% | 法兰克福 | 21个 | 0 | 328ms | 4%  
西雅图 | 22个 | 0 | 235ms | 1% | 巴黎 | 21个 | 0 | 296ms | 6%  
达拉斯 | 19个 | 0 | 253ms | 6% | 新泽西 | 22个 | 0 | 307ms | 8%  
均值 | 309个 | 0 | 259ms | 5% | 伦敦 | 19个 | 0 | 330ms | 9%  
芝加哥 | 20个 | 0 | 268ms | 0 | 阿姆斯特丹 | 22个 | 0 | 335ms | 18%  
