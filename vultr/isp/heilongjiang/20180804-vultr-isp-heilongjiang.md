...
黑龙江全部运营商到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 180个 | 0 | 210ms | 15% | 法兰克福 | 160个 | 0 | 296ms | 3%  
洛杉矶 | 112个 | 0 | 233ms | 3% | 巴黎 | 100个 | 0 | 301ms | 3%  
硅谷 | 192个 | 0 | 248ms | 15% | 新泽西 | 184个 | 0 | 309ms | 4%  
西雅图 | 112个 | 0 | 251ms | 21% | 伦敦 | 184个 | 0 | 310ms | 2%  
达拉斯 | 172个 | 0 | 264ms | 5% | 亚特兰大 | 112个 | 0 | 313ms | 4%  
芝加哥 | 112个 | 0 | 277ms | 9% | 悉尼 | 116个 | 0 | 313ms | 13%  
新加坡 | 84个 | 0 | 278ms | 18% | 迈阿密 | 112个 | 0 | 315ms | 12%  
均值 | 2044个 | 0 | 281ms | 9% | 阿姆斯特丹 | 112个 | 0 | 332ms | 6%  
...
黑龙江电信到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 44个 | 0 | 212ms | 22% | 法兰克福 | 36个 | 0 | 241ms | 1%  
洛杉矶 | 28个 | 0 | 262ms | 5% | 巴黎 | 28个 | 0 | 277ms | 3%  
硅谷 | 44个 | 0 | 256ms | 16% | 新泽西 | 44个 | 0 | 329ms | 5%  
西雅图 | 28个 | 0 | 258ms | 17% | 伦敦 | 44个 | 0 | 315ms | 4%  
达拉斯 | 44个 | 0 | 283ms | 11% | 亚特兰大 | 28个 | 0 | 314ms | 2%  
芝加哥 | 28个 | 0 | 297ms | 7% | 悉尼 | 28个 | 0 | 320ms | 17%  
新加坡 | 24个 | 0 | 277ms | 29% | 迈阿密 | 28个 | 0 | 347ms | 12%  
均值 | 504个 | 0 | 285ms | 11% | 阿姆斯特丹 | 28个 | 0 | 320ms | 11%  
...
黑龙江联通到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 64个 | 0 | 232ms | 13% | 法兰克福 | 56个 | 0 | 345ms | 4%  
洛杉矶 | 40个 | 0 | 221ms | 2% | 巴黎 | 36个 | 0 | 330ms | 2%  
硅谷 | 68个 | 0 | 236ms | 10% | 新泽西 | 68个 | 0 | 299ms | 3%  
西雅图 | 40个 | 0 | 244ms | 21% | 伦敦 | 60个 | 0 | 316ms | 0  
达拉斯 | 60个 | 0 | 249ms | 3% | 亚特兰大 | 40个 | 0 | 310ms | 4%  
芝加哥 | 40个 | 0 | 261ms | 9% | 悉尼 | 40个 | 0 | 337ms | 19%  
新加坡 | 32个 | 0 | 315ms | 17% | 迈阿密 | 40个 | 0 | 296ms | 12%  
均值 | 724个 | 0 | 285ms | 8% | 阿姆斯特丹 | 40个 | 0 | 342ms | 3%  
...
黑龙江移动到Vultr各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 72个 | 0 | 187ms | 10% | 法兰克福 | 68个 | 0 | 304ms | 3%  
洛杉矶 | 44个 | 0 | 218ms | 1% | 巴黎 | 36个 | 0 | 297ms | 4%  
硅谷 | 80个 | 0 | 252ms | 19% | 新泽西 | 72个 | 0 | 298ms | 3%  
西雅图 | 44个 | 0 | 250ms | 26% | 伦敦 | 80个 | 0 | 299ms | 0  
达拉斯 | 68个 | 0 | 261ms | 1% | 亚特兰大 | 44个 | 0 | 314ms | 6%  
芝加哥 | 44个 | 0 | 275ms | 10% | 悉尼 | 48个 | 0 | 281ms | 4%  
新加坡 | 28个 | 0 | 242ms | 10% | 迈阿密 | 44个 | 0 | 301ms | 13%  
均值 | 816个 | 0 | 273ms | 7% | 阿姆斯特丹 | 44个 | 0 | 333ms | 5%  
