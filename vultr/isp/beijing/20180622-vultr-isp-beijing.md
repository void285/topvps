...
北京全部运营商到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 167ms | 16% | 芝加哥 | 9个 | 0 | 263ms | 8%  
硅谷 | 9个 | 0 | 188ms | 0 | 巴黎 | 10个 | 0 | 269ms | 5%  
西雅图 | 10个 | 0 | 210ms | 2% | 均值 | 146个 | 1个 | 270ms | 7%  
达拉斯 | 9个 | 0 | 226ms | 3% | 迈阿密 | 10个 | 0 | 287ms | 7%  
洛杉矶 | 10个 | 0 | 232ms | 3% | 新泽西 | 10个 | 0 | 293ms | 4%  
法兰克福 | 10个 | 1个 | 251ms | 0 | 悉尼 | 11个 | 0 | 296ms | 12%  
亚特兰大 | 10个 | 0 | 253ms | 9% | 伦敦 | 9个 | 0 | 320ms | 6%  
新加坡 | 10个 | 0 | 258ms | 13% | 阿姆斯特丹 | 10个 | 0 | 360ms | 6%  
...
北京电信到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 5个 | 0 | 173ms | 29% | 芝加哥 | 5个 | 0 | 253ms | 0  
硅谷 | 5个 | 0 | 201ms | 0 | 巴黎 | 5个 | 0 | 225ms | 0  
西雅图 | 6个 | 0 | 251ms | 3% | 均值 | 79个 | 1个 | 253ms | 7%  
达拉斯 | 5个 | 0 | 252ms | 6% | 迈阿密 | 6个 | 0 | 287ms | 0  
洛杉矶 | 5个 | 0 | 243ms | 7% | 新泽西 | 5个 | 0 | 317ms | 10%  
法兰克福 | 6个 | 1个 | 223ms | 0 | 悉尼 | 6个 | 0 | 289ms | 22%  
亚特兰大 | 5个 | 0 | 255ms | 10% | 伦敦 | 5个 | 0 | 307ms | 0  
新加坡 | 5个 | 0 | 241ms | 16% | 阿姆斯特丹 | 5个 | 0 | 304ms | 0  
...
北京联通到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 4个 | 0 | 162ms | 4% | 芝加哥 | 4个 | 0 | 273ms | 17%  
硅谷 | 4个 | 0 | 175ms | 0 | 巴黎 | 4个 | 0 | 273ms | 0  
西雅图 | 4个 | 0 | 169ms | 2% | 均值 | 60个 | 0 | 248ms | 5%  
达拉斯 | 4个 | 0 | 200ms | 0 | 迈阿密 | 4个 | 0 | 288ms | 15%  
洛杉矶 | 4个 | 0 | 183ms | 0 | 新泽西 | 4个 | 0 | 296ms | 2%  
法兰克福 | 4个 | 0 | 279ms | 0 | 悉尼 | 4个 | 0 | 274ms | 8%  
亚特兰大 | 4个 | 0 | 257ms | 16% | 伦敦 | 4个 | 0 | 333ms | 12%  
新加坡 | 4个 | 0 | 229ms | 6% | 阿姆斯特丹 | 4个 | 0 | 326ms | 1%  
...
北京移动到Vultr各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | - | - | - | - | 芝加哥 | - | - | - | -  
硅谷 | - | - | - | - | 巴黎 | 1个 | 0 | 310ms | 17%  
西雅图 | - | - | - | - | 均值 | 7个 | 0 | 310ms | 8%  
达拉斯 | - | - | - | - | 迈阿密 | - | - | - | -  
洛杉矶 | 1个 | 0 | 270ms | 4% | 新泽西 | 1个 | 0 | 267ms | 0  
法兰克福 | - | - | - | - | 悉尼 | 1个 | 0 | 326ms | 6%  
亚特兰大 | 1个 | 0 | 247ms | 0 | 伦敦 | - | - | - | -  
新加坡 | 1个 | 0 | 304ms | 17% | 阿姆斯特丹 | 1个 | 0 | 451ms | 16%  
