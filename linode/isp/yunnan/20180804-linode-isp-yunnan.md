...
云南全部运营商到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 126个 | 0 | 245ms | 25% | 纽瓦克 | 130个 | 2个 | 299ms | 4%  
达拉斯 | 135个 | 0 | 265ms | 5% | 伦敦 | 131个 | 0 | 308ms | 14%  
佛利蒙 | 135个 | 0 | 281ms | 8% | 新加坡 | 131个 | 3个 | 323ms | 17%  
均值 | 1046个 | 5个 | 294ms | 11% | 法兰克福 | 131个 | 0 | 337ms | 9%  
亚特兰大 | 127个 | 0 | 296ms | 9% |  |  |  |  |   
...
云南电信到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 62个 | 0 | 256ms | 32% | 纽瓦克 | 58个 | 2个 | 273ms | 0  
达拉斯 | 63个 | 0 | 265ms | 8% | 伦敦 | 59个 | 0 | 284ms | 7%  
佛利蒙 | 63个 | 0 | 211ms | 10% | 新加坡 | 59个 | 3个 | 323ms | 22%  
均值 | 486个 | 5个 | 275ms | 13% | 法兰克福 | 59个 | 0 | 300ms | 8%  
亚特兰大 | 63个 | 0 | 298ms | 13% |  |  |  |  |   
...
云南联通到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 8个 | 0 | 367ms | 42% | 纽瓦克 | 8个 | 0 | 342ms | 13%  
达拉斯 | 8个 | 0 | 252ms | 1% | 伦敦 | 8个 | 0 | 326ms | 10%  
佛利蒙 | 8个 | 0 | 419ms | 13% | 新加坡 | 8个 | 0 | 473ms | 21%  
均值 | 64个 | 0 | 365ms | 16% | 法兰克福 | 8个 | 0 | 428ms | 16%  
亚特兰大 | 8个 | 0 | 312ms | 15% |  |  |  |  |   
...
云南移动到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 56个 | 0 | 112ms | 2% | 纽瓦克 | 64个 | 0 | 282ms | 0  
达拉斯 | 64个 | 0 | 279ms | 4% | 伦敦 | 64个 | 0 | 316ms | 23%  
佛利蒙 | 64个 | 0 | 214ms | 0 | 新加坡 | 64个 | 0 | 174ms | 10%  
均值 | 496个 | 0 | 244ms | 6% | 法兰克福 | 64个 | 0 | 283ms | 5%  
亚特兰大 | 56个 | 0 | 279ms | 0 |  |  |  |  |   
