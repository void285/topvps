...
**江苏全部运营商到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
佛利蒙 | 351个 | 12个 | 192ms | 9%  
东京 | 328个 | 14个 | 203ms | 26%  
达拉斯 | 337个 | 6个 | 245ms | 3%  
均值 | 2698个 | 94个 | 250ms | 9%  
新加坡 | 331个 | 18个 | 256ms | 23%  
伦敦 | 339个 | 0 | 260ms | 0  
纽瓦克 | 340个 | 8个 | 275ms | 3%  
亚特兰大 | 337个 | 6个 | 277ms | 5%  
法兰克福 | 335个 | 30个 | 297ms | 5%  
...
**江苏电信到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
佛利蒙 | 162个 | 12个 | 166ms | 5%  
东京 | 152个 | 12个 | 227ms | 49%  
达拉斯 | 152个 | 6个 | 230ms | 1%  
均值 | 1230个 | 81个 | 248ms | 14%  
新加坡 | 154个 | 15个 | 293ms | 36%  
伦敦 | 149个 | 0 | 244ms | 0  
纽瓦克 | 148个 | 6个 | 280ms | 4%  
亚特兰大 | 155个 | 6个 | 267ms | 5%  
法兰克福 | 158个 | 24个 | 291ms | 9%  
