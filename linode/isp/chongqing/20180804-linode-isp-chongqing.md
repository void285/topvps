#  重庆到Linode各机房的测速数据（20180804） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![重庆到Linode各机房的测速数据（20180804）](/images/thumbnails/Chongqing_to_linode.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点275个，其中超时点8个。连通概况如下：大陆线路响应均值为244毫秒，最快的三个机房所在地为佛利蒙、东京、新加坡，最慢的三个为纽瓦克、亚特兰大、伦敦；佛利蒙、伦敦、东京有响应超时情况；东京、新加坡、伦敦丢包率较高。

[注册 Linode](https://vps123.top/go/linode/_btn1)

## 重庆图表数据

![大陆省份重庆到VPS提供商Linode各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180804](/images/pingtests/linode_20180804/plot_isp_chongqing_linode_20180804.png)

### 全部运营商

重庆全部运营商到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 37个 | 3个 | 192ms | 2% | 达拉斯 | 37个 | 0 | 267ms | 2%  
东京 | 34个 | 2个 | 216ms | 19% | 纽瓦克 | 34个 | 0 | 273ms | 1%  
新加坡 | 34个 | 0 | 242ms | 14% | 亚特兰大 | 31个 | 0 | 281ms | 2%  
均值 | 275个 | 8个 | 244ms | 7% | 伦敦 | 31个 | 3个 | 297ms | 12%  
法兰克福 | 37个 | 0 | 266ms | 1% |  |  |  |  |   
...
重庆电信到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 15个 | 0 | 189ms | 6% | 达拉斯 | 15个 | 0 | 245ms | 7%  
东京 | 14个 | 2个 | 246ms | 26% | 纽瓦克 | 14个 | 0 | 291ms | 3%  
新加坡 | 11个 | 0 | 343ms | 14% | 亚特兰大 | 12个 | 0 | 314ms | 7%  
均值 | 108个 | 2个 | 263ms | 8% | 伦敦 | 12个 | 0 | 244ms | 1%  
法兰克福 | 15个 | 0 | 287ms | 5% |  |  |  |  |   
  
简评：如果你是来自重庆的 **电信** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **伦敦** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **佛利蒙、达拉斯、东京** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_1)吧！

### 联通

重庆联通到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 14个 | 3个 | 206ms | 0 | 达拉斯 | 14个 | 0 | 306ms | 0  
东京 | 12个 | 0 | 152ms | 0 | 纽瓦克 | 12个 | 0 | 270ms | 0  
新加坡 | 11个 | 0 | 183ms | 4% | 亚特兰大 | 11个 | 0 | 270ms | 0  
均值 | 99个 | 6个 | 230ms | 3% | 伦敦 | 11个 | 3个 | 350ms | 22%  
法兰克福 | 14个 | 0 | 275ms | 0 |  |  |  |  |   
  
简评：如果你是来自重庆的 **联通** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、新加坡、佛利蒙** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_2)吧！

### 移动

重庆移动到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 8个 | 0 | 180ms | 0 | 达拉斯 | 8个 | 0 | 252ms | 0  
东京 | 8个 | 0 | 251ms | 33% | 纽瓦克 | 8个 | 0 | 259ms | 0  
新加坡 | 12个 | 0 | 199ms | 25% | 亚特兰大 | 8个 | 0 | 260ms | 0  
均值 | 68个 | 0 | 239ms | 10% | 伦敦 | 8个 | 0 | 298ms | 13%  
法兰克福 | 8个 | 0 | 236ms | 0 |  |  |  |  |   
  
简评：如果你是来自重庆的 **移动** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **佛利蒙、法兰克福** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **新加坡** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_3)吧！
...
本文最初发表于[重庆到Linode各机房的测速数据（20180804）](https://vps123.top/pingtest/20180804-linode-isp-chongqing.html)
