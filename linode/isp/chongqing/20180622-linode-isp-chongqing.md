...
重庆全部运营商到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 13个 | 0 | 192ms | 0 | 伦敦 | 13个 | 1个 | 280ms | 1%  
东京 | 12个 | 1个 | 212ms | 11% | 纽瓦克 | 13个 | 0 | 286ms | 5%  
达拉斯 | 12个 | 0 | 259ms | 0 | 新加坡 | 13个 | 1个 | 329ms | 16%  
亚特兰大 | 13个 | 1个 | 272ms | 4% | 法兰克福 | 12个 | 1个 | 418ms | 8%  
均值 | 101个 | 5个 | 278ms | 5% |  |  |  |  |   
...
重庆电信到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 6个 | 0 | 194ms | 2% | 伦敦 | 6个 | 1个 | 242ms | 1%  
东京 | 5个 | 1个 | 241ms | 24% | 纽瓦克 | 6个 | 0 | 307ms | 6%  
达拉斯 | 5个 | 0 | 238ms | 0 | 新加坡 | 6个 | 1个 | 353ms | 24%  
亚特兰大 | 6个 | 1个 | 271ms | 7% | 法兰克福 | 6个 | 1个 | 235ms | 0  
均值 | 46个 | 5个 | 259ms | 7% |  |  |  |  |   
...
重庆联通到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 4个 | 0 | 196ms | 0 | 伦敦 | 4个 | 0 | 325ms | 0  
东京 | 4个 | 0 | 196ms | 2% | 纽瓦克 | 4个 | 0 | 258ms | 1%  
达拉斯 | 4个 | 0 | 300ms | 0 | 新加坡 | 4个 | 0 | 289ms | 9%  
亚特兰大 | 4个 | 0 | 246ms | 0 | 法兰克福 | 3个 | 0 | 336ms | 1%  
均值 | 31个 | 0 | 261ms | 1% |  |  |  |  |   
  
简评：如果你是来自重庆的 **联通** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **佛利蒙、东京、亚特兰大** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_2)吧！

### 移动

重庆移动到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
佛利蒙 | 3个 | 0 | 187ms | 0 | 伦敦 | 3个 | 0 | 273ms | 2%  
东京 | 3个 | 0 | 200ms | 9% | 纽瓦克 | 3个 | 0 | 294ms | 7%  
达拉斯 | 3个 | 0 | 240ms | 0 | 新加坡 | 3个 | 0 | 346ms | 14%  
亚特兰大 | 3个 | 0 | 299ms | 5% | 法兰克福 | 3个 | 0 | 682ms | 23%  
均值 | 24个 | 0 | 315ms | 7% |  |  |  |  |   
