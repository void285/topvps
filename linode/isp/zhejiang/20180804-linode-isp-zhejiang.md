...
**浙江全部运营商到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 228个 | 16个 | 183ms | 23%  
佛利蒙 | 250个 | 7个 | 194ms | 2%  
新加坡 | 234个 | 22个 | 246ms | 23%  
达拉斯 | 246个 | 13个 | 247ms | 3%  
均值 | 1940个 | 91个 | 251ms | 9%  
纽瓦克 | 240个 | 6个 | 266ms | 2%  
亚特兰大 | 244个 | 10个 | 273ms | 5%  
伦敦 | 244个 | 4个 | 279ms | 9%  
法兰克福 | 254个 | 13个 | 320ms | 5%  
...
**浙江电信到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 100个 | 10个 | 219ms | 45%  
佛利蒙 | 112个 | 3个 | 179ms | 3%  
新加坡 | 104个 | 15个 | 303ms | 46%  
达拉斯 | 104个 | 9个 | 251ms | 6%  
均值 | 832个 | 51个 | 258ms | 16%  
纽瓦克 | 100个 | 2个 | 281ms | 5%  
亚特兰大 | 98个 | 3个 | 291ms | 10%  
伦敦 | 102个 | 0 | 255ms | 3%  
法兰克福 | 112个 | 9个 | 302ms | 7%  
