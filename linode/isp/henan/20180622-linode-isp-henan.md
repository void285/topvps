...
河南全部运营商到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 41个 | 1个 | 167ms | 8% | 新加坡 | 51个 | 2个 | 267ms | 11%  
佛利蒙 | 50个 | 1个 | 193ms | 6% | 纽瓦克 | 52个 | 1个 | 277ms | 6%  
均值 | 383个 | 10个 | 257ms | 5% | 亚特兰大 | 52个 | 1个 | 287ms | 3%  
伦敦 | 45个 | 2个 | 260ms | 0 | 法兰克福 | 49个 | 1个 | 326ms | 4%  
达拉斯 | 43个 | 1个 | 267ms | 4% |  |  |  |  |   
...
河南电信到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 16个 | 1个 | 188ms | 12% | 新加坡 | 16个 | 0 | 303ms | 14%  
佛利蒙 | 18个 | 0 | 191ms | 8% | 纽瓦克 | 17个 | 0 | 312ms | 5%  
均值 | 130个 | 2个 | 274ms | 7% | 亚特兰大 | 17个 | 0 | 309ms | 5%  
伦敦 | 16个 | 1个 | 254ms | 0 | 法兰克福 | 16个 | 0 | 370ms | 7%  
达拉斯 | 14个 | 0 | 272ms | 2% |  |  |  |  |   
...
河南联通到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 179ms | 12% | 新加坡 | 18个 | 1个 | 281ms | 15%  
佛利蒙 | 17个 | 0 | 175ms | 6% | 纽瓦克 | 19个 | 0 | 244ms | 8%  
均值 | 132个 | 1个 | 260ms | 7% | 亚特兰大 | 18个 | 0 | 249ms | 3%  
伦敦 | 16个 | 0 | 276ms | 0 | 法兰克福 | 17个 | 0 | 384ms | 5%  
达拉斯 | 14个 | 0 | 273ms | 3% |  |  |  |  |   
  
简评：如果你是来自河南的 **联通** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **亚特兰大** 的机房；从数据看，你的网络到这里的连通速度、丢包率都比较不错。请慎重选择部署在 **佛利蒙、东京、纽瓦克** 的机房，即使这几个城市离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_2)吧！

### 移动

河南移动到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 132ms | 2% | 新加坡 | 17个 | 1个 | 219ms | 2%  
佛利蒙 | 15个 | 1个 | 215ms | 4% | 纽瓦克 | 16个 | 1个 | 276ms | 4%  
均值 | 121个 | 7个 | 237ms | 2% | 亚特兰大 | 17个 | 1个 | 304ms | 2%  
伦敦 | 13个 | 1个 | 250ms | 0 | 法兰克福 | 16个 | 1个 | 226ms | 0  
达拉斯 | 15个 | 1个 | 257ms | 6% |  |  |  |  |   
