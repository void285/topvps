...
**大陆全部运营商到Linode各机房的测速数据 [20180527]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 954个 | 20个 | 176ms | 12%  
佛利蒙 | 973个 | 9个 | 197ms | 4%  
新加坡 | 977个 | 18个 | 224ms | 11%  
均值 | 7742个 | 88个 | 244ms | 6%  
达拉斯 | 975个 | 7个 | 247ms | 6%  
纽瓦克 | 965个 | 6个 | 265ms | 1%  
亚特兰大 | 970个 | 7个 | 275ms | 9%  
法兰克福 | 967个 | 12个 | 278ms | 3%  
伦敦 | 961个 | 9个 | 293ms | 5%  
...
**大陆电信到Linode各机房的测速数据 [20180527]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 401个 | 15个 | 206ms | 20%  
佛利蒙 | 400个 | 2个 | 188ms | 1%  
新加坡 | 412个 | 13个 | 297ms | 20%  
均值 | 3257个 | 50个 | 245ms | 7%  
达拉斯 | 408个 | 2个 | 224ms | 1%  
纽瓦克 | 407个 | 3个 | 258ms | 1%  
亚特兰大 | 414个 | 4个 | 257ms | 4%  
法兰克福 | 407个 | 9个 | 287ms | 4%  
伦敦 | 408个 | 2个 | 244ms | 1%  
...
佛利蒙 | 287个 | 3个 | 209ms | 4%  
新加坡 | 287个 | 2个 | 117ms | 3%  
均值 | 2250个 | 21个 | 236ms | 7%  
达拉斯 | 283个 | 2个 | 279ms | 12%  
纽瓦克 | 284个 | 2个 | 269ms | 0  
亚特兰大 | 278个 | 3个 | 325ms | 21%  
法兰克福 | 281个 | 3个 | 232ms | 2%  
伦敦 | 272个 | 4个 | 340ms | 9%  
