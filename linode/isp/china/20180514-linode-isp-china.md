...
大陆全部运营商到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 968个 | 15个 | 121ms | 5% | 亚特兰大 | 951个 | 14个 | 283ms | 15%  
新加坡 | 956个 | 14个 | 162ms | 3% | 纽瓦克 | 984个 | 12个 | 290ms | 3%  
佛利蒙 | 957个 | 9个 | 225ms | 10% | 法兰克福 | 949个 | 16个 | 290ms | 6%  
均值 | 7716个 | 106个 | 245ms | 8% | 伦敦 | 976个 | 12个 | 328ms | 8%  
...
大陆电信到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 405个 | 10个 | 131ms | 8% | 亚特兰大 | 404个 | 9个 | 282ms | 7%  
新加坡 | 394个 | 9个 | 220ms | 6% | 纽瓦克 | 413个 | 4个 | 283ms | 2%  
佛利蒙 | 395个 | 4个 | 196ms | 3% | 法兰克福 | 403个 | 10个 | 272ms | 3%  
均值 | 3234个 | 60个 | 247ms | 5% | 伦敦 | 409个 | 8个 | 334ms | 7%  
达拉斯 | 411个 | 6个 | 262ms | 5% |  |  |  |  |   
...
大陆联通到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 277个 | 2个 | 107ms | 2% | 亚特兰大 | 266个 | 3个 | 249ms | 6%  
新加坡 | 279个 | 3个 | 138ms | 1% | 纽瓦克 | 281个 | 5个 | 278ms | 2%  
佛利蒙 | 273个 | 4个 | 203ms | 5% | 法兰克福 | 271个 | 4个 | 325ms | 2%  
均值 | 2213个 | 31个 | 233ms | 3% | 伦敦 | 285个 | 3个 | 321ms | 3%  
达拉斯 | 281个 | 7个 | 239ms | 5% |  |  |  |  |   
...
大陆移动到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 286个 | 3个 | 116ms | 3% | 亚特兰大 | 281个 | 2个 | 315ms | 35%  
新加坡 | 283个 | 2个 | 113ms | 1% | 纽瓦克 | 290个 | 3个 | 309ms | 6%  
佛利蒙 | 289个 | 1个 | 278ms | 24% | 法兰克福 | 275个 | 2个 | 285ms | 13%  
均值 | 2269个 | 15个 | 254ms | 15% | 伦敦 | 282个 | 1个 | 329ms | 16%  
