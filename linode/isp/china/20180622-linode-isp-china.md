...
**大陆全部运营商到Linode各机房的测速数据 [20180622]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 850个 | 39个 | 181ms | 8%  
佛利蒙 | 885个 | 16个 | 196ms | 1%  
达拉斯 | 839个 | 22个 | 244ms | 1%  
均值 | 6991个 | 183个 | 261ms | 5%  
新加坡 | 884个 | 29个 | 264ms | 12%  
伦敦 | 867个 | 22个 | 267ms | 1%  
亚特兰大 | 884个 | 20个 | 275ms | 4%  
纽瓦克 | 919个 | 17个 | 283ms | 4%  
法兰克福 | 863个 | 18个 | 370ms | 6%  
...
**大陆电信到Linode各机房的测速数据 [20180622]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 389个 | 23个 | 221ms | 15%  
佛利蒙 | 398个 | 7个 | 187ms | 1%  
达拉斯 | 376个 | 7个 | 240ms | 1%  
均值 | 3140个 | 86个 | 280ms | 7%  
新加坡 | 391个 | 17个 | 321ms | 18%  
伦敦 | 394个 | 12个 | 243ms | 0  
亚特兰大 | 398个 | 7个 | 269ms | 5%  
纽瓦克 | 407个 | 6个 | 306ms | 5%  
法兰克福 | 387个 | 7个 | 419ms | 11%  
...
佛利蒙 | 236个 | 4个 | 195ms | 1%  
达拉斯 | 229个 | 8个 | 238ms | 1%  
均值 | 1886个 | 50个 | 254ms | 3%  
新加坡 | 243个 | 6个 | 258ms | 11%  
伦敦 | 232个 | 5个 | 298ms | 1%  
亚特兰大 | 237个 | 7个 | 249ms | 2%  
纽瓦克 | 250个 | 5个 | 261ms | 3%  
法兰克福 | 230个 | 5个 | 356ms | 3%  
...
佛利蒙 | 251个 | 5个 | 210ms | 3%  
达拉斯 | 234个 | 7个 | 254ms | 1%  
均值 | 1965个 | 47个 | 238ms | 3%  
新加坡 | 250个 | 6个 | 186ms | 4%  
伦敦 | 241个 | 5个 | 269ms | 2%  
亚特兰大 | 249个 | 6个 | 298ms | 3%  
纽瓦克 | 262个 | 6个 | 278ms | 4%  
法兰克福 | 246个 | 6个 | 274ms | 3%  
