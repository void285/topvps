...
**大陆全部运营商到Linode各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 1270个 | 13个 | 140ms | 3%  
新加坡 | 1434个 | 13个 | 196ms | 3%  
佛利蒙 | 1399个 | 14个 | 209ms | 6%  
均值 | 10812个 | 141个 | 237ms | 6%  
达拉斯 | 1344个 | 16个 | 247ms | 6%  
亚特兰大 | 1336个 | 18个 | 259ms | 7%  
纽瓦克 | 1363个 | 12个 | 272ms | 5%  
伦敦 | 1343个 | 16个 | 283ms | 8%  
法兰克福 | 1323个 | 39个 | 286ms | 7%  
...
**大陆电信到Linode各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 526个 | 9个 | 178ms | 5%  
新加坡 | 603个 | 11个 | 249ms | 4%  
佛利蒙 | 583个 | 9个 | 194ms | 3%  
均值 | 4506个 | 100个 | 238ms | 4%  
达拉斯 | 559个 | 10个 | 244ms | 3%  
亚特兰大 | 560个 | 12个 | 254ms | 4%  
纽瓦克 | 571个 | 8个 | 255ms | 2%  
伦敦 | 554个 | 10个 | 261ms | 4%  
法兰克福 | 550个 | 31个 | 277ms | 5%  
...
**大陆联通到Linode各机房的测速数据 [20180918]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 383个 | 3个 | 121ms | 2%  
新加坡 | 414个 | 2个 | 199ms | 3%  
佛利蒙 | 404个 | 5个 | 227ms | 12%  
均值 | 3181个 | 36个 | 252ms | 11%  
达拉斯 | 398个 | 4个 | 255ms | 14%  
亚特兰大 | 388个 | 6个 | 269ms | 15%  
纽瓦克 | 401个 | 4个 | 290ms | 13%  
伦敦 | 404个 | 6个 | 325ms | 17%  
法兰克福 | 389个 | 6个 | 339ms | 15%  
