...
大陆全部运营商到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 805个 | 3个 | 124ms | 5% | 纽瓦克 | 829个 | 5个 | 296ms | 5%  
新加坡 | 811个 | 5个 | 173ms | 13% | 亚特兰大 | 825个 | 5个 | 300ms | 18%  
佛利蒙 | 292个 | 5个 | 174ms | 4% | 伦敦 | 810个 | 8个 | 314ms | 13%  
均值 | 6017个 | 38个 | 260ms | 12% | 法兰克福 | 810个 | 4个 | 350ms | 17%  
...
大陆电信到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 321个 | 2个 | 137ms | 9% | 纽瓦克 | 329个 | 3个 | 320ms | 6%  
新加坡 | 328个 | 4个 | 219ms | 8% | 亚特兰大 | 331个 | 3个 | 296ms | 15%  
佛利蒙 | 141个 | 3个 | 164ms | 1% | 伦敦 | 328个 | 6个 | 280ms | 10%  
均值 | 2433个 | 26个 | 273ms | 10% | 法兰克福 | 324个 | 3个 | 414ms | 22%  
达拉斯 | 331个 | 2个 | 293ms | 7% |  |  |  |  |   
...
大陆联通到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 232个 | 1个 | 109ms | 2% | 纽瓦克 | 234个 | 1个 | 280ms | 6%  
新加坡 | 228个 | 1个 | 150ms | 4% | 亚特兰大 | 234个 | 2个 | 269ms | 13%  
佛利蒙 | 87个 | 2个 | 183ms | 9% | 伦敦 | 228个 | 1个 | 333ms | 12%  
均值 | 1709个 | 10个 | 247ms | 10% | 法兰克福 | 229个 | 1个 | 334ms | 14%  
...
大陆移动到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 252个 | 0 | 121ms | 3% | 纽瓦克 | 266个 | 1个 | 280ms | 1%  
新加坡 | 255个 | 0 | 135ms | 27% | 亚特兰大 | 260个 | 0 | 333ms | 27%  
佛利蒙 | 64个 | 0 | 187ms | 3% | 伦敦 | 254个 | 1个 | 341ms | 19%  
均值 | 1875个 | 2个 | 255ms | 15% | 法兰克福 | 257个 | 0 | 283ms | 12%  
达拉斯 | 267个 | 0 | 305ms | 16% |  |  |  |  |   
