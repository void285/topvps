#  大陆到Linode各机房的测速数据（20180804） 

## 导读

本文是[TopVPS主机网络测试报告系列](https://vps123.top/pingtest)的一部分，主要提供PING测试的响应速度、丢包率等数据，关于PING指令以及响应速度、丢包率的指标意义，请看[这里](https://vps123.top/what-is-ping.html)。

![大陆到Linode各机房的测速数据（20180804）](/images/thumbnails/China_to_linode.png)
...
测速点的运营商线路为电信、联通、移动，有效样本点43111个，其中超时点403个。连通概况如下：大陆线路响应均值为258毫秒，最快的三个机房所在地为东京、佛利蒙、均值，最慢的三个为伦敦、亚特兰大、法兰克福；新加坡、法兰克福、东京、佛利蒙、达拉斯等8处有响应超时情况；东京、新加坡、佛利蒙、亚特兰大丢包率较高。

[注册 Linode](https://vps123.top/go/linode/_btn1)

## 大陆图表数据

![大陆省份大陆到VPS提供商Linode各机房的ping测试数据统计图，包含响应值的柱状图以及丢包率的散点图，数据日期为20180804](/images/pingtests/linode_20180804/plot_isp_china_linode_20180804.png)

### 全部运营商

大陆全部运营商到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 5342个 | 72个 | 201ms | 20% | 纽瓦克 | 5390个 | 36个 | 276ms | 3%  
佛利蒙 | 5553个 | 40个 | 207ms | 8% | 伦敦 | 5407个 | 18个 | 281ms | 4%  
均值 | 43111个 | 403个 | 258ms | 8% | 亚特兰大 | 5389个 | 39个 | 285ms | 5%  
达拉斯 | 5453个 | 39个 | 259ms | 4% | 法兰克福 | 5386个 | 73个 | 287ms | 3%  
新加坡 | 5191个 | 86个 | 266ms | 18% |  |  |  |  |   
...
大陆电信到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2240个 | 56个 | 234ms | 31% | 纽瓦克 | 2204个 | 20个 | 273ms | 2%  
佛利蒙 | 2311个 | 22个 | 193ms | 5% | 伦敦 | 2260个 | 7个 | 263ms | 1%  
均值 | 18001个 | 263个 | 262ms | 10% | 亚特兰大 | 2258个 | 25个 | 288ms | 7%  
达拉斯 | 2270个 | 22个 | 249ms | 3% | 法兰克福 | 2250个 | 52个 | 272ms | 4%  
新加坡 | 2208个 | 59个 | 327ms | 27% |  |  |  |  |   
  
简评：如果你关注电信的网络到Linode各机房的连通性，此表数据提供了一个不错的概览， **佛利蒙、达拉斯** 的整体的连通速度、丢包率都比较不错， **东京** 也值得关注，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_1)吧！

### 联通

大陆联通到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 1456个 | 8个 | 225ms | 19% | 纽瓦克 | 1496个 | 4个 | 283ms | 4%  
佛利蒙 | 1523个 | 10个 | 204ms | 4% | 伦敦 | 1482个 | 7个 | 296ms | 2%  
均值 | 11855个 | 63个 | 271ms | 7% | 亚特兰大 | 1478个 | 3个 | 282ms | 5%  
达拉斯 | 1520个 | 9个 | 270ms | 6% | 法兰克福 | 1468个 | 13个 | 331ms | 3%  
新加坡 | 1432个 | 9个 | 279ms | 13% |  |  |  |  |   
  
简评：如果你关注联通的网络到Linode各机房的连通性，此表数据提供了一个不错的概览， **佛利蒙** 的整体的连通速度、丢包率都比较不错， **东京** 也值得关注，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_2)吧！

### 移动

大陆移动到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 1646个 | 8个 | 137ms | 7% | 纽瓦克 | 1690个 | 12个 | 274ms | 2%  
佛利蒙 | 1719个 | 8个 | 226ms | 14% | 伦敦 | 1665个 | 4个 | 291ms | 8%  
均值 | 13255个 | 77个 | 241ms | 6% | 亚特兰大 | 1653个 | 11个 | 284ms | 3%  
达拉斯 | 1663个 | 8个 | 262ms | 2% | 法兰克福 | 1668个 | 8个 | 269ms | 3%  
新加坡 | 1551个 | 18个 | 175ms | 10% |  |  |  |  |   
  
简评：如果你关注移动的网络到Linode各机房的连通性，此表数据提供了一个不错的概览， **东京、新加坡、佛利蒙** 也值得关注，如果要选择一个机房用于科学上网、云存储、远程任务、游戏服务器等用途，请查看你所在的省份的更具体的测评。如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_3)吧！
...
本文最初发表于[大陆到Linode各机房的测速数据（20180804）](https://vps123.top/pingtest/20180804-linode-isp-china.html)
