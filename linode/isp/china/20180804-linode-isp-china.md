...
**大陆全部运营商到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 5342个 | 72个 | 201ms | 20%  
佛利蒙 | 5553个 | 40个 | 207ms | 8%  
均值 | 43111个 | 403个 | 258ms | 8%  
达拉斯 | 5453个 | 39个 | 259ms | 4%  
新加坡 | 5191个 | 86个 | 266ms | 18%  
纽瓦克 | 5390个 | 36个 | 276ms | 3%  
伦敦 | 5407个 | 18个 | 281ms | 4%  
亚特兰大 | 5389个 | 39个 | 285ms | 5%  
法兰克福 | 5386个 | 73个 | 287ms | 3%  
...
**大陆电信到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 2240个 | 56个 | 234ms | 31%  
佛利蒙 | 2311个 | 22个 | 193ms | 5%  
均值 | 18001个 | 263个 | 262ms | 10%  
达拉斯 | 2270个 | 22个 | 249ms | 3%  
新加坡 | 2208个 | 59个 | 327ms | 27%  
纽瓦克 | 2204个 | 20个 | 273ms | 2%  
伦敦 | 2260个 | 7个 | 263ms | 1%  
亚特兰大 | 2258个 | 25个 | 288ms | 7%  
法兰克福 | 2250个 | 52个 | 272ms | 4%  
...
**大陆联通到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 1456个 | 8个 | 225ms | 19%  
佛利蒙 | 1523个 | 10个 | 204ms | 4%  
均值 | 11855个 | 63个 | 271ms | 7%  
达拉斯 | 1520个 | 9个 | 270ms | 6%  
新加坡 | 1432个 | 9个 | 279ms | 13%  
纽瓦克 | 1496个 | 4个 | 283ms | 4%  
伦敦 | 1482个 | 7个 | 296ms | 2%  
亚特兰大 | 1478个 | 3个 | 282ms | 5%  
法兰克福 | 1468个 | 13个 | 331ms | 3%  
...
**大陆移动到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 1646个 | 8个 | 137ms | 7%  
佛利蒙 | 1719个 | 8个 | 226ms | 14%  
均值 | 13255个 | 77个 | 241ms | 6%  
达拉斯 | 1663个 | 8个 | 262ms | 2%  
新加坡 | 1551个 | 18个 | 175ms | 10%  
纽瓦克 | 1690个 | 12个 | 274ms | 2%  
伦敦 | 1665个 | 4个 | 291ms | 8%  
亚特兰大 | 1653个 | 11个 | 284ms | 3%  
法兰克福 | 1668个 | 8个 | 269ms | 3%  
