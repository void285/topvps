...
宁夏全部运营商到Linode各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 3个 | 0 | 174ms | 3% | 达拉斯 | 1个 | 0 | 241ms | 1%  
佛利蒙 | 7个 | 0 | 194ms | 0 | 纽瓦克 | 5个 | 0 | 255ms | 0  
法兰克福 | 6个 | 0 | 211ms | 0 | 新加坡 | 8个 | 0 | 258ms | 5%  
伦敦 | 5个 | 0 | 213ms | 0 | 亚特兰大 | 7个 | 0 | 295ms | 0  
均值 | 42个 | 0 | 234ms | 1% |  |  |  |  |   
...
宁夏电信到Linode各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 178ms | 3% | 达拉斯 | - | - | - | -  
佛利蒙 | 5个 | 0 | 189ms | 0 | 纽瓦克 | 4个 | 0 | 255ms | 0  
法兰克福 | 4个 | 0 | 221ms | 0 | 新加坡 | 6个 | 0 | 255ms | 6%  
伦敦 | 4个 | 0 | 231ms | 0 | 亚特兰大 | 5个 | 0 | 280ms | 0  
均值 | 30个 | 0 | 235ms | 1% |  |  |  |  |   
...
宁夏移动到Linode各机房的测速数据 [20180918] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 1个 | 0 | 171ms | 3% | 达拉斯 | 1个 | 0 | 241ms | 1%  
佛利蒙 | 2个 | 0 | 199ms | 0 | 纽瓦克 | 1个 | 0 | 256ms | 0  
法兰克福 | 2个 | 0 | 201ms | 0 | 新加坡 | 2个 | 0 | 262ms | 4%  
伦敦 | 1个 | 0 | 196ms | 0 | 亚特兰大 | 2个 | 0 | 311ms | 0  
均值 | 12个 | 0 | 234ms | 1% |  |  |  |  |   
