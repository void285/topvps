...
**江西全部运营商到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 134个 | 6个 | 170ms | 24%  
佛利蒙 | 139个 | 4个 | 210ms | 10%  
新加坡 | 139个 | 8个 | 226ms | 23%  
均值 | 1102个 | 45个 | 253ms | 9%  
伦敦 | 135个 | 0 | 264ms | 1%  
达拉斯 | 139个 | 7个 | 267ms | 2%  
纽瓦克 | 138个 | 6个 | 286ms | 3%  
亚特兰大 | 139个 | 7个 | 292ms | 6%  
法兰克福 | 139个 | 7个 | 304ms | 3%  
...
佛利蒙 | 75个 | 0 | 184ms | 4%  
新加坡 | 71个 | 0 | 337ms | 48%  
均值 | 594个 | 13个 | 265ms | 15%  
伦敦 | 75个 | 0 | 268ms | 2%  
达拉斯 | 75个 | 3个 | 230ms | 2%  
纽瓦克 | 74个 | 2个 | 284ms | 3%  
亚特兰大 | 75个 | 3个 | 305ms | 11%  
法兰克福 | 75个 | 3个 | 299ms | 6%  
