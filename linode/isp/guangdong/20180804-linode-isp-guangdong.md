...
**广东全部运营商到Linode各机房的测速数据 [20180804]**
...
佛利蒙 | 461个 | 3个 | 179ms | 3%  
新加坡 | 441个 | 3个 | 225ms | 6%  
均值 | 3519个 | 14个 | 236ms | 3%  
达拉斯 | 441个 | 0 | 240ms | 2%  
纽瓦克 | 438个 | 0 | 252ms | 2%  
亚特兰大 | 418个 | 3个 | 262ms | 2%  
伦敦 | 438个 | 0 | 285ms | 2%  
法兰克福 | 440个 | 3个 | 298ms | 2%  
...
**广东电信到Linode各机房的测速数据 [20180804]**

机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---  
东京 | 170个 | 2个 | 232ms | 16%  
佛利蒙 | 181个 | 3个 | 169ms | 6%  
新加坡 | 165个 | 3个 | 293ms | 11%  
均值 | 1366个 | 14个 | 234ms | 5%  
达拉斯 | 173个 | 0 | 213ms | 0  
纽瓦克 | 170个 | 0 | 241ms | 1%  
亚特兰大 | 166个 | 3个 | 257ms | 3%  
伦敦 | 170个 | 0 | 228ms | 0  
法兰克福 | 171个 | 3个 | 251ms | 2%  
