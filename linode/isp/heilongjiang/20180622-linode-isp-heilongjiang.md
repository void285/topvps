...
黑龙江全部运营商到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 32个 | 0 | 202ms | 10% | 均值 | 238个 | 2个 | 281ms | 6%  
佛利蒙 | 27个 | 0 | 212ms | 1% | 亚特兰大 | 30个 | 0 | 299ms | 5%  
达拉斯 | 32个 | 1个 | 255ms | 0 | 纽瓦克 | 30个 | 0 | 306ms | 3%  
伦敦 | 27个 | 0 | 274ms | 1% | 法兰克福 | 30个 | 1个 | 419ms | 9%  
新加坡 | 30个 | 0 | 278ms | 16% |  |  |  |  |   
...
黑龙江电信到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 249ms | 21% | 均值 | 63个 | 0 | 325ms | 11%  
佛利蒙 | 7个 | 0 | 202ms | 0 | 亚特兰大 | 8个 | 0 | 310ms | 9%  
达拉斯 | 9个 | 0 | 265ms | 0 | 纽瓦克 | 8个 | 0 | 331ms | 3%  
伦敦 | 6个 | 0 | 238ms | 0 | 法兰克福 | 8个 | 0 | 629ms | 22%  
新加坡 | 8个 | 0 | 359ms | 31% |  |  |  |  |   
...
黑龙江联通到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 201ms | 5% | 均值 | 88个 | 2个 | 266ms | 3%  
佛利蒙 | 11个 | 0 | 214ms | 3% | 亚特兰大 | 11个 | 0 | 280ms | 1%  
达拉斯 | 11个 | 1个 | 251ms | 0 | 纽瓦克 | 11个 | 0 | 293ms | 3%  
伦敦 | 11个 | 0 | 319ms | 1% | 法兰克福 | 11个 | 1个 | 313ms | 1%  
新加坡 | 11个 | 0 | 257ms | 11% |  |  |  |  |   
  
简评：如果你是来自黑龙江的 **联通** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、佛利蒙** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_2)吧！

### 移动

黑龙江移动到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 156ms | 4% | 均值 | 87个 | 0 | 253ms | 3%  
佛利蒙 | 9个 | 0 | 220ms | 0 | 亚特兰大 | 11个 | 0 | 308ms | 5%  
达拉斯 | 12个 | 0 | 249ms | 0 | 纽瓦克 | 11个 | 0 | 294ms | 3%  
伦敦 | 10个 | 0 | 266ms | 1% | 法兰克福 | 11个 | 0 | 316ms | 4%  
新加坡 | 11个 | 0 | 217ms | 5% |  |  |  |  |   
