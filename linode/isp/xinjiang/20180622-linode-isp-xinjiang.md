...
新疆全部运营商到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 24个 | 1个 | 223ms | 8% | 伦敦 | 20个 | 0 | 316ms | 1%  
佛利蒙 | 21个 | 0 | 242ms | 2% | 新加坡 | 18个 | 1个 | 318ms | 13%  
均值 | 163个 | 2个 | 302ms | 4% | 纽瓦克 | 20个 | 0 | 330ms | 3%  
亚特兰大 | 18个 | 0 | 309ms | 4% | 法兰克福 | 19个 | 0 | 365ms | 4%  
达拉斯 | 23个 | 0 | 315ms | 2% |  |  |  |  |   
...
新疆电信到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 1个 | 278ms | 21% | 伦敦 | 10个 | 0 | 274ms | 1%  
佛利蒙 | 11个 | 0 | 236ms | 0 | 新加坡 | 9个 | 1个 | 419ms | 23%  
均值 | 83个 | 2个 | 326ms | 8% | 纽瓦克 | 11个 | 0 | 380ms | 4%  
亚特兰大 | 9个 | 0 | 328ms | 7% | 法兰克福 | 10个 | 0 | 410ms | 13%  
达拉斯 | 11个 | 0 | 296ms | 0 |  |  |  |  |   
...
新疆联通到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 2个 | 0 | 226ms | 2% | 伦敦 | 2个 | 0 | 364ms | 2%  
佛利蒙 | 2个 | 0 | 237ms | 0 | 新加坡 | 3个 | 0 | 333ms | 14%  
均值 | 20个 | 0 | 312ms | 3% | 纽瓦克 | 3个 | 0 | 301ms | 0  
亚特兰大 | 3个 | 0 | 272ms | 1% | 法兰克福 | 3个 | 0 | 395ms | 0  
达拉斯 | 2个 | 0 | 340ms | 2% |  |  |  |  |   
...
新疆移动到Linode各机房的测速数据 [20180622] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 166ms | 1% | 伦敦 | 8个 | 0 | 309ms | 0  
佛利蒙 | 8个 | 0 | 255ms | 5% | 新加坡 | 6个 | 0 | 202ms | 1%  
均值 | 60个 | 0 | 267ms | 2% | 纽瓦克 | 6个 | 0 | 308ms | 4%  
亚特兰大 | 6个 | 0 | 328ms | 4% | 法兰克福 | 6个 | 0 | 291ms | 0  
达拉斯 | 10个 | 0 | 309ms | 4% |  |  |  |  |   
