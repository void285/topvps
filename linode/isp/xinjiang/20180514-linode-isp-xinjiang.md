...
新疆全部运营商到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 29个 | 0 | 165ms | 6% | 亚特兰大 | 30个 | 1个 | 299ms | 12%  
新加坡 | 29个 | 0 | 203ms | 1% | 纽瓦克 | 28个 | 0 | 322ms | 2%  
佛利蒙 | 29个 | 0 | 273ms | 11% | 法兰克福 | 27个 | 0 | 331ms | 6%  
均值 | 227个 | 1个 | 278ms | 7% | 伦敦 | 27个 | 0 | 356ms | 7%  
达拉斯 | 28个 | 0 | 283ms | 8% |  |  |  |  |   
...
新疆电信到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 12个 | 0 | 184ms | 10% | 亚特兰大 | 13个 | 1个 | 277ms | 0  
新加坡 | 13个 | 0 | 261ms | 2% | 纽瓦克 | 12个 | 0 | 288ms | 0  
佛利蒙 | 12个 | 0 | 229ms | 0 | 法兰克福 | 11个 | 0 | 284ms | 0  
均值 | 95个 | 1个 | 264ms | 2% | 伦敦 | 11个 | 0 | 340ms | 5%  
达拉斯 | 11个 | 0 | 266ms | 0 |  |  |  |  |   
...
新疆联通到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 4个 | 0 | 142ms | 3% | 亚特兰大 | 4个 | 0 | 269ms | 0  
新加坡 | 4个 | 0 | 203ms | 0 | 纽瓦克 | 4个 | 0 | 305ms | 2%  
佛利蒙 | 4个 | 0 | 247ms | 1% | 法兰克福 | 4个 | 0 | 355ms | 0  
均值 | 32个 | 0 | 268ms | 1% | 伦敦 | 4个 | 0 | 366ms | 1%  
达拉斯 | 4个 | 0 | 259ms | 1% |  |  |  |  |   
  
简评：如果你是来自新疆的 **联通** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、新加坡、佛利蒙** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_2)吧！

### 移动

新疆移动到Linode各机房的测速数据 [20180514] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 170ms | 4% | 亚特兰大 | 13个 | 0 | 351ms | 36%  
新加坡 | 12个 | 0 | 143ms | 0 | 纽瓦克 | 12个 | 0 | 372ms | 5%  
佛利蒙 | 13个 | 0 | 343ms | 33% | 法兰克福 | 12个 | 0 | 354ms | 17%  
均值 | 100个 | 0 | 302ms | 17% | 伦敦 | 12个 | 0 | 361ms | 16%  
达拉斯 | 13个 | 0 | 324ms | 23% |  |  |  |  |   
