...
新疆全部运营商到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 162个 | 0 | 251ms | 19% | 纽瓦克 | 162个 | 4个 | 311ms | 0  
佛利蒙 | 155个 | 0 | 267ms | 13% | 达拉斯 | 155个 | 0 | 316ms | 4%  
法兰克福 | 159个 | 0 | 297ms | 1% | 亚特兰大 | 163个 | 0 | 322ms | 3%  
均值 | 1254个 | 4个 | 301ms | 8% | 新加坡 | 143个 | 0 | 322ms | 20%  
伦敦 | 155个 | 0 | 311ms | 2% |  |  |  |  |   
...
新疆电信到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 90个 | 0 | 298ms | 31% | 纽瓦克 | 90个 | 0 | 295ms | 0  
佛利蒙 | 91个 | 0 | 231ms | 4% | 达拉斯 | 87个 | 0 | 290ms | 3%  
法兰克福 | 87个 | 0 | 283ms | 1% | 亚特兰大 | 91个 | 0 | 327ms | 3%  
均值 | 710个 | 0 | 308ms | 9% | 新加坡 | 87个 | 0 | 430ms | 32%  
伦敦 | 87个 | 0 | 312ms | 0 |  |  |  |  |   
...
新疆联通到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 20个 | 0 | 286ms | 24% | 纽瓦克 | 20个 | 0 | 304ms | 0  
佛利蒙 | 12个 | 0 | 265ms | 4% | 达拉斯 | 16个 | 0 | 354ms | 7%  
法兰克福 | 20个 | 0 | 343ms | 0 | 亚特兰大 | 20个 | 0 | 302ms | 3%  
均值 | 148个 | 0 | 315ms | 8% | 新加坡 | 24个 | 0 | 330ms | 18%  
伦敦 | 16个 | 0 | 324ms | 0 |  |  |  |  |   
...
新疆移动到Linode各机房的测速数据 [20180804] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 52个 | 0 | 169ms | 3% | 纽瓦克 | 52个 | 4个 | 333ms | 0  
佛利蒙 | 52个 | 0 | 304ms | 31% | 达拉斯 | 52个 | 0 | 303ms | 1%  
法兰克福 | 52个 | 0 | 266ms | 3% | 亚特兰大 | 52个 | 0 | 337ms | 3%  
均值 | 396个 | 4个 | 280ms | 7% | 新加坡 | 32个 | 0 | 208ms | 10%  
伦敦 | 52个 | 0 | 297ms | 5% |  |  |  |  |   
