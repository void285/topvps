...
湖南全部运营商到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 39个 | 0 | 106ms | 2% | 亚特兰大 | 40个 | 0 | 284ms | 15%  
佛利蒙 | 9个 | 0 | 175ms | 6% | 达拉斯 | 38个 | 0 | 305ms | 10%  
新加坡 | 37个 | 0 | 185ms | 14% | 伦敦 | 38个 | 1个 | 311ms | 10%  
均值 | 279个 | 1个 | 257ms | 10% | 法兰克福 | 39个 | 0 | 350ms | 16%  
纽瓦克 | 39个 | 0 | 276ms | 3% |  |  |  |  |   
...
湖南电信到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 13个 | 0 | 125ms | 5% | 亚特兰大 | 11个 | 0 | 276ms | 14%  
佛利蒙 | 1个 | 0 | 165ms | 2% | 达拉斯 | 11个 | 0 | 281ms | 4%  
新加坡 | 12个 | 0 | 211ms | 8% | 伦敦 | 11个 | 0 | 272ms | 5%  
均值 | 81个 | 0 | 264ms | 9% | 法兰克福 | 11个 | 0 | 434ms | 22%  
纽瓦克 | 11个 | 0 | 290ms | 3% |  |  |  |  |   
...
湖南联通到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 11个 | 0 | 73ms | 1% | 亚特兰大 | 13个 | 0 | 255ms | 7%  
佛利蒙 | 4个 | 0 | 169ms | 15% | 达拉斯 | 12个 | 0 | 319ms | 6%  
新加坡 | 11个 | 0 | 104ms | 0 | 伦敦 | 12个 | 0 | 331ms | 5%  
均值 | 88个 | 0 | 243ms | 5% | 法兰克福 | 13个 | 0 | 342ms | 7%  
纽瓦克 | 12个 | 0 | 264ms | 5% |  |  |  |  |   
  
简评：如果你是来自湖南的 **联通** 用户，想运行Linode的VPS产品，用作科学上网、云存储、远程任务、游戏服务器等用途，建议重点关注部署在 **东京、新加坡** 的机房；从数据看，你的网络到这几处的连通速度、丢包率都比较不错。请慎重选择部署在 **佛利蒙** 的机房，即使此处离你较近；因为响应均值虽然还不错，但丢包率较高。文章结尾处有本文视角的其他近期测评的链接，建议你多看几期以提升判断的准确度；如果看好了，就果断[去让机器跑起来](https://vps123.top/go/linode/_2)吧！

### 移动

湖南移动到Linode各机房的测速数据 [20180426] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 15个 | 0 | 121ms | 1% | 亚特兰大 | 16个 | 0 | 321ms | 25%  
佛利蒙 | 4个 | 0 | 193ms | 2% | 达拉斯 | 15个 | 0 | 314ms | 19%  
新加坡 | 14个 | 0 | 241ms | 35% | 伦敦 | 15个 | 1个 | 329ms | 21%  
均值 | 110个 | 1个 | 265ms | 17% | 法兰克福 | 15个 | 0 | 276ms | 20%  
纽瓦克 | 16个 | 0 | 274ms | 1% |  |  |  |  |   
