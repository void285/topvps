...
湖北全部运营商到Linode各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 43个 | 2个 | 181ms | 13% | 纽瓦克 | 41个 | 0 | 260ms | 0  
佛利蒙 | 44个 | 0 | 202ms | 2% | 亚特兰大 | 44个 | 0 | 272ms | 8%  
新加坡 | 44个 | 1个 | 236ms | 13% | 伦敦 | 44个 | 0 | 289ms | 3%  
达拉斯 | 43个 | 0 | 238ms | 4% | 法兰克福 | 43个 | 1个 | 292ms | 5%  
均值 | 346个 | 4个 | 245ms | 6% |  |  |  |  |   
...
湖北电信到Linode各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 24个 | 2个 | 222ms | 22% | 纽瓦克 | 22个 | 0 | 267ms | 0  
佛利蒙 | 24个 | 0 | 217ms | 2% | 亚特兰大 | 25个 | 0 | 268ms | 3%  
新加坡 | 25个 | 1个 | 309ms | 22% | 伦敦 | 24个 | 0 | 252ms | 1%  
达拉斯 | 24个 | 0 | 238ms | 2% | 法兰克福 | 24个 | 1个 | 335ms | 7%  
均值 | 192个 | 4个 | 258ms | 7% |  |  |  |  |   
...
湖北联通到Linode各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 9个 | 0 | 205ms | 13% | 纽瓦克 | 8个 | 0 | 254ms | 0  
佛利蒙 | 9个 | 0 | 188ms | 4% | 亚特兰大 | 8个 | 0 | 238ms | 1%  
新加坡 | 8个 | 0 | 276ms | 11% | 伦敦 | 9个 | 0 | 281ms | 1%  
达拉斯 | 8个 | 0 | 214ms | 0 | 法兰克福 | 8个 | 0 | 319ms | 2%  
均值 | 67个 | 0 | 246ms | 4% |  |  |  |  |   
...
湖北移动到Linode各机房的测速数据 [20180527] 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率 | 机房所在地 | 测速点 | 超时点 | 响应均值 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
东京 | 10个 | 0 | 117ms | 4% | 纽瓦克 | 11个 | 0 | 259ms | 0  
佛利蒙 | 11个 | 0 | 201ms | 1% | 亚特兰大 | 11个 | 0 | 309ms | 19%  
新加坡 | 11个 | 0 | 123ms | 4% | 伦敦 | 11个 | 0 | 334ms | 8%  
达拉斯 | 11个 | 0 | 263ms | 9% | 法兰克福 | 11个 | 0 | 224ms | 6%  
均值 | 87个 | 0 | 230ms | 6% |  |  |  |  |   
