...
大陆各省份到Linode美国-纽瓦克机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广东 | 58个 | 0 | 274ms | 4.2% | 江西 | 21个 | 0 | 299ms | 4.2%  
湖南 | 40个 | 0 | 276ms | 3.3% | 黑龙江 | 32个 | 0 | 299ms | 4.8%  
河南 | 50个 | 0 | 277ms | 2.6% | 陕西 | 27个 | 0 | 301ms | 3.0%  
山东 | 46个 | 0 | 277ms | 3.8% | 安徽 | 41个 | 0 | 302ms | 4.7%  
广西 | 36个 | 0 | 280ms | 5.9% | 上海 | 7个 | 0 | 302ms | 3.0%  
山西 | 34个 | 0 | 281ms | 4.4% | 辽宁 | 34个 | 0 | 303ms | 7.2%  
海南 | 12个 | 0 | 286ms | 4.8% | 四川 | 43个 | 0 | 309ms | 5.6%  
河北 | 33个 | 0 | 291ms | 5.4% | 内蒙古 | 32个 | 0 | 310ms | 6.5%  
湖北 | 38个 | 0 | 292ms | 5.7% | 天津 | 5个 | 0 | 314ms | 18.3%  
青海 | 4个 | 0 | 294ms | 0 | 云南 | 22个 | 0 | 315ms | 5.1%  
福建 | 25个 | 0 | 294ms | 6.5% | 甘肃 | 21个 | 0 | 327ms | 4.9%  
吉林 | 16个 | 1个 | 294ms | 6.3% | 北京 | 4个 | 1个 | 328ms | 7.0%  
贵州 | 22个 | 0 | 296ms | 4.5% | 宁夏 | 10个 | 0 | 330ms | 4.3%  
均值 | 836个 | 6个 | 296ms | 5.1% | 重庆 | 10个 | 0 | 347ms | 10.7%  
江苏 | 49个 | 1个 | 297ms | 7.4% | 新疆 | 25个 | 1个 | 349ms | 4.3%  
浙江 | 38个 | 2个 | 298ms | 5.3% | 西藏 | 1个 | 0 | 440ms | 3.0%  
...
海外线路到Linode美国-纽瓦克机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 16ms | 0 | 韩国 | 12个 | 0 | 215ms | 0  
美国 | 15个 | 0 | 63ms | 0 | 香港 | 19个 | 0 | 229ms | 0  
法国 | 2个 | 0 | 77ms | 0 | 南非 | 1个 | 0 | 232ms | 0  
荷兰 | 2个 | 0 | 82ms | 0 | 澳大利亚 | 2个 | 0 | 236ms | 0.5%  
英国 | 3个 | 0 | 88ms | 0 | 新加坡 | 5个 | 0 | 243ms | 0  
德国 | 1个 | 0 | 99ms | 0 | 印度尼西亚 | 1个 | 0 | 247ms | 0  
俄罗斯 | 1个 | 0 | 171ms | 0 | 越南 | 1个 | 0 | 260ms | 1.0%  
日本 | 2个 | 0 | 189ms | 0 | 马来西亚 | 4个 | 0 | 263ms | 1.8%  
均值 | 77个 | 0 | 192ms | 0.7% | 菲律宾 | 1个 | 0 | 302ms | 4.0%  
台湾 | 1个 | 0 | 202ms | - | 柬埔寨 | 1个 | 0 | 439ms | 6.0%  
