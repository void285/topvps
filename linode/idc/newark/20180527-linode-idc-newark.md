#  多地到Linode纽瓦克[Newark]机房的Ping测试（20180527） 
...
大陆各省份到Linode美国-纽瓦克机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 8个 | 1个 | 242ms | 0.5% | 均值 | 965个 | 6个 | 265ms | 1.9%  
江苏 | 60个 | 1个 | 246ms | 1.1% | 陕西 | 34个 | 0 | 267ms | 4.0%  
上海 | 8个 | 0 | 246ms | 0.1% | 重庆 | 12个 | 0 | 269ms | 0.5%  
天津 | 5个 | 0 | 248ms | 6.4% | 广西 | 39个 | 0 | 270ms | 1.3%  
广东 | 75个 | 1个 | 248ms | 2.5% | 福建 | 35个 | 0 | 274ms | 0.3%  
浙江 | 48个 | 0 | 253ms | 0 | 内蒙古 | 34个 | 0 | 274ms | 4.8%  
安徽 | 37个 | 0 | 253ms | 0.1% | 青海 | 4个 | 0 | 275ms | 0  
江西 | 23个 | 0 | 255ms | 1.6% | 四川 | 49个 | 0 | 278ms | 3.2%  
河北 | 36个 | 0 | 255ms | 2.4% | 云南 | 23个 | 0 | 278ms | 2.3%  
辽宁 | 38个 | 0 | 255ms | 0.2% | 湖南 | 47个 | 0 | 278ms | 3.6%  
山东 | 52个 | 1个 | 257ms | 3.4% | 黑龙江 | 39个 | 0 | 279ms | 2.3%  
吉林 | 19个 | 1个 | 258ms | 7.9% | 宁夏 | 12个 | 0 | 280ms | 0.2%  
山西 | 37个 | 0 | 258ms | 0.1% | 甘肃 | 23个 | 0 | 283ms | 0.3%  
湖北 | 41个 | 0 | 260ms | 0.4% | 贵州 | 28个 | 0 | 290ms | 1.6%  
河南 | 56个 | 1个 | 263ms | 2.0% | 新疆 | 29个 | 0 | 312ms | 1.0%  
海南 | 14个 | 0 | 264ms | 0.1% |  |  |  |  |   
...
海外线路到Linode美国-纽瓦克机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 4个 | 0 | 15ms | 0 | 台湾 | 1个 | 0 | 200ms | -  
美国 | 21个 | 0 | 64ms | 2.1% | 韩国 | 12个 | 0 | 209ms | 0  
意大利 | 1个 | 0 | 71ms | - | 澳大利亚 | 2个 | 0 | 235ms | 0  
荷兰 | 1个 | 0 | 80ms | 0 | 越南 | 2个 | 0 | 240ms | 0  
英国 | 2个 | 0 | 85ms | 0 | 新加坡 | 5个 | 0 | 240ms | 0  
德国 | 3个 | 0 | 88ms | 0 | 香港 | 20个 | 0 | 243ms | 0  
法国 | 1个 | 0 | 90ms | 0 | 南非 | 2个 | 0 | 255ms | 1.5%  
巴西 | 1个 | 0 | 127ms | 0 | 马来西亚 | 5个 | 0 | 265ms | 0  
日本 | 1个 | 0 | 167ms | 0 | 印度尼西亚 | 1个 | 0 | 281ms | 0  
俄罗斯 | 1个 | 0 | 169ms | 0 | 菲律宾 | 1个 | 0 | 320ms | 0  
均值 | 88个 | 0 | 183ms | 0.6% | 柬埔寨 | 1个 | 0 | 408ms | 8.0%  
