...
大陆各省份到Linode英国-伦敦机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 27个 | 4个 | 233ms | 0 | 福建 | 169个 | 0 | 283ms | 8.4%  
江苏 | 339个 | 0 | 256ms | 0.4% | 海南 | 52个 | 0 | 283ms | 6.9%  
北京 | 32个 | 0 | 258ms | 1.0% | 天津 | 20个 | 0 | 284ms | 1.3%  
河南 | 371个 | 0 | 259ms | 1.7% | 山西 | 190个 | 0 | 284ms | 2.4%  
湖北 | 205个 | 0 | 262ms | 7.0% | 广东 | 438个 | 0 | 286ms | 2.5%  
河北 | 248个 | 0 | 263ms | 2.9% | 甘肃 | 112个 | 0 | 288ms | 1.9%  
青海 | 16个 | 0 | 264ms | 0 | 重庆 | 31个 | 3个 | 289ms | 10.7%  
江西 | 135个 | 0 | 265ms | 1.6% | 四川 | 289个 | 0 | 290ms | 8.2%  
安徽 | 240个 | 0 | 267ms | 2.2% | 湖南 | 265个 | 0 | 298ms | 11.2%  
陕西 | 175个 | 0 | 273ms | 0.3% | 云南 | 131个 | 0 | 302ms | 15.9%  
山东 | 338个 | 0 | 274ms | 1.6% | 内蒙古 | 228个 | 0 | 303ms | 1.7%  
浙江 | 244个 | 4个 | 274ms | 8.7% | 新疆 | 155个 | 0 | 307ms | 2.0%  
宁夏 | 32个 | 0 | 274ms | 5.1% | 黑龙江 | 200个 | 0 | 307ms | 1.9%  
辽宁 | 227个 | 0 | 278ms | 1.0% | 贵州 | 159个 | 0 | 309ms | 7.6%  
广西 | 235个 | 7个 | 280ms | 6.5% | 吉林 | 100个 | 0 | 326ms | 1.3%  
均值 | 5407个 | 18个 | 281ms | 4.1% | 西藏 | 4个 | 0 | 409ms | 3.0%  
...
海外线路到Linode英国-伦敦机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
巴西 | 3个 | 0 | 1ms | 0 | 均值 | 234个 | 3个 | 184ms | 1.4%  
意大利 | 3个 | 0 | 8ms | - | 香港 | 63个 | 3个 | 192ms | 0  
德国 | 9个 | 0 | 28ms | 0 | 印度尼西亚 | 6个 | 0 | 203ms | 0  
英国 | 6个 | 0 | 35ms | 0 | 韩国 | 21个 | 0 | 251ms | 0  
俄罗斯 | 3个 | 0 | 55ms | - | 台湾 | 3个 | 0 | 255ms | 0  
加拿大 | 15个 | 0 | 90ms | 0 | 日本 | 6个 | 0 | 259ms | 1.0%  
荷兰 | 3个 | 0 | 145ms | 0 | 马来西亚 | 12个 | 0 | 270ms | 0.5%  
美国 | 48个 | 0 | 156ms | 11.3% | 法国 | 3个 | 0 | 294ms | 0  
新加坡 | 15个 | 0 | 168ms | 0 | 澳大利亚 | 6个 | 0 | 318ms | 0  
南非 | 6个 | 0 | 181ms | 1.5% | 菲律宾 | 3个 | 0 | 586ms | 10.0%  
