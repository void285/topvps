...
大陆各省份到Linode英国-伦敦机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 8个 | 0 | 241ms | 1.9% | 四川 | 47个 | 0 | 292ms | 6.4%  
浙江 | 49个 | 1个 | 266ms | 2.7% | 均值 | 961个 | 9个 | 293ms | 5.0%  
北京 | 8个 | 1个 | 269ms | 2.0% | 广西 | 39个 | 0 | 295ms | 5.5%  
广东 | 78个 | 1个 | 271ms | 4.0% | 内蒙古 | 34个 | 0 | 296ms | 5.4%  
安徽 | 37个 | 0 | 273ms | 5.7% | 江西 | 23个 | 0 | 297ms | 4.9%  
天津 | 5个 | 0 | 275ms | 1.6% | 陕西 | 32个 | 1个 | 300ms | 5.5%  
青海 | 3个 | 0 | 276ms | 4.3% | 云南 | 21个 | 0 | 301ms | 4.4%  
湖北 | 44个 | 0 | 278ms | 3.6% | 宁夏 | 12个 | 0 | 304ms | 3.3%  
江苏 | 62个 | 2个 | 283ms | 5.7% | 湖南 | 47个 | 0 | 304ms | 10.2%  
河北 | 33个 | 0 | 285ms | 5.1% | 山西 | 36个 | 0 | 305ms | 3.6%  
重庆 | 15个 | 1个 | 288ms | 3.8% | 山东 | 50个 | 1个 | 306ms | 2.0%  
海南 | 14个 | 0 | 288ms | 4.8% | 贵州 | 27个 | 0 | 309ms | 11.3%  
吉林 | 19个 | 0 | 289ms | 3.3% | 甘肃 | 23个 | 0 | 309ms | 4.3%  
辽宁 | 40个 | 0 | 289ms | 4.2% | 黑龙江 | 40个 | 0 | 323ms | 5.9%  
福建 | 34个 | 0 | 291ms | 5.6% | 新疆 | 27个 | 0 | 352ms | 5.8%  
河南 | 54个 | 1个 | 292ms | 4.7% |  |  |  |  |   
...
海外线路到Linode英国-伦敦机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 1个 | 0 | 8ms | 0 | 印度尼西亚 | 1个 | 0 | 193ms | 0  
荷兰 | 1个 | 0 | 8ms | 0 | 巴西 | 1个 | 0 | 195ms | 0  
意大利 | 1个 | 0 | 8ms | - | 马来西亚 | 5个 | 0 | 231ms | 0  
英国 | 2个 | 0 | 17ms | 0 | 日本 | 1个 | 0 | 237ms | 0  
德国 | 3个 | 0 | 21ms | 0 | 香港 | 20个 | 0 | 239ms | 1.7%  
加拿大 | 3个 | 0 | 90ms | 0 | 越南 | 2个 | 0 | 239ms | 0  
俄罗斯 | 1个 | 0 | 104ms | 0 | 台湾 | 1个 | 0 | 259ms | -  
美国 | 21个 | 0 | 131ms | 1.0% | 韩国 | 12个 | 0 | 278ms | 0  
均值 | 86个 | 0 | 174ms | 0.7% | 澳大利亚 | 1个 | 0 | 336ms | 0  
南非 | 2个 | 0 | 185ms | 0 | 柬埔寨 | 1个 | 0 | 344ms | 10.0%  
新加坡 | 5个 | 0 | 190ms | 0 | 菲律宾 | 1个 | 0 | 353ms | 0  
