...
大陆各省份到Linode英国-伦敦机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
宁夏 | 5个 | 0 | 224ms | 0 | 浙江 | 66个 | 4个 | 284ms | 8.3%  
安徽 | 70个 | 1个 | 254ms | 3.7% | 海南 | 14个 | 0 | 285ms | 8.1%  
上海 | 7个 | 0 | 256ms | 7.8% | 甘肃 | 34个 | 0 | 286ms | 4.5%  
天津 | 7个 | 0 | 257ms | 14.6% | 重庆 | 8个 | 0 | 287ms | 11.3%  
江苏 | 90个 | 3个 | 260ms | 6.6% | 四川 | 71个 | 0 | 290ms | 3.4%  
河北 | 48个 | 0 | 261ms | 10.3% | 云南 | 27个 | 0 | 290ms | 2.4%  
广东 | 116个 | 3个 | 264ms | 5.9% | 河南 | 83个 | 0 | 292ms | 14.0%  
湖北 | 52个 | 0 | 268ms | 4.5% | 内蒙古 | 52个 | 0 | 294ms | 10.0%  
广西 | 56个 | 0 | 271ms | 5.0% | 贵州 | 39个 | 1个 | 295ms | 7.2%  
江西 | 41个 | 0 | 272ms | 4.1% | 山东 | 89个 | 0 | 296ms | 12.3%  
北京 | 7个 | 0 | 273ms | 8.9% | 青海 | 6个 | 0 | 303ms | 11.3%  
陕西 | 42个 | 0 | 277ms | 2.2% | 新疆 | 30个 | 0 | 314ms | 8.4%  
福建 | 41个 | 0 | 279ms | 4.8% | 山西 | 53个 | 1个 | 315ms | 15.2%  
湖南 | 62个 | 1个 | 280ms | 4.1% | 黑龙江 | 49个 | 0 | 323ms | 14.1%  
辽宁 | 57个 | 2个 | 282ms | 13.6% | 吉林 | 19个 | 0 | 344ms | 21.4%  
均值 | 1343个 | 16个 | 283ms | 8.0% | 西藏 | 2个 | 0 | 383ms | 11.5%  
...
海外线路到Linode英国-伦敦机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 1个 | 0 | 8ms | - | 台湾 | 2个 | 0 | 196ms | 0  
德国 | 3个 | 0 | 29ms | 0 | 赞比亚 | 2个 | 0 | 209ms | 10.3%  
俄罗斯 | 1个 | 0 | 53ms | - | 越南 | 2个 | 0 | 241ms | 0  
加拿大 | 3个 | 0 | 76ms | 0 | 马来西亚 | 6个 | 0 | 241ms | 0  
荷兰 | 1个 | 0 | 101ms | 0 | 日本 | 3个 | 0 | 246ms | 1.1%  
美国 | 15个 | 0 | 136ms | 0 | 韩国 | 12个 | 0 | 249ms | 0  
新加坡 | 5个 | 0 | 161ms | 0 | 澳大利亚 | 1个 | 0 | 292ms | 0  
香港 | 19个 | 0 | 182ms | 0 | 印度尼西亚 | 1个 | 0 | 303ms | 3.3%  
均值 | 79个 | 0 | 183ms | 3.4% | 菲律宾 | 2个 | 0 | 396ms | 35.5%  
