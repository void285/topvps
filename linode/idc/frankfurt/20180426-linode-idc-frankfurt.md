#  多地到Linode法兰克福[Frankfurt]机房的Ping测试（20180426） 
...
大陆各省份到Linode德国-法兰克福机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
重庆 | 8个 | 0 | 225ms | 16.0% | 河北 | 30个 | 0 | 349ms | 14.2%  
北京 | 4个 | 1个 | 247ms | 21.0% | 均值 | 817个 | 5个 | 350ms | 17.0%  
云南 | 24个 | 0 | 281ms | 8.6% | 山东 | 45个 | 0 | 356ms | 9.8%  
广西 | 34个 | 0 | 288ms | 13.4% | 海南 | 12个 | 0 | 364ms | 12.4%  
西藏 | 1个 | 0 | 295ms | 26.0% | 宁夏 | 10个 | 0 | 380ms | 26.0%  
广东 | 61个 | 0 | 316ms | 9.2% | 新疆 | 28个 | 0 | 381ms | 30.1%  
贵州 | 21个 | 0 | 317ms | 15.9% | 福建 | 24个 | 0 | 383ms | 15.3%  
辽宁 | 33个 | 0 | 323ms | 14.3% | 内蒙古 | 30个 | 0 | 383ms | 21.2%  
陕西 | 24个 | 1个 | 325ms | 13.1% | 浙江 | 37个 | 2个 | 388ms | 18.7%  
河南 | 50个 | 0 | 326ms | 15.8% | 山西 | 31个 | 0 | 391ms | 13.4%  
江苏 | 46个 | 1个 | 326ms | 24.6% | 安徽 | 39个 | 0 | 401ms | 17.3%  
湖北 | 39个 | 0 | 330ms | 23.3% | 江西 | 21个 | 0 | 410ms | 21.2%  
四川 | 42个 | 0 | 338ms | 17.9% | 甘肃 | 20个 | 0 | 444ms | 26.9%  
吉林 | 15个 | 0 | 338ms | 15.5% | 青海 | 4个 | 0 | 449ms | 37.0%  
湖南 | 40个 | 0 | 342ms | 16.6% | 天津 | 5个 | 0 | 494ms | 30.3%  
黑龙江 | 31个 | 0 | 346ms | 15.4% | 上海 | 8个 | 0 | 519ms | 20.9%  
...
海外线路到Linode德国-法兰克福机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
德国 | 1个 | 0 | 0 | 0 | 印度尼西亚 | 1个 | 0 | 194ms | 14.0%  
荷兰 | 2个 | 0 | 11ms | 0 | 香港 | 20个 | 0 | 220ms | 0  
法国 | 2个 | 0 | 14ms | 1.0% | 马来西亚 | 4个 | 0 | 220ms | 0.5%  
英国 | 3个 | 0 | 32ms | 0 | 越南 | 1个 | 0 | 229ms | 0  
俄罗斯 | 1个 | 0 | 95ms | 0 | 日本 | 3个 | 0 | 261ms | 0  
加拿大 | 3个 | 0 | 106ms | 0 | 台湾 | 1个 | 0 | 264ms | -  
美国 | 16个 | 0 | 148ms | 0 | 韩国 | 12个 | 0 | 293ms | 0.2%  
南非 | 1个 | 0 | 174ms | 0 | 澳大利亚 | 2个 | 0 | 327ms | 0  
均值 | 80个 | 0 | 185ms | 1.5% | 菲律宾 | 1个 | 0 | 327ms | 2.0%  
新加坡 | 5个 | 0 | 191ms | 0 | 柬埔寨 | 1个 | 0 | 417ms | 9.0%  
