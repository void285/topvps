#  多地到Linode法兰克福[Frankfurt]机房的Ping测试（20180622） 
...
大陆各省份到Linode德国-法兰克福机房的测速数据 [20180622] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 8个 | 0 | 235ms | 1.7% | 甘肃 | 16个 | 0 | 370ms | 6.3%  
天津 | 3个 | 0 | 249ms | 1.0% | 均值 | 863个 | 18个 | 370ms | 6.6%  
河北 | 34个 | 0 | 309ms | 4.5% | 新疆 | 19个 | 0 | 376ms | 6.9%  
山西 | 34个 | 0 | 311ms | 2.8% | 广西 | 42个 | 0 | 383ms | 7.9%  
福建 | 29个 | 0 | 315ms | 4.4% | 湖北 | 33个 | 0 | 389ms | 7.5%  
安徽 | 35个 | 1个 | 318ms | 4.3% | 海南 | 10个 | 0 | 397ms | 8.0%  
内蒙古 | 32个 | 0 | 322ms | 3.8% | 黑龙江 | 30个 | 1个 | 401ms | 8.3%  
河南 | 49个 | 1个 | 331ms | 4.4% | 重庆 | 12个 | 1个 | 404ms | 8.1%  
浙江 | 49个 | 1个 | 333ms | 4.6% | 江西 | 23个 | 0 | 423ms | 7.6%  
陕西 | 29个 | 1个 | 336ms | 5.2% | 吉林 | 17个 | 0 | 448ms | 11.1%  
辽宁 | 33个 | 0 | 355ms | 7.8% | 宁夏 | 14个 | 0 | 480ms | 13.4%  
湖南 | 35个 | 0 | 362ms | 6.8% | 青海 | 5个 | 0 | 491ms | 17.0%  
广东 | 76个 | 0 | 364ms | 6.3% | 四川 | 40个 | 0 | 504ms | 12.3%  
贵州 | 25个 | 0 | 365ms | 8.0% | 云南 | 22个 | 9个 | 546ms | 13.1%  
江苏 | 65个 | 2个 | 366ms | 5.8% | 上海 | 8个 | 1个 | 546ms | 14.4%  
山东 | 36个 | 0 | 370ms | 5.3% |  |  |  |  |   
...
海外线路到Linode德国-法兰克福机房的测速数据 [20180622] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
法国 | 1个 | 0 | 1ms | 0 | 香港 | 21个 | 0 | 206ms | 0  
德国 | 1个 | 0 | 9ms | - | 马来西亚 | 4个 | 0 | 221ms | 0.3%  
巴西 | 1个 | 0 | 10ms | 0 | 菲律宾 | 2个 | 0 | 240ms | 0  
意大利 | 1个 | 0 | 11ms | - | 台湾 | 2个 | 0 | 263ms | 0  
英国 | 1个 | 0 | 49ms | 0 | 日本 | 2个 | 0 | 268ms | 0  
加拿大 | 2个 | 0 | 105ms | 0 | 韩国 | 13个 | 0 | 272ms | 0  
美国 | 19个 | 0 | 140ms | 0 | 越南 | 2个 | 0 | 295ms | 0  
新加坡 | 5个 | 0 | 164ms | 0 | 澳大利亚 | 1个 | 0 | 307ms | 0  
均值 | 81个 | 0 | 170ms | 0 | 柬埔寨 | 1个 | 0 | 307ms | 0  
南非 | 2个 | 0 | 192ms | 0 |  |  |  |  |   
