...
大陆各省份到Linode德国-法兰克福机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 8个 | 1个 | 235ms | 2.3% | 均值 | 967个 | 12个 | 278ms | 3.9%  
青海 | 4个 | 0 | 236ms | 2.0% | 湖南 | 47个 | 3个 | 279ms | 6.8%  
天津 | 5个 | 0 | 246ms | 0 | 山东 | 52个 | 1个 | 283ms | 2.8%  
宁夏 | 12个 | 0 | 251ms | 1.1% | 重庆 | 15个 | 1个 | 283ms | 5.0%  
安徽 | 36个 | 0 | 260ms | 3.9% | 浙江 | 48个 | 0 | 287ms | 1.7%  
辽宁 | 38个 | 0 | 260ms | 12.0% | 湖北 | 43个 | 1个 | 287ms | 6.2%  
江苏 | 63个 | 3个 | 261ms | 3.1% | 江西 | 25个 | 0 | 289ms | 2.5%  
广东 | 82个 | 0 | 261ms | 2.1% | 甘肃 | 23个 | 0 | 290ms | 4.4%  
河北 | 34个 | 0 | 263ms | 8.4% | 广西 | 39个 | 0 | 291ms | 5.9%  
上海 | 8个 | 0 | 265ms | 3.6% | 福建 | 35个 | 0 | 293ms | 2.2%  
山西 | 35个 | 0 | 271ms | 2.4% | 贵州 | 27个 | 0 | 294ms | 5.4%  
河南 | 53个 | 1个 | 272ms | 2.0% | 新疆 | 27个 | 0 | 294ms | 2.9%  
内蒙古 | 34个 | 0 | 272ms | 2.7% | 云南 | 22个 | 0 | 306ms | 3.9%  
海南 | 14个 | 0 | 272ms | 2.6% | 四川 | 47个 | 1个 | 313ms | 4.8%  
陕西 | 32个 | 0 | 274ms | 3.2% | 吉林 | 19个 | 0 | 315ms | 2.5%  
黑龙江 | 40个 | 0 | 275ms | 2.3% |  |  |  |  |   
...
海外线路到Linode德国-法兰克福机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
意大利 | 1个 | 0 | 9ms | - | 印度尼西亚 | 1个 | 0 | 208ms | 0  
法国 | 1个 | 0 | 10ms | 0 | 香港 | 20个 | 0 | 217ms | 1.7%  
荷兰 | 1个 | 0 | 10ms | 0 | 马来西亚 | 5个 | 0 | 218ms | 0.2%  
德国 | 3个 | 0 | 12ms | 0 | 巴西 | 1个 | 0 | 219ms | 0  
英国 | 2个 | 0 | 34ms | 0 | 日本 | 1个 | 0 | 244ms | 0  
俄罗斯 | 1个 | 0 | 95ms | 0 | 越南 | 2个 | 0 | 261ms | 0.5%  
加拿大 | 3个 | 0 | 98ms | 0 | 韩国 | 12个 | 0 | 282ms | 0  
美国 | 21个 | 1个 | 152ms | 2.8% | 台湾 | 1个 | 0 | 289ms | -  
均值 | 87个 | 1个 | 180ms | 0.5% | 澳大利亚 | 1个 | 0 | 330ms | 0  
新加坡 | 6个 | 0 | 190ms | 0 | 柬埔寨 | 1个 | 0 | 334ms | 2.0%  
南非 | 2个 | 0 | 201ms | 0.5% | 菲律宾 | 1个 | 0 | 374ms | 2.0%  
