...
大陆各省份到Linode新加坡-新加坡机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 132ms | 3.3% | 青海 | 4个 | 0 | 179ms | 24.8%  
河南 | 49个 | 1个 | 133ms | 17.5% | 江西 | 19个 | 0 | 183ms | 14.6%  
山东 | 46个 | 0 | 133ms | 14.4% | 宁夏 | 10个 | 0 | 185ms | 13.2%  
山西 | 31个 | 0 | 146ms | 10.9% | 四川 | 43个 | 0 | 186ms | 8.5%  
安徽 | 38个 | 0 | 151ms | 16.2% | 海南 | 12个 | 0 | 186ms | 10.8%  
江苏 | 50个 | 1个 | 152ms | 14.2% | 西藏 | 1个 | 0 | 190ms | 47.0%  
陕西 | 27个 | 0 | 154ms | 13.8% | 湖南 | 38个 | 0 | 191ms | 16.0%  
浙江 | 36个 | 2个 | 162ms | 14.3% | 上海 | 8个 | 0 | 193ms | 12.6%  
广东 | 60个 | 0 | 162ms | 10.4% | 辽宁 | 34个 | 0 | 197ms | 10.1%  
内蒙古 | 30个 | 1个 | 163ms | 13.5% | 福建 | 27个 | 0 | 201ms | 10.9%  
河北 | 27个 | 0 | 166ms | 9.3% | 湖北 | 36个 | 0 | 202ms | 12.4%  
黑龙江 | 32个 | 0 | 170ms | 11.6% | 甘肃 | 21个 | 1个 | 211ms | 21.1%  
吉林 | 15个 | 0 | 170ms | 6.1% | 新疆 | 26个 | 0 | 215ms | 19.6%  
均值 | 818个 | 7个 | 173ms | 13.3% | 贵州 | 21个 | 0 | 221ms | 13.5%  
广西 | 33个 | 0 | 176ms | 12.3% | 北京 | 4个 | 1个 | 250ms | 0.3%  
云南 | 26个 | 0 | 177ms | 15.0% | 重庆 | 9个 | 0 | 285ms | 17.1%  
...
海外线路到Linode新加坡-新加坡机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
新加坡 | 5个 | 0 | 1ms | 0 | 均值 | 79个 | 2个 | 155ms | 0.6%  
马来西亚 | 4个 | 0 | 22ms | 0 | 德国 | 1个 | 0 | 167ms | 0  
印度尼西亚 | 1个 | 0 | 23ms | 0 | 柬埔寨 | 1个 | 0 | 178ms | 0  
香港 | 20个 | 1个 | 61ms | 0 | 美国 | 16个 | 1个 | 196ms | 0  
台湾 | 1个 | 0 | 63ms | - | 荷兰 | 2个 | 0 | 212ms | 0  
越南 | 1个 | 0 | 66ms | 0 | 英国 | 3个 | 0 | 227ms | 0  
日本 | 2个 | 0 | 80ms | 0.5% | 加拿大 | 3个 | 0 | 245ms | 0.5%  
菲律宾 | 1个 | 0 | 85ms | 0 | 法国 | 2个 | 0 | 276ms | 0  
韩国 | 12个 | 0 | 114ms | 0 | 俄罗斯 | 1个 | 0 | 325ms | 0  
澳大利亚 | 2个 | 0 | 120ms | 0.5% | 南非 | 1个 | 0 | 489ms | 10.0%  
