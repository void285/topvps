#  多地到Linode亚特兰大[Atlanta]机房的Ping测试（20180426） 
...
大陆各省份到Linode美国-亚特兰大机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 4个 | 0 | 250ms | 25.3% | 均值 | 832个 | 6个 | 300ms | 18.4%  
上海 | 8个 | 0 | 271ms | 10.1% | 北京 | 3个 | 1个 | 302ms | 35.0%  
江苏 | 48个 | 1个 | 272ms | 10.3% | 内蒙古 | 31个 | 0 | 302ms | 19.4%  
湖北 | 36个 | 0 | 275ms | 15.4% | 陕西 | 27个 | 0 | 305ms | 18.6%  
广东 | 57个 | 0 | 278ms | 16.2% | 宁夏 | 10个 | 0 | 311ms | 18.2%  
广西 | 33个 | 1个 | 280ms | 16.7% | 河南 | 51个 | 1个 | 315ms | 26.9%  
河北 | 30个 | 0 | 280ms | 17.9% | 黑龙江 | 34个 | 0 | 316ms | 21.0%  
山西 | 31个 | 0 | 281ms | 18.8% | 重庆 | 10个 | 0 | 316ms | 22.4%  
浙江 | 40个 | 2个 | 284ms | 13.1% | 安徽 | 39个 | 0 | 318ms | 23.9%  
海南 | 12个 | 0 | 285ms | 16.7% | 福建 | 27个 | 0 | 320ms | 22.4%  
贵州 | 22个 | 0 | 287ms | 12.7% | 江西 | 20个 | 0 | 321ms | 22.8%  
湖南 | 41个 | 0 | 287ms | 16.6% | 云南 | 24个 | 0 | 340ms | 24.2%  
山东 | 47个 | 0 | 288ms | 14.4% | 甘肃 | 21个 | 0 | 360ms | 26.1%  
吉林 | 16个 | 0 | 291ms | 15.2% | 青海 | 4个 | 0 | 362ms | 34.8%  
四川 | 43个 | 0 | 295ms | 16.5% | 新疆 | 27个 | 0 | 388ms | 26.0%  
辽宁 | 35个 | 0 | 295ms | 15.5% | 西藏 | 1个 | 0 | 468ms | 28.0%  
...
海外线路到Linode美国-亚特兰大机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 30ms | 0 | 韩国 | 12个 | 0 | 208ms | 0  
美国 | 16个 | 0 | 48ms | 0 | 香港 | 20个 | 0 | 221ms | 0  
荷兰 | 2个 | 0 | 96ms | 0 | 新加坡 | 5个 | 0 | 224ms | 0  
法国 | 2个 | 0 | 97ms | 0 | 澳大利亚 | 2个 | 0 | 229ms | 0  
英国 | 3个 | 0 | 101ms | 0 | 印度尼西亚 | 1个 | 0 | 239ms | 1.0%  
德国 | 1个 | 0 | 107ms | 0 | 马来西亚 | 4个 | 0 | 240ms | 0  
日本 | 3个 | 0 | 189ms | 0 | 南非 | 1个 | 0 | 247ms | 0  
均值 | 80个 | 0 | 191ms | 0.5% | 菲律宾 | 1个 | 0 | 276ms | 2.0%  
俄罗斯 | 1个 | 0 | 198ms | 0 | 越南 | 1个 | 0 | 281ms | 0  
台湾 | 1个 | 0 | 203ms | - | 柬埔寨 | 1个 | 0 | 403ms | 6.0%  
