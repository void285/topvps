...
大陆各省份到Linode美国-亚特兰大机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 4个 | 0 | 215ms | 2.5% | 宁夏 | 11个 | 0 | 276ms | 16.2%  
上海 | 8个 | 0 | 226ms | 5.4% | 均值 | 951个 | 14个 | 283ms | 15.9%  
吉林 | 13个 | 0 | 236ms | 0.9% | 甘肃 | 22个 | 0 | 289ms | 19.8%  
北京 | 7个 | 1个 | 247ms | 16.8% | 江西 | 25个 | 0 | 291ms | 16.0%  
陕西 | 33个 | 0 | 256ms | 11.3% | 海南 | 10个 | 0 | 297ms | 16.9%  
辽宁 | 41个 | 0 | 257ms | 14.2% | 青海 | 3个 | 0 | 301ms | 27.3%  
河北 | 30个 | 0 | 258ms | 8.8% | 湖北 | 46个 | 0 | 303ms | 14.3%  
山东 | 53个 | 1个 | 259ms | 18.0% | 广东 | 74个 | 3个 | 304ms | 18.2%  
江苏 | 63个 | 1个 | 260ms | 17.0% | 湖南 | 44个 | 0 | 307ms | 20.0%  
安徽 | 41个 | 1个 | 260ms | 18.2% | 贵州 | 27个 | 1个 | 309ms | 16.8%  
山西 | 34个 | 0 | 264ms | 16.0% | 新疆 | 30个 | 1个 | 311ms | 16.8%  
河南 | 54个 | 0 | 268ms | 17.9% | 重庆 | 15个 | 0 | 313ms | 14.9%  
福建 | 33个 | 1个 | 270ms | 10.5% | 广西 | 37个 | 0 | 318ms | 21.0%  
黑龙江 | 38个 | 0 | 272ms | 16.1% | 四川 | 47个 | 0 | 329ms | 14.1%  
浙江 | 49个 | 4个 | 274ms | 13.3% | 云南 | 24个 | 0 | 338ms | 25.0%  
...
海外线路到Linode美国-亚特兰大机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 37ms | 0 | 俄罗斯 | 1个 | 0 | 196ms | 0  
美国 | 19个 | 0 | 49ms | 0 | 日本 | 2个 | 0 | 200ms | 1.0%  
法国 | 2个 | 0 | 97ms | 0 | 澳大利亚 | 2个 | 0 | 210ms | 0.5%  
英国 | 2个 | 0 | 104ms | 0 | 新加坡 | 6个 | 0 | 221ms | 0  
德国 | 2个 | 0 | 113ms | 0 | 菲律宾 | 1个 | 0 | 223ms | 1.0%  
巴西 | 1个 | 0 | 121ms | 0 | 香港 | 18个 | 0 | 232ms | 0  
均值 | 79个 | 0 | 186ms | 0.4% | 马来西亚 | 4个 | 0 | 266ms | 1.0%  
台湾 | 1个 | 0 | 190ms | - | 南非 | 1个 | 0 | 294ms | 0  
韩国 | 13个 | 0 | 192ms | 0 | 印度尼西亚 | 1个 | 0 | 417ms | 3.0%  
