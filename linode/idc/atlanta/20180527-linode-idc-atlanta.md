#  多地到Linode亚特兰大[Atlanta]机房的Ping测试（20180527） 
...
大陆各省份到Linode美国-亚特兰大机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 8个 | 1个 | 238ms | 1.9% | 均值 | 970个 | 7个 | 275ms | 9.0%  
江苏 | 61个 | 1个 | 241ms | 1.5% | 四川 | 48个 | 0 | 279ms | 8.0%  
上海 | 8个 | 0 | 242ms | 3.6% | 江西 | 25个 | 0 | 279ms | 9.3%  
浙江 | 51个 | 0 | 250ms | 2.4% | 安徽 | 37个 | 0 | 279ms | 12.1%  
天津 | 5个 | 0 | 252ms | 7.8% | 河南 | 52个 | 1个 | 282ms | 11.5%  
吉林 | 19个 | 0 | 255ms | 3.3% | 山西 | 36个 | 1个 | 282ms | 10.3%  
福建 | 37个 | 0 | 263ms | 6.4% | 宁夏 | 12个 | 0 | 283ms | 10.3%  
河北 | 34个 | 0 | 263ms | 9.6% | 陕西 | 33个 | 0 | 285ms | 10.2%  
广东 | 76个 | 2个 | 265ms | 9.5% | 湖南 | 45个 | 0 | 287ms | 14.0%  
辽宁 | 41个 | 0 | 266ms | 8.0% | 黑龙江 | 40个 | 0 | 289ms | 11.6%  
海南 | 13个 | 0 | 268ms | 8.9% | 贵州 | 28个 | 0 | 291ms | 12.0%  
山东 | 52个 | 1个 | 270ms | 9.3% | 云南 | 22个 | 0 | 292ms | 10.7%  
重庆 | 15个 | 0 | 272ms | 6.8% | 甘肃 | 23个 | 0 | 312ms | 10.9%  
广西 | 39个 | 0 | 274ms | 10.9% | 青海 | 4个 | 0 | 326ms | 16.3%  
内蒙古 | 34个 | 0 | 274ms | 8.2% | 新疆 | 28个 | 0 | 345ms | 14.2%  
湖北 | 44个 | 0 | 275ms | 7.4% |  |  |  |  |   
...
海外线路到Linode美国-亚特兰大机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 3个 | 0 | 39ms | 0 | 台湾 | 1个 | 0 | 200ms | -  
美国 | 21个 | 0 | 47ms | 0.7% | 日本 | 1个 | 0 | 213ms | 0  
意大利 | 1个 | 0 | 94ms | - | 香港 | 20个 | 0 | 228ms | 0  
荷兰 | 1个 | 0 | 95ms | 0 | 澳大利亚 | 2个 | 0 | 231ms | 0  
法国 | 1个 | 0 | 98ms | 0 | 新加坡 | 5个 | 0 | 237ms | 0  
英国 | 2个 | 0 | 104ms | 0 | 越南 | 2个 | 0 | 242ms | 0  
德国 | 3个 | 0 | 120ms | 10.0% | 马来西亚 | 5个 | 0 | 256ms | 0  
巴西 | 1个 | 0 | 121ms | 0 | 印度尼西亚 | 1个 | 0 | 262ms | 0  
俄罗斯 | 1个 | 0 | 184ms | 0 | 南非 | 2个 | 0 | 277ms | 1.5%  
均值 | 87个 | 0 | 188ms | 0.9% | 菲律宾 | 1个 | 0 | 349ms | 2.0%  
韩国 | 12个 | 0 | 199ms | 0 | 柬埔寨 | 1个 | 0 | 360ms | 2.0%  
