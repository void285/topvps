...
大陆各省份到Linode美国-亚特兰大机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广东 | 418个 | 3个 | 259ms | 2.6% | 云南 | 127个 | 0 | 287ms | 7.5%  
海南 | 52个 | 0 | 265ms | 3.4% | 重庆 | 31个 | 0 | 289ms | 3.0%  
山东 | 362个 | 0 | 268ms | 3.1% | 河南 | 347个 | 0 | 290ms | 8.3%  
天津 | 20个 | 0 | 270ms | 11.5% | 贵州 | 151个 | 0 | 290ms | 4.3%  
北京 | 36个 | 0 | 271ms | 9.2% | 四川 | 285个 | 3个 | 291ms | 3.5%  
湖南 | 261个 | 3个 | 272ms | 2.8% | 吉林 | 100个 | 0 | 296ms | 6.4%  
浙江 | 244个 | 10个 | 273ms | 5.4% | 江西 | 139个 | 7个 | 297ms | 7.7%  
河北 | 244个 | 0 | 273ms | 5.7% | 内蒙古 | 228个 | 0 | 300ms | 7.4%  
江苏 | 337个 | 6个 | 274ms | 5.2% | 上海 | 31个 | 4个 | 302ms | 8.5%  
湖北 | 209个 | 0 | 274ms | 5.4% | 辽宁 | 227个 | 0 | 305ms | 10.1%  
广西 | 239个 | 0 | 274ms | 5.7% | 黑龙江 | 200个 | 0 | 306ms | 6.0%  
山西 | 194个 | 0 | 275ms | 4.7% | 陕西 | 163个 | 0 | 316ms | 5.8%  
安徽 | 244个 | 0 | 282ms | 8.7% | 青海 | 16个 | 0 | 325ms | 13.7%  
均值 | 5389个 | 39个 | 285ms | 5.8% | 新疆 | 163个 | 0 | 328ms | 3.5%  
宁夏 | 32个 | 0 | 286ms | 6.3% | 甘肃 | 112个 | 0 | 331ms | 8.8%  
福建 | 169个 | 3个 | 287ms | 9.1% | 西藏 | 8个 | 0 | 458ms | 14.2%  
...
海外线路到Linode美国-亚特兰大机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
加拿大 | 15个 | 0 | 36ms | 0 | 新加坡 | 15个 | 0 | 193ms | 0  
荷兰 | 3个 | 0 | 52ms | 0 | 南非 | 6个 | 0 | 197ms | 0.5%  
美国 | 48个 | 0 | 85ms | 0.2% | 香港 | 66个 | 0 | 198ms | 0  
巴西 | 3个 | 0 | 89ms | 0 | 韩国 | 21个 | 0 | 198ms | 0  
意大利 | 3个 | 0 | 92ms | - | 台湾 | 3个 | 0 | 200ms | 0  
德国 | 9个 | 0 | 113ms | 0 | 法国 | 3个 | 0 | 218ms | 0  
英国 | 6个 | 0 | 122ms | 0 | 澳大利亚 | 6个 | 0 | 243ms | 0  
俄罗斯 | 3个 | 0 | 136ms | - | 印度尼西亚 | 6个 | 0 | 259ms | 0  
日本 | 3个 | 0 | 180ms | 3.0% | 马来西亚 | 12个 | 0 | 266ms | 1.0%  
均值 | 234个 | 0 | 181ms | 1.1% | 菲律宾 | 3个 | 0 | 576ms | 13.3%  
