...
大陆各省份到Linode美国-佛利蒙机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
重庆 | 2个 | 0 | 91ms | 1.0% | 湖南 | 10个 | 0 | 179ms | 8.1%  
北京 | 4个 | 1个 | 129ms | 19.7% | 山西 | 10个 | 0 | 179ms | 7.0%  
四川 | 18个 | 0 | 140ms | 2.5% | 贵州 | 5个 | 0 | 180ms | 8.0%  
山东 | 25个 | 0 | 150ms | 4.4% | 福建 | 16个 | 0 | 186ms | 5.9%  
广东 | 16个 | 0 | 161ms | 1.6% | 河北 | 16个 | 1个 | 188ms | 3.0%  
宁夏 | 5个 | 0 | 162ms | 1.2% | 河南 | 7个 | 0 | 189ms | 1.0%  
广西 | 16个 | 0 | 163ms | 2.4% | 江苏 | 15个 | 1个 | 191ms | 10.2%  
甘肃 | 7个 | 1个 | 167ms | 4.2% | 上海 | 6个 | 0 | 193ms | 1.2%  
湖北 | 20个 | 0 | 169ms | 2.1% | 安徽 | 5个 | 0 | 194ms | 3.8%  
天津 | 3个 | 0 | 171ms | 21.0% | 内蒙古 | 14个 | 0 | 194ms | 2.8%  
黑龙江 | 11个 | 0 | 171ms | 5.8% | 陕西 | 6个 | 0 | 197ms | 1.7%  
吉林 | 6个 | 0 | 171ms | 8.0% | 海南 | 3个 | 0 | 197ms | 5.7%  
均值 | 301个 | 6个 | 174ms | 4.4% | 云南 | 7个 | 0 | 206ms | 2.3%  
江西 | 5个 | 0 | 175ms | 3.4% | 青海 | 1个 | 0 | 222ms | 0  
辽宁 | 14个 | 0 | 175ms | 4.2% | 新疆 | 7个 | 0 | 231ms | 1.7%  
浙江 | 20个 | 2个 | 178ms | 5.4% | 西藏 | 1个 | 0 | 250ms | 0  
...
海外线路到Linode美国-佛利蒙机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 16个 | 0 | 17ms | 0 | 新加坡 | 5个 | 0 | 174ms | 0  
加拿大 | 3个 | 0 | 68ms | 0 | 均值 | 80个 | 0 | 184ms | 0.3%  
日本 | 3个 | 0 | 120ms | 0 | 澳大利亚 | 2个 | 0 | 192ms | 0  
荷兰 | 2个 | 0 | 142ms | 0 | 越南 | 1个 | 0 | 215ms | 0  
英国 | 3个 | 0 | 147ms | 0 | 马来西亚 | 4个 | 0 | 237ms | 0.5%  
韩国 | 12个 | 0 | 150ms | 0.2% | 俄罗斯 | 1个 | 0 | 238ms | 0  
法国 | 2个 | 0 | 151ms | 0 | 菲律宾 | 1个 | 0 | 239ms | 1.0%  
德国 | 1个 | 0 | 160ms | 0 | 印度尼西亚 | 1个 | 0 | 269ms | 0  
香港 | 20个 | 0 | 162ms | 0 | 南非 | 1个 | 0 | 288ms | 0  
台湾 | 1个 | 0 | 173ms | - | 柬埔寨 | 1个 | 0 | 364ms | 4.0%  
