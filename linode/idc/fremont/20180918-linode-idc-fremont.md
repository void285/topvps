...
大陆各省份到Linode美国-佛利蒙机房的测速数据 [20180918] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
北京 | 7个 | 0 | 180ms | 4.4% | 均值 | 1399个 | 14个 | 209ms | 6.1%  
福建 | 42个 | 1个 | 185ms | 2.6% | 辽宁 | 57个 | 0 | 210ms | 12.9%  
安徽 | 71个 | 0 | 185ms | 2.7% | 贵州 | 42个 | 0 | 211ms | 3.3%  
广东 | 117个 | 2个 | 187ms | 4.0% | 陕西 | 45个 | 0 | 212ms | 4.0%  
江苏 | 90个 | 5个 | 188ms | 4.7% | 山东 | 94个 | 0 | 214ms | 10.3%  
广西 | 61个 | 0 | 189ms | 3.9% | 内蒙古 | 54个 | 0 | 217ms | 8.3%  
宁夏 | 7个 | 0 | 191ms | 0 | 四川 | 70个 | 1个 | 218ms | 4.1%  
江西 | 41个 | 1个 | 193ms | 2.9% | 甘肃 | 33个 | 0 | 218ms | 0.5%  
海南 | 13个 | 0 | 199ms | 6.6% | 云南 | 29个 | 0 | 221ms | 3.3%  
浙江 | 66个 | 3个 | 201ms | 3.5% | 山西 | 55个 | 1个 | 225ms | 9.5%  
天津 | 6个 | 0 | 201ms | 0.2% | 河南 | 88个 | 0 | 230ms | 14.4%  
重庆 | 8个 | 0 | 201ms | 5.3% | 吉林 | 23个 | 0 | 242ms | 14.2%  
河北 | 55个 | 0 | 202ms | 6.4% | 新疆 | 33个 | 0 | 246ms | 7.4%  
湖南 | 69个 | 0 | 202ms | 3.6% | 黑龙江 | 54个 | 0 | 249ms | 7.0%  
湖北 | 52个 | 0 | 208ms | 1.9% | 青海 | 6个 | 0 | 277ms | 13.2%  
上海 | 7个 | 0 | 209ms | 9.5% | 西藏 | 4个 | 0 | 306ms | 3.3%  
...
海外线路到Linode美国-佛利蒙机房的测速数据 [20180918] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
台湾 | 1个 | 0 | 22ms | 0 | 香港 | 17个 | 0 | 166ms | 0  
美国 | 12个 | 0 | 41ms | 0.2% | 均值 | 71个 | 0 | 176ms | 2.8%  
加拿大 | 3个 | 0 | 73ms | 0 | 澳大利亚 | 2个 | 0 | 184ms | 0  
韩国 | 10个 | 0 | 125ms | 0 | 越南 | 2个 | 0 | 207ms | 0.5%  
新加坡 | 5个 | 0 | 135ms | 0 | 印度尼西亚 | 1个 | 0 | 210ms | 0  
意大利 | 1个 | 0 | 140ms | - | 荷兰 | 1个 | 0 | 232ms | 0  
日本 | 2个 | 0 | 155ms | 0 | 马来西亚 | 6个 | 0 | 240ms | 0  
俄罗斯 | 2个 | 0 | 155ms | 0 | 赞比亚 | 1个 | 0 | 351ms | 13.3%  
德国 | 3个 | 0 | 165ms | 0 | 菲律宾 | 2个 | 0 | 396ms | 30.5%  
