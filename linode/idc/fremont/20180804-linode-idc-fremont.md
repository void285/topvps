#  多地到Linode佛利蒙[Fremont]机房的Ping测试（20180804） 
...
大陆各省份到Linode美国-佛利蒙机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
广东 | 461个 | 3个 | 178ms | 3.3% | 吉林 | 100个 | 0 | 207ms | 3.6%  
福建 | 172个 | 0 | 185ms | 5.0% | 均值 | 5553个 | 40个 | 207ms | 8.1%  
北京 | 32个 | 0 | 187ms | 6.4% | 山东 | 370个 | 0 | 208ms | 12.7%  
天津 | 20个 | 0 | 188ms | 12.7% | 辽宁 | 226个 | 0 | 211ms | 5.9%  
海南 | 52个 | 0 | 189ms | 3.4% | 贵州 | 159个 | 0 | 212ms | 4.2%  
江苏 | 351个 | 12个 | 190ms | 8.8% | 四川 | 285个 | 0 | 213ms | 2.3%  
重庆 | 37个 | 3个 | 192ms | 2.9% | 上海 | 27个 | 4个 | 214ms | 0  
浙江 | 250个 | 7个 | 194ms | 2.3% | 山西 | 197个 | 3个 | 216ms | 3.8%  
广西 | 243个 | 4个 | 194ms | 3.8% | 河南 | 387个 | 0 | 222ms | 16.7%  
青海 | 16个 | 0 | 195ms | 6.3% | 陕西 | 175个 | 0 | 223ms | 10.1%  
湖北 | 217个 | 0 | 196ms | 3.1% | 甘肃 | 112个 | 0 | 223ms | 9.3%  
湖南 | 261个 | 0 | 196ms | 2.5% | 内蒙古 | 232个 | 0 | 223ms | 8.1%  
安徽 | 242个 | 0 | 201ms | 14.9% | 云南 | 135个 | 0 | 225ms | 5.8%  
江西 | 139个 | 4个 | 203ms | 11.1% | 黑龙江 | 204个 | 0 | 236ms | 15.8%  
宁夏 | 32个 | 0 | 204ms | 10.9% | 新疆 | 155个 | 0 | 259ms | 13.6%  
河北 | 256个 | 0 | 207ms | 13.8% | 西藏 | 8个 | 0 | 448ms | 39.8%  
...
海外线路到Linode美国-佛利蒙机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 3个 | 0 | 21ms | 0 | 香港 | 66个 | 3个 | 161ms | 0  
美国 | 48个 | 0 | 52ms | 3.8% | 德国 | 9个 | 0 | 161ms | 0  
加拿大 | 15个 | 0 | 81ms | 0 | 均值 | 234个 | 3个 | 175ms | 1.2%  
巴西 | 3个 | 0 | 139ms | 0 | 英国 | 6个 | 0 | 180ms | 0.5%  
日本 | 3个 | 0 | 140ms | 2.0% | 俄罗斯 | 3个 | 0 | 191ms | -  
意大利 | 3个 | 0 | 140ms | - | 南非 | 6个 | 0 | 192ms | 2.0%  
新加坡 | 15个 | 0 | 141ms | 0 | 澳大利亚 | 6个 | 0 | 229ms | 0  
韩国 | 21个 | 0 | 148ms | 0 | 印度尼西亚 | 6个 | 0 | 259ms | 0  
法国 | 3个 | 0 | 160ms | 0 | 马来西亚 | 12个 | 0 | 306ms | 1.3%  
台湾 | 3个 | 0 | 160ms | 10.0% | 菲律宾 | 3个 | 0 | 470ms | 0  
