...
大陆各省份到Linode美国-佛利蒙机房的测速数据 [20180514] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
上海 | 7个 | 0 | 171ms | 2.9% | 陕西 | 30个 | 0 | 225ms | 9.1%  
天津 | 5个 | 0 | 176ms | 2.2% | 均值 | 957个 | 9个 | 225ms | 10.7%  
福建 | 36个 | 1个 | 197ms | 4.3% | 云南 | 23个 | 0 | 226ms | 10.0%  
广东 | 78个 | 1个 | 199ms | 6.9% | 四川 | 49个 | 0 | 229ms | 5.5%  
北京 | 8个 | 1个 | 201ms | 8.9% | 河南 | 59个 | 0 | 235ms | 14.5%  
安徽 | 42个 | 0 | 203ms | 15.4% | 辽宁 | 39个 | 0 | 235ms | 10.8%  
江苏 | 59个 | 1个 | 204ms | 14.6% | 宁夏 | 12个 | 0 | 238ms | 15.3%  
海南 | 10个 | 0 | 204ms | 5.2% | 浙江 | 47个 | 3个 | 239ms | 15.9%  
广西 | 38个 | 0 | 206ms | 8.9% | 山东 | 49个 | 2个 | 242ms | 13.4%  
吉林 | 14个 | 0 | 208ms | 4.8% | 山西 | 36个 | 0 | 248ms | 12.2%  
重庆 | 15个 | 0 | 208ms | 5.0% | 黑龙江 | 38个 | 0 | 250ms | 12.4%  
贵州 | 26个 | 0 | 209ms | 7.9% | 内蒙古 | 34个 | 0 | 252ms | 11.1%  
湖北 | 45个 | 0 | 218ms | 5.6% | 甘肃 | 22个 | 0 | 261ms | 14.2%  
河北 | 31个 | 0 | 219ms | 6.7% | 青海 | 4个 | 0 | 262ms | 13.3%  
江西 | 26个 | 0 | 221ms | 12.4% | 新疆 | 29个 | 0 | 285ms | 16.0%  
湖南 | 46个 | 0 | 222ms | 15.0% |  |  |  |  |   
...
海外线路到Linode美国-佛利蒙机房的测速数据 [20180514] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 18个 | 0 | 17ms | 1.7% | 新加坡 | 6个 | 0 | 176ms | 0  
加拿大 | 3个 | 0 | 81ms | 1.0% | 均值 | 77个 | 0 | 177ms | 0.3%  
日本 | 2个 | 0 | 127ms | 0 | 巴西 | 1个 | 0 | 181ms | 0  
韩国 | 13个 | 0 | 138ms | 0 | 香港 | 18个 | 0 | 185ms | 0  
法国 | 2个 | 0 | 150ms | 0 | 菲律宾 | 1个 | 0 | 188ms | 0  
英国 | 2个 | 0 | 152ms | 1.5% | 俄罗斯 | 1个 | 0 | 235ms | 0  
德国 | 2个 | 0 | 159ms | 0 | 马来西亚 | 3个 | 0 | 242ms | 0.7%  
澳大利亚 | 2个 | 0 | 172ms | 0 | 印度尼西亚 | 1个 | 0 | 303ms | 0  
台湾 | 1个 | 0 | 173ms | - | 南非 | 1个 | 0 | 341ms | 0  
