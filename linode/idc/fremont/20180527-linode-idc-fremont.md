...
大陆各省份到Linode美国-佛利蒙机房的测速数据 [20180527] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
天津 | 5个 | 0 | 177ms | 7.2% | 湖南 | 44个 | 1个 | 197ms | 7.2%  
广东 | 79个 | 0 | 179ms | 2.6% | 辽宁 | 40个 | 0 | 197ms | 6.2%  
上海 | 8个 | 0 | 179ms | 0 | 均值 | 973个 | 9个 | 197ms | 4.5%  
北京 | 8个 | 1个 | 182ms | 4.7% | 贵州 | 26个 | 0 | 198ms | 4.1%  
福建 | 36个 | 0 | 183ms | 3.8% | 陕西 | 33个 | 0 | 199ms | 4.4%  
江苏 | 62个 | 1个 | 187ms | 4.9% | 吉林 | 19个 | 0 | 200ms | 4.5%  
广西 | 39个 | 0 | 187ms | 5.7% | 内蒙古 | 34个 | 0 | 202ms | 6.3%  
河北 | 36个 | 0 | 190ms | 5.7% | 宁夏 | 12个 | 0 | 203ms | 3.4%  
海南 | 14个 | 0 | 191ms | 5.1% | 云南 | 22个 | 0 | 205ms | 2.0%  
河南 | 56个 | 1个 | 192ms | 5.2% | 湖北 | 44个 | 0 | 206ms | 2.4%  
山东 | 54个 | 2个 | 192ms | 4.8% | 四川 | 47个 | 0 | 207ms | 3.9%  
山西 | 37个 | 1个 | 192ms | 6.3% | 黑龙江 | 40个 | 1个 | 213ms | 5.3%  
浙江 | 48个 | 0 | 193ms | 4.3% | 甘肃 | 23个 | 0 | 221ms | 2.7%  
重庆 | 14个 | 1个 | 193ms | 2.6% | 青海 | 4个 | 0 | 223ms | 8.3%  
江西 | 24个 | 0 | 196ms | 3.4% | 新疆 | 28个 | 0 | 249ms | 4.7%  
安徽 | 37个 | 0 | 196ms | 2.1% |  |  |  |  |   
...
海外线路到Linode美国-佛利蒙机房的测速数据 [20180527] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 21个 | 0 | 14ms | 1.1% | 新加坡 | 6个 | 0 | 178ms | 0  
加拿大 | 3个 | 0 | 82ms | 0 | 巴西 | 1个 | 0 | 182ms | 0  
日本 | 1个 | 0 | 119ms | 0 | 均值 | 88个 | 0 | 183ms | 0.3%  
韩国 | 12个 | 0 | 141ms | 0 | 澳大利亚 | 2个 | 0 | 195ms | 0  
台湾 | 1个 | 0 | 142ms | - | 越南 | 2个 | 0 | 206ms | 0  
意大利 | 1个 | 0 | 142ms | - | 俄罗斯 | 1个 | 0 | 231ms | 0  
荷兰 | 1个 | 0 | 149ms | 0 | 马来西亚 | 5个 | 0 | 254ms | 0  
英国 | 2个 | 0 | 150ms | 0 | 印度尼西亚 | 1个 | 0 | 271ms | 0  
德国 | 3个 | 0 | 153ms | 0 | 柬埔寨 | 1个 | 0 | 292ms | 2.0%  
法国 | 1个 | 0 | 153ms | 0 | 菲律宾 | 1个 | 0 | 297ms | 1.0%  
香港 | 20个 | 0 | 170ms | 0 | 南非 | 2个 | 0 | 324ms | 1.0%  
