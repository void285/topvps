...
大陆各省份到Linode美国-达拉斯机房的测速数据 [20180426] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
吉林 | 16个 | 0 | 256ms | 12.4% | 贵州 | 23个 | 0 | 291ms | 6.7%  
重庆 | 10个 | 0 | 266ms | 8.7% | 均值 | 842个 | 4个 | 292ms | 13.1%  
宁夏 | 10个 | 0 | 268ms | 2.5% | 山东 | 48个 | 0 | 299ms | 10.0%  
广东 | 55个 | 0 | 269ms | 9.1% | 江西 | 21个 | 0 | 300ms | 20.4%  
湖北 | 38个 | 0 | 271ms | 22.6% | 陕西 | 27个 | 0 | 300ms | 8.1%  
广西 | 35个 | 0 | 271ms | 6.3% | 河南 | 51个 | 0 | 302ms | 17.1%  
山西 | 33个 | 0 | 271ms | 12.3% | 河北 | 31个 | 0 | 302ms | 13.5%  
浙江 | 40个 | 2个 | 272ms | 17.7% | 辽宁 | 36个 | 0 | 303ms | 12.6%  
上海 | 8个 | 0 | 272ms | 9.0% | 安徽 | 38个 | 0 | 305ms | 18.5%  
天津 | 4个 | 0 | 274ms | 21.7% | 湖南 | 39个 | 0 | 306ms | 10.9%  
四川 | 44个 | 0 | 281ms | 8.8% | 云南 | 25个 | 0 | 313ms | 10.6%  
海南 | 12个 | 0 | 281ms | 4.8% | 福建 | 27个 | 0 | 315ms | 14.2%  
江苏 | 49个 | 1个 | 285ms | 20.8% | 甘肃 | 21个 | 1个 | 337ms | 14.8%  
北京 | 3个 | 0 | 288ms | 17.3% | 青海 | 4个 | 0 | 339ms | 7.0%  
内蒙古 | 31个 | 0 | 289ms | 10.9% | 西藏 | 1个 | 0 | 341ms | 0  
黑龙江 | 34个 | 0 | 290ms | 12.9% | 新疆 | 28个 | 0 | 359ms | 16.6%  
...
海外线路到Linode美国-达拉斯机房的测速数据 [20180426] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
美国 | 16个 | 0 | 34ms | 0 | 香港 | 19个 | 0 | 201ms | 0  
加拿大 | 3个 | 0 | 36ms | 0 | 新加坡 | 5个 | 0 | 205ms | 0  
法国 | 2个 | 0 | 113ms | 0 | 俄罗斯 | 1个 | 0 | 217ms | 0  
荷兰 | 2个 | 0 | 119ms | 0 | 澳大利亚 | 2个 | 0 | 223ms | 0  
英国 | 3个 | 0 | 122ms | 0 | 马来西亚 | 4个 | 0 | 225ms | 0.3%  
德国 | 1个 | 0 | 125ms | 0 | 越南 | 1个 | 0 | 250ms | 0  
日本 | 3个 | 1个 | 153ms | 0.5% | 南非 | 1个 | 0 | 265ms | 0  
韩国 | 12个 | 0 | 186ms | 0 | 印度尼西亚 | 1个 | 0 | 265ms | 2.0%  
均值 | 79个 | 1个 | 189ms | 0.6% | 菲律宾 | 1个 | 0 | 266ms | 2.0%  
台湾 | 1个 | 0 | 192ms | - | 柬埔寨 | 1个 | 0 | 393ms | 6.0%  
