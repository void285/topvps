...
大陆各省份到Linode美国-达拉斯机房的测速数据 [20180804] 省份 | 测速点 | 超时点 | 响应时间 | 丢包率 | 省份 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
海南 | 52个 | 0 | 232ms | 0.6% | 福建 | 172个 | 0 | 263ms | 4.8%  
广东 | 441个 | 0 | 234ms | 2.0% | 安徽 | 239个 | 0 | 265ms | 6.2%  
广西 | 243个 | 0 | 240ms | 1.3% | 山西 | 197个 | 6个 | 265ms | 5.8%  
湖南 | 265个 | 0 | 242ms | 2.3% | 辽宁 | 230个 | 3个 | 265ms | 7.2%  
山东 | 370个 | 0 | 243ms | 2.6% | 宁夏 | 32个 | 0 | 268ms | 4.1%  
江苏 | 337个 | 6个 | 243ms | 3.3% | 云南 | 135个 | 0 | 271ms | 6.3%  
浙江 | 246个 | 13个 | 245ms | 3.4% | 甘肃 | 112个 | 0 | 271ms | 3.5%  
北京 | 32个 | 0 | 247ms | 3.7% | 天津 | 20个 | 0 | 272ms | 15.0%  
湖北 | 213个 | 0 | 250ms | 2.7% | 陕西 | 163个 | 0 | 272ms | 3.0%  
河北 | 248个 | 0 | 251ms | 4.6% | 内蒙古 | 224个 | 0 | 273ms | 7.8%  
江西 | 139个 | 7个 | 253ms | 2.1% | 上海 | 28个 | 4个 | 273ms | 8.9%  
重庆 | 37个 | 0 | 256ms | 3.0% | 河南 | 363个 | 0 | 286ms | 6.6%  
四川 | 289个 | 0 | 258ms | 1.3% | 黑龙江 | 196个 | 0 | 289ms | 5.0%  
均值 | 5453个 | 39个 | 259ms | 4.0% | 青海 | 16个 | 0 | 294ms | 2.3%  
贵州 | 155个 | 0 | 262ms | 4.5% | 新疆 | 155个 | 0 | 302ms | 3.2%  
吉林 | 96个 | 0 | 262ms | 4.2% | 西藏 | 8个 | 0 | 470ms | 8.2%  
...
海外线路到Linode美国-达拉斯机房的测速数据 [20180804] 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率 | 国家地区 | 测速点 | 超时点 | 响应时间 | 丢包率  
---|---|---|---|---|---|---|---|---|---  
荷兰 | 3个 | 0 | 25ms | 0 | 新加坡 | 15个 | 0 | 175ms | 0  
加拿大 | 15个 | 0 | 47ms | 0 | 均值 | 237个 | 0 | 175ms | 1.0%  
美国 | 48个 | 0 | 71ms | 0 | 香港 | 66个 | 0 | 180ms | 1.4%  
意大利 | 3个 | 0 | 107ms | - | 法国 | 3个 | 0 | 197ms | 0  
巴西 | 3个 | 0 | 108ms | 0 | 南非 | 6个 | 0 | 198ms | 0.5%  
英国 | 6个 | 0 | 137ms | 0 | 台湾 | 3个 | 0 | 203ms | 0  
德国 | 9个 | 0 | 152ms | 0 | 澳大利亚 | 6个 | 0 | 203ms | 0  
俄罗斯 | 3个 | 0 | 157ms | - | 印度尼西亚 | 6个 | 0 | 245ms | 0  
日本 | 6个 | 0 | 167ms | 1.0% | 马来西亚 | 12个 | 0 | 251ms | 1.5%  
韩国 | 21个 | 0 | 168ms | 0 | 菲律宾 | 3个 | 0 | 530ms | 13.3%  
